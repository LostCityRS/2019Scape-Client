...
public abstract class IcmpService implements Runnable {
	...
	protected abstract void method14892(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!jaclib/ping/IcmpService", name = "notify", descriptor = "(III)V")
	protected abstract void method14893(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);
	...
	protected abstract void method14894(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!jaclib/ping/IcmpService", name = "n", descriptor = "(I)V")
	protected abstract void method14895(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!jaclib/ping/IcmpService", name = "m", descriptor = "(III)V")
	protected abstract void method14896(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "client!jaclib/ping/IcmpService", name = "k", descriptor = "(III)V")
	protected abstract void method14897(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);
}
