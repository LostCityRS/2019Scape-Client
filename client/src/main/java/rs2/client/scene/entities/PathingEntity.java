...
public abstract class PathingEntity extends PrimaryLayerEntity implements CameraTrackable {
	...
	public PathingEntity(Scene arg0, int arg1, VarTypeList arg2) {
		...
		this.field10408 = 0;
		this.field10410 = 0;
		this.field10411 = new int[Statics.field11389.field7758];
		this.field10412 = new int[Statics.field11389.field7758];
	...
	public int method16523() {
		return this.field10463 == -32768 ? 0 : this.field10463;
	}
	...
	public void method16493(int[] arg0, int[] arg1) {
		if (this.field10418 == null && arg0 != null) {
			this.field10418 = new int[Statics.field1709.field7766.length];
		} else if (arg0 == null) {
	...
	public boolean method16583(int arg0, int arg1) {
		if (this.field10442 == null) {
			...
			this.field10442 = new int[Statics.field1709.field7766.length];
			for (int var3 = 0; var3 < Statics.field1709.field7766.length; var3++) {
		...
		if (arg1 != -1) {
			...
			for (int var9 = 0; var9 < Statics.field1709.field7766.length; var9++) {
	...
	public void method16576(Renderer arg0, Model[] arg1, Matrix4x3 arg2, boolean arg3) {
		if (!arg3) {
			...
			if (this.field10393 != null) {
				...
				this.field10393.method9936(arg0, (long) Client.field10903, var15, var19, false);
				this.field10449 = true;
			}
		} else if (this.field10393 != null) {
			this.field10393.method9935((long) Client.field10903);
		}
		if (this.field10393 != null) {
			this.field10393.method9963(this.field11717, this.field12471, this.field12472, this.field12468, this.field12467);
		}
	}
	...
	public final void method16563(int arg0, int arg1, int arg2, int arg3, boolean arg4, int arg5) {
		...
		if (arg0 != -1 && var8 != -1) {
			if (arg0 == var8) {
				EffectAnimType var9 = (EffectAnimType) Statics.field4874.getById(arg0);
				if (var9.field8261 && var9.anim != -1) {
					SeqType var10 = (SeqType) Statics.field8797.getById(var9.anim);
				...
				EffectAnimType var12 = (EffectAnimType) Statics.field4874.getById(arg0);
				EffectAnimType var13 = (EffectAnimType) Statics.field4874.getById(var8);
				if (var12.anim != -1 && var13.anim != -1) {
					SeqType var14 = (SeqType) Statics.field8797.getById(var12.anim);
					SeqType var15 = (SeqType) Statics.field8797.getById(var13.anim);
		...
		byte var16 = 0;
		if (arg0 != -1 && !((EffectAnimType) Statics.field4874.getById(arg0)).field8261) {
			var16 = 2;
		}
		if (arg0 != -1 && arg4) {
			var16 = 1;
		...
		var7.field6660 = arg2;
		var7.field6659.method14353(arg0 == -1 ? -1 : ((EffectAnimType) Statics.field4874.getById(arg0)).anim, arg1 & 0xFFFF, var16, false);
	}
	...
	public final void method16498(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
		boolean var7 = true;
		boolean var8 = true;
		for (int var9 = 0; var9 < Statics.field11389.field7758; var9++) {
		...
		int var12 = 0;
		if (arg0 >= 0) {
			HitmarkType var13 = (HitmarkType) Statics.field2936.getById(arg0);
		...
		if (var8) {
			...
			for (int var15 = 1; var15 < Statics.field11389.field7758; var15++) {
				if (var11 == 0) {
			...
			for (int var16 = 0; var16 < Statics.field11389.field7758; var16++) {
				byte var17 = this.field10410;
				this.field10410 = (byte) ((this.field10410 + 1) % Statics.field11389.field7758);
	...
	public final void method16499(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
		HeadbarType var7 = (HeadbarType) Statics.field4894.getById(arg0);
		Headbar var8 = null;
		Headbar var9 = null;
		...
		if (var11 >= Statics.field11389.field7745) {
			var9.method8433();
		}
	}
	...
	public final void method16500(int arg0) {
		HeadbarType var2 = (HeadbarType) Statics.field4894.getById(arg0);
	...
	public void method16505(Model arg0) {
		...
		int var4 = arg0.method1748() / 2;
		arg0.method1805(0, -var4, 0);
		arg0.method1696(var2 & 0x3FFF);
		arg0.method1852(var3 & 0x3FFF);
		arg0.method1805(0, var4, 0);
	}
	...
	public void method16506(Renderer arg0, BASType arg1, int arg2, int arg3, int arg4, int arg5) {
		for (int var7 = 0; var7 < this.field10422.length; var7++) {
			...
			if (var9.field6657 == -1 || var9.field6659.method14355()) {
				...
				EffectAnimType var10 = (EffectAnimType) Statics.field4874.getById(var9.field6657);
				int var11 = arg2;
				if (var9.field6660 != 0) {
					var11 = arg2 | 0x5;
				}
				...
				if (var9.field6658 < 0 || arg1.field7357 == null || arg1.field7357[var9.field6658] == null) {
					...
					if (var12 != null) {
						...
						var12.method1805(var13, var14, var15);
						if (var9.field6661 != 0) {
							var12.method1805(0, -var9.field6661 << 2, 0);
						}
	...
	public void method16507(int arg0, int arg1, int arg2, int arg3, int arg4) {
		...
		int var15 = Statics.method15200((int) var6.field4308 + var13, (int) var6.field4313 + var14, var7, var8, this.field11717);
		int var16 = arg1 / 2;
		int var17 = -arg2 / 2;
		int var18 = var9 * var17 + var10 * var16 >> 14;
		int var19 = var10 * var17 - var9 * var16 >> 14;
		int var20 = Statics.method15200((int) var6.field4308 + var18, (int) var6.field4313 + var19, var7, var8, this.field11717);
		int var21 = -arg1 / 2;
		int var22 = arg2 / 2;
		int var23 = var9 * var22 + var10 * var21 >> 14;
		int var24 = var10 * var22 - var9 * var21 >> 14;
		int var25 = Statics.method15200((int) var6.field4308 + var23, (int) var6.field4313 + var24, var7, var8, this.field11717);
		int var26 = arg1 / 2;
		int var27 = arg2 / 2;
		int var28 = var9 * var27 + var10 * var26 >> 14;
		int var29 = var10 * var27 - var9 * var26 >> 14;
		int var30 = Statics.method15200((int) var6.field4308 + var28, (int) var6.field4313 + var29, var7, var8, this.field11717);
	...
	public BASType method16508() {
		...
		return var1 == -1 ? BASTypeList.field11886 : (BASType) Statics.field11742.getById(var1);
	}

	@ObfuscatedName("ahm.cl(B)V")
	public void method16520() {
		if (this.field10409 != null && this.field10409.field6682 != null) {
			this.field10409.field6683--;
			if (this.field10409.field6683 == 0) {
				this.field10409.field6682 = null;
			}
		}
	}
	...
	public void method16571(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
		if (this.method16515()) {
			Client.method17231(this.field10461, this.field10461.method3923(), -1, arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
		}
	}
	...
	public void method16518(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
		if (this.method16515()) {
			Client.method6797(this.field10461.method3923(), -1, arg1, arg2, arg3, arg4, arg5, arg6, arg0, false);
		} else if (arg0 == -1) {
	...
	public abstract int method16486();

	@ObfuscatedName("ahm.bj(S)I")
	public abstract int method16509();
