...
public final class Client extends GameShell {
	...
	public static LinkedList hookRequests = new LinkedList();

	@ObfuscatedName("client.st")
	public static LinkedList hookRequestsTimer = new LinkedList();

	@ObfuscatedName("client.sl")
	public static LinkedList hookRequestsMouseStop = new LinkedList();
	...
	public final void updateTitleScreen() {
		...
		while (true) {
			...
			Component var18;
			do {
				var16 = (HookRequest) hookRequestsTimer.pollFront();
				if (var16 == null) {
					while (true) {
						HookRequest var19;
						Component var20;
						Component var21;
						do {
							var19 = (HookRequest) hookRequestsMouseStop.pollFront();
							if (var19 == null) {
								while (true) {
									HookRequest var22;
									Component var23;
									Component var24;
									do {
										var22 = (HookRequest) hookRequests.pollFront();
										if (var22 == null) {
											if (field10989 != null) {
												method6847();
											}
	...
	public static final void updateGame() {
		...
		while (true) {
			...
			Component var32;
			do {
				var30 = (HookRequest) hookRequestsTimer.pollFront();
				if (var30 == null) {
					while (true) {
						HookRequest var33;
						Component var34;
						Component var35;
						do {
							var33 = (HookRequest) hookRequestsMouseStop.pollFront();
							if (var33 == null) {
								while (true) {
									HookRequest var36;
									Component var37;
									Component var38;
									do {
										var36 = (HookRequest) hookRequests.pollFront();
										if (var36 == null) {
	...
	public static final void updateInterfaces() {
		...
		for (DelayedStateChange var1 = DelayedStateChange.poll(); var1 != null; var1 = DelayedStateChange.poll()) {
			...
			if (var2 == 1) {
				...
				clientVariableManager.setVarValueInt(var5, var1.int0);
				varcTransmitted[++varcTransmitNum - 1 & 0x3F] = (int) var3;
			} else if (var2 == 2) {
				VarType var6 = (VarType) varBasicTypeList.list((int) var3);
				clientVariableManager.setVarValue(var6, var1.str0);
	...
	public static final boolean read(ServerConnection connection) throws IOException {
		...
		if (ServerProt.IF_SETTEXTANTIMACRO == connection.packetType) {
			...
			incrementVerifyId();
			DelayedStateChange.onServerSetTextAntimacro(var5, var6);
			...
			int var9 = in.g2();
			incrementVerifyId();
			DelayedStateChange.onServerVarc(var9, var8);
			connection.packetType = null;
			return true;
			...
			int var44 = in.g4s();
			incrementVerifyId();
			DelayedStateChange.onServerSetColour(var44, var43);
			connection.packetType = null;
			return true;
			...
			incrementVerifyId();
			DelayedStateChange.onServerSetModelZoom(var61, var62, var63, var64);
			connection.packetType = null;
			return true;
			...
			incrementVerifyId();
			DelayedStateChange.onServerVarcbit(var80, var81);
			connection.packetType = null;
			return true;
			...
			incrementVerifyId();
			DelayedStateChange.onServerSetHide(var154, var155);
			connection.packetType = null;
			return true;
			...
			incrementVerifyId();
			DelayedStateChange.onServerSetModel(var196, 7, var198 << 16 | var195, var197);
			connection.packetType = null;
			return true;
			...
			int var217 = -var216 - 2;
			incrementVerifyId();
			DelayedStateChange.onServerSetModel(var215, 5, var217, 0);
			connection.packetType = null;
			return true;
		} else if (ServerProt.IF_SETPLAYERMODEL_SELF == connection.packetType) {
			int var218 = in.g4s();
			incrementVerifyId();
			DelayedStateChange.onServerSetModel(var218, 5, currentPlayerUid, 0);
			connection.packetType = null;
			return true;
			...
			int var230 = in.g4s();
			incrementVerifyId();
			DelayedStateChange.onServerSetModel(var229, 1, var230, -1);
			connection.packetType = null;
			return true;
			...
			incrementVerifyId();
			DelayedStateChange.onServerVarcbit(var231, var232);
			connection.packetType = null;
			return true;
			...
			incrementVerifyId();
			DelayedStateChange.onServerSetGraphic(var235, var234);
			connection.packetType = null;
			return true;
			...
			incrementVerifyId();
			DelayedStateChange.onServerVarc(var263, var262);
			connection.packetType = null;
			return true;
			...
			incrementVerifyId();
			DelayedStateChange.onServerSetModel(var272, 3, var271, var270);
			connection.packetType = null;
			return true;
			...
			incrementVerifyId();
			DelayedStateChange.onServerSetText(var282, var283);
			connection.packetType = null;
			return true;
			...
			incrementVerifyId();
			DelayedStateChange.onServerSetModel(var319, 3, currentPlayerUid, 0);
			connection.packetType = null;
			return true;
			...
			DelayedStateChange.onServerSetMapFlag(var518, var519);
			connection.packetType = null;
			return true;
			...
			incrementVerifyId();
			DelayedStateChange.onServerSetObjectData(var528, var527, var529);
			ObjType var530 = (ObjType) objTypeList.list(var527);
			DelayedStateChange.onServerSetModelZoom(var528, var530.xan2d, var530.yan2d, var530.zoom2d);
			DelayedStateChange.onServerSetModelAngle(var528, var530.xof2d, var530.yof2d, var530.zan2d);
			connection.packetType = null;
			return true;
			...
			incrementVerifyId();
			DelayedStateChange.onServerSetTextFont(var573, var574);
			connection.packetType = null;
			return true;
			...
			incrementVerifyId();
			DelayedStateChange.onServerSetPosition(var643, var641, var642);
			connection.packetType = null;
			return true;
			...
			incrementVerifyId();
			DelayedStateChange.onServerSetModelAnim(var658, var659);
			connection.packetType = null;
			return true;
			...
			incrementVerifyId();
			DelayedStateChange.onServerSetClickMask(var664, var665);
			connection.packetType = null;
			return true;
			...
			incrementVerifyId();
			DelayedStateChange.onServerVarcString(var670, var671);
			connection.packetType = null;
			return true;
			...
			incrementVerifyId();
			DelayedStateChange.onServerSetScrollPos(var685, var686);
			connection.packetType = null;
			return true;
			...
			incrementVerifyId();
			DelayedStateChange.onServerSetModel(var687, 2, var688, -1);
			connection.packetType = null;
			return true;
			...
			incrementVerifyId();
			DelayedStateChange.onServerSetRecol(var708, var709, var706, var707);
			connection.packetType = null;
			return true;
			...
			int var715 = in.g4s();
			incrementVerifyId();
			DelayedStateChange.onServerSetModel(var714, 5, var713, var715);
			connection.packetType = null;
			return true;
			...
			incrementVerifyId();
			DelayedStateChange.onServerVarcString(var717, var718);
			connection.packetType = null;
			return true;
		} else {
							...
							if (child.type == 3) {
								...
								if (child.invobject != -1) {
									...
									if (var69 && var68 != null && var68.model != null) {
										var60 = var68.model.method10126(toolkit, var61, basTypeList, idkTypeList, npcTypeList, objTypeList, localPlayerGameState, localPlayerGameState, child.modelAnimator, null, null, null, 0, true, wearposDefaults);
									}
					...
					if (!ifIsVisible(var12)) {
						...
						if (var12.field2324 || var15 < var17 && var16 < var18) {
							if (var12.noclickthrough && arg9 >= var15 && arg10 >= var16 && arg9 < var17 && arg10 < var18) {
								for (HookRequest var21 = (HookRequest) hookRequests.peekFront(); var21 != null; var21 = (HookRequest) hookRequests.prev()) {
							...
							if (var12.hashook || var12.clientcode != 0) {
								...
								if (var12.held && !var28) {
									...
									if (var12.onrelease != null) {
										...
										hookRequestsMouseStop.pushBack(var78);
									}
								}
								...
								if (var12.field2350 && !var23) {
									...
									if (var12.onmouseleave != null) {
										...
										hookRequestsMouseStop.pushBack(var82);
									}
								}
								if (var12.ontimer != null) {
									...
									hookRequestsTimer.pushBack(var83);
								}
