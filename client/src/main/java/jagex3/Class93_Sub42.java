...
public final class Class93_Sub42 extends Class93 {
	...
	@OriginalMember(owner = "client!aly", name = "<init>", descriptor = "(Z)V")
	public Class93_Sub42(@OriginalArg(0) boolean arg0) {
		if (arg0) {
			if (Class339.aString185.startsWith("win")) {
				this.anInt2058 = 1520491363;
			} else if (Class339.aString185.startsWith("mac")) {
				this.anInt2058 = -1253984570;
			} else if (Class339.aString185.startsWith("linux")) {
				this.anInt2058 = 266506793;
			} else {
				this.anInt2058 = 1786998156;
			}
			if (Class320.aString179.startsWith("amd64") || Class320.aString179.startsWith("x86_64")) {
				this.aBoolean363 = true;
			} else {
				this.aBoolean363 = false;
			}
			if (this.anInt2058 * 2065137227 == 1) {
				if (Class672.aString247.indexOf("4.0") != -1) {
					this.anInt2041 = -604099985;
				} else if (Class672.aString247.indexOf("4.1") != -1) {
					this.anInt2041 = -1208199970;
				} else if (Class672.aString247.indexOf("4.9") != -1) {
					this.anInt2041 = -1812299955;
				} else if (Class672.aString247.indexOf("5.0") != -1) {
					this.anInt2041 = 1878567356;
				} else if (Class672.aString247.indexOf("5.1") != -1) {
					this.anInt2041 = 1274467371;
				} else if (Class672.aString247.indexOf("5.2") != -1) {
					this.anInt2041 = -537832584;
				} else if (Class672.aString247.indexOf("6.0") != -1) {
					this.anInt2041 = 670367386;
				} else if (Class672.aString247.indexOf("6.1") != -1) {
					this.anInt2041 = 66267401;
				} else if (Class672.aString247.indexOf("6.2") != -1) {
					this.anInt2041 = -1141932569;
				} else if (Class672.aString247.indexOf("6.3") != -1) {
					this.anInt2041 = -1746032554;
				} else if (Class672.aString247.indexOf("10.0") != -1) {
					this.anInt2041 = 1944834757;
				}
			} else if (this.anInt2058 * 2065137227 == 2) {
				if (Class672.aString247.indexOf("10.4") != -1) {
					this.anInt2041 = 802902188;
				} else if (Class672.aString247.indexOf("10.5") != -1) {
					this.anInt2041 = 198802203;
				} else if (Class672.aString247.indexOf("10.6") != -1) {
					this.anInt2041 = -405297782;
				} else if (Class672.aString247.indexOf("10.7") != -1) {
					this.anInt2041 = -1009397767;
				} else if (Class672.aString247.indexOf("10.8") != -1) {
					this.anInt2041 = -1613497752;
				} else if (Class672.aString247.indexOf("10.9") != -1) {
					this.anInt2041 = 2077369559;
				} else if (Class672.aString247.indexOf("10.10") != -1) {
					this.anInt2041 = 1473269574;
				} else if (Class672.aString247.indexOf("10.11") != -1) {
					this.anInt2041 = 869169589;
				}
			}
			if (Class392.aString206.toLowerCase().indexOf("sun") != -1) {
				this.anInt2047 = 1324620785;
			} else if (Class392.aString206.toLowerCase().indexOf("microsoft") != -1) {
				this.anInt2047 = -1645725726;
			} else if (Class392.aString206.toLowerCase().indexOf("apple") != -1) {
				this.anInt2047 = -321104941;
			} else if (Class392.aString206.toLowerCase().indexOf("oracle") == -1) {
			...
			try {
				...
				if (local443 != null && local443.length % 5 == 0) {
					...
					if (local524 != null) {
						@Pc(531) Class93_Sub41 local531 = new Class93_Sub41(13);
						local531.method22408(local524.anInt119 * 1396359751, 1986541412);
						local531.method22408(local524.anInt122 * -762512765, 1023601104);
						local531.method22408(local524.anInt121 * -407508469, 1150404530);
						local531.anInt3070 = 0;
						this.aString55 = local531.method22439(1090969084);
					}
					...
					@Pc(625) Class93_Sub41 local625 = new Class93_Sub41(49);
					for (local493 = -2147483646; local493 <= -2147483644; local493++) {
						@Pc(636) Class37 local636 = (Class37) local455.get(local493);
						if (local636 != null) {
							local625.method22408(local636.anInt118 * 233985593, 847203018);
							local625.method22408(local636.anInt119 * 1396359751, 1391402069);
							local625.method22408(local636.anInt121 * -407508469, 1219806041);
							local625.method22408(local636.anInt122 * -762512765, 1535188596);
						}
					}
					local625.anInt3070 = 0;
					this.aString56 = local625.method22439(1400341971);
				}
		...
		this.method15309((short) 4473);
	}

	@OriginalMember(owner = "client!aly", name = "l", descriptor = "(Lclient!alw;)V")
	public void method15308(@OriginalArg(0) Class93_Sub41 arg0) {
		arg0.method22522(8, (byte) -128);
		arg0.method22522(this.anInt2058 * 2065137227, (byte) -74);
		arg0.method22522(this.aBoolean363 ? 1 : 0, (byte) -39);
		arg0.method22466(this.anInt2041 * -2131463025, 2127102055);
		arg0.method22522(this.anInt2047 * -1974110959, (byte) -65);
		arg0.method22522(this.anInt2045 * -2102924425, (byte) -29);
		arg0.method22522(this.anInt2049 * 1127818643, (byte) -12);
		arg0.method22522(this.anInt2036 * -1691907005, (byte) -124);
		arg0.method22522(this.aBoolean364 ? 1 : 0, (byte) -54);
		arg0.method22466(this.anInt2023 * -1954378101, 2137743820);
		arg0.method22522(this.anInt2053 * -1871990631, (byte) 1);
		arg0.method22406(this.anInt2055 * 714183489, (byte) 109);
		arg0.method22466(this.anInt2056 * 1094433601, 2126980591);
		arg0.method22415(this.aString52, 1516871641);
		arg0.method22415(this.aString57, 1516871641);
		arg0.method22415(this.aString53, 1516871641);
		arg0.method22415(this.aString54, 1516871641);
		arg0.method22522(this.anInt2060 * -1138260491, (byte) -74);
		arg0.method22466(this.anInt2059 * 856968677, 2142051520);
		arg0.method22415(this.aString55, 1516871641);
		arg0.method22415(this.aString56, 1516871641);
		arg0.method22522(this.anInt2033 * -66714701, (byte) -115);
		arg0.method22522(this.anInt2062 * 1212306539, (byte) -80);
		for (@Pc(151) int local151 = 0; local151 < this.anIntArray199.length; local151++) {
			arg0.method22407(this.anIntArray199[local151], (byte) 34);
		}
		arg0.method22407(this.anInt2063 * 728684047, (byte) -8);
		arg0.method22415(this.aString51, 1516871641);
	}

	@OriginalMember(owner = "client!aly", name = "e", descriptor = "(S)V")
	void method15309(@OriginalArg(0) short arg0) {
	...
	@OriginalMember(owner = "client!aly", name = "n", descriptor = "(Lclient!alw;I)V")
	public void method15310(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		arg0.method22522(8, (byte) -37);
		arg0.method22522(this.anInt2058 * 2065137227, (byte) -123);
		arg0.method22522(this.aBoolean363 ? 1 : 0, (byte) -78);
		arg0.method22466(this.anInt2041 * -2131463025, 2129353747);
		arg0.method22522(this.anInt2047 * -1974110959, (byte) -67);
		arg0.method22522(this.anInt2045 * -2102924425, (byte) -126);
		arg0.method22522(this.anInt2049 * 1127818643, (byte) -123);
		arg0.method22522(this.anInt2036 * -1691907005, (byte) -58);
		arg0.method22522(this.aBoolean364 ? 1 : 0, (byte) -113);
		arg0.method22466(this.anInt2023 * -1954378101, 2140591903);
		arg0.method22522(this.anInt2053 * -1871990631, (byte) -65);
		arg0.method22406(this.anInt2055 * 714183489, (byte) 89);
		arg0.method22466(this.anInt2056 * 1094433601, 2130906676);
		arg0.method22415(this.aString52, 1516871641);
		arg0.method22415(this.aString57, 1516871641);
		arg0.method22415(this.aString53, 1516871641);
		arg0.method22415(this.aString54, 1516871641);
		arg0.method22522(this.anInt2060 * -1138260491, (byte) -87);
		arg0.method22466(this.anInt2059 * 856968677, 2143582345);
		arg0.method22415(this.aString55, 1516871641);
		arg0.method22415(this.aString56, 1516871641);
		arg0.method22522(this.anInt2033 * -66714701, (byte) -41);
		arg0.method22522(this.anInt2062 * 1212306539, (byte) -53);
		for (@Pc(151) int local151 = 0; local151 < this.anIntArray199.length; local151++) {
			arg0.method22407(this.anIntArray199[local151], (byte) -28);
		}
		arg0.method22407(this.anInt2063 * 728684047, (byte) -109);
		arg0.method22415(this.aString51, 1516871641);
	}

	@OriginalMember(owner = "client!aly", name = "m", descriptor = "(I)I")
	public int method15311(@OriginalArg(0) int arg0) {
		@Pc(1) byte local1 = 39;
		@Pc(8) int local8 = local1 + Class582.method31595(this.aString52, 1642462336);
		@Pc(15) int local15 = local8 + Class582.method31595(this.aString57, 1178809023);
		@Pc(22) int local22 = local15 + Class582.method31595(this.aString53, 1471923545);
		@Pc(29) int local29 = local22 + Class582.method31595(this.aString54, -1809860357);
		@Pc(36) int local36 = local29 + Class582.method31595(this.aString55, 1291092271);
		@Pc(43) int local43 = local36 + Class582.method31595(this.aString56, -924011362);
		return local43 + Class582.method31595(this.aString51, 1270568662);
	}

	@OriginalMember(owner = "client!aly", name = "f", descriptor = "()V")
	void method15312() {
		if (this.aString52.length() > 40) {
			this.aString52 = this.aString52.substring(0, 40);
		}
	...
	@OriginalMember(owner = "client!aly", name = "k", descriptor = "()V")
	void method15313() {
		if (this.aString52.length() > 40) {
			this.aString52 = this.aString52.substring(0, 40);
		}
	...
	@OriginalMember(owner = "client!aly", name = "w", descriptor = "(Lclient!alw;)V")
	public void method15314(@OriginalArg(0) Class93_Sub41 arg0) {
		arg0.method22522(8, (byte) -51);
		arg0.method22522(this.anInt2058 * 2065137227, (byte) -11);
		arg0.method22522(this.aBoolean363 ? 1 : 0, (byte) -127);
		arg0.method22466(this.anInt2041 * -2131463025, 2130321133);
		arg0.method22522(this.anInt2047 * -1974110959, (byte) -24);
		arg0.method22522(this.anInt2045 * -2102924425, (byte) -61);
		arg0.method22522(this.anInt2049 * 1127818643, (byte) -46);
		arg0.method22522(this.anInt2036 * -1691907005, (byte) -73);
		arg0.method22522(this.aBoolean364 ? 1 : 0, (byte) 2);
		arg0.method22466(this.anInt2023 * -1954378101, 2136415413);
		arg0.method22522(this.anInt2053 * -1871990631, (byte) -60);
		arg0.method22406(this.anInt2055 * 714183489, (byte) 94);
		arg0.method22466(this.anInt2056 * 1094433601, 2125577705);
		arg0.method22415(this.aString52, 1516871641);
		arg0.method22415(this.aString57, 1516871641);
		arg0.method22415(this.aString53, 1516871641);
		arg0.method22415(this.aString54, 1516871641);
		arg0.method22522(this.anInt2060 * -1138260491, (byte) -89);
		arg0.method22466(this.anInt2059 * 856968677, 2128055715);
		arg0.method22415(this.aString55, 1516871641);
		arg0.method22415(this.aString56, 1516871641);
		arg0.method22522(this.anInt2033 * -66714701, (byte) -110);
		arg0.method22522(this.anInt2062 * 1212306539, (byte) -36);
		for (@Pc(151) int local151 = 0; local151 < this.anIntArray199.length; local151++) {
			arg0.method22407(this.anIntArray199[local151], (byte) 47);
		}
		arg0.method22407(this.anInt2063 * 728684047, (byte) 57);
		arg0.method22415(this.aString51, 1516871641);
	}
}
