...
public final class Class32_Sub16 extends Class32 {

	@OriginalMember(owner = "client!aor", name = "w", descriptor = "I")
	public static final int anInt2413 = 64;

	@OriginalMember(owner = "client!aor", name = "<init>", descriptor = "(Lclient!zd;Lclient!zt;Lclient!py;Ljava/util/Map;)V")
