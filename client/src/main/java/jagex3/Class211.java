...
public final class Class211 implements SerializableEnum {
	...
	@OriginalMember(owner = "client!cr", name = "w", descriptor = "()[Lclient!cr;")
	static Class211[] method25516() {
		return new Class211[] { aClass211_12, aClass211_6, aClass211_3, aClass211_4, aClass211_5, aClass211_10, aClass211_1, aClass211_8, aClass211_9, aClass211_15, aClass211_7, aClass211_11, aClass211_13, aClass211_14, aClass211_2, aClass211_16, aClass211_17 };
	}

	@OriginalMember(owner = "client!cr", name = "u", descriptor = "()[Lclient!cr;")
	static Class211[] method25517() {
		return new Class211[] { aClass211_12, aClass211_6, aClass211_3, aClass211_4, aClass211_5, aClass211_10, aClass211_1, aClass211_8, aClass211_9, aClass211_15, aClass211_7, aClass211_11, aClass211_13, aClass211_14, aClass211_2, aClass211_16, aClass211_17 };
	}

	@OriginalMember(owner = "client!cr", name = "d", descriptor = "(I)Lclient!cr;")
	static Class211 method25519(@OriginalArg(0) int arg0) {
	...
	@OriginalMember(owner = "client!cr", name = "c", descriptor = "(I)Lclient!cr;")
	static Class211 method25520(@OriginalArg(0) int arg0) {
		@Pc(6) Class211 local6 = (Class211) Class107.method18131(Class430.method28941(-406593969), arg0, -1915563430);
		if (local6 == null) {
			local6 = aClass211_12;
		}
	...
	public static void method25521(@OriginalArg(0) int arg0) {
		if (Class127.method9264(929532042)) {
			Class132_Sub1_Sub3_Sub1.method12302(new Class668(), (short) 1002);
		}
	}

	@OriginalMember(owner = "client!cr", name = "m", descriptor = "(Lclient!als;I)V")
	public static void method25522(@OriginalArg(0) Class93_Sub39 arg0, @OriginalArg(1) int arg1) {
		Class689.method36704(arg0, 500000, 905886770);
	}

	@OriginalMember(owner = "client!cr", name = "bdh", descriptor = "(Lclient!yf;B)V")
	static void method25523(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(17) boolean local17 = arg0.anIntArray521[(arg0.anInt6052 -= 1189701933) * -1497248091] == 1;
		Class339.method27581(local17, -575951673);
	}

	@OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(IILjava/lang/String;II)V")
	Class211(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		this.anInt3638 = arg0 * -88555945;
		this.anInt3639 = arg1 * -641903087;
		this.anInt3640 = arg3 * -556072083;
	}

	@OriginalMember(owner = "client!cr", name = "z", descriptor = "()I")
	int method25514() {
		return this.anInt3640 * -1903657371;
	}

	@OriginalMember(owner = "client!cr", name = "m", descriptor = "(I)I")
	int method25515(@OriginalArg(0) int arg0) {
		return this.anInt3640 * -1903657371;
	}
	...
	@Override
	public int getId() {
		return this.anInt3639 * -1400874255;
	}
