...
public final class Class116_Sub1 extends Class116 {
	...
	@OriginalMember(owner = "client!agl", name = "<init>", descriptor = "(Lclient!aqv;Lclient!hn;)V")
	Class116_Sub1(@OriginalArg(0) Class104_Sub2_Sub2 arg0, @OriginalArg(1) Class318 arg1) {
		...
		if (arg1.aString176 != null) {
			...
			if (arg1.aClass309Array1 != null) {
				...
				for (local65 = 0; local65 < local63.length; local65++) {
					...
					local50.append("#define " + local73.aString167 + " " + local73.aString166 + '\n');
				}
			}
			local50.append(new String(arg0.method21333(this.aString39)));
		...
		if (arg1.aString177 != null) {
			...
			local50.append(new String(arg0.method21333(this.aString41)));
			this.aString37 = local50.toString();
		}
		Class713.method37024(this.anIntArray84, 0, this.anIntArray84.length, -1);
	}

	@OriginalMember(owner = "client!agl", name = "<init>", descriptor = "(Lclient!aqv;Lclient!ago;Lclient!hn;)V")
	...
	@OriginalMember(owner = "client!agl", name = "w", descriptor = "(Lclient!aql;FFF)V")
	@Override
	void method8463(@OriginalArg(0) Class93_Sub33_Sub1 arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3) {
		@Pc(3) int local3 = ((Class93_Sub33_Sub1_Sub2) arg0).method23680();
		...
		if (arg0.method23665(-1548677525) != Class323.aClass323_107) {
			throw new IllegalArgumentException_Sub1(arg0, "");
		}
		OpenGL.glUniform3f(local3, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!agl", name = "g", descriptor = "(Lclient!aql;F)V")
	@Override
	void method8477(@OriginalArg(0) Class93_Sub33_Sub1 arg0, @OriginalArg(1) float arg1) {
		...
		this.aMap10.put(local3, arg1);
		if (arg0.method23665(-811031715) != Class323.aClass323_92 && arg0.method23665(283681093) != Class323.aClass323_77) {
			throw new IllegalArgumentException_Sub1(arg0, "");
		}
		OpenGL.glUniform1f(local3, arg1);
	}

	@OriginalMember(owner = "client!agl", name = "n", descriptor = "()Z")
	@Override
	public boolean method8438() {
		...
		@Pc(112) int local112;
		for (local112 = 0; local112 < this.aClass115_Sub2_1.method8199((byte) -81); local112++) {
			if (this.aClass115_Sub2_1.method8200(local112, -1596755927) == this) {
				local110 = local112;
				break;
			}
		}
		...
		for (local112 = 0; local112 < this.aClass115_Sub2_1.method8230(-348623653); local112++) {
			local149 = this.aClass115_Sub2_1.method8201(local112, -2119497531);
			if (local149 != null) {
				local149.method23663(local110);
			}
		}
		for (local112 = 0; local112 < this.aClass115_Sub2_1.method8231(198685086); local112++) {
			local149 = this.aClass115_Sub2_1.method8228(local112, (byte) 6);
			if (local149 != null) {
				local149.method23663(local110);
			}
		}
	...
	@OriginalMember(owner = "client!agl", name = "k", descriptor = "(Lclient!aql;F)V")
	@Override
	void method8439(@OriginalArg(0) Class93_Sub33_Sub1 arg0, @OriginalArg(1) float arg1) {
		...
		this.aMap10.put(local3, arg1);
		if (arg0.method23665(964724587) != Class323.aClass323_92 && arg0.method23665(-343838246) != Class323.aClass323_77) {
			throw new IllegalArgumentException_Sub1(arg0, "");
		}
		OpenGL.glUniform1f(local3, arg1);
	}

	@OriginalMember(owner = "client!agl", name = "f", descriptor = "(Lclient!aql;FF)V")
	@Override
	void method8440(@OriginalArg(0) Class93_Sub33_Sub1 arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2) {
		...
		this.aMap10.put(local3, arg1);
		this.aMap11.put(local3, arg2);
		if (arg0.method23665(738288180) != Class323.aClass323_63) {
			throw new IllegalArgumentException_Sub1(arg0, "");
		}
		OpenGL.glUniform2f(local3, arg1, arg2);
	}

	@OriginalMember(owner = "client!agl", name = "aa", descriptor = "(ILclient!pq;)V")
	@Override
	void method8482(@OriginalArg(0) int arg0, @OriginalArg(1) Class489 arg1) {
		OpenGL.glUniform3fv(arg0, 3, arg1.method30113(aFloatArray31), 0);
	}

	@OriginalMember(owner = "client!agl", name = "l", descriptor = "(Lclient!aql;FFFF)V")
	@Override
	void method8442(@OriginalArg(0) Class93_Sub33_Sub1 arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4) {
		...
		if (arg0.method23665(35138706) != Class323.aClass323_34) {
			throw new IllegalArgumentException_Sub1(arg0, "");
		}
		OpenGL.glUniform4f(local3, arg1, arg2, arg3, arg4);
	}

	@OriginalMember(owner = "client!agl", name = "u", descriptor = "()V")
	@Override
	public void method31066() {
		if (this.anInt958 == 0) {
			return;
		}
		this.aClass104_Sub2_Sub2_1.method21331(this.anInt958);
		if (this.anInt959 != 0) {
			this.aClass104_Sub2_Sub2_1.method21319((long) this.anInt959);
		}
		if (this.anInt960 != 0) {
			this.aClass104_Sub2_Sub2_1.method21319((long) this.anInt960);
		}
		this.anInt958 = 0;
		this.anInt959 = 0;
		this.anInt960 = 0;
	...
	@OriginalMember(owner = "client!agl", name = "af", descriptor = "(ILjava/lang/String;Ljava/lang/String;)I")
	...
	@OriginalMember(owner = "client!agl", name = "aw", descriptor = "(Lclient!aql;Lclient!pq;)V")
	@Override
	void method8466(@OriginalArg(0) Class93_Sub33_Sub1 arg0, @OriginalArg(1) Class489 arg1) {
		assert arg0.method23665(-1718821514) == Class323.aClass323_50;
		@Pc(14) int local14 = ((Class93_Sub33_Sub1_Sub2) arg0).method23680();
		if (local14 != -1) {
			OpenGL.glUniform4fv(local14, 4, arg1.method30008(aFloatArray31), 0);
		}
	}

	@OriginalMember(owner = "client!agl", name = "c", descriptor = "(Lclient!aql;ILclient!mq;)V")
	@Override
	void method8436(@OriginalArg(0) Class93_Sub33_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Interface43 arg2) {
		...
		if (arg1 < this.aClass104_Sub2_Sub2_1.anInt2954) {
			this.aClass104_Sub2_Sub2_1.method20978(arg1);
			this.aClass104_Sub2_Sub2_1.method21032(arg2);
		} else {
	...
	@OriginalMember(owner = "client!agl", name = "r", descriptor = "(IFFF)V")
	@Override
	...
	@OriginalMember(owner = "client!agl", name = "o", descriptor = "(I[FI)V")
	@Override
	...
	@OriginalMember(owner = "client!agl", name = "ae", descriptor = "(Lclient!aql;FFF)V")
	@Override
	void method8460(@OriginalArg(0) Class93_Sub33_Sub1 arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3) {
		...
		this.aMap11.put(local3, arg2);
		this.aMap13.put(local3, arg3);
		if (arg0.method23665(-1404800417) != Class323.aClass323_107) {
			throw new IllegalArgumentException_Sub1(arg0, "");
		}
		OpenGL.glUniform3f(local3, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!agl", name = "az", descriptor = "(ILclient!pq;)V")
	@Override
	void method8481(@OriginalArg(0) int arg0, @OriginalArg(1) Class489 arg1) {
		OpenGL.glUniform3fv(arg0, 3, arg1.method30113(aFloatArray31), 0);
	}

	@OriginalMember(owner = "client!agl", name = "y", descriptor = "(ILclient!pq;)V")
	@Override
	void method8450(@OriginalArg(0) int arg0, @OriginalArg(1) Class489 arg1) {
		OpenGL.glUniform2fv(arg0, 4, arg1.method30096(aFloatArray31), 0);
	}

	@OriginalMember(owner = "client!agl", name = "z", descriptor = "(Lclient!aql;[FI)V")
	@Override
	...
	@OriginalMember(owner = "client!agl", name = "x", descriptor = "(IILclient!mq;)V")
	@Override
	...
	@OriginalMember(owner = "client!agl", name = "m", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "client!agl", name = "i", descriptor = "(Lclient!aql;F)V")
	@Override
	void method8457(@OriginalArg(0) Class93_Sub33_Sub1 arg0, @OriginalArg(1) float arg1) {
		...
		this.aMap10.put(local3, arg1);
		if (arg0.method23665(-1525763991) != Class323.aClass323_92 && arg0.method23665(-1829538548) != Class323.aClass323_77) {
			throw new IllegalArgumentException_Sub1(arg0, "");
		}
		OpenGL.glUniform1f(local3, arg1);
	}

	@OriginalMember(owner = "client!agl", name = "hl", descriptor = "()V")
	void method8159() {
		this.method31065();
	}

	@OriginalMember(owner = "client!agl", name = "a", descriptor = "()Z")
	@Override
	public boolean method8455() {
		...
		@Pc(110) int local110 = -1;
		@Pc(112) int local112;
		for (local112 = 0; local112 < this.aClass115_Sub2_1.method8199((byte) -5); local112++) {
			if (this.aClass115_Sub2_1.method8200(local112, -1316554355) == this) {
				local110 = local112;
				break;
			}
		}
		...
		@Pc(149) Class93_Sub33_Sub1 local149;
		for (local112 = 0; local112 < this.aClass115_Sub2_1.method8230(-1330985516); local112++) {
			local149 = this.aClass115_Sub2_1.method8201(local112, -1073492800);
			if (local149 != null) {
				local149.method23663(local110);
			}
		}
		for (local112 = 0; local112 < this.aClass115_Sub2_1.method8231(-11161597); local112++) {
			local149 = this.aClass115_Sub2_1.method8228(local112, (byte) 6);
			if (local149 != null) {
				local149.method23663(local110);
			}
	...
	@OriginalMember(owner = "client!agl", name = "s", descriptor = "(ILclient!pq;)V")
	@Override
	void method8449(@OriginalArg(0) int arg0, @OriginalArg(1) Class489 arg1) {
		OpenGL.glUniform3fv(arg0, 3, arg1.method30113(aFloatArray31), 0);
	}

	@OriginalMember(owner = "client!agl", name = "p", descriptor = "(Lclient!aql;Lclient!pq;)V")
	@Override
	void method8444(@OriginalArg(0) Class93_Sub33_Sub1 arg0, @OriginalArg(1) Class489 arg1) {
		assert arg0.method23665(1453655088) == Class323.aClass323_48;
		@Pc(14) int local14 = ((Class93_Sub33_Sub1_Sub2) arg0).method23680();
		if (local14 != -1) {
			OpenGL.glUniform2fv(local14, 4, arg1.method30096(aFloatArray31), 0);
		}
	}

	@OriginalMember(owner = "client!agl", name = "v", descriptor = "(IFFFF)V")
	@Override
	...
	@OriginalMember(owner = "client!agl", name = "d", descriptor = "(Lclient!aql;Lclient!pq;)V")
	@Override
	void method8456(@OriginalArg(0) Class93_Sub33_Sub1 arg0, @OriginalArg(1) Class489 arg1) {
		assert arg0.method23665(296480459) == Class323.aClass323_50;
		@Pc(14) int local14 = ((Class93_Sub33_Sub1_Sub2) arg0).method23680();
		if (local14 != -1) {
			OpenGL.glUniform4fv(local14, 4, arg1.method30008(aFloatArray31), 0);
		}
	...
	@OriginalMember(owner = "client!agl", name = "ai", descriptor = "(Lclient!aql;Lclient!pq;)V")
	@Override
	void method8459(@OriginalArg(0) Class93_Sub33_Sub1 arg0, @OriginalArg(1) Class489 arg1) {
		assert arg0.method23665(1360623807) == Class323.aClass323_50;
		@Pc(14) int local14 = ((Class93_Sub33_Sub1_Sub2) arg0).method23680();
		if (local14 != -1) {
			OpenGL.glUniform4fv(local14, 4, arg1.method30008(aFloatArray31), 0);
		}
	...
	@OriginalMember(owner = "client!agl", name = "ag", descriptor = "(Lclient!aql;[FI)V")
	@Override
	...
	@OriginalMember(owner = "client!agl", name = "ah", descriptor = "(Lclient!aql;Lclient!pq;)V")
	@Override
	void method8453(@OriginalArg(0) Class93_Sub33_Sub1 arg0, @OriginalArg(1) Class489 arg1) {
		assert arg0.method23665(406257278) == Class323.aClass323_48;
		@Pc(14) int local14 = ((Class93_Sub33_Sub1_Sub2) arg0).method23680();
		if (local14 != -1) {
			OpenGL.glUniform2fv(local14, 4, arg1.method30096(aFloatArray31), 0);
		}
	...
	@OriginalMember(owner = "client!agl", name = "al", descriptor = "(Lclient!aql;Lclient!pq;)V")
	@Override
	void method8480(@OriginalArg(0) Class93_Sub33_Sub1 arg0, @OriginalArg(1) Class489 arg1) {
		assert arg0.method23665(1430627427) == Class323.aClass323_50;
		@Pc(14) int local14 = ((Class93_Sub33_Sub1_Sub2) arg0).method23680();
		if (local14 != -1) {
			OpenGL.glUniform4fv(local14, 4, arg1.method30008(aFloatArray31), 0);
		}
	...
	@OriginalMember(owner = "client!agl", name = "ac", descriptor = "(Lclient!aql;Lclient!pq;)V")
	@Override
	void method8464(@OriginalArg(0) Class93_Sub33_Sub1 arg0, @OriginalArg(1) Class489 arg1) {
		assert arg0.method23665(-429771548) == Class323.aClass323_50;
		@Pc(14) int local14 = ((Class93_Sub33_Sub1_Sub2) arg0).method23680();
		if (local14 != -1) {
			OpenGL.glUniform4fv(local14, 4, arg1.method30008(aFloatArray31), 0);
		}
	...
	@OriginalMember(owner = "client!agl", name = "au", descriptor = "(ILclient!pq;)V")
	@Override
	void method8471(@OriginalArg(0) int arg0, @OriginalArg(1) Class489 arg1) {
		OpenGL.glUniform2fv(arg0, 4, arg1.method30096(aFloatArray31), 0);
	}

	@OriginalMember(owner = "client!agl", name = "j", descriptor = "(Lclient!aql;F)V")
	@Override
	void method8458(@OriginalArg(0) Class93_Sub33_Sub1 arg0, @OriginalArg(1) float arg1) {
		...
		this.aMap10.put(local3, arg1);
		if (arg0.method23665(-554121446) != Class323.aClass323_92 && arg0.method23665(-1617881755) != Class323.aClass323_77) {
			throw new IllegalArgumentException_Sub1(arg0, "");
		}
		OpenGL.glUniform1f(local3, arg1);
	}

	@OriginalMember(owner = "client!agl", name = "as", descriptor = "(Lclient!aql;ILclient!mq;)V")
	@Override
	...
	void method8475(@OriginalArg(0) Class93_Sub33_Sub1 arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4) {
		...
		this.aMap13.put(local3, arg3);
		this.aMap12.put(local3, arg4);
		if (arg0.method23665(-208980163) != Class323.aClass323_34) {
			throw new IllegalArgumentException_Sub1(arg0, "");
		}
		OpenGL.glUniform4f(local3, arg1, arg2, arg3, arg4);
	}

	@OriginalMember(owner = "client!agl", name = "ar", descriptor = "(ILclient!pq;)V")
	@Override
	void method8469(@OriginalArg(0) int arg0, @OriginalArg(1) Class489 arg1) {
		OpenGL.glUniform4fv(arg0, 4, arg1.method30008(aFloatArray31), 0);
	}

	@OriginalMember(owner = "client!agl", name = "ap", descriptor = "(ILclient!pq;)V")
	@Override
	void method8473(@OriginalArg(0) int arg0, @OriginalArg(1) Class489 arg1) {
		OpenGL.glUniform4fv(arg0, 4, arg1.method30008(aFloatArray31), 0);
	}

	@OriginalMember(owner = "client!agl", name = "aq", descriptor = "(ILclient!pq;)V")
	@Override
	void method8465(@OriginalArg(0) int arg0, @OriginalArg(1) Class489 arg1) {
		OpenGL.glUniform4fv(arg0, 4, arg1.method30008(aFloatArray31), 0);
	}

	@OriginalMember(owner = "client!agl", name = "ab", descriptor = "(ILclient!pq;)V")
	@Override
	void method8445(@OriginalArg(0) int arg0, @OriginalArg(1) Class489 arg1) {
		OpenGL.glUniform3fv(arg0, 3, arg1.method30113(aFloatArray31), 0);
	}

	@OriginalMember(owner = "client!agl", name = "av", descriptor = "(IILclient!mq;)V")
	@Override
	...
	@OriginalMember(owner = "client!agl", name = "ao", descriptor = "(IILclient!mq;)V")
	@Override
	...
	@OriginalMember(owner = "client!agl", name = "ak", descriptor = "(ILjava/lang/String;Ljava/lang/String;)I")
	...
	@OriginalMember(owner = "client!agl", name = "an", descriptor = "(ILjava/lang/String;Ljava/lang/String;)I")
	int method8161(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2) {
		if (arg1 == null) {
			return 0;
		}
		@Pc(6) int local6 = OpenGL.glCreateShader(arg0);
	...
	@OriginalMember(owner = "client!agl", name = "aj", descriptor = "(IFFFF)V")
	@Override
	...
	@OriginalMember(owner = "client!agl", name = "ay", descriptor = "(ILclient!pq;)V")
	@Override
	void method8479(@OriginalArg(0) int arg0, @OriginalArg(1) Class489 arg1) {
		OpenGL.glUniform3fv(arg0, 3, arg1.method30113(aFloatArray31), 0);
	}

	@OriginalMember(owner = "client!agl", name = "t", descriptor = "(Lclient!aql;FF)V")
	@Override
	void method8467(@OriginalArg(0) Class93_Sub33_Sub1 arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2) {
		...
		this.aMap10.put(local3, arg1);
		this.aMap11.put(local3, arg2);
		if (arg0.method23665(2132270744) != Class323.aClass323_63) {
			throw new IllegalArgumentException_Sub1(arg0, "");
		}
		OpenGL.glUniform2f(local3, arg1, arg2);
	}

	@OriginalMember(owner = "client!agl", name = "q", descriptor = "(ILclient!pq;)V")
	@Override
