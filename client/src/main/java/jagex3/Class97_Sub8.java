...
public final class Class97_Sub8 extends Class97 {
	...
	@OriginalMember(owner = "client!aev", name = "<init>", descriptor = "(Lclient!afa;Lclient!bz;)V")
	Class97_Sub8(@OriginalArg(0) Class104_Sub1 arg0, @OriginalArg(1) Class199 arg1) {
		...
		if (this.aClass199_5.aClass88_Sub3_1 != null && this.aClass104_Sub1_25.aBoolean101 && this.aClass104_Sub1_25.aBoolean103) {
			...
			this.aClass191_2 = Class191.method24602(this.aClass104_Sub1_25, new Class190[] { local29, local35 });
			this.aBoolean65 = this.aClass191_2 != null;
		}
	}

	@OriginalMember(owner = "client!aev", name = "m", descriptor = "(Z)V")
	@Override
	void method2792(@OriginalArg(0) boolean arg0) {
	}

	@OriginalMember(owner = "client!aev", name = "e", descriptor = "()Z")
	@Override
	boolean method2790() {
		return this.aBoolean65;
	}

	@OriginalMember(owner = "client!aev", name = "x", descriptor = "(Lclient!bq;I)V")
	@Override
	...
	@OriginalMember(owner = "client!aev", name = "d", descriptor = "()Z")
	@Override
	boolean method2799() {
		return this.aBoolean65;
	}

	@OriginalMember(owner = "client!aev", name = "k", descriptor = "()V")
	@Override
	void method2793() {
		if (!this.aBoolean64) {
			return;
	...
	@OriginalMember(owner = "client!aev", name = "f", descriptor = "(II)V")
	@Override
	...
	@OriginalMember(owner = "client!aev", name = "w", descriptor = "(Lclient!bq;I)V")
	@Override
	...
	@OriginalMember(owner = "client!aev", name = "l", descriptor = "()Z")
	@Override
	boolean method2796() {
		return this.aBoolean65;
	}

	@OriginalMember(owner = "client!aev", name = "u", descriptor = "()Z")
	@Override
	boolean method2802() {
		return this.aBoolean65;
	}

	@OriginalMember(owner = "client!aev", name = "z", descriptor = "()Z")
	@Override
	boolean method2798() {
		return this.aBoolean65;
	}

	@OriginalMember(owner = "client!aev", name = "r", descriptor = "(Z)V")
	@Override
	void method2797(@OriginalArg(0) boolean arg0) {
	}

	@OriginalMember(owner = "client!aev", name = "n", descriptor = "(Z)V")
	@Override
	void method2801(@OriginalArg(0) boolean arg0) {
		...
		this.aClass104_Sub1_25.method3803(0);
		this.aClass104_Sub1_25.method3804(this.aClass199_5.aClass88_Sub3_1);
	...
	@OriginalMember(owner = "client!aev", name = "y", descriptor = "(II)V")
	@Override
	...
	@OriginalMember(owner = "client!aev", name = "v", descriptor = "()V")
	@Override
	void method2795() {
		if (!this.aBoolean64) {
			return;
	...
	@OriginalMember(owner = "client!aev", name = "o", descriptor = "(II)V")
	@Override
	...
	@OriginalMember(owner = "client!aev", name = "s", descriptor = "(II)V")
	@Override
	...
	@OriginalMember(owner = "client!aev", name = "p", descriptor = "()Z")
	@Override
	boolean method2791() {
		return this.aBoolean65;
	}

	@OriginalMember(owner = "client!aev", name = "c", descriptor = "(Z)V")
	@Override
	...
	@OriginalMember(owner = "client!aev", name = "q", descriptor = "(Lclient!bq;I)V")
	@Override
