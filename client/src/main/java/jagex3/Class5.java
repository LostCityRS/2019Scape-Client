...
public final class Class5 {
	...
	@OriginalMember(owner = "client!aac", name = "g", descriptor = "(Lclient!py;IILclient!aaw;)Lclient!aac;")
	...
	@OriginalMember(owner = "client!aac", name = "ae", descriptor = "(Lclient!py;ILclient!aaw;)Lclient!aac;")
	public static Class5 method34(@OriginalArg(0) Class497 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Interface1 arg2) {
		@Pc(4) byte[] local4 = arg0.method30240(arg1, (byte) 22);
		return local4 == null ? null : new Class5(local4, arg2);
	}

	@OriginalMember(owner = "client!aac", name = "h", descriptor = "(Lclient!py;II)Lclient!aac;")
	public static Class5 method47(@OriginalArg(0) Class497 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		return Class446.method29078(arg0, arg1, arg2, null, -1150628510);
	}

	@OriginalMember(owner = "client!aac", name = "a", descriptor = "(Lclient!py;II)Lclient!aac;")
	public static Class5 method48(@OriginalArg(0) Class497 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		return Class446.method29078(arg0, arg1, arg2, null, 1261778633);
	}

	@OriginalMember(owner = "client!aac", name = "i", descriptor = "(Lclient!py;ILclient!aaw;)Lclient!aac;")
	public static Class5 method50(@OriginalArg(0) Class497 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Interface1 arg2) {
		@Pc(4) byte[] local4 = arg0.method30240(arg1, (byte) 106);
		return local4 == null ? null : new Class5(local4, arg2);
	}

	@OriginalMember(owner = "client!aac", name = "j", descriptor = "(Lclient!py;ILclient!aaw;)Lclient!aac;")
	public static Class5 method51(@OriginalArg(0) Class497 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Interface1 arg2) {
		@Pc(4) byte[] local4 = arg0.method30240(arg1, (byte) 73);
		return local4 == null ? null : new Class5(local4, arg2);
	}

	@OriginalMember(owner = "client!aac", name = "t", descriptor = "(Lclient!py;ILclient!aaw;)Lclient!aac;")
	public static Class5 method52(@OriginalArg(0) Class497 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Interface1 arg2) {
		@Pc(4) byte[] local4 = arg0.method30240(arg1, (byte) 48);
		return local4 == null ? null : new Class5(local4, arg2);
	}

	@OriginalMember(owner = "client!aac", name = "ag", descriptor = "([[B[[B[B[B[BII)I")
	...
	@OriginalMember(owner = "client!aac", name = "ah", descriptor = "([[B[[B[B[B[BII)I")
	...
	@OriginalMember(owner = "client!aac", name = "e", descriptor = "(Lclient!alw;B)Lclient!ne;")
	public static Class434 method76(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) byte arg1) {
	...
	@OriginalMember(owner = "client!aac", name = "n", descriptor = "(II)I")
	public static int method77(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	@OriginalMember(owner = "client!aac", name = "ix", descriptor = "(Lclient!alh;IZI)V")
	public static void method78(@OriginalArg(0) Class132_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) int arg3) {
		Class77.method1300(arg0, arg1, true, arg2, -938103640);
	}

	@OriginalMember(owner = "client!aac", name = "e", descriptor = "(ILjava/awt/Canvas;Lclient!df;Lclient!es;Lclient!nx;Lclient!nb;Lclient!np;Lclient!py;II)Lclient!dh;")
	public static Class104 method79(@OriginalArg(0) int arg0, @OriginalArg(1) Canvas arg1, @OriginalArg(2) Class225 arg2, @OriginalArg(3) Interface24 arg3, @OriginalArg(4) Interface48 arg4, @OriginalArg(5) Interface46 arg5, @OriginalArg(6) Interface47 arg6, @OriginalArg(7) Class497 arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9) {
		@Pc(1) int local1 = 0;
		@Pc(3) int local3 = 0;
		if (arg1 != null) {
		...
		return Class104.method20491(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, local1, local3, 999922012);
	}

	@OriginalMember(owner = "client!aac", name = "agn", descriptor = "(Lclient!yf;I)V")
	static void method80(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray521[(arg0.anInt6052 -= 1189701933) * -1497248091];
		@Pc(18) Class47 local18 = (Class47) Class277.aClass32_Sub12_1.method18273(local12, 1561296549);
		if (local18.anInt163 * 1265448031 == -1 && local18.anInt171 * -17795249 >= 0) {
			arg0.anIntArray521[(arg0.anInt6052 += 1189701933) * -1497248091 - 1] = local18.anInt171 * -17795249;
		} else {
			arg0.anIntArray521[(arg0.anInt6052 += 1189701933) * -1497248091 - 1] = local12;
		}
	}

	@OriginalMember(owner = "client!aac", name = "<init>", descriptor = "([BLclient!aaw;)V")
	Class5(@OriginalArg(0) byte[] arg0, @OriginalArg(1) Interface1 arg1) {
		...
		@Pc(13) int local13 = local9.method22425((short) 16384);
		if (local13 != 0) {
			throw new RuntimeException("");
		}
		@Pc(30) boolean local30 = local9.method22425((short) 16384) == 1;
		this.aByteArray3 = new byte[256];
		local9.method22442(this.aByteArray3, 0, 256, (short) 16190);
		this.aByteArray1 = new byte[256];
		local9.method22442(this.aByteArray1, 0, 256, (short) 11301);
		this.aByteArray2 = new byte[256];
		local9.method22442(this.aByteArray2, 0, 256, (short) 2803);
		this.aShortArrayArray1 = new short[256][4];
		this.anInt12 = local9.method22427(-1434290800) * -535085581;
		this.anInt13 = local9.method22427(-1434290800) * 2057731677;
		@Pc(84) int local84;
		for (local84 = 0; local84 < 256; local84++) {
			this.aShortArrayArray1[local84][0] = (short) local9.method22427(-1434290800);
		}
		for (local84 = 0; local84 < 256; local84++) {
			this.aShortArrayArray1[local84][1] = (short) local9.method22427(-1434290800);
		}
		for (local84 = 0; local84 < 256; local84++) {
		...
		if (local30) {
			...
			for (local152 = 0; local152 < 256; local152++) {
				...
				for (local167 = 0; local167 < local150[local152].length; local167++) {
					local165 += local9.method22426(526491709);
			...
			for (local195 = 0; local195 < 256; local195++) {
				...
				for (@Pc(210) int local210 = 0; local210 < local193[local195].length; local210++) {
					local208 += local9.method22426(1764571622);
				...
				if (local195 != 32 && local195 != 160) {
					for (local167 = 0; local167 < 256; local167++) {
						if (local167 != 32 && local167 != 160) {
							this.aByteArrayArray1[local195][local167] = (byte) Class650.method32849(local150, local193, this.aByteArray2, this.aByteArray3, this.aByteArray1, local195, local167, (byte) 96);
						}
					}
				}
			}
			...
			this.anInt7 = local9.method22425((short) 16384) * -744138367;
		}
		this.anInt9 = local9.method22425((short) 16384) * -1209958315;
		this.anInt8 = local9.method22425((short) 16384) * -991427611;
		this.anInt6 = local9.method22425((short) 16384) * 1756701383;
		this.anInt10 = local9.method22425((short) 16384) * -144696809;
		this.anInt11 = local9.method22425((short) 16384) * -1904958279;
	...
	@OriginalMember(owner = "client!aac", name = "au", descriptor = "(Ljava/lang/String;[Lclient!aay;)I")
					...
					if (local41.equals("lt")) {
						...
						if (!local41.equals("reg")) {
							...
							if (local41.startsWith("img=") && arg1 != null) {
								try {
									local111 = Class616.method32271(local41.substring(4), (byte) 8);
									local10 += arg1[local111].method18172();
									local8 = -1;
							...
							if (local41.startsWith("sprite=") && this.anInterface1_1 != null) {
								try {
									...
									if (local136 == -1) {
										local111 = Class616.method32271(local41.substring(7), (byte) 8);
									} else {
										local111 = Class616.method32271(local41.substring(7, local136), (byte) 8);
									}
									local10 += this.anInterface1_1.method29413(local111, 345803169);
									local8 = -1;
	...
	@OriginalMember(owner = "client!aac", name = "l", descriptor = "(II)I")
	public int method33(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return this.aByteArray1[arg0] & 0xFF;
	}

	@OriginalMember(owner = "client!aac", name = "aj", descriptor = "(Ljava/lang/String;I[Lclient!aay;I)Ljava/lang/String;")
	public String method35(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Interface2[] arg2, @OriginalArg(3) int arg3) {
		@Pc(12) int local12 = this.method39(arg0, new int[] { arg1 }, aStringArray1, arg2, (byte) 50);
		return arg3 >= 0 && arg3 < local12 ? aStringArray1[arg3] : null;
	}

	@OriginalMember(owner = "client!aac", name = "p", descriptor = "(Ljava/lang/String;I)I")
	public int method36(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		return this.method37(arg0, null, (byte) -117);
	}

	@OriginalMember(owner = "client!aac", name = "d", descriptor = "(Ljava/lang/String;[Lclient!aay;B)I")
	public int method37(@OriginalArg(0) String arg0, @OriginalArg(1) Interface2[] arg1, @OriginalArg(2) byte arg2) {
		if (arg0 == null) {
			return 0;
		}
		@Pc(6) int local6 = -1;
						...
						if (!local41.equals("reg")) {
							...
							if (local41.startsWith("sprite=") && this.anInterface1_1 != null) {
								try {
									...
									local10 += this.anInterface1_1.method29413(local111, -1557198);
									local8 = -1;
								} catch (@Pc(165) Exception local165) {
								}
							}
	...
	@OriginalMember(owner = "client!aac", name = "c", descriptor = "(Ljava/lang/String;I[Lclient!aay;I)Ljava/lang/String;")
	public String method38(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Interface2[] arg2, @OriginalArg(3) int arg3) {
		if (this.method37(arg0, arg2, (byte) -33) <= arg1) {
			return arg0;
		}
		@Pc(16) int local16 = arg1 - this.method37("...", null, (byte) -108);
		@Pc(18) int local18 = -1;
		@Pc(20) int local20 = -1;
		@Pc(22) int local22 = 0;
					...
					if (local55.equals("lt")) {
						...
						if (!local55.equals("reg")) {
							...
							if (local55.startsWith("img=") && arg2 != null) {
								try {
									local126 = Class616.method32271(local55.substring(4), (byte) 8);
									local22 += arg2[local126].method18172();
									local20 = -1;
									if (local22 > local16) {
										return local27 + "...";
									}
							...
							if (local55.startsWith("sprite=") && this.anInterface1_1 != null) {
								try {
									...
									if (local171 == -1) {
										local126 = Class616.method32271(local55.substring(7), (byte) 8);
									} else {
										local126 = Class616.method32271(local55.substring(7, local171), (byte) 8);
									}
									local22 += this.anInterface1_1.method29413(local126, 1402377332);
									local20 = -1;
									if (local22 > local16) {
										return local27 + "...";
									}
	...
	@OriginalMember(owner = "client!aac", name = "r", descriptor = "(Ljava/lang/String;[I[Ljava/lang/String;[Lclient!aay;B)I")
	public int method39(@OriginalArg(0) String arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) String[] arg2, @OriginalArg(3) Interface2[] arg3, @OriginalArg(4) byte arg4) {
		return this.method40(arg0, arg1, arg2, arg3, true, -1106545472);
	}

	@OriginalMember(owner = "client!aac", name = "v", descriptor = "(Ljava/lang/String;[I[Ljava/lang/String;[Lclient!aay;ZI)I")
	int method40(@OriginalArg(0) String arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) String[] arg2, @OriginalArg(3) Interface2[] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		if (arg0 == null) {
			return 0;
		}
		@Pc(5) int local5 = 0;
		...
		for (@Pc(24) int local24 = 0; local24 < local22; local24++) {
			...
			if (local35 == 60) {
				...
				if (local15 == -1) {
					local52 = local24;
					local37 += this.method62(local35, (byte) 68);
					...
					if (local59.equals("lt")) {
						...
						if (local59.startsWith("img=") && arg3 != null) {
							try {
								local338 = Class616.method32271(local59.substring(4), (byte) 8);
								local37 += arg3[local338].method18172();
								local17 = -1;
							...
							try {
								...
								if (local363 == -1) {
									local338 = Class616.method32271(local59.substring(7), (byte) 8);
								} else {
									local338 = Class616.method32271(local59.substring(7, local363), (byte) 8);
								}
								@Pc(387) int local387 = local37 + this.anInterface1_1.method29413(local338, -895768569);
								local17 = -1;
	...
	@OriginalMember(owner = "client!aac", name = "f", descriptor = "(ICB)I")
	public int method41(@OriginalArg(0) int arg0, @OriginalArg(1) char arg1, @OriginalArg(2) byte arg2) {
		return this.aByteArrayArray1 == null ? 0 : this.aByteArrayArray1[arg0][arg1];
	}

	@OriginalMember(owner = "client!aac", name = "s", descriptor = "(Ljava/lang/String;I[Lclient!aay;I)I")
	public int method42(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Interface2[] arg2, @OriginalArg(3) int arg3) {
		return this.method39(arg0, new int[] { arg1 }, aStringArray1, arg2, (byte) 9);
	}

	@OriginalMember(owner = "client!aac", name = "y", descriptor = "(Ljava/lang/String;I[Lclient!aay;IB)Ljava/lang/String;")
	public String method43(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Interface2[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte arg4) {
		@Pc(12) int local12 = this.method39(arg0, new int[] { arg1 }, aStringArray1, arg2, (byte) -25);
		return arg3 >= 0 && arg3 < local12 ? aStringArray1[arg3] : null;
	}

	@OriginalMember(owner = "client!aac", name = "am", descriptor = "(Ljava/lang/String;[Lclient!aay;)I")
						...
						if (!local41.equals("reg")) {
							...
							if (local41.startsWith("sprite=") && this.anInterface1_1 != null) {
								try {
									...
									local10 += this.anInterface1_1.method29413(local111, -1142002331);
									local8 = -1;
								} catch (@Pc(165) Exception local165) {
								}
							}
	...
	@OriginalMember(owner = "client!aac", name = "x", descriptor = "(Ljava/lang/String;III[Lclient!aay;I)Ljava/awt/Point;")
	public Point method45(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Interface2[] arg4, @OriginalArg(5) int arg5) {
		if (arg3 <= 0) {
		...
		@Pc(41) int local41 = this.method40(arg0, new int[] { arg1 }, aStringArray1, arg4, false, -1106545472);
		@Pc(43) int local43 = 0;
		for (@Pc(45) int local45 = 0; local45 < local41; local45++) {
			...
			if (local53 + local43 > arg3 || local45 == local41 - 1 && arg3 == arg0.length()) {
				...
				@Pc(89) int local89 = this.method37(local72, arg4, (byte) -18);
	...
	@OriginalMember(owner = "client!aac", name = "b", descriptor = "(Ljava/lang/String;IIII[Lclient!aay;I)I")
	public int method46(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) Interface2[] arg5, @OriginalArg(6) int arg6) {
		if (arg2 == 0) {
			arg2 = this.anInt7 * -2059082111;
		}
		@Pc(20) int local20 = this.method40(arg0, new int[] { arg1 }, aStringArray1, arg5, false, -1106545472);
		if (local20 == 0) {
			return 0;
		}
		if (arg4 < 0) {
		...
		@Pc(47) int local47 = 0;
		@Pc(49) int local49;
		for (local49 = 0; local49 < arg3 && local45 < local43.length(); local49 = this.method37(local43.substring(0, local45), arg5, (byte) -76)) {
			local47 = local49;
			local45++;
		}
	...
	@OriginalMember(owner = "client!aac", name = "q", descriptor = "(Ljava/lang/String;II[Lclient!aay;B)I")
	public int method49(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Interface2[] arg3, @OriginalArg(4) byte arg4) {
		if (arg2 == 0) {
			arg2 = this.anInt7 * -2059082111;
		}
		@Pc(19) int local19 = this.method39(arg0, new int[] { arg1 }, aStringArray1, arg3, (byte) 11);
		@Pc(25) int local25 = arg2 * (local19 - 1);
		return this.anInt10 * -1093354073 + this.anInt6 * -8978697 + local25;
	}

	@OriginalMember(owner = "client!aac", name = "at", descriptor = "(Ljava/lang/String;[Lclient!aay;)I")
						...
						if (!local41.equals("reg")) {
							...
							if (local41.startsWith("sprite=") && this.anInterface1_1 != null) {
								try {
									...
									local10 += this.anInterface1_1.method29413(local111, -513420382);
									local8 = -1;
								} catch (@Pc(165) Exception local165) {
								}
							}
	...
	@OriginalMember(owner = "client!aac", name = "o", descriptor = "(Ljava/lang/String;I[Lclient!aay;I)I")
	public int method55(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Interface2[] arg2, @OriginalArg(3) int arg3) {
		@Pc(12) int local12 = this.method39(arg0, new int[] { arg1 }, aStringArray1, arg2, (byte) 115);
		@Pc(14) int local14 = 0;
		for (@Pc(16) int local16 = 0; local16 < local12; local16++) {
			@Pc(27) int local27 = this.method37(aStringArray1[local16], arg2, (byte) -66);
			if (local27 > local14) {
				local14 = local27;
			}
		}
	...
	@OriginalMember(owner = "client!aac", name = "al", descriptor = "(I)I")
	public int method56(@OriginalArg(0) int arg0) {
		return this.aByteArray3[arg0] & 0xFF;
	}

	@OriginalMember(owner = "client!aac", name = "ac", descriptor = "(I)I")
	public int method57(@OriginalArg(0) int arg0) {
		return this.aByteArray2[arg0] & 0xFF;
	}

	@OriginalMember(owner = "client!aac", name = "ai", descriptor = "(I)I")
	public int method58(@OriginalArg(0) int arg0) {
		return this.aByteArray2[arg0] & 0xFF;
	}

	@OriginalMember(owner = "client!aac", name = "aw", descriptor = "(I)[S")
	public short[] method59(@OriginalArg(0) int arg0) {
		return this.aShortArrayArray1[arg0];
	}

	@OriginalMember(owner = "client!aac", name = "as", descriptor = "(I)[S")
	public short[] method60(@OriginalArg(0) int arg0) {
		return this.aShortArrayArray1[arg0];
	}

	@OriginalMember(owner = "client!aac", name = "ar", descriptor = "(Ljava/lang/String;I[Lclient!aay;)Ljava/lang/String;")
	public String method61(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Interface2[] arg2) {
		if (this.method37(arg0, arg2, (byte) -19) <= arg1) {
			return arg0;
		}
		@Pc(16) int local16 = arg1 - this.method37("...", null, (byte) -15);
		@Pc(18) int local18 = -1;
		@Pc(20) int local20 = -1;
		@Pc(22) int local22 = 0;
		@Pc(25) int local25 = arg0.length();
						...
						if (!local55.equals("reg")) {
							...
							if (local55.startsWith("sprite=") && this.anInterface1_1 != null) {
								try {
									...
									local22 += this.anInterface1_1.method29413(local126, 448021774);
									local20 = -1;
									if (local22 > local16) {
										return local27 + "...";
									}
	...
	@OriginalMember(owner = "client!aac", name = "w", descriptor = "(IB)I")
	public int method62(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		return this.aByteArray3[arg0] & 0xFF;
	}

	@OriginalMember(owner = "client!aac", name = "ao", descriptor = "(Ljava/lang/String;I[Lclient!aay;)I")
	public int method63(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Interface2[] arg2) {
		return this.method39(arg0, new int[] { arg1 }, aStringArray1, arg2, (byte) -11);
	}

	@OriginalMember(owner = "client!aac", name = "u", descriptor = "(IB)I")
	public int method64(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		return this.aByteArray2[arg0] & 0xFF;
	}

	@OriginalMember(owner = "client!aac", name = "z", descriptor = "(II)[S")
	public short[] method65(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return this.aShortArrayArray1[arg0];
	}

	@OriginalMember(owner = "client!aac", name = "ap", descriptor = "(Ljava/lang/String;[I[Ljava/lang/String;[Lclient!aay;)I")
	...
	@OriginalMember(owner = "client!aac", name = "aq", descriptor = "(Ljava/lang/String;I[Lclient!aay;)I")
	public int method67(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Interface2[] arg2) {
		@Pc(12) int local12 = this.method39(arg0, new int[] { arg1 }, aStringArray1, arg2, (byte) 9);
		@Pc(14) int local14 = 0;
		for (@Pc(16) int local16 = 0; local16 < local12; local16++) {
			@Pc(27) int local27 = this.method37(aStringArray1[local16], arg2, (byte) -40);
			if (local27 > local14) {
				local14 = local27;
			}
		}
	...
	@OriginalMember(owner = "client!aac", name = "ax", descriptor = "(Ljava/lang/String;I[Lclient!aay;)I")
	public int method68(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Interface2[] arg2) {
		return this.method39(arg0, new int[] { arg1 }, aStringArray1, arg2, (byte) 86);
	}

	@OriginalMember(owner = "client!aac", name = "av", descriptor = "(Ljava/lang/String;I[Lclient!aay;)I")
	public int method69(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Interface2[] arg2) {
		return this.method39(arg0, new int[] { arg1 }, aStringArray1, arg2, (byte) 46);
	}

	@OriginalMember(owner = "client!aac", name = "ad", descriptor = "(Ljava/lang/String;[Lclient!aay;)I")
						...
						if (!local41.equals("reg")) {
							...
							if (local41.startsWith("sprite=") && this.anInterface1_1 != null) {
								try {
									...
									local10 += this.anInterface1_1.method29413(local111, 1933094139);
									local8 = -1;
								} catch (@Pc(165) Exception local165) {
								}
							}
	...
	@OriginalMember(owner = "client!aac", name = "ay", descriptor = "(Ljava/lang/String;II[Lclient!aay;)I")
	public int method72(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Interface2[] arg3) {
		...
		@Pc(19) int local19 = this.method39(arg0, new int[] { arg1 }, aStringArray1, arg3, (byte) 69);
		@Pc(25) int local25 = arg2 * (local19 - 1);
		return this.anInt10 * -1093354073 + this.anInt6 * -8978697 + local25;
	}

	@OriginalMember(owner = "client!aac", name = "ab", descriptor = "(Ljava/lang/String;III[Lclient!aay;)Ljava/awt/Point;")
	public Point method73(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Interface2[] arg4) {
		...
		for (@Pc(45) int local45 = 0; local45 < local41; local45++) {
			...
			if (local53 + local43 > arg3 || local45 == local41 - 1 && arg3 == arg0.length()) {
				...
				@Pc(89) int local89 = this.method37(local72, arg4, (byte) -30);
				@Pc(98) int local98 = this.anInt6 * -8978697 + local45 * arg2;
				return new Point(local89, local98);
			}
			local43 += local53;
	...
	@OriginalMember(owner = "client!aac", name = "az", descriptor = "(Ljava/lang/String;IIII[Lclient!aay;)I")
	public int method74(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) Interface2[] arg5) {
		...
		@Pc(47) int local47 = 0;
		@Pc(49) int local49;
		for (local49 = 0; local49 < arg3 && local45 < local43.length(); local49 = this.method37(local43.substring(0, local45), arg5, (byte) -81)) {
			local47 = local49;
			local45++;
		}
		if (local45 == local43.length() && local43.endsWith("<br>")) {
	...
	@OriginalMember(owner = "client!aac", name = "aa", descriptor = "(Ljava/lang/String;IIII[Lclient!aay;)I")
	public int method75(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) Interface2[] arg5) {
		...
		@Pc(47) int local47 = 0;
		@Pc(49) int local49;
		for (local49 = 0; local49 < arg3 && local45 < local43.length(); local49 = this.method37(local43.substring(0, local45), arg5, (byte) -106)) {
			local47 = local49;
			local45++;
		}
		if (local45 == local43.length() && local43.endsWith("<br>")) {
