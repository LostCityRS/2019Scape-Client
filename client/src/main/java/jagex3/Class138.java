...
public class Class138 implements SerializableEnum {
	...
	@OriginalMember(owner = "client!qe", name = "e", descriptor = "(I)[Lclient!qe;")
	public static Class138[] method11526(@OriginalArg(0) int arg0) {
		return new Class138[] { aClass138_70, aClass138_68, aClass138_69, aClass138_62, aClass138_65, aClass138_63, aClass138_66, aClass138_72, aClass138_64, aClass138_67, aClass138_71 };
	}
	...
	@OriginalMember(owner = "client!qe", name = "bb", descriptor = "(ZLclient!yf;B)V")
	static void method11534(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class681 arg1, @OriginalArg(2) byte arg2) {
		@Pc(12) int local12 = arg1.anIntArray521[(arg1.anInt6052 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32986(local12, 829506846);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		if (arg0) {
			Class240.method25964(local22, local16, (short) -15699);
		} else {
			Class337.method27553(local22, local16, 2136484877);
		}
	}

	@OriginalMember(owner = "client!qe", name = "aoa", descriptor = "(Lclient!yf;I)V")
	static void method11535(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) throws Exception_Sub3 {
		arg0.anInt6052 -= -1915563430;
		@Pc(18) boolean local18 = arg0.anIntArray521[arg0.anInt6052 * -1497248091] == 1;
		@Pc(33) boolean local33 = arg0.anIntArray521[arg0.anInt6052 * -1497248091 + 1] == 1;
		Class65.aClass123_Sub1_2.method8943(local18, local33, 1906509690);
	}

	@OriginalMember(owner = "client!qe", name = "vm", descriptor = "(Lclient!yf;I)V")
	static void method11536(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anInt6052 -= -1915563430;
		@Pc(13) int local13 = arg0.anIntArray521[arg0.anInt6052 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray521[arg0.anInt6052 * -1497248091 + 1];
		@Pc(32) Class677 local32 = arg0.aBoolean884 ? arg0.aClass677_2 : arg0.aClass677_1;
		Class125_Sub1.method9215(local32.aClass312_13, local13, local23, 1359108582);
	}

	@OriginalMember(owner = "client!qe", name = "eq", descriptor = "(ZI)V")
	public static void method11537(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
		if (arg0) {
			if (client.anInt3526 * -703563959 != -1) {
				Class535.method30934(client.anInt3526 * -703563959, 2123689163);
			}
			for (@Pc(16) Class93_Sub40 local16 = (Class93_Sub40) client.aClass16_22.method220((byte) 31); local16 != null; local16 = (Class93_Sub40) client.aClass16_22.method222(2127698728)) {
				if (!local16.method23982(-2007414972)) {
					local16 = (Class93_Sub40) client.aClass16_22.method220((byte) -82);
					if (local16 == null) {
						break;
					}
				}
				Class372.method28200(local16, true, false, 1923291343);
			}
			client.anInt3526 = -823798521;
			client.aClass16_22 = new Class16(8);
			Class361.method27983((byte) -46);
			client.anInt3526 = Class93_Sub26.aClass645_15.anInt5927 * 1630912889;
			if (client.anInt3526 * -703563959 != -1) {
				Class618.method32282(false, -1814616275);
				Class635.method32622((short) 255);
				Class56.method18048(client.anInt3526 * -703563959, null, -311790733);
			}
		}
		Class692.method36779((byte) -40);
		Class65.aClass123_Sub1_2.method8923(true, (byte) -25);
		Class411.aBoolean761 = false;
		Class548.method31194((byte) 1);
		client.anInt3520 = 410366683;
		Class696.method36831(client.anInt3555 * 225035861, 785682939);
		Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3 = new Class132_Sub1_Sub1_Sub1_Sub2(null);
		client.aMap18.clear();
		Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.method24243((float) (client.aClass532_1.method30625(750691944) * 512 / 2), 0.0F, (float) (client.aClass532_1.method30655((short) 128) * 512 / 2));
		Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.anIntArray240[0] = client.aClass532_1.method30625(668145533) / 2;
		Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.anIntArray239[0] = client.aClass532_1.method30655((short) 128) / 2;
		...
		if (Class429.anInt4942 * -1453926679 == 5) {
			...
			Class270.anInt3925 = (Class20.anInt70 * 390649993 << 9) * -967471741;
		} else {
			Class631.method32464(1251129319);
		}
		client.aClass532_1.method30713((byte) 16).method33184(1086101290);
	}

	@OriginalMember(owner = "client!qe", name = "p", descriptor = "(IZB)V")
	static void method11538(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) byte arg2) {
	...
	@OriginalMember(owner = "client!qe", name = "ali", descriptor = "(Lclient!yf;B)V")
	static void method11539(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		Class373.method28203(1643192011);
	}

	@OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(Lclient!xq;IZZ)V")
	...
	// $FF: synthetic method
	@OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(Lclient!xq;IZZLclient!aib;)V")
	...
	public final Class667 method11528(@OriginalArg(0) byte arg0) {
	...
	@OriginalMember(owner = "client!qe", name = "r", descriptor = "()Lclient!xq;")
	public final Class667 method11530() {
		return this.aClass667_8;
	}

	@OriginalMember(owner = "client!qe", name = "v", descriptor = "()Lclient!xq;")
