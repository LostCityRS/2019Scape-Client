...
public final class Class95 {
	...
	public static void method1800(@OriginalArg(0) int arg0) {
		if (client.anInt3435 * -849002901 == 0) {
			@Pc(10) Class93_Sub22 local10 = Class102.method2592(Class446.aClass446_63, client.aClass175_1.aClass24_2, (byte) 32);
			client.aClass175_1.method24363(local10, -1573030867);
			Class676.aClass704_1 = Class704.aClass704_3;
			Class355.aString190 = null;
		}
	}

	@OriginalMember(owner = "client!ae", name = "m", descriptor = "(Ljava/lang/String;ZLclient!dh;Lclient!eu;Lclient!aac;B)V")
	public static void method1801(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) Class104 arg2, @OriginalArg(3) Class106 arg3, @OriginalArg(4) Class5 arg4, @OriginalArg(5) byte arg5) {
		...
		if (Class93_Sub1_Sub1.aBoolean42 && local8) {
			...
			@Pc(23) Class106 local23 = arg2.method20518(local17, Class171.aClass105_Sub2_1, true);
			...
			local90 = Class171.aClass390_8.method28454(local30, client.anInt3511 * 2040043391, 15040190) + Class171.anInt3055 * 1543350707;
			@Pc(102) int local102 = Class171.aClass392_8.method28471(local41, client.anInt3512 * -817449061, (short) 255) + Class355.anInt4260 * -246562615;
			arg2.method20511(Class531.aClass105_3, false).method18191(local90 + Class171.aClass105_2.method7206(), local102 + Class171.aClass105_2.method7198(), local30 - Class171.aClass105_2.method7206() * 2, local41 - Class171.aClass105_2.method7198() * 2, 1, -1, 0);
			arg2.method20511(Class171.aClass105_2, true).method18181(local90, local102);
			Class171.aClass105_2.method7168();
			arg2.method20511(Class171.aClass105_2, true).method18181(local90 + local30 - local44, local102);
			Class171.aClass105_2.method7169();
			arg2.method20511(Class171.aClass105_2, true).method18181(local90 + local30 - local44, local41 + local102 - local44);
			Class171.aClass105_2.method7168();
			arg2.method20511(Class171.aClass105_2, true).method18181(local90, local102 + local41 - local44);
			Class171.aClass105_2.method7169();
			arg2.method20511(Class171.aClass105_1, true).method18190(local90, local102 + Class171.aClass105_2.method7198(), local44, local41 - Class171.aClass105_2.method7198() * 2);
			Class171.aClass105_1.method7155();
			arg2.method20511(Class171.aClass105_1, true).method18190(local90 + Class171.aClass105_2.method7206(), local102, local30 - Class171.aClass105_2.method7206() * 2, local44);
			Class171.aClass105_1.method7155();
			arg2.method20511(Class171.aClass105_1, true).method18190(local30 + local90 - local44, local102 + Class171.aClass105_2.method7198(), local44, local41 - Class171.aClass105_2.method7198() * 2);
			Class171.aClass105_1.method7155();
			arg2.method20511(Class171.aClass105_1, true).method18190(local90 + Class171.aClass105_2.method7206(), local41 + local102 - local44, local30 - Class171.aClass105_2.method7206() * 2, local44);
			Class171.aClass105_1.method7155();
			local23.method7563(arg0, local48 + local90, local102 + local48, local30 - local48 * 2, local41 - local48 * 2, anInt320 * 2016248431 | 0xFF000000, -1, 1, 1, 0, null, null, null, 0, 0, (short) 657);
			Class269.method26366(local90, local102, local30, local41, (byte) -40);
		} else {
			...
			Class269.method26366(local48 - local326, local90 - local326, local30 + local326 + local326, local326 + local326 + local41, (byte) -63);
		}
		if (!arg1) {
			return;
		}
		try {
			arg2.method20513();
			arg2.method20426(-1392012896);
		} catch (@Pc(420) Exception_Sub4 local420) {
		}
	}

	@OriginalMember(owner = "client!ae", name = "ge", descriptor = "(Lclient!yf;I)V")
	static void method1802(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean884 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		arg0.anInt6052 -= -1915563430;
		@Pc(25) int local25 = arg0.anIntArray521[arg0.anInt6052 * -1497248091];
		@Pc(35) int local35 = arg0.anIntArray521[arg0.anInt6052 * -1497248091 + 1];
		@Pc(41) Class87 local41 = (Class87) Class124.aClass32_Sub21_7.method18273(local25, -1583968213);
		if (local35 == local41.anInt265 * 951920133) {
			local11.method26955(local25, 2087973884);
		} else {
			local11.method26953(local25, local35, 1662412852);
		}
	}

	@OriginalMember(owner = "client!ae", name = "ago", descriptor = "(Lclient!yf;I)V")
	static void method1803(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		arg0.anIntArray521[(arg0.anInt6052 += 1189701933) * -1497248091 - 1] = Class342.method27603(local13, local26 == 1, (short) 31342);
	}
