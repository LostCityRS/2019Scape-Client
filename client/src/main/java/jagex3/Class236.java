...
public final class Class236 {
	...
	static final int anInt3853 = 1;

	@OriginalMember(owner = "client!dx", name = "x", descriptor = "I")
	static final int anInt3854 = 2;
	...
	@OriginalMember(owner = "client!dx", name = "<init>", descriptor = "([BLclient!ako;)V")
	Class236(@OriginalArg(0) byte[] arg0, @OriginalArg(1) Class93_Sub25 arg1) {
		...
		try {
			...
			@Pc(33) int local33 = local24.method22425((short) 16384);
			local24.anInt3070 += 1403713386;
			@Pc(43) int local43 = local24.method22427(-1434290800);
			@Pc(45) int local45 = 0;
			@Pc(47) int local47 = -1;
			@Pc(49) int local49 = -1;
			...
			for (local61 = 0; local61 < local43; local61++) {
				...
				@Pc(78) int local78 = local24.method22425((short) 16384);
				if (local78 > 0) {
					if (local70 == 0) {
						local49 = local61;
					}
					...
					if (local33 >= 2 && local70 == 7) {
						if ((local78 & 0x1) == 0) {
							...
							aShortArray100[local45] = (short) local29.method22443(-358186793);
							local29.method22443(-358186793);
						}
						if ((local78 & 0x2) == 0) {
							aShortArray107[local45] = local91;
						} else {
							aShortArray107[local45] = (short) local29.method22443(-358186793);
							local29.method22443(-358186793);
						}
						if ((local78 & 0x4) == 0) {
							aShortArray101[local45] = local91;
						} else {
							aShortArray101[local45] = (short) local29.method22443(-358186793);
							local29.method22443(-358186793);
						}
					} else {
						if ((local78 & 0x1) == 0) {
