...
public final class Class97_Sub7 extends Class97 {
	...
	@OriginalMember(owner = "client!aeu", name = "<init>", descriptor = "(Lclient!afa;Lclient!bz;)V")
	Class97_Sub7(@OriginalArg(0) Class104_Sub1 arg0, @OriginalArg(1) Class199 arg1) {
		...
		if (this.aClass104_Sub1_25.aBoolean100 && this.aClass104_Sub1_25.anInt573 >= 2) {
			this.aClass196_5 = Class196.method24626(this.aClass104_Sub1_25, 34336, "!!ARBvp1.0\nOPTION  ARB_position_invariant;\nATTRIB  iPos         = vertex.position;\nATTRIB  iColour      = vertex.color;\nATTRIB  iTexCoord    = vertex.texcoord[0];\nOUTPUT  oColour      = result.color;\nOUTPUT  oTexCoord0   = result.texcoord[0];\nOUTPUT  oTexCoord1   = result.texcoord[1];\nOUTPUT  oFogCoord    = result.fogcoord;\nPARAM   time         = program.local[65];\nPARAM   turbulence   = program.local[64];\nPARAM   lightAmbient = program.local[66]; \nPARAM   pMatrix[4]   = { state.matrix.projection };\nPARAM   mvMatrix[4]  = { state.matrix.modelview };\nPARAM   ivMatrix[4]  = { state.matrix.texture[1] };\nPARAM   texMatrix[4]  = { state.matrix.texture[0] };\nPARAM   fNoise[64]   = { program.local[0..63] };\nTEMP    noise, viewPos, worldPos, texCoord;\nADDRESS noiseAddr;\nDP4   viewPos.x, mvMatrix[0], iPos;\nDP4   viewPos.y, mvMatrix[1], iPos;\nDP4   viewPos.z, mvMatrix[2], iPos;\nDP4   viewPos.w, mvMatrix[3], iPos;\nMOV   oFogCoord.x, viewPos.z;\nDP4   worldPos.x, ivMatrix[0], viewPos;\nDP4   worldPos.y, ivMatrix[1], viewPos;\nDP4   worldPos.z, ivMatrix[2], viewPos;\nDP4   worldPos.w, ivMatrix[3], viewPos;\nADD   noise.x, worldPos.x, worldPos.z;SUB   noise.y, worldPos.z, worldPos.x;MUL   noise, noise, 0.0001220703125;\nFRC   noise, noise;\nMUL   noise, noise, 64;\nARL   noiseAddr.x, noise.x;\nMOV   noise.x, fNoise[noiseAddr.x].x;\nARL   noiseAddr.x, noise.y;\nMOV   noise.y, fNoise[noiseAddr.x].y;\nMUL   noise, noise, turbulence.x;\nDP4   texCoord.x, texMatrix[0], iTexCoord;\nDP4   texCoord.y, texMatrix[1], iTexCoord;\nADD   oTexCoord0.xy, texCoord, noise;\nMOV   oTexCoord0.z, 0;\nMOV   oTexCoord0.w, 1;\nMUL   oTexCoord1.xy, texCoord, 0.125;\nMOV   oTexCoord1.zw, time.xxxw;\nMUL   oColour.xyz, iColour, lightAmbient;\nMOV   oColour.w, iColour.w;\nEND");
			if (this.aClass196_5 == null) {
				return;
			}
			@Pc(36) int[][] local36 = Class174.method24359(64, 256, 0, 4, 4, 3, 0.4F, false, 196764202);
			@Pc(47) int[][] local47 = Class174.method24359(64, 256, 8, 4, 4, 3, 0.4F, false, -715326154);
			@Pc(49) int local49 = 0;
	...
	@OriginalMember(owner = "client!aeu", name = "y", descriptor = "(II)V")
	@Override
	void method2805(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if ((arg0 & 0x80) != 0) {
			...
			if (this.aClass199_4.aBoolean579) {
				this.aClass104_Sub1_25.method3804(this.aClass199_4.aClass88_Sub3_2);
			} else {
				this.aClass104_Sub1_25.method3804(this.aClass199_4.aClass88_Sub2Array2[0]);
			}
			OpenGL.glProgramLocalParameter4fARB(34336, 65, 0.0F, 0.0F, 0.0F, 1.0F);
		} else if (this.aClass199_4.aBoolean579) {
			this.aClass104_Sub1_25.method3804(this.aClass199_4.aClass88_Sub3_2);
			...
			this.aClass104_Sub1_25.method3804(this.aClass199_4.aClass88_Sub2Array2[local30]);
			OpenGL.glProgramLocalParameter4fARB(34336, 65, 0.0F, 0.0F, 0.0F, 1.0F);
		}
	...
	void method2683() {
		...
		this.aClass182_4.method24571(0);
		this.aClass104_Sub1_25.method3803(1);
		this.aClass104_Sub1_25.method3792(-16777216);
		this.aClass104_Sub1_25.method3837(260, 7681);
		this.aClass104_Sub1_25.method3808(0, 34166, 770);
		this.aClass104_Sub1_25.method3803(0);
		OpenGL.glBindProgramARB(34336, this.aClass196_5.anInt3365);
		OpenGL.glEnable(34336);
		this.aClass182_4.method24569();
		this.aClass182_4.method24571(1);
		this.aClass104_Sub1_25.method3803(1);
		OpenGL.glMatrixMode(5890);
		OpenGL.glLoadIdentity();
		OpenGL.glMatrixMode(5888);
		this.aClass104_Sub1_25.method3805(0);
	...
	@OriginalMember(owner = "client!aeu", name = "h", descriptor = "()V")
	void method2684() {
		this.aClass182_4 = new Class182(this.aClass104_Sub1_25, 2);
		this.aClass182_4.method24571(0);
		this.aClass104_Sub1_25.method3803(1);
	...
	@OriginalMember(owner = "client!aeu", name = "e", descriptor = "()Z")
	@Override
	boolean method2790() {
		return true;
	}

	@OriginalMember(owner = "client!aeu", name = "k", descriptor = "()V")
	@Override
	void method2793() {
		if (this.aClass182_4 != null) {
			this.aClass182_4.method24572('\u0001');
			this.aClass104_Sub1_25.method3803(1);
			this.aClass104_Sub1_25.method3804(null);
			this.aClass104_Sub1_25.method3803(0);
		}
	...
	@OriginalMember(owner = "client!aeu", name = "n", descriptor = "(Z)V")
	@Override
	...
	@OriginalMember(owner = "client!aeu", name = "u", descriptor = "()Z")
	@Override
	boolean method2802() {
		return true;
	}

	@OriginalMember(owner = "client!aeu", name = "l", descriptor = "()Z")
	@Override
	boolean method2796() {
		return true;
	}
	...
	@OriginalMember(owner = "client!aeu", name = "z", descriptor = "()Z")
	@Override
	boolean method2798() {
		return true;
	}

	@OriginalMember(owner = "client!aeu", name = "p", descriptor = "()Z")
	@Override
	boolean method2791() {
		return true;
	}

	@OriginalMember(owner = "client!aeu", name = "d", descriptor = "()Z")
	@Override
	boolean method2799() {
		return true;
	}

	@OriginalMember(owner = "client!aeu", name = "w", descriptor = "(Lclient!bq;I)V")
	@Override
	...
	@OriginalMember(owner = "client!aeu", name = "c", descriptor = "(Z)V")
	@Override
	...
	@OriginalMember(owner = "client!aeu", name = "r", descriptor = "(Z)V")
	@Override
	...
	@OriginalMember(owner = "client!aeu", name = "o", descriptor = "(II)V")
	@Override
	...
	@OriginalMember(owner = "client!aeu", name = "s", descriptor = "(II)V")
	@Override
	...
	@OriginalMember(owner = "client!aeu", name = "f", descriptor = "(II)V")
	@Override
	...
	@OriginalMember(owner = "client!aeu", name = "q", descriptor = "(Lclient!bq;I)V")
	@Override
	...
	@OriginalMember(owner = "client!aeu", name = "x", descriptor = "(Lclient!bq;I)V")
	@Override
