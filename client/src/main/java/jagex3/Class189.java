...
public final class Class189 {
	...
	final boolean aBoolean577;

	@OriginalMember(owner = "client!bl", name = "u", descriptor = "I")
	final int anInt3344;

	@OriginalMember(owner = "client!bl", name = "azm", descriptor = "(Lclient!yf;B)V")
	static void method24594(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anIntArray521[(arg0.anInt6052 += 1189701933) * -1497248091 - 1] = 0;
	}

	@OriginalMember(owner = "client!bl", name = "n", descriptor = "([BIII)Ljava/lang/String;")
	static String method24595(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	@OriginalMember(owner = "client!bl", name = "ko", descriptor = "(III)V")
	static void method24596(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (Class383.method28326(arg0, null, 1588031466)) {
			Class550.method31214(Class166_Sub1.aClass320Array1[arg0].aClass312Array3, arg1, (byte) 49);
		}
	}
