...
public final class Class703 {
	...
	@OriginalMember(owner = "client!ze", name = "xl", descriptor = "(Lclient!yf;I)V")
	static void method36904(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray521[(arg0.anInt6052 -= 1189701933) * -1497248091];
		arg0.anIntArray521[(arg0.anInt6052 += 1189701933) * -1497248091 - 1] = Class624.aClass120_1.method8656(local12, -2117194675);
	}

	@OriginalMember(owner = "client!ze", name = "baq", descriptor = "(Lclient!yf;I)V")
	static void method36905(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray521[(arg0.anInt6052 -= 1189701933) * -1497248091];
		arg0.anIntArray521[(arg0.anInt6052 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub4_1.method16555(local12, 1270068358);
	}

	@OriginalMember(owner = "client!ze", name = "z", descriptor = "(IIZI)Ljava/lang/String;")
	static String method36906(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) int arg3) {
		if (arg1 < 2 || arg1 > 36) {
