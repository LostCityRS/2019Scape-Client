...
public final class Class591 implements Interface75, Interface64 {
	...
	public static void method31877(@OriginalArg(0) int arg0) {
		...
		while (true) {
			@Pc(17) Interface63 local17 = (Interface63) Class602.aLinkedList6.poll();
			if (local17 == null) {
				return;
			}
	...
	static void method31878(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static void method31879(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static void method31880(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray521[(arg0.anInt6052 -= 1189701933) * -1497248091];
		if (local12 == 0) {
	...
	static void method31881(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static void method31882(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Class620 arg4, @OriginalArg(5) int arg5) {
	...
	static void method31883(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	Class591(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(2) Class519[] arg2) {
		this.anInt5637 = arg0 * 1968733325;
		...
		while (local14 < local12.length) {
			...
			switch(local22.aClass500_7.anInt5357 * -1217885029) {
				case 1:
				case 2:
				case 3:
				case 4:
	...
	public int method37101() {
		return this.anInt5637 * -1028676027;
	}
