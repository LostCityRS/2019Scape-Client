...
public final class Class14 {
	...
	@OriginalMember(owner = "client!aal", name = "e", descriptor = "(JII)Ljava/lang/String;")
	public static String method192(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		return arg1 == 3 ? Class474.method29847(arg0, arg1, (byte) -115) : Integer.toString(local5 / 10) + local5 % 10 + "-" + Class69.aStringArrayArray1[arg1][local9] + "-" + local13;
	}

	@OriginalMember(owner = "client!aal", name = "n", descriptor = "(IIZI)I")
	...
	@OriginalMember(owner = "client!aal", name = "aow", descriptor = "(Lclient!yf;I)V")
	static void method194(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		if (!Class65.aClass123_Sub1_2.method8986((byte) -80).method27556((byte) 1)) {
			throw new RuntimeException();
		}
		@Pc(14) Class25_Sub4 local14 = (Class25_Sub4) Class65.aClass123_Sub1_2.method9040(-1633922274);
		local14.method23150(Class382.aClass479_2, -1, 0.0F, -678450998);
		client.aBoolean621 = true;
	}

	@OriginalMember(owner = "client!aal", name = "ahr", descriptor = "(Lclient!yf;I)V")
	static void method195(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray521[(arg0.anInt6052 -= 1189701933) * -1497248091];
		arg0.anIntArray521[(arg0.anInt6052 += 1189701933) * -1497248091 - 1] = ((Class47) Class277.aClass32_Sub12_1.method18273(local12, -1790603482)).anInt139 * 415441565;
	}
