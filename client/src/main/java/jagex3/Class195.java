...
public final class Class195 {
	...
	@OriginalMember(owner = "client!bt", name = "<init>", descriptor = "(Lclient!afa;Lclient!ci;Lclient!aek;IIIII)V")
			...
			if (this.aClass104_Sub1_41.aBoolean106) {
					...
					for (local105 = 0; local105 < local23; local105++) {
						...
						if (local114 != null) {
							for (local118 = 0; local118 < local114.length; local118++) {
								local83.method22466(local114[local118] & 0xFFFF, 2130950967);
							}
						}
					}
				}
				...
				for (local49 = 0; local49 < local23; local49++) {
					...
					for (local105 = 0; local105 < local23; local105++) {
						...
						if (local114 != null) {
							for (local118 = 0; local118 < local114.length; local118++) {
								local83.method22405(local114[local118] & 0xFFFF, -198370378);
							}
						}
					}
				}
			}
			this.anInterface16_5 = this.aClass104_Sub1_41.method3793(5123, local83.aByteArray58, local83.anInt3070 * 212851357, false);
	...
	void method24610() {
		...
		if (this.aClass88_Sub2_5 == null) {
			...
			this.aClass88_Sub2_5.method18092(false, false);
			this.aClass88_Sub2_5.method18053(true);
		} else {
			this.aClass88_Sub2_5.method18111(0, 0, 128, 128, this.aClass104_Sub1_41.aByteArray17, Class206.aClass206_19, 0, 0, false);
		}
	}

	@OriginalMember(owner = "client!bt", name = "e", descriptor = "()V")
	void method24611() {
		this.method24617(this.anInterface16_5, this.anInt3364);
	}

	@OriginalMember(owner = "client!bt", name = "o", descriptor = "()V")
	void method24612() {
		if (!this.aBoolean578) {
			return;
		}
	...
	@OriginalMember(owner = "client!bt", name = "k", descriptor = "()V")
	void method24613() {
		if (!this.aBoolean578) {
			return;
		}
	...
	@OriginalMember(owner = "client!bt", name = "w", descriptor = "()V")
	void method24616() {
		this.method24617(this.anInterface16_5, this.anInt3364);
	}

	@OriginalMember(owner = "client!bt", name = "m", descriptor = "(Lclient!cf;I)V")
	void method24617(@OriginalArg(0) Interface16 arg0, @OriginalArg(1) int arg1) {
		if (arg1 != 0) {
			this.method24613();
			this.aClass104_Sub1_41.method3804(this.aClass88_Sub2_5);
			this.aClass104_Sub1_41.method3948(arg0, 4, 0, arg1);
		}
	}

	@OriginalMember(owner = "client!bt", name = "u", descriptor = "([BI)V")
	void method24618(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		this.aClass101_Sub1_2.method2561(5123, arg0, arg1 * 2);
		this.method24617(this.aClass101_Sub1_2, arg1);
	}

	@OriginalMember(owner = "client!bt", name = "l", descriptor = "([BI)V")
	void method24619(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		this.aClass101_Sub1_2.method2561(5123, arg0, arg1 * 2);
		this.method24617(this.aClass101_Sub1_2, arg1);
	}

	@OriginalMember(owner = "client!bt", name = "p", descriptor = "(Lclient!cf;I)V")
	void method24620(@OriginalArg(0) Interface16 arg0, @OriginalArg(1) int arg1) {
		if (arg1 != 0) {
			this.method24613();
			this.aClass104_Sub1_41.method3804(this.aClass88_Sub2_5);
			this.aClass104_Sub1_41.method3948(arg0, 4, 0, arg1);
	...
	@OriginalMember(owner = "client!bt", name = "z", descriptor = "([BI)V")
	void method24621(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		this.aClass101_Sub1_2.method2561(5123, arg0, arg1 * 2);
		this.method24617(this.aClass101_Sub1_2, arg1);
	}
	...
	@OriginalMember(owner = "client!bt", name = "n", descriptor = "([BI)V")
	void method24623(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		this.aClass101_Sub1_2.method2561(5123, arg0, arg1 * 2);
		this.method24617(this.aClass101_Sub1_2, arg1);
	}

	@OriginalMember(owner = "client!bt", name = "v", descriptor = "()V")
	void method24624() {
		if (!this.aBoolean578) {
			return;
		}
