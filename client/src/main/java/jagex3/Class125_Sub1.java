...
public final class Class125_Sub1 extends Class125 {
	...
	@OriginalMember(owner = "client!ahe", name = "f", descriptor = "(Lclient!alw;)Lclient!kp;")
	public static Class125 method9212(@OriginalArg(0) Class93_Sub41 arg0) {
		...
		@Pc(15) int local15 = arg0.method22448(-1869949931);
	...
	static void method9213(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) Class93_Sub1_Sub8 arg7, @OriginalArg(8) Class106 arg8, @OriginalArg(9) Class5 arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12) {
		...
		arg8.method7532(local31, arg2 + 3, arg6, arg10, 0, client.aRandom2, Class106.anInt891, Class110_Sub14.aClass100Array4, null, (byte) 1);
	}

	@OriginalMember(owner = "client!ahe", name = "e", descriptor = "(ZI)Lclient!tl;")
	public static Class573 method9214(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
	...
	@OriginalMember(owner = "client!ahe", name = "kx", descriptor = "(Lclient!hf;III)V")
	public static void method9215(@OriginalArg(0) Class312 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (client.aClass312_5 != null || Class454.aBoolean782 || (arg0 == null || !Class349.method27721(arg0, -1323171957))) {
			return;
		}
		client.aClass312_5 = arg0;
		client.aClass312_3 = Class40.method799(arg0, -1216225751);
		client.anInt3528 = arg1 * -1933597649;
		client.anInt3529 = arg2 * 365276271;
		Class550.anInt5475 = 0;
		client.aBoolean618 = false;
	}

	@OriginalMember(owner = "client!ahe", name = "<init>", descriptor = "(Lclient!kv;Lclient!ky;IIIIIIIIII)V")
	...
	@OriginalMember(owner = "client!ahe", name = "n", descriptor = "(S)Lclient!kt;")
	@Override
	public Class388 method28759(@OriginalArg(0) short arg0) {
		return Class388.aClass388_3;
	}

	@OriginalMember(owner = "client!ahe", name = "l", descriptor = "()Lclient!kt;")
	@Override
