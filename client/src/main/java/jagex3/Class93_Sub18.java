...
public final class Class93_Sub18 extends Class93 {
	...
	@OriginalMember(owner = "client!akh", name = "<init>", descriptor = "(Lclient!aem;IILclient!dy;)V")
	...
	@OriginalMember(owner = "client!akh", name = "e", descriptor = "(I)V")
	void method13590(@OriginalArg(0) int arg0) {
		this.aByteBuffer4 = this.aClass104_Sub2_26.method21092(arg0 * 4);
		this.aLong77 = this.aClass104_Sub2_26.method20903(this.aByteBuffer4);
	...
	@OriginalMember(owner = "client!akh", name = "k", descriptor = "(IIIF)V")
	void method13591(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) float arg3) {
		@Pc(16) int local16;
		@Pc(26) int local26;
		if (this.anInt1538 != -1) {
			@Pc(11) Class235 local11 = this.aClass104_Sub2_26.aClass225_6.method25690(this.anInt1538, -972045759);
	...
	@OriginalMember(owner = "client!akh", name = "n", descriptor = "(I)V")
	void method13592(@OriginalArg(0) int arg0) {
		this.aClass104_Sub2_26.anUnsafe4.putByte(this.aLong77 + (long) (arg0 * 4) + 3L, (byte) -1);
	}

	@OriginalMember(owner = "client!akh", name = "m", descriptor = "(III)V")
	void method13593(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anIntArray177[arg1 * this.aClass99_Sub3_1.anInt414 * -1667858293 + arg0] |= 0x1 << arg2;
		this.anInt1539++;
	}

	@OriginalMember(owner = "client!akh", name = "p", descriptor = "(III)V")
	void method13594(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anIntArray177[arg1 * this.aClass99_Sub3_1.anInt414 * -1667858293 + arg0] |= 0x1 << arg2;
		this.anInt1539++;
	}

	@OriginalMember(owner = "client!akh", name = "f", descriptor = "(I)V")
	void method13595(@OriginalArg(0) int arg0) {
		this.anInterface37_10 = this.aClass104_Sub2_26.method21025(false);
		this.anInterface37_10.method29496(arg0 * 4, 4);
		this.anInterface37_10.method29514(0, arg0 * 4, this.aLong77);
		this.aByteBuffer4.clear();
		this.aByteBuffer4 = null;
		this.aLong77 = 0L;
	}

	@OriginalMember(owner = "client!akh", name = "w", descriptor = "([II)V")
	void method13596(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1) {
		this.anInt1541 = 0;
	...
	@OriginalMember(owner = "client!akh", name = "l", descriptor = "(I)V")
	void method13597(@OriginalArg(0) int arg0) {
		this.aByteBuffer4 = this.aClass104_Sub2_26.method21092(arg0 * 4);
		this.aLong77 = this.aClass104_Sub2_26.method20903(this.aByteBuffer4);
		for (@Pc(16) int local16 = 3; local16 < arg0 * 4; local16 += 4) {
			this.aClass104_Sub2_26.anUnsafe4.putByte(this.aLong77 + (long) local16, (byte) 0);
	...
	@OriginalMember(owner = "client!akh", name = "u", descriptor = "(I)V")
	void method13598(@OriginalArg(0) int arg0) {
		this.aClass104_Sub2_26.anUnsafe4.putByte(this.aLong77 + (long) (arg0 * 4) + 3L, (byte) -1);
	}

	@OriginalMember(owner = "client!akh", name = "z", descriptor = "(I)V")
	void method13599(@OriginalArg(0) int arg0) {
		this.aClass104_Sub2_26.anUnsafe4.putByte(this.aLong77 + (long) (arg0 * 4) + 3L, (byte) -1);
	}

	@OriginalMember(owner = "client!akh", name = "d", descriptor = "(III)V")
	void method13600(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anIntArray177[arg1 * this.aClass99_Sub3_1.anInt414 * -1667858293 + arg0] |= 0x1 << arg2;
		this.anInt1539++;
	}

	@OriginalMember(owner = "client!akh", name = "r", descriptor = "(III)V")
	void method13601(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anIntArray177[arg1 * this.aClass99_Sub3_1.anInt414 * -1667858293 + arg0] |= 0x1 << arg2;
		this.anInt1539++;
	}

	@OriginalMember(owner = "client!akh", name = "c", descriptor = "(III)V")
	void method13602(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anIntArray177[arg1 * this.aClass99_Sub3_1.anInt414 * -1667858293 + arg0] |= 0x1 << arg2;
		this.anInt1539++;
	}

	@OriginalMember(owner = "client!akh", name = "a", descriptor = "([II)V")
	void method13603(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1) {
		this.anInt1541 = 0;
		this.anInt1537 = 32767;
		this.anInt1540 = -32768;
		@Pc(12) ByteBuffer local12 = this.aClass104_Sub2_26.aByteBuffer7;
	...
	@OriginalMember(owner = "client!akh", name = "v", descriptor = "(IIIF)V")
	void method13604(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) float arg3) {
		@Pc(16) int local16;
		@Pc(26) int local26;
		if (this.anInt1538 != -1) {
			@Pc(11) Class235 local11 = this.aClass104_Sub2_26.aClass225_6.method25690(this.anInt1538, -594209001);
			local16 = local11.aByte123 & 0xFF;
			@Pc(49) int local49;
			if (local16 != 0 && local11.aByte114 != 4) {
				if (arg2 < 0) {
	...
	@OriginalMember(owner = "client!akh", name = "x", descriptor = "(I)V")
	...
	@OriginalMember(owner = "client!akh", name = "h", descriptor = "(I)V")
	void method13606(@OriginalArg(0) int arg0) {
		this.anInterface37_10 = this.aClass104_Sub2_26.method21025(false);
		this.anInterface37_10.method29496(arg0 * 4, 4);
		this.anInterface37_10.method29514(0, arg0 * 4, this.aLong77);
		this.aByteBuffer4.clear();
	...
	@OriginalMember(owner = "client!akh", name = "y", descriptor = "(IIIF)V")
	void method13607(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) float arg3) {
		@Pc(16) int local16;
		@Pc(26) int local26;
		if (this.anInt1538 != -1) {
			@Pc(11) Class235 local11 = this.aClass104_Sub2_26.aClass225_6.method25690(this.anInt1538, 139313815);
			local16 = local11.aByte123 & 0xFF;
			@Pc(49) int local49;
			if (local16 != 0 && local11.aByte114 != 4) {
				if (arg2 < 0) {
	...
	@OriginalMember(owner = "client!akh", name = "g", descriptor = "([II)V")
