...
public interface Interface72 {
	...
	String method29137(@OriginalArg(0) Class669 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) long arg2);

	@OriginalMember(owner = "client!xx", name = "e", descriptor = "(Lclient!xs;[IJ)Ljava/lang/String;")
	String method29138(@OriginalArg(0) Class669 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) long arg2);
}
