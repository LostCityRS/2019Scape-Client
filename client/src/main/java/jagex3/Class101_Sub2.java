...
public final class Class101_Sub2 extends Class101 implements Interface14 {

	@OriginalMember(owner = "client!aey", name = "m", descriptor = "I")
	int anInt446;

	@OriginalMember(owner = "client!aey", name = "<init>", descriptor = "(Lclient!afa;ILclient!jaclib/memory/Buffer;)V")
	Class101_Sub2(@OriginalArg(0) Class104_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Buffer arg2) {
		super(arg0, arg2);
		this.anInt446 = arg1;
	}

	@OriginalMember(owner = "client!aey", name = "<init>", descriptor = "(Lclient!afa;I[BI)V")
	Class101_Sub2(@OriginalArg(0) Class104_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2, @OriginalArg(3) int arg3) {
		super(arg0, arg2, arg3);
		this.anInt446 = arg1;
	}

	@OriginalMember(owner = "client!aey", name = "w", descriptor = "()I")
	@Override
	public int method2784() {
		return 0;
	}

	@OriginalMember(owner = "client!aey", name = "e", descriptor = "()I")
	@Override
	public int method2787() {
		return 0;
	}

	@OriginalMember(owner = "client!aey", name = "n", descriptor = "()I")
	@Override
	public int method2788() {
		return this.anInt446;
	}

	@OriginalMember(owner = "client!aey", name = "m", descriptor = "()J")
	@Override
	public long method2781() {
		return this.aBuffer3.method27896();
	}

	@OriginalMember(owner = "client!aey", name = "k", descriptor = "(I[BI)V")
	@Override
	...
	@OriginalMember(owner = "client!aey", name = "f", descriptor = "()I")
	@Override
	...
	@OriginalMember(owner = "client!aey", name = "p", descriptor = "()I")
	@Override
	public int method2780() {
		return this.anInt446;
	}

	@OriginalMember(owner = "client!aey", name = "u", descriptor = "()J")
	@Override
	public long method2782() {
		return this.aBuffer3.method27896();
	}

	@OriginalMember(owner = "client!aey", name = "z", descriptor = "(I[BI)V")
	@Override
