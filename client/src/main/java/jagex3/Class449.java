...
public final class Class449 {
	...
	static {
		@Pc(77) Class449[] local77 = Class53.method14958(-1396233847);
		for (@Pc(79) int local79 = 0; local79 < local77.length; local79++) {
			aClass449Array1[local77[local79].anInt5141 * 1690737369] = local77[local79];
		}
	}

	@OriginalMember(owner = "client!nu", name = "n", descriptor = "()[Lclient!nu;")
	static Class449[] method29107() {
	...
	@OriginalMember(owner = "client!nu", name = "m", descriptor = "()[Lclient!nu;")
	static Class449[] method29108() {
		return new Class449[] { aClass449_1, aClass449_9, aClass449_11, aClass449_2, aClass449_10, aClass449_5, aClass449_8, aClass449_7, aClass449_4, aClass449_6, aClass449_3, aClass449_12 };
	}

	@OriginalMember(owner = "client!nu", name = "e", descriptor = "(Lclient!alw;I)Lclient!la;")
	public static Class133 method29109(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		@Pc(3) int local3 = arg0.method22448(-1215915305);
		@Pc(10) Class390 local10 = Class708.method36937(1635987414)[arg0.method22425((short) 16384)];
		@Pc(17) Class392 local17 = Class252.method26071(-2134249016)[arg0.method22425((short) 16384)];
		@Pc(21) int local21 = arg0.method22494((byte) -123);
		@Pc(25) int local25 = arg0.method22494((byte) -63);
		return new Class133(local3, local10, local17, local21, local25);
	}

	@OriginalMember(owner = "client!nu", name = "ant", descriptor = "(Lclient!yf;B)V")
	static void method29110(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) throws Exception_Sub3 {
		@Pc(12) int local12 = arg0.anIntArray521[(arg0.anInt6052 -= 1189701933) * -1497248091];
		Class65.aClass123_Sub1_2.method8931(Class180.method24530(local12, (byte) -1), true, -1917523624);
		client.aBoolean621 = true;
	}

	@OriginalMember(owner = "client!nu", name = "e", descriptor = "(I)[Lclient!ht;")
	static Class323[] method29111(@OriginalArg(0) int arg0) {
	...
	@OriginalMember(owner = "client!nu", name = "za", descriptor = "(Lclient!yf;I)V")
	static void method29112(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray521[(arg0.anInt6052 += 1189701933) * -1497248091 - 1] = Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aClass523_7.method30544(1285948352) >> 3;
	}

	@OriginalMember(owner = "client!nu", name = "iv", descriptor = "(Lclient!yf;I)V")
	static void method29113(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean884 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class183.method24589(local11, local14, arg0, -977933591);
	}

	@OriginalMember(owner = "client!nu", name = "<init>", descriptor = "(II)V")
	Class449(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.anInt5141 = arg0 * -864139927;
	}
}
