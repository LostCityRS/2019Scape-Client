...
public final class Class166_Sub3 extends Class166 {
	...
	@OriginalMember(owner = "client!amc", name = "e", descriptor = "(I)[Lclient!nz;")
	public static Class453[] method15419(@OriginalArg(0) int arg0) {
	...
	@OriginalMember(owner = "client!amc", name = "<init>", descriptor = "(ILclient!ali;)V")
	public Class166_Sub3(@OriginalArg(0) int arg0, @OriginalArg(1) Class93_Sub36 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!amc", name = "<init>", descriptor = "(Lclient!ali;)V")
	public Class166_Sub3(@OriginalArg(0) Class93_Sub36 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!amc", name = "q", descriptor = "()V")
	public void method15412() {
		if (this.aClass93_Sub36_49.method14359((byte) 25) != Class702.aClass702_6) {
			this.anInt2379 = -88839937;
		}
		if (this.anInt2379 * 960141055 != 0 && this.anInt2379 * 960141055 != 1) {
			this.anInt2379 = this.method16554((byte) -61) * -88839937;
		}
	}

	@OriginalMember(owner = "client!amc", name = "e", descriptor = "(B)I")
	@Override
	int method16554(@OriginalArg(0) byte arg0) {
		return 1;
	}

	@OriginalMember(owner = "client!amc", name = "s", descriptor = "(B)Z")
	public boolean method15413(@OriginalArg(0) byte arg0) {
		return this.aClass93_Sub36_49.method14359((byte) 99) == Class702.aClass702_6;
	}

	@OriginalMember(owner = "client!amc", name = "n", descriptor = "(II)I")
	@Override
	public int method16555(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return this.aClass93_Sub36_49.method14359((byte) 36) == Class702.aClass702_6 ? 1 : 3;
	}

	@OriginalMember(owner = "client!amc", name = "k", descriptor = "(II)V")
	@Override
	void method16557(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.anInt2379 = arg0 * -88839937;
	}

	@OriginalMember(owner = "client!amc", name = "y", descriptor = "(I)I")
	public int method15414(@OriginalArg(0) int arg0) {
		return this.anInt2379 * 960141055;
	}

	@OriginalMember(owner = "client!amc", name = "f", descriptor = "()I")
	@Override
	int method16553() {
		return 1;
	}

	@OriginalMember(owner = "client!amc", name = "o", descriptor = "(S)V")
	public void method15415(@OriginalArg(0) short arg0) {
		if (this.aClass93_Sub36_49.method14359((byte) 11) != Class702.aClass702_6) {
			this.anInt2379 = -88839937;
		}
		if (this.anInt2379 * 960141055 != 0 && this.anInt2379 * 960141055 != 1) {
	...
	@OriginalMember(owner = "client!amc", name = "h", descriptor = "()I")
	public int method15416() {
		return this.anInt2379 * 960141055;
	}

	@OriginalMember(owner = "client!amc", name = "z", descriptor = "(I)I")
	@Override
	public int method16561(@OriginalArg(0) int arg0) {
		return this.aClass93_Sub36_49.method14359((byte) 75) == Class702.aClass702_6 ? 1 : 3;
	}

	@OriginalMember(owner = "client!amc", name = "p", descriptor = "(I)I")
	@Override
	public int method16552(@OriginalArg(0) int arg0) {
		return this.aClass93_Sub36_49.method14359((byte) 69) == Class702.aClass702_6 ? 1 : 3;
	}

	@OriginalMember(owner = "client!amc", name = "d", descriptor = "(I)V")
	@Override
	void method16558(@OriginalArg(0) int arg0) {
		this.anInt2379 = arg0 * -88839937;
	}

	@OriginalMember(owner = "client!amc", name = "c", descriptor = "(I)V")
	@Override
	void method16563(@OriginalArg(0) int arg0) {
		this.anInt2379 = arg0 * -88839937;
	}

	@OriginalMember(owner = "client!amc", name = "u", descriptor = "()I")
	@Override
	int method16560() {
		return 1;
	}

	@OriginalMember(owner = "client!amc", name = "x", descriptor = "()Z")
	public boolean method15417() {
		return this.aClass93_Sub36_49.method14359((byte) 16) == Class702.aClass702_6;
	}

	@OriginalMember(owner = "client!amc", name = "b", descriptor = "()Z")
	public boolean method15418() {
		return this.aClass93_Sub36_49.method14359((byte) 16) == Class702.aClass702_6;
	}
