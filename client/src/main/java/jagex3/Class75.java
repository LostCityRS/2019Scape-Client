...
public final class Class75 {
	...
	public static void method1263() {
		...
		Class277.method26453(client.aClass532_1.method30640(-1472658235).aClass572ArrayArrayArray1, 2010590815);
		if (client.aClass532_1.method30640(-1813439572).aClass572ArrayArrayArray2 != null) {
			Class277.method26453(client.aClass532_1.method30640(-2000392838).aClass572ArrayArrayArray2, 1088151341);
		}
		aBoolean31 = true;
	}

	@OriginalMember(owner = "client!ad", name = "k", descriptor = "([[[Lclient!tk;)V")
	...
	@OriginalMember(owner = "client!ad", name = "f", descriptor = "([[[Lclient!tk;)V")
	...
	@OriginalMember(owner = "client!ad", name = "mp", descriptor = "(Lclient!hf;Lclient!hq;Lclient!yf;B)V")
	static void method1266(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) byte arg3) {
		...
		arg0.anObjectArray12 = Class499.method30329(local13, arg2, -1334512652);
		arg0.aBoolean684 = true;
	}

	@OriginalMember(owner = "client!ad", name = "aan", descriptor = "(Lclient!yf;I)V")
	static void method1267(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		if (client.anInt3572 * 825168203 == 0 || local12 >= client.anInt3573 * 1882800101) {
			...
			arg0.anObjectArray45[(arg0.anInt6049 += 957530791) * 587908375 - 1] = client.aClass177Array1[local12].aString124;
		}
	}

	@OriginalMember(owner = "client!ad", name = "aav", descriptor = "(Lclient!yf;B)V")
	static void method1268(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray521[(arg0.anInt6052 -= 1189701933) * -1497248091];
		if (client.anInt3572 * 825168203 == 2 && local12 >= 0 && local12 < client.anInt3444 * 862418793) {
			arg0.anIntArray521[(arg0.anInt6052 += 1189701933) * -1497248091 - 1] = client.aClass281Array1[local12].anInt3937 * 1129198739;
		} else {
			arg0.anIntArray521[(arg0.anInt6052 += 1189701933) * -1497248091 - 1] = 0;
		}
	}

	@OriginalMember(owner = "client!ad", name = "k", descriptor = "(CLclient!zt;I)I")
	static int method1269(@OriginalArg(0) char arg0, @OriginalArg(1) Class717 arg1, @OriginalArg(2) int arg2) {
	...
	@OriginalMember(owner = "client!ad", name = "hr", descriptor = "(IB)V")
	static void method1270(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
	...
	@OriginalMember(owner = "client!ad", name = "abr", descriptor = "(Lclient!yf;I)V")
	static void method1271(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray521[(arg0.anInt6052 += 1189701933) * -1497248091 - 1] = Class692.anInt6097 * 1714267873;
	}

	@OriginalMember(owner = "client!ad", name = "n", descriptor = "(B)Lclient!ou;")
	public static Class470 method1272(@OriginalArg(0) byte arg0) {
