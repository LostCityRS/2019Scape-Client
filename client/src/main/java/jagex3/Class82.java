...
public final class Class82 {
	...
	public static void method1384(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2) {
		...
		for (@Pc(9) int local9 = 0; local9 < local3; local9++) {
			...
			if (local18 != null && local18 != Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3 && local18.aString82 != null && local18.aString82.equalsIgnoreCase(arg1)) {
				...
				if (local35 != null) {
					@Pc(102) Class93_Sub22 local102 = Class102.method2592(local35, client.aClass175_2.aClass24_2, (byte) 28);
					local102.aClass93_Sub41_Sub2_1.method22466(local5[local9], 2129512639);
					local102.aClass93_Sub41_Sub2_1.method22458(0, -1591808004);
					client.aClass175_2.method24363(local102, -2107828542);
				}
				local7 = true;
				break;
			}
		...
		if (!local7) {
			Class103.method2811(4, Class74.aClass74_127.method1259(Class106.aClass717_8, (byte) 16) + arg1, -1963408433);
		}
	}

	@OriginalMember(owner = "client!adh", name = "k", descriptor = "(Ljava/lang/CharSequence;Lclient!adi;B)Ljava/lang/String;")
	public static String method1385(@OriginalArg(0) CharSequence arg0, @OriginalArg(1) Class83 arg1, @OriginalArg(2) byte arg2) {
		if (arg0 == null) {
			return null;
		}
		@Pc(6) int local6 = 0;
		...
		if (local37 < 1 || local37 > Class153.method14099(arg1, (byte) -109)) {
			return null;
		}
		...
		for (@Pc(54) int local54 = local6; local54 < local9; local54++) {
			...
			if (Class687.method36683(local61, (byte) 0)) {
				@Pc(70) char local70 = Class549.method31208(local61, 2072969717);
				if (local70 != '\u0000') {
	...
	@OriginalMember(owner = "client!adh", name = "<init>", descriptor = "(Lclient!py;I)V")
	public Class82(@OriginalArg(0) Class497 arg0, @OriginalArg(1) int arg1) {
		@Pc(7) byte[] local7 = arg0.method30225(arg1, 0, (byte) 0);
		this.method1382(new Class93_Sub41(local7), (byte) -1);
	}

	@OriginalMember(owner = "client!adh", name = "<init>", descriptor = "(Lclient!py;II)V")
	public Class82(@OriginalArg(0) Class497 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(9) byte[] local9 = arg0.method30225(arg1, arg2 + 1, (byte) 0);
		this.method1382(new Class93_Sub41(local9), (byte) -1);
	}

	@OriginalMember(owner = "client!adh", name = "m", descriptor = "(Ljava/lang/Object;)Ljava/util/List;")
	public List method1380(@OriginalArg(0) Object arg0) {
		return (List) this.aMap5.get(arg0);
	}

	@OriginalMember(owner = "client!adh", name = "n", descriptor = "(Ljava/lang/Object;I)Ljava/util/List;")
	public List method1381(@OriginalArg(0) Object arg0, @OriginalArg(1) int arg1) {
		return (List) this.aMap5.get(arg0);
	}
	...
	void method1382(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) byte arg1) {
		...
		while (local13-- > 0) {
			...
			while (local32-- > 0) {
				@Pc(43) int local43 = arg0.method22608((short) -1723);
				local36.add(local43);
			}
	...
	@OriginalMember(owner = "client!adh", name = "k", descriptor = "(Ljava/lang/Object;)Ljava/util/List;")
