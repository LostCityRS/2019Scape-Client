...
public abstract class Class140 {
	...
	static {
		for (@Pc(4) int local4 = 0; local4 < 4096; local4++) {
			anIntArray249[local4] = method20418(local4);
		}
	}

	@OriginalMember(owner = "client!ol", name = "q", descriptor = "(IIII)I")
	static int method20395(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	@OriginalMember(owner = "client!ol", name = "w", descriptor = "(IIII)I")
	static int method20398(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(3) int local3 = arg0 & 0xF;
		@Pc(10) int local10 = local3 < 8 ? arg1 : arg2;
		@Pc(25) int local25 = local3 < 4 ? arg2 : local3 == 12 || local3 == 14 ? arg1 : arg3;
		return ((local3 & 0x1) == 0 ? local10 : -local10) + ((local3 & 0x2) == 0 ? local25 : -local25);
	...
	static int method20409(@OriginalArg(0) int arg0) {
	...
	@OriginalMember(owner = "client!ol", name = "x", descriptor = "(IIII)I")
	static int method20414(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(3) int local3 = arg0 & 0xF;
		@Pc(10) int local10 = local3 < 8 ? arg1 : arg2;
		@Pc(25) int local25 = local3 < 4 ? arg2 : local3 == 12 || local3 == 14 ? arg1 : arg3;
		return ((local3 & 0x1) == 0 ? local10 : -local10) + ((local3 & 0x2) == 0 ? local25 : -local25);
	...
	static int method20416(@OriginalArg(0) int arg0) {
		@Pc(9) int local9 = arg0 * (arg0 * arg0 >> 12) >> 12;
		@Pc(15) int local15 = arg0 * 6 - 61440;
		@Pc(23) int local23 = (local15 * arg0 >> 12) + 40960;
		return local23 * local9 >> 12;
	...
	static int method20417(@OriginalArg(0) int arg0) {
		@Pc(9) int local9 = arg0 * (arg0 * arg0 >> 12) >> 12;
		@Pc(15) int local15 = arg0 * 6 - 61440;
		@Pc(23) int local23 = (local15 * arg0 >> 12) + 40960;
		return local23 * local9 >> 12;
	...
	@OriginalMember(owner = "client!ol", name = "u", descriptor = "(I)I")
	static int method20418(@OriginalArg(0) int arg0) {
		@Pc(9) int local9 = arg0 * (arg0 * arg0 >> 12) >> 12;
		@Pc(15) int local15 = arg0 * 6 - 61440;
		@Pc(23) int local23 = (local15 * arg0 >> 12) + 40960;
		return local23 * local9 >> 12;
	...
	@OriginalMember(owner = "client!ol", name = "e", descriptor = "(III)V")
	final void method20397(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
			...
			for (@Pc(62) int local62 = 0; local62 < arg1; local62++) {
				for (@Pc(67) int local67 = 0; local67 < arg0; local67++) {
					for (@Pc(72) int local72 = 0; local72 < this.anInt2879; local72++) {
						...
						@Pc(294) int local294 = method20398(this.aShortArray68[local155 + local262], local112, local120, local128);
						@Pc(305) int local305 = method20398(this.aShortArray68[local151 + local262], local237, local120, local128);
						@Pc(315) int local315 = local294 + (local225 * (local305 - local294) >> 12);
						@Pc(326) int local326 = method20398(this.aShortArray68[local155 + local269], local112, local241, local128);
						@Pc(337) int local337 = method20398(this.aShortArray68[local151 + local269], local237, local241, local128);
						@Pc(347) int local347 = local326 + (local225 * (local337 - local326) >> 12);
						@Pc(357) int local357 = local315 + (local229 * (local347 - local315) >> 12);
						@Pc(368) int local368 = method20398(this.aShortArray68[local155 + local276], local112, local120, local245);
						@Pc(379) int local379 = method20398(this.aShortArray68[local151 + local276], local237, local120, local245);
						@Pc(389) int local389 = local368 + (local225 * (local379 - local368) >> 12);
						@Pc(400) int local400 = method20398(this.aShortArray68[local155 + local283], local112, local241, local245);
						@Pc(411) int local411 = method20398(this.aShortArray68[local151 + local283], local237, local241, local245);
						@Pc(421) int local421 = local400 + (local225 * (local411 - local400) >> 12);
						@Pc(431) int local431 = local389 + (local229 * (local421 - local389) >> 12);
						this.method20401(local72, local357 + (local233 * (local431 - local357) >> 12));
					}
					this.method20406();
				}
			}
	...
	@OriginalMember(owner = "client!ol", name = "l", descriptor = "()V")
	final void method20399() {
	...
	abstract void method20401(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1);

	@OriginalMember(owner = "client!ol", name = "o", descriptor = "(II)V")
	abstract void method20402(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1);

	@OriginalMember(owner = "client!ol", name = "d", descriptor = "()V")
	abstract void method20403();

	@OriginalMember(owner = "client!ol", name = "z", descriptor = "(III)V")
	final void method20404(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(2) int[] local2 = new int[arg0];
		@Pc(5) int[] local5 = new int[arg1];
		@Pc(8) int[] local8 = new int[arg2];
		@Pc(10) int local10;
	...
	abstract void method20413();

	@OriginalMember(owner = "client!ol", name = "h", descriptor = "()V")
