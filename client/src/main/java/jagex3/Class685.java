...
public final class Class685 {
	...
	static int anInt6066 = 0;

	@OriginalMember(owner = "client!yk", name = "n", descriptor = "I")
	static int anInt6067 = 0;

	@OriginalMember(owner = "client!yk", name = "y", descriptor = "(ZZ)V")
	public static void method33607(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1) {
		if (arg0) {
			anInt6066 -= 1883407479;
			if (anInt6066 * 774673735 == 0) {
				anIntArray524 = null;
			}
		}
		if (arg1) {
			anInt6067 -= -236883317;
			if (anInt6067 * -771365597 == 0) {
				anIntArray526 = null;
			}
		}
	}

	@OriginalMember(owner = "client!yk", name = "i", descriptor = "(I)S")
	public static short method33608(@OriginalArg(0) int arg0) {
	...
	@OriginalMember(owner = "client!yk", name = "ai", descriptor = "(I)I")
	public static int method33609(@OriginalArg(0) int arg0) {
	...
	@OriginalMember(owner = "client!yk", name = "ah", descriptor = "(III)I")
	public static int method33610(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	@OriginalMember(owner = "client!yk", name = "t", descriptor = "(II)I")
	public static int method33611(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	@OriginalMember(owner = "client!yk", name = "q", descriptor = "()V")
	static void method33612() {
		...
		for (@Pc(12) int local12 = 0; local12 < 512; local12++) {
			...
			for (@Pc(38) int local38 = 0; local38 < 128; local38++) {
				...
				anIntArray524[local10++] = local195;
			}
		}
	}

	@OriginalMember(owner = "client!yk", name = "x", descriptor = "()V")
	static void method33613() {
		if (anIntArray524 != null) {
			return;
		}
		anIntArray524 = new int[65536];
	...
	@OriginalMember(owner = "client!yk", name = "b", descriptor = "()V")
	static void method33614() {
		if (anIntArray526 != null) {
			return;
		}
		anIntArray526 = new int[65536];
		anIntArray525 = new int[65536];
		...
		for (@Pc(12) int local12 = 0; local12 < 65536; local12++) {
			...
			anIntArray526[local12] = local283 & 0xFFFFFF;
			@Pc(299) int local299 = (local268 << 8) + (local273 << 16) + local263;
			anIntArray525[local12] = local299;
		}
	}

	@OriginalMember(owner = "client!yk", name = "h", descriptor = "()V")
	static void method33615() {
		if (anIntArray526 != null) {
			return;
		}
		anIntArray526 = new int[65536];
	...
	@OriginalMember(owner = "client!yk", name = "a", descriptor = "(I)S")
	public static short method33616(@OriginalArg(0) int arg0) {
		@Pc(5) int local5 = arg0 >> 10 & 0x3F;
		@Pc(11) int local11 = arg0 >> 3 & 0x70;
		@Pc(15) int local15 = arg0 & 0x7F;
		@Pc(32) int local32 = local15 <= 64 ? local11 * local15 >> 7 : (127 - local15) * local11 >> 7;
	...
	@OriginalMember(owner = "client!yk", name = "g", descriptor = "(I)S")
	public static short method33617(@OriginalArg(0) int arg0) {
		@Pc(5) int local5 = arg0 >> 10 & 0x3F;
		@Pc(11) int local11 = arg0 >> 3 & 0x70;
		@Pc(15) int local15 = arg0 & 0x7F;
		@Pc(32) int local32 = local15 <= 64 ? local11 * local15 >> 7 : (127 - local15) * local11 >> 7;
	...
	@OriginalMember(owner = "client!yk", name = "ag", descriptor = "(III)I")
	public static int method33618(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(3) int local3 = 255 - arg2;
		@Pc(21) int local21 = (arg2 * (arg1 & 0xFF00FF) & 0xFF00FF00 | (arg1 & 0xFF00) * arg2 & 0xFF0000) >>> 8;
		return local21 + ((local3 * (arg0 & 0xFF00FF) & 0xFF00FF00 | (arg0 & 0xFF00) * local3 & 0xFF0000) >>> 8);
	}

	@OriginalMember(owner = "client!yk", name = "j", descriptor = "(II)I")
	public static int method33619(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	@OriginalMember(owner = "client!yk", name = "o", descriptor = "(ZZ)V")
	public static void method33620(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1) {
		if (arg0) {
			anInt6066 += 1883407479;
			Class376.method28224(213749755);
		}
		if (arg1) {
			anInt6067 += -236883317;
	...
	@OriginalMember(owner = "client!yk", name = "ae", descriptor = "(II)I")
	public static int method33621(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(3) int local3 = arg1 >>> 24;
		@Pc(7) int local7 = 255 - local3;
		@Pc(25) int local25 = (local3 * (arg1 & 0xFF00FF) & 0xFF00FF00 | local3 * (arg1 & 0xFF00) & 0xFF0000) >>> 8;
		return ((local7 * (arg0 & 0xFF00FF) & 0xFF00FF00 | local7 * (arg0 & 0xFF00) & 0xFF0000) >>> 8) + local25;
	...
	@OriginalMember(owner = "client!yk", name = "s", descriptor = "(ZZ)V")
	public static void method33622(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1) {
		if (arg0) {
			anInt6066 += 1883407479;
			Class376.method28224(1427294686);
		}
		if (arg1) {
			anInt6067 += -236883317;
			Class262.method26267((short) 8448);
	...
	@OriginalMember(owner = "client!yk", name = "as", descriptor = "(I)I")
	public static int method33623(@OriginalArg(0) int arg0) {
		@Pc(8) double local8 = (double) (arg0 >> 16 & 0xFF) / 256.0D;
		@Pc(17) double local17 = (double) (arg0 >> 8 & 0xFF) / 256.0D;
		@Pc(24) double local24 = (double) (arg0 & 0xFF) / 256.0D;
		@Pc(26) double local26 = local8;
	...
	@OriginalMember(owner = "client!yk", name = "v", descriptor = "(ZZ)V")
	public static void method33624(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1) {
		if (arg0) {
			anInt6066 += 1883407479;
			Class376.method28224(-1643142297);
		}
		if (arg1) {
			anInt6067 += -236883317;
			Class262.method26267((short) 8448);
	...
	@OriginalMember(owner = "client!yk", name = "ac", descriptor = "(I)I")
	public static int method33625(@OriginalArg(0) int arg0) {
		@Pc(8) double local8 = (double) (arg0 >> 16 & 0xFF) / 256.0D;
		@Pc(17) double local17 = (double) (arg0 >> 8 & 0xFF) / 256.0D;
		@Pc(24) double local24 = (double) (arg0 & 0xFF) / 256.0D;
		@Pc(26) double local26 = local8;
	...
	@OriginalMember(owner = "client!yk", name = "ad", descriptor = "(II)I")
	public static int method33626(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 == -2) {
			return 12345678;
		} else if (arg0 == -1) {
			if (arg1 < 2) {
	...
	@OriginalMember(owner = "client!yk", name = "aw", descriptor = "(I)I")
	public static int method33627(@OriginalArg(0) int arg0) {
		@Pc(8) double local8 = (double) (arg0 >> 16 & 0xFF) / 256.0D;
		@Pc(17) double local17 = (double) (arg0 >> 8 & 0xFF) / 256.0D;
		@Pc(24) double local24 = (double) (arg0 & 0xFF) / 256.0D;
		@Pc(26) double local26 = local8;
	...
	@OriginalMember(owner = "client!yk", name = "at", descriptor = "(II)I")
	public static int method33628(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 == -1) {
			return 12345678;
		}
	...
	@OriginalMember(owner = "client!yk", name = "al", descriptor = "(IIF)I")
	public static int method33629(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2) {
		return Class260.method26247(arg0, arg1, (int) arg2, 445606420);
	}

	@OriginalMember(owner = "client!yk", name = "am", descriptor = "(III)I")
	public static int method33630(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg2 > 243) {
			arg1 >>= 0x4;
		} else if (arg2 > 217) {
			arg1 >>= 0x3;
	...
	@OriginalMember(owner = "client!yk", name = "au", descriptor = "(III)I")
	public static int method33631(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg2 > 243) {
			arg1 >>= 0x4;
		} else if (arg2 > 217) {
			arg1 >>= 0x3;
	...
	@OriginalMember(owner = "client!yk", name = "u", descriptor = "([I[F[FIII)V")
	static void method33632(@OriginalArg(0) int[] arg0, @OriginalArg(1) float[] arg1, @OriginalArg(2) float[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		if (arg3 >= arg4) {
			return;
		}
		...
		method33632(arg0, arg1, arg2, arg3, local10 - 1, -1558733387);
		method33632(arg0, arg1, arg2, local10 + 1, arg4, -1786317961);
	}

	@OriginalMember(owner = "client!yk", name = "ayt", descriptor = "(Lclient!yf;I)V")
	static void method33633(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		Class642.method32702((byte) 80);
		Class275.method26434(1725709509);
		client.aClass532_1.method30650((byte) 0);
		Class106_Sub1.method5148(-2032756498);
		client.aBoolean603 = false;
	}

	@OriginalMember(owner = "client!yk", name = "e", descriptor = "(Ljava/lang/CharSequence;B)J")
	static long method33634(@OriginalArg(0) CharSequence arg0, @OriginalArg(1) byte arg1) {
		@Pc(1) long local1 = 0L;
