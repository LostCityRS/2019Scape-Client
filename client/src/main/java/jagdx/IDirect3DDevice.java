...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "()V", line = 8)
	...
	public static int method27709(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2) {
		return SetRenderStatef(arg0, arg1, arg2);
	}

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "m", descriptor = "(JIF)I", line = 139)
	public static int method27710(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2) {
		return SetRenderStatef(arg0, arg1, arg2);
	}

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "k", descriptor = "(JIF)I", line = 139)
	public static int method27711(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2) {
		return SetRenderStatef(arg0, arg1, arg2);
	}

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "n", descriptor = "(JIZ)I", line = 143)
	public static int method27712(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		return SetRenderStateb(arg0, arg1, arg2);
	}

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "f", descriptor = "(JIZ)I", line = 143)
	public static int method27713(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		return SetRenderStateb(arg0, arg1, arg2);
	}

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "w", descriptor = "(JIZ)I", line = 143)
	public static int method27714(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		return SetRenderStateb(arg0, arg1, arg2);
	}
