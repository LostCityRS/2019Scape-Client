...
public final class Class80_Sub1_Sub4 extends Class80_Sub1 {
	...
	final SecondaryLinkedList aSecondaryLinkedList_10;

	@OriginalMember(owner = "client!ara", name = "<init>", descriptor = "(Ljava/lang/String;)V")
	Class80_Sub1_Sub4(@OriginalArg(0) String arg0) {
		this.aString95 = arg0;
		this.aSecondaryLinkedList_10 = new SecondaryLinkedList();
	}

	@OriginalMember(owner = "client!ara", name = "g", descriptor = "()I")
	int method21705() {
		return this.aSecondaryLinkedList_10.aClass80_Sub1_2 == this.aSecondaryLinkedList_10.aClass80_Sub1_2.aClass80_Sub1_68 ? -1 : ((Class80_Sub1_Sub11) this.aSecondaryLinkedList_10.aClass80_Sub1_2.aClass80_Sub1_68).anInt3079 * 1479399259;
	}
	...
	boolean method21706(@OriginalArg(0) Class80_Sub1_Sub11 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(10) Class80_Sub1_Sub11 local10 = (Class80_Sub1_Sub11) this.aSecondaryLinkedList_10.head((byte) -40);
		while (local10 != null) {
			...
			local10 = (Class80_Sub1_Sub11) this.aSecondaryLinkedList_10.next((byte) -102);
			local1 = false;
		}
		this.aSecondaryLinkedList_10.addTail(arg0, 1599142138);
		this.anInt3022 += -1676985911;
		return local1;
	}
	...
	boolean method21707(@OriginalArg(0) Class80_Sub1_Sub11 arg0) {
		...
		@Pc(10) Class80_Sub1_Sub11 local10 = (Class80_Sub1_Sub11) this.aSecondaryLinkedList_10.head((byte) 5);
		while (local10 != null) {
	...
	boolean method21709(@OriginalArg(0) Class80_Sub1_Sub11 arg0, @OriginalArg(1) int arg1) {
		...
		this.unlinkSecondary(-2147483643);
	...
	boolean method21712(@OriginalArg(0) Class80_Sub1_Sub11 arg0) {
		...
		@Pc(10) Class80_Sub1_Sub11 local10 = (Class80_Sub1_Sub11) this.aSecondaryLinkedList_10.head((byte) 64);
		while (local10 != null) {
	...
	boolean method21713(@OriginalArg(0) Class80_Sub1_Sub11 arg0) {
		...
		this.unlinkSecondary(-2147483646);
		Class630.anInt5554 -= -561979003;
		Class630.aClass243_89.method26253(this, arg0.aLong249 * -6321316696381466459L);
		return false;
	}
	...
	boolean method21714(@OriginalArg(0) Class80_Sub1_Sub11 arg0) {
		...
		this.unlinkSecondary(-2147483645);
		Class630.anInt5554 -= -561979003;
		Class630.aClass243_89.method26253(this, arg0.aLong249 * -6321316696381466459L);
		return false;
	}
	...
	boolean method21715(@OriginalArg(0) Class80_Sub1_Sub11 arg0) {
		...
		this.unlinkSecondary(-2147483642);
		Class630.anInt5554 -= -561979003;
		Class630.aClass243_89.method26253(this, arg0.aLong249 * -6321316696381466459L);
		return false;
	}
