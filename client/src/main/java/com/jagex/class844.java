...
public class class844 extends class116 {
	...
	public class328 field9756;

	@ObfuscatedName("afo.ap")
	public class349 field9731;

	@ObfuscatedName("afo.aq")
	public class349 field9732;

	@ObfuscatedName("afo.ax")
	public class349 field9733;

	@ObfuscatedName("afo.av")
	public class349 field9734;
	...
	public class844(class850 arg0, class120 arg1, int arg2, int arg3, int arg4, int arg5) {
		...
		for (int var10 = 0; var10 < arg1.field1384; var10++) {
			if (arg1.field1391 == null || arg1.field1391[var10] != 2) {
				if (arg1.field1396 != null && arg1.field1396[var10] != -1) {
					...
					if (((this.field9700 & 0x40) == 0 || !var11.field1342) && var11.field1361) {
						continue;
					}
				}
				int var10003 = this.field9716 * -1431655765;
				int var10001 = this.field9716 * -1431655765;
		...
		this.field9721 = this.field9716 * -1431655765;
		long[] var12 = new long[this.field9716 * -1431655765];
		boolean var13 = (this.field9725 & 0x100) != 0;
		for (int var14 = 0; var14 < this.field9716 * -1431655765; var14++) {
			...
			if (arg1.field1403 != null) {
				...
				for (int var27 = 0; var27 < arg1.field1403.length; var27++) {
					...
					if (var28.field1463 == var15) {
						class376 var29 = this.field9730.field1599.method6004(var28.field1477);
						if (var29.field3510) {
							var26 = true;
						}
					}
			...
			if (arg1.field1396 != null) {
				...
				if (var30 != -1) {
					var16 = var7.method2043(var30 & 0xFFFF);
					if ((this.field9700 & 0x40) != 0 && var16.field1342) {
						var30 = -1;
						var16 = null;
					} else {
		...
		if (arg1.field1412 != null) {
			...
			this.field9758 = new class346[this.field9746];
			this.field9757 = new class338[this.field9746];
			for (int var37 = 0; var37 < this.field9746; var37++) {
				...
				int var40 = -1;
				for (int var41 = 0; var41 < this.field9716 * -1431655765; var41++) {
				...
				this.field9758[var37] = new class346(var40, arg1.field1415[var38.field1654], arg1.field1386[var38.field1654], arg1.field1400[var38.field1654], var39.field3451, var39.field3452, var39.field3455, var39.field3450, var39.field3453, var39.field3456, var39.field3449, var38.field1656);
		...
		this.field9722 = new short[this.field9716 * -1431655765];
		this.field9745 = new byte[this.field9716 * -1431655765];
		this.field9713 = new short[this.field9716 * -1431655765];
		this.field9762 = new short[this.field9716 * -1431655765];
		this.field9726 = new short[this.field9716 * -1431655765];
		this.field9717 = new short[this.field9716 * -1431655765];
		if (arg1.field1399 != null) {
			this.field9759 = new short[this.field9716 * -1431655765];
		}
		...
		class142 var48 = this.method1687(arg1, var9, this.field9716 * -1431655765);
		...
		for (int var72 = 0; var72 < this.field9716 * -1431655765; var72++) {
			...
			if (var76 != -1 && (this.field9700 & 0x40) != 0 && var7.method2043(var76).field1342) {
				var76 = -1;
			}
			float var77 = 0.0F;
			float var78 = 0.0F;
		...
		if (arg1.field1397 != null && class325.method5496(arg2, this.field9700)) {
			...
			for (int var191 = 0; var191 < this.field9716 * -1431655765; var191++) {
			...
			for (int var194 = 0; var194 < this.field9716 * -1431655765; var194++) {
	...
	public short method15592(class120 arg0, int arg1, int arg2, long arg3, int arg4, int arg5, int arg6, int arg7, float arg8, float arg9) {
	...
	public class116 method1773(byte arg0, int arg1, boolean arg2) {
		...
		if (arg0 > 0 && arg0 <= 8) {
			...
			var6 = var5 = new class844(this.field9730, 0, 0, true, false);
		}
		return this.method15593(var6, var5, arg1, var4, arg2);
	}

	@ObfuscatedName("afo.hq(Lafo;Lafo;IZZ)Ldo;")
	public class116 method15593(class844 arg0, class844 arg1, int arg2, boolean arg3, boolean arg4) {
		arg0.field9725 = arg2;
		...
		if (class325.method5471(arg2, this.field9700)) {
			if (arg1.field9722 == null || arg1.field9722.length < this.field9716 * -1431655765) {
				arg0.field9722 = arg1.field9722 = new short[this.field9716 * -1431655765];
			} else {
				arg0.field9722 = arg1.field9722;
			}
			for (int var11 = 0; var11 < this.field9716 * -1431655765; var11++) {
		...
		if (class325.method5458(arg2, this.field9700)) {
			if (arg1.field9745 == null || arg1.field9745.length < this.field9716 * -1431655765) {
				arg0.field9745 = arg1.field9745 = new byte[this.field9716 * -1431655765];
			} else {
				arg0.field9745 = arg1.field9745;
			}
			for (int var12 = 0; var12 < this.field9716 * -1431655765; var12++) {
		...
		if (class325.method5439(arg2, this.field9700)) {
			...
			if (this.field9771 == null) {
				...
				if (arg1.field9771 == null) {
					arg1.field9771 = new class358();
				}
				class358 var14 = arg0.field9771 = arg1.field9771;
		...
		if (class325.method5514(arg2, this.field9700)) {
			if (arg1.field9707 == null || arg1.field9707.length < this.field9716 * -1431655765) {
		...
		if (class325.method5443(arg2, this.field9700)) {
			if (arg1.field9713 == null || arg1.field9713.length < this.field9716 * -1431655765) {
				int var20 = this.field9716 * -1431655765;
			...
			for (int var21 = 0; var21 < this.field9716 * -1431655765; var21++) {
		...
		if (class325.method5434(arg2, this.field9700)) {
			if (arg1.field9717 == null || arg1.field9717.length < this.field9716 * -1431655765) {
				int var22 = this.field9716 * -1431655765;
				arg0.field9717 = arg1.field9717 = new short[var22];
			} else {
				arg0.field9717 = arg1.field9717;
			}
			for (int var23 = 0; var23 < this.field9716 * -1431655765; var23++) {
		...
		if (!class325.method5445(arg2, this.field9700)) {
			...
			arg0.field9757 = arg1.field9757 = new class338[var25];
	...
	public void method1698() {
		...
		for (int var3 = 0; var3 < this.field9716 * -1431655765; var3++) {
	...
	public void method1686(class116 arg0, int arg1, int arg2, int arg3, boolean arg4) {
		class844 var6 = (class844) arg0;
		if (this.field9716 * -1431655765 == 0 || var6.field9716 * -1431655765 == 0) {
			return;
		}
						...
						if (var35 != -1) {
							for (int var39 = 0; var39 < var7; var39++) {
								if (var8[var39] == var33 && var10[var39] == var34 && var9[var39] == var32) {
									...
									if (var40 != -1) {
										if (var15 == null) {
											this.field9771 = new class358();
											var15 = this.field9771.field3408 = Statics.method13987(this.field9723);
											var16 = this.field9771.field3407 = Statics.method13987(this.field9714);
											var17 = this.field9771.field3409 = Statics.method13987(this.field9715);
											var18 = this.field9771.field3410 = Statics.method4405(this.field9747);
										}
										if (var19 == null) {
											class358 var44 = var6.field9771 = new class358();
											var19 = var44.field3408 = Statics.method13987(var11);
											var20 = var44.field3407 = Statics.method13987(var12);
											var21 = var44.field3409 = Statics.method13987(var13);
											var22 = var44.field3410 = Statics.method4405(var14);
										}
	...
	public void method1859(short arg0, short arg1) {
		...
		if (this.field9758 != null) {
			for (int var4 = 0; var4 < this.field9746; var4++) {
				class346 var5 = this.field9758[var4];
				class338 var6 = this.field9757[var4];
				var6.field3297 = var6.field3297 & 0xFF000000 | Statics.field8151[this.field9722[var5.field3345] & 0xFFFF] & 0xFFFFFF;
			}
		}
		this.method15596();
	}
	...
	public void method1747(byte arg0, byte[] arg1) {
		if (arg1 == null) {
			...
			for (int var4 = 0; var4 < this.field9716 * -1431655765; var4++) {
	...
	public void method1744(short arg0, short arg1) {
		class125 var3 = this.field9730.field1597;
		for (int var4 = 0; var4 < this.field9716 * -1431655765; var4++) {
		...
		if (this.field9758 != null) {
			for (int var11 = 0; var11 < this.field9746; var11++) {
				class346 var12 = this.field9758[var11];
				class338 var13 = this.field9757[var11];
				var13.field3297 = var13.field3297 & 0xFF000000 | Statics.field8151[this.field9722[var12.field3345] & 0xFFFF] & 0xFFFFFF;
			}
		}
		this.method15596();
	}
	...
	public void method1745(int arg0, int arg1, int arg2, int arg3) {
		for (int var5 = 0; var5 < this.field9716 * -1431655765; var5++) {
		...
		if (this.field9758 != null) {
			for (int var10 = 0; var10 < this.field9746; var10++) {
				class346 var11 = this.field9758[var10];
				class338 var12 = this.field9757[var10];
				var12.field3297 = var12.field3297 & 0xFF000000 | Statics.field8151[this.field9722[var11.field3345] & 0xFFFF] & 0xFFFFFF;
			}
		}
		this.method15596();
	}
	...
	public boolean method1746() {
		...
		for (int var1 = 0; var1 < this.field9717.length; var1++) {
			if (this.field9717[var1] != -1 && !this.field9730.field10188.method5642(this.field9730.field1597.method2043(this.field9717[var1]), -1)) {
				return false;
			}
		}
		return true;
				...
				if (var177) {
					if (this.field9758 != null) {
						for (int var184 = 0; var184 < this.field9746; var184++) {
							class346 var185 = this.field9758[var184];
							class338 var186 = this.field9757[var184];
				...
				if (var187) {
					if (this.field9758 != null) {
						for (int var200 = 0; var200 < this.field9746; var200++) {
							class346 var201 = this.field9758[var200];
							class338 var202 = this.field9757[var200];
							var202.field3297 = var202.field3297 & 0xFF000000 | Statics.field8151[this.field9722[var201.field3345] & 0xFFFF] & 0xFFFFFF;
						}
					}
					this.method15596();
				}
				...
				for (int var203 = 0; var203 < var9; var203++) {
					...
					if (var204 < this.field9751.length) {
						...
						for (int var206 = 0; var206 < var205.length; var206++) {
							class338 var207 = this.field9757[var205[var206]];
				...
				for (int var208 = 0; var208 < var9; var208++) {
					...
					if (var209 < this.field9751.length) {
						...
						for (int var211 = 0; var211 < var210.length; var211++) {
							class338 var212 = this.field9757[var210[var211]];
			...
			for (int var213 = 0; var213 < var9; var213++) {
				...
				if (var214 < this.field9751.length) {
					...
					for (int var216 = 0; var216 < var215.length; var216++) {
						class338 var217 = this.field9757[var215[var216]];
	...
	public void method1721(int arg0, int arg1, int arg2, int arg3) {
		if (arg0 == 0) {
			...
			for (int var19 = 0; var19 < this.field9716 * -1431655765; var19++) {
			...
			if (this.field9758 != null) {
				for (int var21 = 0; var21 < this.field9746; var21++) {
					class346 var22 = this.field9758[var21];
					class338 var23 = this.field9757[var21];
					var23.field3297 = var23.field3297 & 0xFFFFFF | 255 - (this.field9745[var22.field3345] & 0xFF) << 24;
				}
			}
			this.method15596();
		} else if (arg0 == 7) {
			for (int var24 = 0; var24 < this.field9716 * -1431655765; var24++) {
			...
			if (this.field9758 != null) {
				for (int var32 = 0; var32 < this.field9746; var32++) {
					class346 var33 = this.field9758[var32];
					class338 var34 = this.field9757[var32];
					var34.field3297 = var34.field3297 & 0xFF000000 | Statics.field8151[this.field9722[var33.field3345] & 0xFFFF] & 0xFFFFFF;
				}
			}
			this.method15596();
		} else if (arg0 == 8) {
			for (int var35 = 0; var35 < this.field9746; var35++) {
				class338 var36 = this.field9757[var35];
				var36.field3299 += arg1;
				var36.field3298 += arg2;
			}
		} else if (arg0 == 10) {
			for (int var37 = 0; var37 < this.field9746; var37++) {
				class338 var38 = this.field9757[var37];
				var38.field3294 = var38.field3294 * arg1 >> 7;
				var38.field3296 = var38.field3296 * arg2 >> 7;
			}
		} else if (arg0 == 9) {
			for (int var39 = 0; var39 < this.field9746; var39++) {
				class338 var40 = this.field9757[var39];
				...
				if (var74) {
					if (this.field9758 != null) {
						for (int var81 = 0; var81 < this.field9746; var81++) {
							class346 var82 = this.field9758[var81];
							class338 var83 = this.field9757[var81];
				...
				if (var84) {
					if (this.field9758 != null) {
						for (int var97 = 0; var97 < this.field9746; var97++) {
							class346 var98 = this.field9758[var97];
							class338 var99 = this.field9757[var97];
							var99.field3297 = var99.field3297 & 0xFF000000 | Statics.field8151[this.field9722[var98.field3345] & 0xFFFF] & 0xFFFFFF;
						}
					}
					this.method15596();
				}
				...
				for (int var100 = 0; var100 < var8; var100++) {
					...
					if (var101 < this.field9751.length) {
						...
						for (int var103 = 0; var103 < var102.length; var103++) {
							class338 var104 = this.field9757[var102[var103]];
				...
				for (int var105 = 0; var105 < var8; var105++) {
					...
					if (var106 < this.field9751.length) {
						...
						for (int var108 = 0; var108 < var107.length; var108++) {
							class338 var109 = this.field9757[var107[var108]];
			...
			for (int var110 = 0; var110 < var8; var110++) {
				...
				if (var111 < this.field9751.length) {
					...
					for (int var113 = 0; var113 < var112.length; var113++) {
						class338 var114 = this.field9757[var112[var113]];
	...
	public void method1689(class419 arg0) {
		...
		if (this.field9755 != null) {
			for (int var3 = 0; var3 < this.field9755.length; var3++) {
				class128 var4 = this.field9755[var3];
				class128 var5 = var4;
				if (var4.field1465 != null) {
					var5 = var4.field1465;
				}
				var5.field1470 = (int) (var2.field4315[8] * (float) this.field9712[var4.field1476] + var2.field4315[0] * (float) this.field9705[var4.field1476] + var2.field4315[4] * (float) this.field9767[var4.field1476] + var2.field4315[12]);
				var5.field1474 = (int) (var2.field4315[9] * (float) this.field9712[var4.field1476] + var2.field4315[1] * (float) this.field9705[var4.field1476] + var2.field4315[5] * (float) this.field9767[var4.field1476] + var2.field4315[13]);
				var5.field1472 = (int) (var2.field4315[10] * (float) this.field9712[var4.field1476] + var2.field4315[2] * (float) this.field9705[var4.field1476] + var2.field4315[6] * (float) this.field9767[var4.field1476] + var2.field4315[14]);
				var5.field1473 = (int) (var2.field4315[8] * (float) this.field9712[var4.field1467] + var2.field4315[0] * (float) this.field9705[var4.field1467] + var2.field4315[4] * (float) this.field9767[var4.field1467] + var2.field4315[12]);
				var5.field1469 = (int) (var2.field4315[9] * (float) this.field9712[var4.field1467] + var2.field4315[1] * (float) this.field9705[var4.field1467] + var2.field4315[5] * (float) this.field9767[var4.field1467] + var2.field4315[13]);
				var5.field1475 = (int) (var2.field4315[10] * (float) this.field9712[var4.field1467] + var2.field4315[2] * (float) this.field9705[var4.field1467] + var2.field4315[6] * (float) this.field9767[var4.field1467] + var2.field4315[14]);
				var5.field1464 = (int) (var2.field4315[8] * (float) this.field9712[var4.field1468] + var2.field4315[0] * (float) this.field9705[var4.field1468] + var2.field4315[4] * (float) this.field9767[var4.field1468] + var2.field4315[12]);
				var5.field1466 = (int) (var2.field4315[9] * (float) this.field9712[var4.field1468] + var2.field4315[1] * (float) this.field9705[var4.field1468] + var2.field4315[5] * (float) this.field9767[var4.field1468] + var2.field4315[13]);
				var5.field1478 = (int) (var2.field4315[10] * (float) this.field9712[var4.field1468] + var2.field4315[2] * (float) this.field9705[var4.field1468] + var2.field4315[6] * (float) this.field9767[var4.field1468] + var2.field4315[14]);
			}
		}
		...
		for (int var6 = 0; var6 < this.field9738.length; var6++) {
			class102 var7 = this.field9738[var6];
			class102 var8 = var7;
			...
			var8.field1226 = (int) (var2.field4315[8] * (float) this.field9712[var7.field1225] + var2.field4315[0] * (float) this.field9705[var7.field1225] + var2.field4315[4] * (float) this.field9767[var7.field1225] + var2.field4315[12]);
			var8.field1229 = (int) (var2.field4315[9] * (float) this.field9712[var7.field1225] + var2.field4315[1] * (float) this.field9705[var7.field1225] + var2.field4315[5] * (float) this.field9767[var7.field1225] + var2.field4315[13]);
			var8.field1227 = (int) (var2.field4315[10] * (float) this.field9712[var7.field1225] + var2.field4315[2] * (float) this.field9705[var7.field1225] + var2.field4315[6] * (float) this.field9767[var7.field1225] + var2.field4315[14]);
		}
	}
	...
	public boolean method15590(int arg0, int arg1, int arg2, int arg3, class419 arg4, boolean arg5, int arg6) {
		...
		for (int var26 = 0; var26 < 8; var26++) {
			...
			float var30 = var8.field4315[10] * var29 + var8.field4315[2] * var27 + var8.field4315[6] * var28 + var8.field4315[14];
			float var31 = var8.field4315[11] * var29 + var8.field4315[3] * var27 + var8.field4315[7] * var28 + var8.field4315[15];
			if (var30 >= -var31) {
				float var32 = var8.field4315[8] * var29 + var8.field4315[0] * var27 + var8.field4315[4] * var28 + var8.field4315[12];
				float var33 = var8.field4315[9] * var29 + var8.field4315[1] * var27 + var8.field4315[5] * var28 + var8.field4315[13];
		...
		if (var9 && (float) var36 > var10 && (float) arg0 < var11 && (float) var37 > var12 && (float) arg1 < var13) {
			...
			for (int var38 = 0; var38 < this.field9704; var38++) {
				...
				float var42 = var8.field4315[10] * var41 + var8.field4315[2] * var39 + var8.field4315[6] * var40 + var8.field4315[14];
				float var43 = var8.field4315[11] * var41 + var8.field4315[3] * var39 + var8.field4315[7] * var40 + var8.field4315[15];
				if (var42 >= -var43) {
					float var44 = var8.field4315[8] * var41 + var8.field4315[0] * var39 + var8.field4315[4] * var40 + var8.field4315[12];
					float var45 = var8.field4315[9] * var41 + var8.field4315[1] * var39 + var8.field4315[5] * var40 + var8.field4315[13];
			...
			for (int var54 = 0; var54 < this.field9716 * -1431655765; var54++) {
	...
	public void method1813(class419 arg0, class141 arg1, int arg2) {
		...
		if (arg1 != null) {
			...
			float var25 = var6.field4315[8] * (float) var21 + var6.field4315[0] * (float) var20 + var6.field4315[4] * (float) var23 + var6.field4315[12];
			float var26 = var6.field4315[9] * (float) var21 + var6.field4315[1] * (float) var20 + var6.field4315[5] * (float) var23 + var6.field4315[13];
			float var27 = var6.field4315[10] * (float) var21 + var6.field4315[2] * (float) var20 + var6.field4315[6] * (float) var23 + var6.field4315[14];
			float var28 = var6.field4315[11] * (float) var21 + var6.field4315[3] * (float) var20 + var6.field4315[7] * (float) var23 + var6.field4315[15];
			if (var27 >= -var28) {
			...
			float var32 = var6.field4315[8] * (float) var21 + var6.field4315[0] * (float) var20 + var6.field4315[4] * (float) var30 + var6.field4315[12];
			float var33 = var6.field4315[9] * (float) var21 + var6.field4315[1] * (float) var20 + var6.field4315[5] * (float) var30 + var6.field4315[13];
			float var34 = var6.field4315[10] * (float) var21 + var6.field4315[2] * (float) var20 + var6.field4315[6] * (float) var30 + var6.field4315[14];
			float var35 = var6.field4315[11] * (float) var21 + var6.field4315[3] * (float) var20 + var6.field4315[7] * (float) var30 + var6.field4315[15];
			if (var34 >= -var35) {
			...
			if (var19) {
				if (var27 / var28 > var34 / var35) {
					float var44 = var4.field4315[0] * (float) this.field9740 + var25 + var4.field4315[12];
					float var45 = var4.field4315[3] * (float) this.field9740 + var28 + var4.field4315[15];
					arg1.field1687 = (int) (this.field9730.field10084 * var44 / var45 + (this.field9730.field10083 - (float) arg1.field1683));
				} else {
					float var46 = var4.field4315[0] * (float) this.field9740 + var32 + var4.field4315[12];
					float var47 = var4.field4315[3] * (float) this.field9740 + var35 + var4.field4315[15];
		...
		var5.method6609(arg0);
		var5.method6720(this.field9730.field10059);
	...
	public void method15601(class419 arg0) {
		...
		this.field9730.field10066.method6609(arg0);
		...
		if (this.field9730.field10169 > 0) {
			...
			var2.field2975.method6491((float) (this.field9730.field10191 >> 16 & 0xFF) / 255.0F, (float) (this.field9730.field10191 >> 8 & 0xFF) / 255.0F, (float) (this.field9730.field10191 >> 0 & 0xFF) / 255.0F);
			this.field9730.field10066.method6609(arg0);
			this.field9730.field10066.method6631();
			var2.field2979.method6265(this.field9730.field10066);
			this.field9730.field10066.method6609(arg0);
			this.field9730.field10066.method6720(this.field9730.field10059);
			this.field9730.field10066.method6631();
			...
			var2.field2975.method6491(0.0F, 0.0F, 0.0F);
		}
		if ((this.field9700 & 0x37) == 0) {
			...
			for (int var4 = 0; var4 < this.field9741.length; var4++) {
				...
				if (var7 == -1) {
					...
					float[] var11 = var2.field2982.field4315;
					var2.field2982.field4315[13] = 0.0F;
					var11[12] = 0.0F;
				} else {
					class118 var10 = this.field9730.field1597.method2043(var7 & 0xFFFF);
					var2.field2966 = this.field9730.field10188.method5639(var10);
					var8 = !class118.method261(var10.field1308);
			...
			if (this.field9730.field10099) {
				...
				var2.field2976.method6491(this.field9730.field10114[0], this.field9730.field10114[1], this.field9730.field10114[2]);
				var2.field2976.method6521(var12);
				var2.field2977.method6491(this.field9730.field10142 * this.field9730.field10123, this.field9730.field10123 * this.field9730.field10120, this.field9730.field10210 * this.field9730.field10123);
				var2.field2978.method6491(-this.field9730.field10124 * this.field9730.field10142, -this.field9730.field10124 * this.field9730.field10120, -this.field9730.field10124 * this.field9730.field10210);
				...
				if (this.field9730.field10126 > 0) {
					...
					for (int var15 = 0; var15 < var13; var15++) {
						...
						var2.field2965[var15 * 4 + 2] = var14.field4313;
			...
			for (int var19 = 0; var19 < this.field9741.length; var19++) {
				...
				if (var22 == -1) {
					var2.field2966 = this.field9730.field10140;
					float[] var26 = var2.field2982.field4315;
					var2.field2982.field4315[13] = 0.0F;
					var26[12] = 0.0F;
				} else {
					var24 = this.field9730.field1597.method2043(var22 & 0xFFFF);
				...
				switch(var23) {
					case 1:
						var2.field2969.method6491(this.field9730.field10035.field4315[12], this.field9730.field10035.field4315[13], this.field9730.field10035.field4315[14]);
					...
					case 5:
						if (this.field9730.field10099) {
							...
							var27.field12108.method6720(this.field9730.field10081);
						...
						break;
					case 6:
						var2.method5019(!class118.method261(var23));
						break;
					case 7:
						var2.field2969.method6491(this.field9730.field10035.field4315[12], this.field9730.field10035.field4315[13], this.field9730.field10035.field4315[14]);
						var2.field2969.method6567(var12);
						var2.field2980.method6609(arg0);
	...
	public void method15604(class426 arg0) {
		...
		if (var4) {
			...
			var3.field2990.method6491(0.0F, 0.0F, 0.0F);
		}
		for (int var5 = 0; var5 < this.field9746; var5++) {
			class346 var6 = this.field9758[var5];
			class338 var7 = this.field9757[var5];
			if (!var6.field3349 || !this.field9730.method2242()) {
				...
				float var11 = arg0.field4315[8] * var10 + arg0.field4315[0] * var8 + arg0.field4315[4] * var9 + arg0.field4315[12];
				float var12 = arg0.field4315[9] * var10 + arg0.field4315[1] * var8 + arg0.field4315[5] * var9 + arg0.field4315[13];
				float var13 = arg0.field4315[10] * var10 + arg0.field4315[2] * var8 + arg0.field4315[6] * var9 + arg0.field4315[14];
				...
				this.field9730.field10039.method6609(var2);
				...
				var3.field2991 = null;
				if (var6.field3347 != -1) {
					var3.field2991 = this.field9730.field10188.method5639(this.field9730.field1597.method2043(var6.field3347 & 0xFFFF));
				}
		...
		if (var2) {
			...
			if (var72 == null) {
				...
				for (int var83 = 0; var83 < this.field9710; var83++) {
					...
					var82.putFloat(var84.field4308);
				...
				for (int var76 = 0; var76 < this.field9710; var76++) {
					...
					var72.putFloat(var74, var77.field4308);
					long var78 = var74 + 4L;
					var72.putFloat(var78, var77.field4311);
					long var80 = var78 + 4L;
	...
	public int method15609(int arg0, short arg1, int arg2) {
		...
		if (arg1 != -1) {
			class118 var5 = this.field9730.field1597.method2043(arg1 & 0xFFFF);
