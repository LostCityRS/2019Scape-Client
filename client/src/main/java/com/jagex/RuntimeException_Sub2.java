...
public final class RuntimeException_Sub2 extends RuntimeException {
	...
	@OriginalMember(owner = "client!atl", name = "n", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lclient!atc;")
	public static RuntimeException_Sub1 method23542(@OriginalArg(0) Throwable arg0, @OriginalArg(1) String arg1) {
	...
	@OriginalMember(owner = "client!atl", name = "<init>", descriptor = "(Ljava/lang/String;)V")
