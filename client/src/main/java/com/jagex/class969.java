...
public class class969 extends class532 {
	...
	public final class98 field11281;

	@ObfuscatedName("ajr.v")
	public final class79 field11282;

	@ObfuscatedName("ajr.o")
	public final class83 field11283;

	@ObfuscatedName("ajr.s")
	public final class83 field11284;
	...
	public void method17573(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
		...
		if ((arg4 & 0x7F) == 0 || (arg5 & 0x7F) == 0) {
			...
			class985 var12 = (class985) this.field11290.method14495(var7);
			if (var12 != null) {
		...
		if (var7 != -1L) {
			this.field11290.method14501(new class985(var13), var7);
		}
		float var14;
		float var15;
		float var16;
