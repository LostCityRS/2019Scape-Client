...
public class class572 implements class573 {
	...
	@ObfuscatedName("uh.s")
	public static final class572 field7265 = new class572("", 25);

	@ObfuscatedName("uh.y")
	public static final class572 field7264 = new class572("", 26);

	@ObfuscatedName("uh.q")
	public static final class572 field7248 = new class572("", 27);

	@ObfuscatedName("uh.x")
	public static final class572 field7266 = new class572("", 28);

	@ObfuscatedName("uh.b")
	public static final class572 field7267 = new class1010("", 29, true, false);

	@ObfuscatedName("uh.h")
	public static final class572 field7268 = new class1009("", 30, true, false);

	@ObfuscatedName("uh.a")
	public static final class572 field7270 = new class572("", 73, true, true);

	@ObfuscatedName("uh.g")
	public static final class572 field7250 = new class572("", 76, true, false);

	@ObfuscatedName("uh.i")
	public final int field7271;

	// $FF: synthetic method
	public class572(String arg0, int arg1, boolean arg2, boolean arg3, class1010 arg4) {
