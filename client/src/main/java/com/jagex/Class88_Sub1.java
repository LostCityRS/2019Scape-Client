...
public class Class88_Sub1 extends Class88 {
	...
	@OriginalMember(owner = "client!adq", name = "<init>", descriptor = "(Lclient!afa;Lclient!ck;Lclient!dg;I)V", line = 17)
	Class88_Sub1(@OriginalArg(0) Class104_Sub1 arg0, @OriginalArg(1) Class206 arg1, @OriginalArg(2) Class226 arg2, @OriginalArg(3) int arg3) {
		...
		for (@Pc(20) int local20 = 0; local20 < 6; local20++) {
			OpenGL.glTexImage2Dub(local20 + 34069, 0, Class104_Sub1.method3978(this.aClass206_16, this.aClass226_17), arg3, arg3, 0, Class104_Sub1.method3977(this.aClass206_16), 5121, null, 0);
		}
		this.method18040(true);
	}

	@OriginalMember(owner = "client!adq", name = "<init>", descriptor = "(Lclient!afa;Lclient!ck;Lclient!dg;IZ[[I)V", line = 25)
	Class88_Sub1(@OriginalArg(0) Class104_Sub1 arg0, @OriginalArg(1) Class206 arg1, @OriginalArg(2) Class226 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int[][] arg5) {
		...
		if (arg4) {
			for (local22 = 0; local22 < 6; local22++) {
				method18067(local22 + 34069, Class104_Sub1.method3978(this.aClass206_16, this.aClass226_17), arg3, arg3, 32993, this.aClass104_Sub1_34.anInt527, arg5[local22]);
			}
		} else {
			for (local22 = 0; local22 < 6; local22++) {
				OpenGL.glTexImage2Di(local22 + 34069, 0, Class104_Sub1.method3978(this.aClass206_16, this.aClass226_17), arg3, arg3, 0, 32993, this.aClass104_Sub1_34.anInt527, arg5[local22], 0);
			}
		}
		this.method18040(true);
	}

	@OriginalMember(owner = "client!adq", name = "<init>", descriptor = "(Lclient!afa;Lclient!ck;Lclient!dg;IZ[[BLclient!ck;)V", line = 38)
	Class88_Sub1(@OriginalArg(0) Class104_Sub1 arg0, @OriginalArg(1) Class206 arg1, @OriginalArg(2) Class226 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) byte[][] arg5, @OriginalArg(6) Class206 arg6) {
		...
		this.aClass104_Sub1_34.method3887(this);
		for (@Pc(20) int local20 = 0; local20 < 6; local20++) {
			OpenGL.glTexImage2Dub(local20 + 34069, 0, Class104_Sub1.method3978(this.aClass206_16, this.aClass226_17), arg3, arg3, 0, Class104_Sub1.method3977(arg6), 5121, arg5[local20], 0);
		}
		this.method18040(true);
	}

	@OriginalMember(owner = "client!adq", name = "ar", descriptor = "(II)Lclient!dp;", line = 48)
	Interface18 method1592(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return new Class204(this, arg0, arg1);
	}

	@OriginalMember(owner = "client!adq", name = "ap", descriptor = "(II)Lclient!dp;", line = 48)
