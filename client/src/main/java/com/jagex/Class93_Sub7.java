...
public final class Class93_Sub7 extends Class93 {
	...
	@OriginalMember(owner = "client!ajr", name = "<init>", descriptor = "(Lclient!afa;Lclient!aek;Lclient!akf;[I)V")
	Class93_Sub7(@OriginalArg(0) Class104_Sub1 arg0, @OriginalArg(1) Class99_Sub2 arg1, @OriginalArg(2) Class93_Sub16 arg2, @OriginalArg(3) int[] arg3) {
		...
		@Pc(22) int local22 = this.aClass93_Sub16_1.method13523((byte) -95) - (arg1.anInt412 * -1678286317 >> 1);
		...
		this.anInt1454 = this.aClass93_Sub16_1.method13522(1811765606) - local22 >> arg1.anInt415 * -373302705;
		this.anInt1455 = this.aClass93_Sub16_1.method13522(461241388) + local22 >> arg1.anInt415 * -373302705;
			...
			if (local127 > 0 && local127 < this.aClass99_Sub2_1.anInt413 * -143202029 - 1) {
				for (local140 = 0; local140 <= local82; local140++) {
					...
					if (local148 > 0 && local148 < this.aClass99_Sub2_1.anInt414 * -1667858293 - 1) {
						local175 = arg1.method2482(local148 + 1, local127, -811210147) - arg1.method2482(local148 - 1, local127, -2137291032);
						local191 = arg1.method2482(local148, local127 + 1, -1527908784) - arg1.method2482(local148, local127 - 1, -888830335);
		...
		if (this.anInt1456 > 0) {
			...
			this.aClass16_10 = new Class16(Class134_Sub2.method10212(this.anInt1456, (byte) 116));
			local127 = 0;
			local119 = 0;
			...
			this.anInterface16_3 = this.aClass104_Sub1_29.method3793(5123, this.aClass93_Sub41_8.aByteArray58, this.aClass93_Sub41_8.anInt3070 * 212851357, false);
			this.anInterface14_5 = this.aClass104_Sub1_29.method3794(16, this.aClass93_Sub41_Sub1_2.aByteArray58, this.aClass93_Sub41_Sub1_2.anInt3070 * 212851357, false);
	...
	@OriginalMember(owner = "client!ajr", name = "e", descriptor = "(S)V")
	void method12729(@OriginalArg(0) short arg0) {
		if (this.aClass104_Sub1_29.aBoolean106) {
			this.aClass93_Sub41_8.method22466(arg0, 2144235018);
		} else {
			this.aClass93_Sub41_8.method22405(arg0, -1186779702);
		}
	}

	@OriginalMember(owner = "client!ajr", name = "m", descriptor = "(III[[Z)V")
	void method12730(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3) {
		...
		for (@Pc(34) int local34 = this.anInt1454; local34 <= this.anInt1455; local34++) {
			for (@Pc(41) int local41 = this.anInt1453; local41 <= this.anInt1452; local41++) {
				...
				if (local49 > -arg2 && local49 < arg2 && local53 > -arg2 && local53 < arg2 && arg3[local49 + arg2][local53 + arg2]) {
					this.aClass104_Sub1_29.method3792((int) (this.aClass93_Sub16_1.method13525(1886489724) * 255.0F) << 24);
					this.aClass104_Sub1_29.method3836(this.aClass193_11, null, this.aClass193_12, null);
					this.aClass104_Sub1_29.method3948(this.anInterface16_3, 4, 0, this.anInt1456);
					return;
				}
			}
		}
	...
	@OriginalMember(owner = "client!ajr", name = "n", descriptor = "(IIIIII)V")
	void method12731(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		@Pc(28) int local28 = this.aClass99_Sub2_1.method2480(local11, local21, 658119551);
		if ((arg4 & 0x7F) == 0 || (arg5 & 0x7F) == 0) {
			local1 = ((long) local21 & 0xFFFFL) << 16 | (long) local11 & 0xFFFFL;
			@Pc(54) Class93_Sub20 local54 = (Class93_Sub20) this.aClass16_10.method215(local1);
			if (local54 != null) {
		...
		if (local1 != -1L) {
			this.aClass16_10.method221(new Class93_Sub20(local70), local1);
		}
		@Pc(93) float local93;
		...
		local257 = this.aClass93_Sub16_1.method13522(1321135326) - local21;
		local264 = (float) Math.sqrt((double) (local240 * local240 + local250 * local250 + local257 * local257));
		local271 = 1.0F / local264;
		local240 *= local271;
		local250 *= local271;
		local257 *= local271;
		local280 = local264 / (float) this.aClass93_Sub16_1.method13523((byte) -73);
		...
		@Pc(528) int local528 = this.aClass93_Sub16_1.method13539((byte) -115);
		...
		if (this.aClass104_Sub1_29.aBoolean106) {
			this.aClass93_Sub41_Sub1_2.method22334((float) local11);
			this.aClass93_Sub41_Sub1_2.method22334((float) local28);
			this.aClass93_Sub41_Sub1_2.method22334((float) local21);
		} else {
			this.aClass93_Sub41_Sub1_2.method22337((float) local11);
			this.aClass93_Sub41_Sub1_2.method22337((float) local28);
			this.aClass93_Sub41_Sub1_2.method22337((float) local21);
		}
		this.aClass93_Sub41_Sub1_2.method22522(local538, (byte) -80);
		this.aClass93_Sub41_Sub1_2.method22522(local553, (byte) -37);
		this.aClass93_Sub41_Sub1_2.method22522(local566, (byte) -37);
		this.aClass93_Sub41_Sub1_2.method22522(255, (byte) -40);
		this.method12729(local70);
	}

	@OriginalMember(owner = "client!ajr", name = "k", descriptor = "(S)V")
	void method12732(@OriginalArg(0) short arg0) {
		if (this.aClass104_Sub1_29.aBoolean106) {
			this.aClass93_Sub41_8.method22466(arg0, 2131065806);
		} else {
			this.aClass93_Sub41_8.method22405(arg0, -1592249828);
		}
	}

	@OriginalMember(owner = "client!ajr", name = "f", descriptor = "(IIIIII)V")
	void method12733(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		@Pc(1) long local1 = -1L;
		@Pc(11) int local11 = arg4 + (arg2 << this.aClass99_Sub2_1.anInt415 * -373302705);
		@Pc(21) int local21 = arg5 + (arg3 << this.aClass99_Sub2_1.anInt415 * -373302705);
		@Pc(28) int local28 = this.aClass99_Sub2_1.method2480(local11, local21, 252085972);
		if ((arg4 & 0x7F) == 0 || (arg5 & 0x7F) == 0) {
			local1 = ((long) local21 & 0xFFFFL) << 16 | (long) local11 & 0xFFFFL;
			@Pc(54) Class93_Sub20 local54 = (Class93_Sub20) this.aClass16_10.method215(local1);
			if (local54 != null) {
		...
		local250 = this.aClass93_Sub16_1.method13521(1655674161) - local28;
		local257 = this.aClass93_Sub16_1.method13522(973410424) - local21;
		local264 = (float) Math.sqrt((double) (local240 * local240 + local250 * local250 + local257 * local257));
		local271 = 1.0F / local264;
		local240 *= local271;
		local250 *= local271;
		local257 *= local271;
		local280 = local264 / (float) this.aClass93_Sub16_1.method13523((byte) -49);
		local289 = 1.0F - local280 * local280;
		if (local289 < 0.0F) {
			local289 = 0.0F;
		}
		...
		@Pc(528) int local528 = this.aClass93_Sub16_1.method13539((byte) -65);
		@Pc(538) int local538 = (int) (local517 * (float) (local528 >> 16 & 0xFF));
		if (local538 > 255) {
			local538 = 255;
		}
		...
		this.aClass93_Sub41_Sub1_2.method22522(local538, (byte) -48);
		this.aClass93_Sub41_Sub1_2.method22522(local553, (byte) -103);
		this.aClass93_Sub41_Sub1_2.method22522(local566, (byte) -54);
		this.aClass93_Sub41_Sub1_2.method22522(255, (byte) -15);
		this.method12729(local70);
	}

	@OriginalMember(owner = "client!ajr", name = "w", descriptor = "(III[[Z)V")
	void method12734(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3) {
		...
		for (@Pc(34) int local34 = this.anInt1454; local34 <= this.anInt1455; local34++) {
			for (@Pc(41) int local41 = this.anInt1453; local41 <= this.anInt1452; local41++) {
				...
				@Pc(53) int local53 = local34 - arg1;
				if (local49 > -arg2 && local49 < arg2 && local53 > -arg2 && local53 < arg2 && arg3[local49 + arg2][local53 + arg2]) {
					this.aClass104_Sub1_29.method3792((int) (this.aClass93_Sub16_1.method13525(1582787109) * 255.0F) << 24);
					this.aClass104_Sub1_29.method3836(this.aClass193_11, null, this.aClass193_12, null);
					this.aClass104_Sub1_29.method3948(this.anInterface16_3, 4, 0, this.anInt1456);
					return;
				}
