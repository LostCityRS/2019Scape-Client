...
@ObfuscatedName("afi")
public class class842 extends class116 {

	@ObfuscatedName("afi.f")
	public class848 field9572;

	@ObfuscatedName("afi.w")
	public boolean field9533 = false;

	@ObfuscatedName("afi.l")
	public class55 field9534;

	@ObfuscatedName("afi.u")
	public class55 field9535;

	@ObfuscatedName("afi.z")
	public class65 field9536;
	...
	public class58[] field9568;

	@ObfuscatedName("afi.ag")
	public class58[] field9555;
	...
	public class842[] field9617;

	@ObfuscatedName("afi.cf")
	public class842[] field9539;

	public class842(class848 arg0) {
		this.field9572 = arg0;
	}

	public class842(class848 arg0, class120 arg1, int arg2, int arg3, int arg4, int arg5) {
		this.field9572 = arg0;
		this.field9616 = arg2;
		this.field9546 = arg3;
		this.field9600 = arg4;
		class125 var7 = this.field9572.field1597;
		class383 var8 = this.field9572.field1598;
		...
		for (int var13 = 0; var13 < this.field9611; var13++) {
			...
			if (arg1.field1412 != null) {
				...
				for (int var21 = 0; var21 < arg1.field1412.length; var21++) {
					class137 var22 = arg1.field1412[var21];
					if (var22.field1654 == var14) {
						class375 var23 = var8.method6015(var22.field1653);
						if (var23.field3456) {
							var20 = true;
						}
						if (var23.field3455 != -1) {
							class118 var24 = var7.method2043(var23.field3455);
			...
			if (arg1.field1403 != null) {
				...
				for (int var26 = 0; var26 < arg1.field1403.length; var26++) {
					class128 var27 = arg1.field1403[var26];
					if (var27.field1463 == var14) {
						class376 var28 = this.field9572.field1599.method6004(var27.field1477);
						if (var28.field3510) {
							var25 = true;
						}
					}
		...
		if (arg1.field1412 != null) {
			...
			this.field9589 = new class61[this.field9588];
			this.field9590 = new class54[this.field9588];
			for (int var35 = 0; var35 < arg1.field1412.length; var35++) {
				class137 var36 = arg1.field1412[var35];
				class375 var37 = var8.method6015(var36.field1653);
				...
				this.field9589[var35] = new class61(var36.field1654, arg1.field1415[var36.field1654], arg1.field1386[var36.field1654], arg1.field1400[var36.field1654], var37.field3451, var37.field3452, var37.field3455, var37.field3450, var37.field3453, var37.field3456, var36.field1656);
				this.field9590[var35] = new class54(var39);
			}
		}
		...
		class55 var41 = this.field9572.method15674(Thread.currentThread());
		...
		if (arg1.field1396 == null) {
			...
			for (int var123 = 0; var123 < this.field9611; var123++) {
				...
				if (var124 == -1) {
					...
					class118 var125 = this.field9572.field1597.method2043(var124 & 0xFFFF);
	...
	public void method15458(class55 arg0) {
	...
	public void method15545(Thread arg0) {
		class55 var2 = this.field9572.method15674(arg0);
	...
	public void method15459() {
		this.field9568 = new class58[this.field9549];
		for (int var1 = 0; var1 < this.field9549; var1++) {
			this.field9568[var1] = new class58();
		}
		...
		if (this.field9602 == 1) {
			...
			for (int var8 = 0; var8 < this.field9611; var8++) {
				...
				if (var11 != -1) {
					...
					short var14 = class662.method4937(var12 & 0xFFFFFF80 | var13);
					class58 var15;
					if (this.field9555 == null || this.field9555[this.field9558[var8]] == null) {
					...
					this.field9563[var8] = var18 << 17 | class662.method6807(var14, var18);
					class58 var19;
					if (this.field9555 == null || this.field9555[this.field9559[var8]] == null) {
					...
					this.field9583[var8] = var22 << 17 | class662.method6807(var14, var22);
					class58 var23;
					if (this.field9555 == null || this.field9555[this.field9560[var8]] == null) {
					...
					this.field9565[var8] = var26 << 17 | class662.method6807(var14, var26);
				} else if (var9 == 1) {
					int var27 = this.field9575[var8] & 0xFFFF;
					int var28 = (var27 & 0x7F) * this.field9546 >> 7;
					short var29 = class662.method4937(var27 & 0xFFFFFF80 | var28);
					...
					this.field9563[var8] = var33 << 17 | class662.method6807(var29, var33);
					this.field9565[var8] = -1;
				} else if (var9 == 3) {
	...
	public int method15461(int arg0, short arg1, int arg2) {
		...
		class118 var5 = this.field9572.field1597.method2043(arg1 & 0xFFFF);
	...
	public void method15464() {
		for (int var1 = 0; var1 < this.field9611; var1++) {
			...
			if (var2 == -1) {
				...
				short var5 = class662.method4937(var3 & 0xFFFFFF80 | var4);
				if (this.field9565[var1] == -1) {
					int var6 = this.field9563[var1] & 0xFFFE0000;
					this.field9563[var1] = var6 | class662.method6807(var5, var6 >> 17);
				} else if (this.field9565[var1] != -2) {
					int var7 = this.field9563[var1] & 0xFFFE0000;
					this.field9563[var1] = var7 | class662.method6807(var5, var7 >> 17);
					int var8 = this.field9583[var1] & 0xFFFE0000;
					this.field9583[var1] = var8 | class662.method6807(var5, var8 >> 17);
					int var9 = this.field9565[var1] & 0xFFFE0000;
					this.field9565[var1] = var9 | class662.method6807(var5, var9 >> 17);
				}
			}
		}
		this.field9602 = 2;
	...
	public void method1686(class116 arg0, int arg1, int arg2, int arg3, boolean arg4) {
		...
		if ((this.field9616 & 0x10000) != 65536) {
			...
			for (int var10 = 0; var10 < this.field9549; var10++) {
				class58 var11 = this.field9568[var10];
				if (var11.field876 != 0) {
						...
						if (var13 >= var6.field9569 && var13 <= var6.field9553) {
							...
							if (var14 >= var6.field9599 && var14 <= var6.field9537) {
								for (int var15 = 0; var15 < var9; var15++) {
									class58 var16 = var6.field9568[var15];
									if (var8[var15] == var13 && var6.field9552[var15] == var14 && var6.field9551[var15] == var12 && var16.field876 != 0) {
										if (this.field9555 == null) {
											this.field9555 = new class58[this.field9549];
										}
										if (var6.field9555 == null) {
											var6.field9555 = new class58[var9];
										}
										class58 var17 = this.field9555[var10];
										if (var17 == null) {
											var17 = this.field9555[var10] = new class58(var11);
										}
										class58 var18 = var6.field9555[var15];
										if (var18 == null) {
											var18 = var6.field9555[var15] = new class58(var16);
										}
	...
	public class116 method1773(byte arg0, int arg1, boolean arg2) {
		...
		if (arg0 > 0 && arg0 <= 8) {
			...
			var6 = var5 = new class842(this.field9572);
		}
		return this.method15465(var6, var5, arg1, var4, arg2);
	}

	@ObfuscatedName("afi.he(Lafi;Lafi;IZZ)Ldo;")
	public class116 method15465(class842 arg0, class842 arg1, int arg2, boolean arg3, boolean arg4) {
		...
		if ((arg2 & 0x8) == 0 && (arg2 & 0x10) == 0) {
			...
			if (arg1.field9568 == null || arg1.field9568.length < this.field9549) {
				...
				arg0.field9568 = arg1.field9568 = new class58[var22];
			} else {
			...
			if (this.field9568 == null) {
				...
				for (int var23 = 0; var23 < this.field9549; var23++) {
					arg0.field9568[var23] = new class58(this.field9568[var23]);
				}
			}
			if (this.field9570 == null) {
				arg0.field9570 = null;
		...
		if ((arg2 & 0xC580) == 0) {
			...
			arg0.field9590 = arg1.field9590 = new class54[var31];
			...
			if (this.field9605 != null && this.field9573 != null) {
				...
				if (this.field9589 != null) {
					for (int var64 = 0; var64 < this.field9588; var64++) {
						class61 var65 = this.field9589[var64];
						class54 var66 = this.field9590[var64];
			...
			if (this.field9605 != null) {
				...
				if (this.field9589 != null) {
					for (int var79 = 0; var79 < this.field9588; var79++) {
						class61 var80 = this.field9589[var79];
						class54 var81 = this.field9590[var79];
						var81.field819 = var81.field819 & 0xFF000000 | Statics.field8149[class662.method4937(this.field9575[var80.field901] & 0xFFFF) & 0xFFFF] & 0xFFFFFF;
					}
				}
			}
		} else if (arg0 == 8) {
				...
				for (int var82 = 0; var82 < var8; var82++) {
					...
					if (var83 < this.field9591.length) {
						...
						for (int var85 = 0; var85 < var84.length; var85++) {
							class54 var86 = this.field9590[var84[var85]];
							var86.field822 += arg2;
							var86.field816 += arg3;
						}
					}
				...
				for (int var87 = 0; var87 < var8; var87++) {
					...
					if (var88 < this.field9591.length) {
						...
						for (int var90 = 0; var90 < var89.length; var90++) {
							class54 var91 = this.field9590[var89[var90]];
			...
			for (int var92 = 0; var92 < var8; var92++) {
				...
				if (var93 < this.field9591.length) {
					...
					for (int var95 = 0; var95 < var94.length; var95++) {
						class54 var96 = this.field9590[var94[var95]];
			...
			if (this.field9605 != null && this.field9573 != null) {
				...
				if (this.field9589 != null) {
					for (int var169 = 0; var169 < this.field9588; var169++) {
						class61 var170 = this.field9589[var169];
						class54 var171 = this.field9590[var169];
			...
			if (this.field9605 != null) {
				...
				if (this.field9589 != null) {
					for (int var184 = 0; var184 < this.field9588; var184++) {
						class61 var185 = this.field9589[var184];
						class54 var186 = this.field9590[var184];
						var186.field819 = var186.field819 & 0xFF000000 | Statics.field8149[class662.method4937(this.field9575[var185.field901] & 0xFFFF) & 0xFFFF] & 0xFFFFFF;
					}
				}
			}
		} else if (arg0 == 8) {
				...
				for (int var187 = 0; var187 < var9; var187++) {
					...
					if (var188 < this.field9591.length) {
						...
						for (int var190 = 0; var190 < var189.length; var190++) {
							class54 var191 = this.field9590[var189[var190]];
				...
				for (int var192 = 0; var192 < var9; var192++) {
					...
					if (var193 < this.field9591.length) {
						...
						for (int var195 = 0; var195 < var194.length; var195++) {
							class54 var196 = this.field9590[var194[var195]];
			...
			for (int var197 = 0; var197 < var9; var197++) {
				...
				if (var198 < this.field9591.length) {
					...
					for (int var200 = 0; var200 < var199.length; var200++) {
						class54 var201 = this.field9590[var199[var200]];
		...
		if (arg0 == 0) {
			...
			if (this.field9589 != null) {
				for (int var21 = 0; var21 < this.field9588; var21++) {
					class61 var22 = this.field9589[var21];
					class54 var23 = this.field9590[var21];
			...
			if (this.field9589 != null) {
				for (int var32 = 0; var32 < this.field9588; var32++) {
					class61 var33 = this.field9589[var32];
					class54 var34 = this.field9590[var32];
					var34.field819 = var34.field819 & 0xFF000000 | Statics.field8149[class662.method4937(this.field9575[var33.field901] & 0xFFFF) & 0xFFFF] & 0xFFFFFF;
				}
			}
		} else if (arg0 == 8) {
			for (int var35 = 0; var35 < this.field9588; var35++) {
				class54 var36 = this.field9590[var35];
				var36.field822 += arg1;
				var36.field816 += arg2;
			}
		} else if (arg0 == 10) {
			for (int var37 = 0; var37 < this.field9588; var37++) {
				class54 var38 = this.field9590[var37];
			...
			for (int var39 = 0; var39 < this.field9588; var39++) {
				class54 var40 = this.field9590[var39];
	...
	public void method15478(Matrix4x3 arg0, class141 arg1, int arg2) {
		...
		if (this.field9589 != null) {
			for (int var39 = 0; var39 < this.field9588; var39++) {
				class61 var40 = this.field9589[var39];
				class54 var41 = this.field9590[var39];
	...
	public final void method15490(boolean arg0, boolean arg1, boolean arg2, boolean arg3, boolean arg4) {
		if (this.field9589 != null) {
			...
			while (var6 < this.field9588) {
				class61 var7 = this.field9589[var6];
	...
	public final void method15479(boolean arg0, boolean arg1, boolean arg2) {
		for (int var4 = 0; var4 < this.field9588; var4++) {
			class61 var5 = this.field9589[var4];
			if (var5.field898) {
				class54 var6 = this.field9590[var4];
	...
	public final void method15519(boolean arg0, boolean arg1, boolean arg2, int arg3, boolean arg4, boolean arg5) {
		...
		class61 var18 = this.field9589[var17];
		class54 var19 = this.field9590[var17];
		if (!var18.field898) {
			this.method15483(arg0, arg1, arg2, arg3);
		}
	...
	public final void method15484(boolean arg0, boolean arg1, boolean arg2, int arg3) {
		...
		if (this.field9534.field867) {
			...
			if (var5) {
				...
				this.field9536.method1030(arg0, arg1, arg2, this.field9607[var27], this.field9607[var28], this.field9607[var29], this.field9578[var27], this.field9578[var28], this.field9578[var29], this.field9609[var27], this.field9609[var28], this.field9609[var29], class662.method19201(Statics.field8149[this.field9563[arg3] & 0xFFFF], this.field9534.field858, var30 * 255.0F), class662.method19201(Statics.field8149[this.field9563[arg3] & 0xFFFF], this.field9534.field858, var31 * 255.0F), class662.method19201(Statics.field8149[this.field9563[arg3] & 0xFFFF], this.field9534.field858, var32 * 255.0F));
			} else {
				this.field9536.method1030(arg0, arg1, arg2, this.field9607[var27], this.field9607[var28], this.field9607[var29], this.field9578[var27], this.field9578[var28], this.field9578[var29], this.field9609[var27], this.field9609[var28], this.field9609[var29], class662.method19201(Statics.field8149[this.field9563[arg3] & 0xFFFF], this.field9534.field858, var30 * 255.0F), class662.method19201(Statics.field8149[this.field9583[arg3] & 0xFFFF], this.field9534.field858, var31 * 255.0F), class662.method19201(Statics.field8149[this.field9565[arg3] & 0xFFFF], this.field9534.field858, var32 * 255.0F));
			}
			return;
		}
		...
		if (var5) {
			...
			this.field9536.method1030(arg0, arg1, arg2, this.field9607[var6], this.field9607[var7], this.field9607[var8], this.field9578[var6], this.field9578[var7], this.field9578[var8], this.field9609[var6], this.field9609[var7], this.field9609[var8], class662.method19201(Statics.field8149[this.field9563[arg3] & 0xFFFF], this.field9534.field858, var21 * 255.0F), class662.method19201(Statics.field8149[this.field9563[arg3] & 0xFFFF], this.field9534.field858, var22 * 255.0F), class662.method19201(Statics.field8149[this.field9563[arg3] & 0xFFFF], this.field9534.field858, var23 * 255.0F));
		} else {
			this.field9536.method1030(arg0, arg1, arg2, this.field9607[var6], this.field9607[var7], this.field9607[var8], this.field9578[var6], this.field9578[var7], this.field9578[var8], this.field9609[var6], this.field9609[var7], this.field9609[var8], class662.method19201(Statics.field8149[this.field9563[arg3] & 0xFFFF], this.field9534.field858, var21 * 255.0F), class662.method19201(Statics.field8149[this.field9583[arg3] & 0xFFFF], this.field9534.field858, var22 * 255.0F), class662.method19201(Statics.field8149[this.field9565[arg3] & 0xFFFF], this.field9534.field858, var23 * 255.0F));
		}
	}
	...
	public void method1689(Matrix4x3 arg0) {
		...
		if (this.field9586 != null) {
			for (int var3 = 0; var3 < this.field9586.length; var3++) {
				class128 var4 = this.field9586[var3];
				class128 var5 = var4;
		...
		for (int var6 = 0; var6 < this.field9532.length; var6++) {
			class102 var7 = this.field9532[var6];
			class102 var8 = var7;
	...
	public void method1859(short arg0, short arg1) {
		...
		if (this.field9589 != null) {
			for (int var4 = 0; var4 < this.field9588; var4++) {
				class61 var5 = this.field9589[var4];
				class54 var6 = this.field9590[var4];
				var6.field819 = var6.field819 & 0xFF000000 | Statics.field8149[class662.method4937(this.field9575[var5.field901]) & 0xFFFF] & 0xFFFFFF;
			}
		}
		if (this.field9602 == 2) {
			this.field9602 = 1;
	...
	public void method1744(short arg0, short arg1) {
		...
		if (!this.field9608 && arg1 >= 0) {
			class118 var3 = this.field9572.field1597.method2043(arg1 & 0xFFFF);
	...
	public void method1745(int arg0, int arg1, int arg2, int arg3) {
		...
		if (this.field9589 != null) {
			for (int var10 = 0; var10 < this.field9588; var10++) {
				class61 var11 = this.field9589[var10];
				class54 var12 = this.field9590[var10];
				var12.field819 = var12.field819 & 0xFF000000 | Statics.field8149[class662.method4937(this.field9575[var11.field901] & 0xFFFF) & 0xFFFF] & 0xFFFFFF;
			}
		}
		if (this.field9602 == 2) {
			this.field9602 = 1;
