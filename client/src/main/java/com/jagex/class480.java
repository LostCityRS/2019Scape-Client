...
public class class480 {
	...
	public class480(class473 arg0, int arg1, int arg2, class365 arg3, class366 arg4) {
		...
		this.field4921.method3770(new class478(this));
		this.method7517();
	}

	@ObfuscatedName("rq.e(I)Lqn;")
	public class474 method7550() {
		return this.field4912;
	}

	@ObfuscatedName("rq.n(Lqn;I)V")
	public void method7480(class474 arg0) {
		this.field4912 = arg0;
	}

	@ObfuscatedName("rq.m(I)Z")
	public boolean method7581() {
		return class474.field4858 == this.field4912;
	}

	@ObfuscatedName("rq.k(B)Z")
	public boolean method7482() {
		return class474.field4865 == this.field4912;
	}

	@ObfuscatedName("rq.f(I)V")
	public void method7592() {
		if (this.method7550().field4867 >= class474.field4860.field4867) {
			throw new RuntimeException("");
		}
		this.method7480(class474.field4860);
	}
	...
	public void method7484() {
		...
		this.field4905 = null;
		this.method7480(class474.field4866);
	}
	...
	public boolean method7487(byte[] arg0, class477 arg1, int arg2, float arg3, boolean arg4, boolean arg5, int arg6, float arg7, Object arg8) {
		synchronized (this) {
			if (arg1 == null) {
				this.field4901 = arg0;
			} else {
	...
	public void method7489() {
		synchronized (this) {
			if (this.method7550() != class474.field4858 && this.method7550().field4867 >= class474.field4860.field4867) {
				this.method7480(class474.field4858);
			}
		}
	}

	@ObfuscatedName("rq.c(Lro;I)V")
	public void method7536(class479 arg0) {
		this.field4933 = arg0;
	...
	public void method7497() {
		if (this.method7550().field4867 < class474.field4861.field4867) {
			return;
		}
		if (this.method7550() == class474.field4866) {
			this.method7483();
			return;
		}
		this.method7563();
		...
		this.method7492();
		if (this.method7550().field4867 < class474.field4858.field4867) {
			this.method7501();
		}
	}
	...
	public void method7573() {
		if (this.method7550() != class474.field4858 && this.method7550().field4867 < class474.field4861.field4867) {
			this.method7480(class474.field4861);
			this.field4920 = true;
			this.method7501();
			this.method7492();
		}
	...
	public void method7501() {
		if (this.field4920 && this.method7550().field4867 >= class474.field4861.field4867 && this.method7550().field4867 < class474.field4865.field4867 && this.field4933 != null && this.field4937 == this.field4897) {
			this.field4933.method3053(this.field4905, this.field4910, null);
		}
	}
	...
	public void method7504() {
		if (this.method7550().field4867 < class474.field4861.field4867 || this.method7550().field4867 >= class474.field4858.field4867 || !this.method7491()) {
			return;
		}
		synchronized (this) {
