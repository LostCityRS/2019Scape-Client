...
public abstract class Class131 {
	...
	@OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(Lclient!afc;)V", line = 32)
	Class131(@OriginalArg(0) Class104_Sub2 arg0) {
		this.aClass104_Sub2_18 = arg0;
	}

	@OriginalMember(owner = "client!jj", name = "h", descriptor = "(B)V", line = 37)
	public void method10099(@OriginalArg(0) byte arg0) {
		switch(arg0) {
			case 1:
	...
	@OriginalMember(owner = "client!jj", name = "b", descriptor = "(B)V", line = 37)
	public void method10100(@OriginalArg(0) byte arg0) {
		switch(arg0) {
			case 1:
				this.aFloat122 = 32.0F;
				this.aFloat123 = 0.0F;
	...
	@OriginalMember(owner = "client!jj", name = "e", descriptor = "(B)V", line = 37)
	public void method10101(@OriginalArg(0) byte arg0) {
		switch(arg0) {
			case 1:
				this.aFloat122 = 32.0F;
				this.aFloat123 = 0.0F;
	...
	public abstract void method10102(@OriginalArg(0) Class489 arg0);

	@OriginalMember(owner = "client!jj", name = "m", descriptor = "(Z)V")
	public abstract void method10103(@OriginalArg(0) boolean arg0);

	@OriginalMember(owner = "client!jj", name = "k", descriptor = "(I)V")
	public abstract void method10104(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!jj", name = "z", descriptor = "(Lclient!pq;)V")
	public abstract void method10105(@OriginalArg(0) Class489 arg0);

	@OriginalMember(owner = "client!jj", name = "r", descriptor = "(Z)V")
	public abstract void method10106(@OriginalArg(0) boolean arg0);
	...
	public abstract void method10108();

	@OriginalMember(owner = "client!jj", name = "p", descriptor = "(Z)V")
	public abstract void method10109(@OriginalArg(0) boolean arg0);

	@OriginalMember(owner = "client!jj", name = "w", descriptor = "(I)V")
	public abstract void method10110(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!jj", name = "c", descriptor = "(Z)V")
	public abstract void method10111(@OriginalArg(0) boolean arg0);

	@OriginalMember(owner = "client!jj", name = "x", descriptor = "()V")
	public abstract void method10112();
	...
	public abstract void method10116(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!jj", name = "q", descriptor = "()V")
	public abstract void method10117();

	@OriginalMember(owner = "client!jj", name = "d", descriptor = "(Z)V")
	public abstract void method10118(@OriginalArg(0) boolean arg0);

	@OriginalMember(owner = "client!jj", name = "y", descriptor = "()V")
	public abstract void method10119();
}
