...
public class Class641 implements Interface75 {
	...
	static final void method32508(@OriginalArg(0) Class440 arg0, @OriginalArg(1) int arg1) {
				...
				if (local75 != null) {
					for (@Pc(84) Class93_Sub3 local84 = (Class93_Sub3) local75.aClass22_17.method428((byte) 86); local84 != null; local84 = (Class93_Sub3) local75.aClass22_17.method442(1402996631)) {
						if (local84.anInt1405 * -308533965 == local49 && local84.anInt1404 * -815066371 == local53) {
							...
							Class676.method33222(Class113_Sub1.anInt866 * 1733983357, local45, local28, local84, 2026343802);
							break;
						}
					}
					if (local38 >= 0 && local21 >= 0 && local38 < client.aClass532_1.method30459(-1068841303) && local21 < client.aClass532_1.method30466((short) 128)) {
						Class518.method30305(Class113_Sub1.anInt866 * 1733983357, local38, local21, 2090140645);
					}
				}
			}
			return;
		...
		if (arg0 == Class440.aClass440_14) {
			...
			if (client.aClass532_1.method30443(-2077151248).method30383((byte) 23) || local21 >= 0 && local28 >= 0 && local21 < client.aClass532_1.method30459(-13743953) && local28 < client.aClass532_1.method30466((short) 128)) {
				Class359.method27788(Class113_Sub1.anInt866 * 1733983357, local21, local28, local45, -1, local181.anInt5709 * 1175627307, local181.anInt5708 * -1626288991, local181.aClass458_90, (byte) 61);
			}
			return;
		}
		@Pc(288) int local288;
		...
		if (Class440.aClass440_7 == arg0) {
			...
			if (client.aClass532_1.method30443(-1474467379).method30383((byte) 14) || local28 >= 0 && local38 >= 0 && local28 < client.aClass532_1.method30459(398663230) && local38 < client.aClass532_1.method30466((short) 128)) {
			...
			if (client.aClass532_1.method30443(-1016027029) != Class526.aClass526_2 && (local21 >= 0 && local28 >= 0 && local21 < client.aClass532_1.method30459(-92475261) && local28 < client.aClass532_1.method30466((short) 128) && local38 >= 0 && local45 >= 0 && local38 < client.aClass532_1.method30459(-2106086182) && local45 < client.aClass532_1.method30466((short) 128) && local53 != 65535)) {
				...
				local288 <<= 0x2;
				local524 <<= 0x2;
				@Pc(1138) Class132_Sub1_Sub1_Sub4 local1138 = new Class132_Sub1_Sub1_Sub4(client.aClass532_1.method30481(-1455667273), local53, Class113_Sub1.anInt866 * 1733983357, Class113_Sub1.anInt866 * 1733983357, local21, local28, local57, client.anInt3485 + local312, client.anInt3485 + local475, local361, local524, 0, local49, local288, local959, -1, local534);
				local1138.method23915(local38, local45, Class305.method26802(local38, local45, Class113_Sub1.anInt866 * 1733983357, (byte) -12) - local288, client.anInt3485 + local312, -24684772);
			...
			if (Class440.aClass440_6 == arg0) {
				...
				@Pc(1226) Class93_Sub5 local1226 = (Class93_Sub5) client.aClass16_20.method214((long) (Class113_Sub1.anInt866 * 1733983357 << 28 | local38 << 14 | local49));
				if (local1226 != null) {
					...
					if (local45 >= 0 && local28 >= 0 && local45 < client.aClass532_1.method30459(-1937689022) && local28 < client.aClass532_1.method30466((short) 128)) {
						Class518.method30305(Class113_Sub1.anInt866 * 1733983357, local45, local28, -1266442059);
					}
				}
				...
				if (client.anInt3513 * -859840571 != local57) {
					...
					if (local1362 || client.aClass532_1.method30443(-1823123234).method30383((byte) 126)) {
						Class676.method33222(Class113_Sub1.anInt866 * 1733983357, local49, local38, new Class93_Sub3(local53, local9), 2107991193);
						if (local1362) {
							Class518.method30305(Class113_Sub1.anInt866 * 1733983357, local45, local28, 1500256836);
						}
					}
				}
			} else {
				...
				if (arg0 == Class440.aClass440_5) {
					...
					if ((local9 & 0x1) == 1) {
						Class475.method29678(Class113_Sub1.anInt866 * 1733983357, local38, local45, local53, local156, local1436.anInt5709 * 1175627307, null, (byte) -52);
					} else {
					...
					if (client.aClass532_1.method30443(-1174203992) != Class526.aClass526_2 && (local156 >= 0 && local21 >= 0 && local156 < client.aClass532_1.method30459(527465057) && local21 < client.aClass532_1.method30466((short) 128))) {
						if (local28 == -1) {
							...
							if (local312 < 3 && client.aClass532_1.method30487(182541256).method30330(local156, local21, -662808309)) {
								local312++;
							}
							@Pc(1818) Class132_Sub1_Sub1_Sub5 local1818 = new Class132_Sub1_Sub1_Sub5(client.aClass532_1.method30481(-1815959157), local28, local45, Class113_Sub1.anInt866 * 1733983357, local312, local57, Class305.method26802(local57, local288, Class113_Sub1.anInt866 * 1733983357, (byte) -82) - local38, local288, local156, local156, local21, local21, local49, false, local53);
					...
					if (local1900 || client.aClass532_1.method30443(-1974156521).method30383((byte) 9)) {
						...
						if (local1900) {
							Class518.method30305(Class113_Sub1.anInt866 * 1733983357, local38, local21, 2124335454);
						}
					}
				} else {
					Class646.method32608("" + arg0, new RuntimeException(), 475912576);
					Class642.method32520(false, (short) 28594);
				}
			}
		}
	}
	...
	static final void method32509(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub39_2.method16345(-1440210536);
	}
