...
public class Class572 {
	...
	@OriginalMember(owner = "client!tk", name = "<init>", descriptor = "(I)V", line = 18)
	public Class572(@OriginalArg(0) int arg0) {
		this.aByte163 = (byte) arg0;
	}

	@OriginalMember(owner = "client!tk", name = "s", descriptor = "(Lclient!dh;I)I", line = 235)
	public static int method31333(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
		Class312.method26845(-1739939257);
		return Class166_Sub13.aTwitchTV1.StopStreaming();
	}

	@OriginalMember(owner = "client!tk", name = "xi", descriptor = "(Lclient!yf;I)V", line = 9150)
	static final void method31334(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(13) Class93_Sub30 local13 = (Class93_Sub30) arg0.anObjectArray45[(arg0.anInt5888 -= 957530791) * 587908375];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = local13.anInt1611 * 1802884841;
	}

	@OriginalMember(owner = "client!tk", name = "kv", descriptor = "(Lclient!hf;III)V", line = 11959)
	static void method31335(@OriginalArg(0) Class312 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(4) Class327 local4 = arg0.method26904(Class694.aClass104_14, (byte) 24);
		if (local4 == null) {
			return;
		}
		Class694.aClass104_14.method20569(arg1, arg2, arg1 + arg0.anInt3981 * 1215292027, arg0.anInt3982 * -1490598249 + arg2);
		if (Class172.anInt3177 * 910154737 >= 3) {
			Class694.aClass104_14.method20592(-16777216, local4.aClass96_1, arg1, arg2);
			return;
		}
		@Pc(42) int local42;
		if (Class429.anInt4781 * -1453926679 == 3) {
			local42 = (int) -((double) Class65.aClass123_Sub1_2.method9042((byte) -110) * 2607.5945876176133D);
		} else {
			local42 = (int) -client.aFloat253;
		}
		local42 = local42 + client.anInt3477 * 1580280690 & 0x3FFF;
		local42 <<= 0x2;
		Class153.aClass100_18.method18178((float) arg1 + (float) (arg0.anInt3981 * 1215292027) / 2.0F, (float) (arg0.anInt3982 * -1490598249) / 2.0F + (float) arg2, 4226, local42, local4.aClass96_1, arg1, arg2);
	}
}
