...
@ObfuscatedName("ahm")
public abstract class class892 extends class1200 implements class273 {
	...
	public class892(class550 arg0, int arg1, class808 arg2) {
	...
	public class892(class550 arg0, class808 arg1) {
		this(arg0, 10, arg1);
	}
	...
	public void method16576(class133 arg0, class116[] arg1, class419 arg2, boolean arg3) {
		if (!arg3) {
			...
			int var9 = -1;
			int var10 = -1;
			class128[][] var11 = new class128[arg1.length][];
			class102[][] var12 = new class102[arg1.length][];
	...
	public void method16505(class116 arg0) {
		...
		for (int var7 = 0; var7 < this.field10422.length; var7++) {
			...
			if (var9.field6657 == -1 || var9.field6659.method14355()) {
				...
				if (var9.field6658 < 0 || arg1.field7357 == null || arg1.field7357[var9.field6658] == null) {
					class116 var21 = this.field10459[var7 + 1] = var10.method13800(arg0, var11, var9.field6660 * 2048, this.field10405, this.field12466, this.field10407, var9.field6659, var8);
					if (var21 != null) {
						if (var9.field6661 != 0) {
					...
					class116 var12 = this.field10459[var7 + 1] = var10.method13817(arg0, var11, var9.field6659, var8);
					if (var12 != null) {
						int var13 = 0;
						int var14 = 0;
						int var15 = 0;
						...
						if (var15 != 0 || var13 != 0) {
							...
							int var18 = class417.field4270[var17];
							int var19 = class417.field4272[var17];
	...
	public void method16507(int arg0, int arg1, int arg2, int arg3, int arg4) {
		...
		int var10 = class417.field4272[arg0];
		int var11 = -arg1 / 2;
		int var12 = -arg2 / 2;
	...
	public class594 method16521() {
		...
		return new class594(this.field11717, var3, var4);
	}
