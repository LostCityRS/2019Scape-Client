...
public final class class462 {
	...
	@ObfuscatedName("qy.w")
	public final class459 field4627;

	@ObfuscatedName("qy.l")
	public final int field4633;

	public class462(int arg0, class459 arg1) {
		this(-1L, arg0, arg1);
	}

	public class462(long arg0, int arg1, class459 arg2) {
	...
	public Object method7278(Object arg0) {
		synchronized (this) {
			...
			class460 var3 = (class460) this.field4628.get(arg0);
			if (var3 == null) {
				return null;
			} else {
	...
	public Object method7279(Object arg0, Object arg1) {
		synchronized (this) {
			...
			class460 var4 = (class460) this.field4628.get(arg0);
			if (var4 != null) {
			...
			if (this.method7277() && this.field4628.size() == this.field4633) {
				class460 var6 = (class460) this.field4630.remove();
				this.field4628.remove(var6.field4623);
				this.field4629.remove(var6);
			}
			class460 var7 = new class460(arg1, arg0);
	...
	public void method7286(class460 arg0, boolean arg1) {
		if (!arg1) {
	...
	public void method7281() {
		...
		while (!this.field4629.isEmpty()) {
			class460 var3 = (class460) this.field4629.peek();
