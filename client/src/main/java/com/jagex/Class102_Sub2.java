...
public class Class102_Sub2 extends Class102 {
	...
	@OriginalMember(owner = "client!aeq", name = "<init>", descriptor = "(Lclient!afc;[I)V", line = 10)
	Class102_Sub2(@OriginalArg(0) Class104_Sub2 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass104_Sub2_3 = arg0;
		if (this.aClass104_Sub2_3.aBoolean471) {
			@Pc(12) byte[] local12 = this.method2596(arg1);
			this.anInterface43_1 = this.aClass104_Sub2_3.method21215(Class206.aClass206_22, 16, 16, 16, false, local12);
		} else {
			this.anInterface43_1 = this.aClass104_Sub2_3.method21038(256, 16, false, arg1);
		}
	}

	@OriginalMember(owner = "client!aeq", name = "e", descriptor = "()Lclient!mq;", line = 20)
	public Interface43 method2593() {
		return this.anInterface43_1;
	}

	@OriginalMember(owner = "client!aeq", name = "k", descriptor = "()Lclient!mq;", line = 20)
	public Interface43 method2594() {
		return this.anInterface43_1;
	}

	@OriginalMember(owner = "client!aeq", name = "m", descriptor = "()Lclient!mq;", line = 20)
	public Interface43 method2595() {
		return this.anInterface43_1;
	}

	@OriginalMember(owner = "client!aeq", name = "n", descriptor = "([I)[B", line = 24)
	byte[] method2596(@OriginalArg(0) int[] arg0) {
	...
	@OriginalMember(owner = "client!aeq", name = "f", descriptor = "([I)[B", line = 24)
	...
	@OriginalMember(owner = "client!aeq", name = "w", descriptor = "([I)[B", line = 24)
