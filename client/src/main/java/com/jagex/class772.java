...
@ObfuscatedName("acw")
public class class772 implements SerializableEnum {

	@ObfuscatedName("acw.e")
	public static final class772 field8907 = new class772(0);

	@ObfuscatedName("acw.n")
	public static final class772 field8908 = new class772(1);
