...
public abstract class Class98 {
	...
	@OriginalMember(owner = "client!bs", name = "<init>", descriptor = "(Lclient!afa;I[BIZ)V", line = 18)
	...
	@OriginalMember(owner = "client!bs", name = "<init>", descriptor = "(Lclient!afa;ILclient!jaclib/memory/Buffer;IZ)V", line = 30)
	Class98(@OriginalArg(0) Class104_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Buffer arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4) {
		...
		this.anInt444 = anIntArray36[0];
		this.method2752();
		OpenGL.glBufferDataARBa(arg1, this.anInt440, arg2.n(), this.aBoolean68 ? 35040 : 35044);
		this.aClass104_Sub1_23.anInt534 += this.anInt440;
	}

	@OriginalMember(owner = "client!bs", name = "c", descriptor = "([BI)V", line = 45)
	void method2748(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		this.method2752();
	...
	@OriginalMember(owner = "client!bs", name = "hl", descriptor = "()V", line = 55)
	void method2749() throws Throwable {
		if (!this.aBoolean69) {
			this.aClass104_Sub1_23.method3954(this.anInt444, this.anInt440);
			this.aBoolean69 = true;
		}
		super.finalize();
	}

	@OriginalMember(owner = "client!bs", name = "finalize", descriptor = "()V", line = 55)
	@Override
