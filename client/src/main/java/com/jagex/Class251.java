...
final class Class251 implements Interface23 {
	...
	@OriginalMember(owner = "client!et", name = "al", descriptor = "(Lclient!ec;)I", line = 41)
	@Override
	...
	@OriginalMember(owner = "client!et", name = "z", descriptor = "(I)Lclient!zl;", line = 122)
	public static Class709 method25968(@OriginalArg(0) int arg0) {
	...
	static void method25970(@OriginalArg(0) Class54_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		arg0.method14879(arg1, 1494441756);
		@Pc(10) byte local10;
		if (arg2 > 100000) {
			Class642.method32518((byte) 14);
			local10 = 4;
		} else if (arg2 > 50000) {
			Class586.method31636((byte) 46);
			local10 = 3;
		} else if (arg2 > 10000) {
			Class260.method26155(1522173328);
			local10 = 2;
		} else {
	...
	@OriginalMember(owner = "client!et", name = "pm", descriptor = "(Lclient!hf;Lclient!hq;Lclient!yf;I)V", line = 7741)
	static final void method25971(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
		...
		arg0.anObjectArray29 = Class499.method30149(local13, arg2, -619820294);
		arg0.aBoolean680 = true;
	}

	@OriginalMember(owner = "client!et", name = "ald", descriptor = "(Lclient!yf;I)V", line = 11893)
	static final void method25972(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		if (local12 >= 1 && local12 <= 2) {
			Class717.method36895(local12, -1, -1, false, (byte) 42);
		}
	}
