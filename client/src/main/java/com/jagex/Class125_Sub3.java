...
public final class Class125_Sub3 extends Class125 {
	...
	@OriginalMember(owner = "client!ahs", name = "f", descriptor = "(Lclient!alw;)Lclient!kp;")
	public static Class125 method10060(@OriginalArg(0) Class93_Sub41 arg0) {
	...
	@OriginalMember(owner = "client!ahs", name = "e", descriptor = "(I)V")
	static void method10061(@OriginalArg(0) int arg0) {
	}
	...
	static void method10063(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		for (@Pc(4) Class149_Sub6 local4 = (Class149_Sub6) client.aClass21_6.method390((short) 8345); local4 != null; local4 = (Class149_Sub6) client.aClass21_6.method377(-1915563430)) {
			if (client.anInt3485 >= local4.anInt1473 * -2062413229) {
				local4.method23778(-719770481);
			} else {
				Class166_Sub11.method15606(local4.anInt1476 * -280800109, (local4.anInt1472 * -374049833 << 9) + 256, (local4.anInt1474 * -965608087 << 9) + 256, 0, local4.anInt1475 * 1432638006, false, false, -1885279070);
				Class118_Sub1.aClass106_3.method7526(local4.aString43, (int) ((float) arg0 + client.aFloatArray93[0]), (int) (client.aFloatArray93[1] + (float) arg1), local4.anInt1477 * -1204675145 | 0xFF000000, 0, 1357185837);
			}
		}
	}

	@OriginalMember(owner = "client!ahs", name = "<init>", descriptor = "(Lclient!kv;Lclient!ky;IIIIIIIII)V")
	...
	@OriginalMember(owner = "client!ahs", name = "n", descriptor = "(S)Lclient!kt;")
	@Override
	public Class388 method28759(@OriginalArg(0) short arg0) {
		return Class388.aClass388_2;
	}

	@OriginalMember(owner = "client!ahs", name = "l", descriptor = "()Lclient!kt;")
	@Override
