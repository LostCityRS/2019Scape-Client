...
public final class Class614 {
	...
	@OriginalMember(owner = "client!vi", name = "n", descriptor = "(Lclient!alw;)Lclient!vt;")
	public static Interface67 method32247(@OriginalArg(0) Class93_Sub41 arg0) {
		@Pc(5) Class623 local5 = Class351.method27735(arg0.method22425((short) 16384), 1962594255);
		if (Class623.aClass623_2 == local5) {
			return Class632.method32476(arg0, -1105609638);
		} else if (local5 == Class623.aClass623_1) {
			return Class280.method26547(arg0, (byte) -123);
		} else if (Class623.aClass623_3 == local5) {
			return Class448.method29101(arg0, 1134570666);
		} else {
			return null;
		}
	}

	@OriginalMember(owner = "client!vi", name = "m", descriptor = "(Lclient!alw;)Lclient!vt;")
	public static Interface67 method32248(@OriginalArg(0) Class93_Sub41 arg0) {
		@Pc(5) Class623 local5 = Class351.method27735(arg0.method22425((short) 16384), 1962594255);
		if (Class623.aClass623_2 == local5) {
			return Class632.method32476(arg0, 132834097);
		} else if (local5 == Class623.aClass623_1) {
			return Class280.method26547(arg0, (byte) -68);
		} else if (Class623.aClass623_3 == local5) {
			return Class448.method29101(arg0, -307865580);
		} else {
			return null;
		}
	}

	@OriginalMember(owner = "client!vi", name = "hu", descriptor = "(Lclient!yf;I)V")
	static void method32249(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean884 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class12.method188(local11, local14, false, 0, arg0, 1691862116);
	}

	@OriginalMember(owner = "client!vi", name = "e", descriptor = "([FIFZFZ[FB)I")
	static int method32250(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) float arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) byte arg7) {
		...
		if (arg1 == 0) {
			...
			@Pc(225) int local225 = method32250(local190, arg1 - 1, arg2, false, arg4, false, local213, (byte) -88);
			if (local225 == -1) {
				return 0;
			}
			...
			for (@Pc(240) int local240 = 0; local240 <= local225; local240++) {
				...
				if (local240 == 0) {
					local253 = arg2;
					local236 = Class368.method28143(local41, arg1, arg2, (short) -219);
				...
				local234 = Class368.method28143(local41, arg1, local238, (short) -17300);
				if (local232) {
					local232 = false;
