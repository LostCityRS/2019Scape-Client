...
public class Class125_Sub2 extends Class125 {
	...
	@OriginalMember(owner = "client!ahp", name = "<init>", descriptor = "(Lclient!kv;Lclient!ky;IIIIIIIIIIIII)V", line = 14)
	...
	@OriginalMember(owner = "client!ahp", name = "l", descriptor = "()Lclient!kt;", line = 35)
	@Override
	public Class388 method28579() {
		return Class388.aClass388_7;
	}

	@OriginalMember(owner = "client!ahp", name = "n", descriptor = "(S)Lclient!kt;", line = 35)
	@Override
	public Class388 method28578(@OriginalArg(0) short arg0) {
		return Class388.aClass388_7;
	}

	@OriginalMember(owner = "client!ahp", name = "au", descriptor = "(IIIII)V", line = 245)
	static void method21464(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(4) Class93_Sub1_Sub11 local4 = Class371.method28000(8, (long) arg0);
		local4.method21886(2020440513);
		local4.anInt3020 = arg1 * 1415359557;
		local4.anInt3025 = arg2 * -302789657;
		local4.anInt3019 = arg3 * 1929524779;
	}

	@OriginalMember(owner = "client!ahp", name = "we", descriptor = "(Lclient!yf;I)V", line = 8975)
	static final void method21465(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		Class274.aClass258_1.method26098(Class275.aClass275_9, local13, local23, local43, Class280.aClass280_7.method26450(-1244463309), Class278.aClass278_2, 0.0F, 0.0F, null, 0, local53, local33, -1068855624);
	}

	@OriginalMember(owner = "client!ahp", name = "awu", descriptor = "(Lclient!yf;I)V", line = 13568)
	static final void method21466(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(2) long local2 = Class305.method26797(195487695);
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = (int) (local2 / 86400000L) - 11745;
	}
}
