...
public final class Class209 {
	...
	@OriginalMember(owner = "client!cp", name = "<init>", descriptor = "(Lclient!afa;)V")
	Class209(@OriginalArg(0) Class104_Sub1 arg0) {
		this.aClass104_Sub1_46 = arg0;
	}

	@OriginalMember(owner = "client!cp", name = "n", descriptor = "(Lclient!adu;Lclient!adu;F)Z")
	boolean method25498(@OriginalArg(0) Class88_Sub3 arg0, @OriginalArg(1) Class88_Sub3 arg1, @OriginalArg(2) float arg2) {
		if (!this.method25499()) {
			return false;
		}
		...
		local8.method23446(0, local20);
		if (local8.method23453()) {
			OpenGL.glPushMatrix();
			...
			for (@Pc(94) int local94 = 0; local94 < arg0.anInt315; local94++) {
				...
				this.aClass104_Sub1_46.method3804(arg1);
				OpenGL.glBegin(7);
		...
		local8.method23446(0, null);
		this.aClass104_Sub1_46.method20454(local8, -1497248091);
		return local22;
	}
	...
	boolean method25499() {
		if (this.aClass104_Sub1_46.aBoolean90 && this.aClass104_Sub1_46.aBoolean103 && this.aClass191_8 == null) {
			@Pc(16) Class190 local16 = Class190.method24597(this.aClass104_Sub1_46, 35632, "uniform float rcpRelief;\nuniform vec2 sampleSize;\nuniform sampler3D heightMap;\nvoid main() {\nfloat dx = texture3D(heightMap, vec3(-sampleSize.x, 0.0, 0.0)+gl_TexCoord[0].xyz).r - texture3D(heightMap, vec3(sampleSize.x, 0.0, 0.0)+gl_TexCoord[0].xyz).r;\nfloat dy = texture3D(heightMap, vec3(0.0, -sampleSize.y, 0.0)+gl_TexCoord[0].xyz).r - texture3D(heightMap, vec3(0.0, sampleSize.y, 0.0)+gl_TexCoord[0].xyz).r;\ngl_FragColor = vec4(0.5+normalize(vec3(dx, dy, rcpRelief))*0.5, texture3D(heightMap, gl_TexCoord[0].xyz).r);\n}\n");
			if (local16 != null) {
				this.aClass191_8 = Class191.method24602(this.aClass104_Sub1_46, new Class190[] { local16 });
			}
		}
	...
	@OriginalMember(owner = "client!cp", name = "f", descriptor = "(Lclient!adu;Lclient!adu;F)Z")
	boolean method25502(@OriginalArg(0) Class88_Sub3 arg0, @OriginalArg(1) Class88_Sub3 arg1, @OriginalArg(2) float arg2) {
		if (!this.method25499()) {
			return false;
		}
		@Pc(8) Class112_Sub1_Sub2 local8 = this.aClass104_Sub1_46.aClass112_Sub1_Sub2_1;
