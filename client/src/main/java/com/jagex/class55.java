...
public class class55 {
	...
	@ObfuscatedName("az.b")
	public float[] field842 = new float[class842.field9547];

	@ObfuscatedName("az.h")
	public float[] field843 = new float[class842.field9547];

	@ObfuscatedName("az.a")
	public float[] field844 = new float[class842.field9547];

	@ObfuscatedName("az.g")
	public float[] field864 = new float[class842.field9547];
	...
	public class842[] field830 = new class842[8];

	@ObfuscatedName("az.ap")
	public class842[] field862 = new class842[8];
	...
	public class55(class848 arg0) {
		this.field833 = arg0;
		this.field837 = new class65(arg0, this);
		for (int var2 = 0; var2 < 8; var2++) {
			this.field830[var2] = new class842(this.field833);
			this.field862[var2] = new class842(this.field833);
		}
		this.field851 = new int[class842.field9564];
		for (int var3 = 0; var3 < class842.field9564; var3++) {
	...
	public void method999() {
		this.field837 = new class65(this.field833, this);
	}
