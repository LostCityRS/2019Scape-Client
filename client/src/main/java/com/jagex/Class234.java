...
public class Class234 {
	...
	@OriginalMember(owner = "client!du", name = "<init>", descriptor = "(IIIIIB)V", line = 24)
	Class234(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) byte arg5) {
		this.anInt3767 = arg0 * -952453115;
		this.anInt3755 = arg1 * -2111330579;
		this.anInt3766 = arg2 * 513585415;
		this.anInt3758 = arg3 * 53989639;
		this.anInt3759 = arg4 * 1538465323;
		this.aByte111 = arg5;
	}

	@OriginalMember(owner = "client!du", name = "e", descriptor = "(Lclient!nb;B)Lclient!nj;", line = 34)
	public Class439 method25735(@OriginalArg(0) Interface46 arg0, @OriginalArg(1) byte arg1) {
		return arg0.method28821(this.anInt3767 * -343583539, -2016440903);
	}

	@OriginalMember(owner = "client!du", name = "m", descriptor = "(Lclient!nb;)Lclient!nj;", line = 34)
	public Class439 method25736(@OriginalArg(0) Interface46 arg0) {
		return arg0.method28821(this.anInt3767 * -343583539, -11623941);
	}

	@OriginalMember(owner = "client!du", name = "k", descriptor = "(Lclient!nb;)Lclient!nj;", line = 34)
	public Class439 method25737(@OriginalArg(0) Interface46 arg0) {
		return arg0.method28821(this.anInt3767 * -343583539, -226095254);
	}

	@OriginalMember(owner = "client!du", name = "f", descriptor = "(Lclient!nb;)Lclient!nj;", line = 34)
	public Class439 method25738(@OriginalArg(0) Interface46 arg0) {
		return arg0.method28821(this.anInt3767 * -343583539, 1181810277);
	}

	@OriginalMember(owner = "client!du", name = "n", descriptor = "(IIIIB)Lclient!du;", line = 38)
	Class234 method25739(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte arg4) {
		return new Class234(this.anInt3767 * -343583539, arg0, arg1, arg2, arg3, this.aByte111);
	}

	@OriginalMember(owner = "client!du", name = "w", descriptor = "(IIII)Lclient!du;", line = 38)
	Class234 method25740(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return new Class234(this.anInt3767 * -343583539, arg0, arg1, arg2, arg3, this.aByte111);
	}

	@OriginalMember(owner = "client!du", name = "l", descriptor = "(IIII)Lclient!du;", line = 38)
	Class234 method25741(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return new Class234(this.anInt3767 * -343583539, arg0, arg1, arg2, arg3, this.aByte111);
	}
	...
	@OriginalMember(owner = "client!du", name = "m", descriptor = "(B)V", line = 51)
	static void method25743(@OriginalArg(0) byte arg0) {
		Class173.aClass240_64.method25847((byte) -100);
	}
	...
	static void method25744(@OriginalArg(0) Class312 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		...
		arg0.aClass331_2.method27378(arg1, arg2, -2071842212);
	}

	@OriginalMember(owner = "client!du", name = "zp", descriptor = "(Lclient!yf;I)V", line = 9575)
	static final void method25745(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anInt5888 -= 957530791;
		arg0.anInt5891 -= -725861497;
		@Pc(20) String local20 = (String) arg0.anObjectArray45[arg0.anInt5888 * 587908375];
