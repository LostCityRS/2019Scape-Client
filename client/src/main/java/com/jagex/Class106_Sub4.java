...
public class Class106_Sub4 extends Class106 {
	...
	@OriginalMember(owner = "client!afs", name = "<init>", descriptor = "(Lclient!afa;Lclient!aac;Lclient!de;Z)V", line = 17)
	Class106_Sub4(@OriginalArg(0) Class104_Sub1 arg0, @OriginalArg(1) Class5 arg1, @OriginalArg(2) Class105 arg2, @OriginalArg(3) boolean arg3) {
		...
		if (arg3) {
			...
			this.aClass88_Sub2_Sub1_4 = Class88_Sub2_Sub1.method18106(arg0, Class206.aClass206_19, Class226.aClass226_22, this.aClass5_10.anInt12 * -2141347013, this.aClass5_10.anInt13 * -345881099, false, local38, Class206.aClass206_19);
			...
			this.aClass88_Sub2_Sub1_4 = Class88_Sub2_Sub1.method18103(arg0, this.aClass5_10.anInt12 * -2141347013, this.aClass5_10.anInt13 * -345881099, false, local19, 0, 0);
			this.aBoolean170 = false;
		}
		this.aClass88_Sub2_Sub1_4.method18040(this.aClass5_10.anInt11 * 286794121 != 1);
		...
		for (local43 = 0; local43 < 256; local43++) {
			local77 = arg1.method45(local43, (byte) -23);
			local85 = arg1.method46(local43, 1415476369);
			@Pc(355) short[] local355 = this.aClass5_10.method52(local43, 306054503);
			...
			@Pc(397) int local397 = this.aClass5_10.method49(local43, (byte) -84);
			this.aClass182_6.method24557(local43);
			OpenGL.glBegin(7);
			...
			OpenGL.glEnd();
			this.aClass182_6.method24559();
		}
	}

	@OriginalMember(owner = "client!afs", name = "s", descriptor = "(CIIIZ)V", line = 116)
	@Override
	void method7576(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4) {
		this.aClass104_Sub1_27.method3868();
		this.aClass104_Sub1_27.method3887(this.aClass88_Sub2_Sub1_4);
		if (this.aBoolean170 || arg4) {
			this.aClass104_Sub1_27.method3894(7681, 8448);
			this.aClass104_Sub1_27.method3898(0, 34168, 768);
		} else {
			this.aClass104_Sub1_27.method3894(7681, 7681);
		}
		OpenGL.glColor4ub((byte) (arg3 >> 16), (byte) (arg3 >> 8), (byte) arg3, (byte) (arg3 >> 24));
		OpenGL.glTranslatef((float) arg1, (float) arg2, 0.0F);
		this.aClass182_6.method24563(arg0);
		OpenGL.glLoadIdentity();
		if (this.aBoolean170 || arg4) {
			this.aClass104_Sub1_27.method3898(0, 5890, 768);
		}
	}

	@OriginalMember(owner = "client!afs", name = "b", descriptor = "(CIIIZ)V", line = 116)
	@Override
	...
	@OriginalMember(owner = "client!afs", name = "q", descriptor = "(CIIIZ)V", line = 116)
	@Override
	...
	@OriginalMember(owner = "client!afs", name = "x", descriptor = "(CIIIZ)V", line = 116)
	@Override
	...
	@OriginalMember(owner = "client!afs", name = "h", descriptor = "(CIIIZ)V", line = 116)
	@Override
	...
	@OriginalMember(owner = "client!afs", name = "y", descriptor = "(CIIIZLclient!ch;II)V", line = 131)
	@Override
	void method7577(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class96 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		...
		this.aClass104_Sub1_27.method3882(1);
		this.aClass104_Sub1_27.method3887(local5);
		this.aClass104_Sub1_27.method3894(7681, 8448);
		this.aClass104_Sub1_27.method3898(0, 34168, 768);
		...
		this.aClass104_Sub1_27.method3898(0, 5890, 768);
		this.aClass104_Sub1_27.method3894(8448, 8448);
		this.aClass104_Sub1_27.method3887(null);
		this.aClass104_Sub1_27.method3882(0);
		if (this.aBoolean170 || arg4) {
			this.aClass104_Sub1_27.method3898(0, 5890, 768);
		}
	}

	@OriginalMember(owner = "client!afs", name = "a", descriptor = "(CIIIZLclient!ch;II)V", line = 131)
	@Override
	...
	@OriginalMember(owner = "client!afs", name = "g", descriptor = "(CIIIZLclient!ch;II)V", line = 131)
	@Override
	...
	@OriginalMember(owner = "client!afs", name = "i", descriptor = "(CIIIZLclient!ch;II)V", line = 131)
	@Override
