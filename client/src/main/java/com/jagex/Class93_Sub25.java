...
public class Class93_Sub25 extends Class93 {
	...
	static final boolean aBoolean337 = false;
	...
	@OriginalMember(owner = "client!ako", name = "m", descriptor = "()V", line = 61)
	void method13787() {
		@Pc(2) Class212[] local2 = this.aClass212Array1;
		for (@Pc(4) int local4 = 0; local4 < local2.length; local4++) {
			@Pc(12) Class212 local12 = local2[local4];
			if (local12.anInt3600 * 703780279 >= 0) {
				local12.aClass212_1 = this.aClass212Array1[local12.anInt3600 * 703780279];
			}
		}
	}

	@OriginalMember(owner = "client!ako", name = "e", descriptor = "(I)V", line = 61)
	...
	@OriginalMember(owner = "client!ako", name = "n", descriptor = "()V", line = 61)
	void method13789() {
		@Pc(2) Class212[] local2 = this.aClass212Array1;
		for (@Pc(4) int local4 = 0; local4 < local2.length; local4++) {
			@Pc(12) Class212 local12 = local2[local4];
	...
	@OriginalMember(owner = "client!ako", name = "k", descriptor = "()V", line = 61)
	void method13790() {
		@Pc(2) Class212[] local2 = this.aClass212Array1;
		for (@Pc(4) int local4 = 0; local4 < local2.length; local4++) {
			@Pc(12) Class212 local12 = local2[local4];
