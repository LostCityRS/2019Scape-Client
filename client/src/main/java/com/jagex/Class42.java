...
public class Class42 {
	...
	@OriginalMember(owner = "client!abp", name = "<init>", descriptor = "(Lclient!abl;II)V", line = 19)
	public Class42(@OriginalArg(0) Class38 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws IOException {
		...
		this.aLong6 = (this.aLong4 = arg0.method732(1648608512) * -451821661113593867L) * -1558313948680994995L;
		this.aByteArray12 = new byte[arg1];
		this.aByteArray13 = new byte[arg2];
		this.aLong8 = 0L;
	}

	@OriginalMember(owner = "client!abp", name = "e", descriptor = "(I)V", line = 28)
	public void method818(@OriginalArg(0) int arg0) throws IOException {
		this.method836((byte) 0);
		this.aClass38_1.method728(-986398221);
	}

	@OriginalMember(owner = "client!abp", name = "n", descriptor = "(J)V", line = 33)
	public void method819(@OriginalArg(0) long arg0) throws IOException {
		if (arg0 < 0L) {
	...
	@OriginalMember(owner = "client!abp", name = "p", descriptor = "(J)V", line = 33)
	...
	@OriginalMember(owner = "client!abp", name = "z", descriptor = "(J)V", line = 33)
	public void method821(@OriginalArg(0) long arg0) throws IOException {
		if (arg0 < 0L) {
			throw new IOException("");
		}
		this.aLong8 = arg0 * -8636336681283858287L;
	...
	@OriginalMember(owner = "client!abp", name = "m", descriptor = "(B)J", line = 38)
	public long method822(@OriginalArg(0) byte arg0) {
		return this.aLong6 * -6213719775271939759L;
	}

	@OriginalMember(owner = "client!abp", name = "d", descriptor = "()J", line = 38)
	public long method823() {
		return this.aLong6 * -6213719775271939759L;
	}

	@OriginalMember(owner = "client!abp", name = "c", descriptor = "([B)V", line = 42)
	public void method824(@OriginalArg(0) byte[] arg0) throws IOException {
		this.method826(arg0, 0, arg0.length, -1661717816);
	}

	@OriginalMember(owner = "client!abp", name = "k", descriptor = "([BI)V", line = 42)
	public void method825(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) throws IOException {
		this.method826(arg0, 0, arg0.length, -1950267895);
	}

	@OriginalMember(owner = "client!abp", name = "f", descriptor = "([BIII)V", line = 47)
	public void method826(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) throws IOException {
		try {
			...
			if (arg2 > this.aByteArray12.length) {
				this.aClass38_1.method720(this.aLong8 * -132147995563560847L);
				this.aLong9 = this.aLong8 * -297616410474490659L;
				while (arg2 > 0) {
					local129 = this.aClass38_1.method734(arg0, arg1, arg2, (byte) 92);
					if (local129 == -1) {
						break;
					}
	...
	@OriginalMember(owner = "client!abp", name = "r", descriptor = "([BII)V", line = 47)
	public void method827(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws IOException {
		try {
			if (arg1 + arg2 > arg0.length) {
				throw new ArrayIndexOutOfBoundsException(arg2 + arg1 - arg0.length);
			}
			...
			if (arg2 > this.aByteArray12.length) {
				...
				this.aLong9 = this.aLong8 * -297616410474490659L;
				while (arg2 > 0) {
					local129 = this.aClass38_1.method734(arg0, arg1, arg2, (byte) 53);
					if (local129 == -1) {
						break;
					}
					this.aLong9 += (long) local129 * -4777806551621951187L;
	...
	@OriginalMember(owner = "client!abp", name = "v", descriptor = "([BII)V", line = 47)
	public void method828(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws IOException {
		try {
			if (arg1 + arg2 > arg0.length) {
				throw new ArrayIndexOutOfBoundsException(arg2 + arg1 - arg0.length);
			}
			...
			if (arg2 > this.aByteArray12.length) {
				...
				this.aLong9 = this.aLong8 * -297616410474490659L;
				while (arg2 > 0) {
					local129 = this.aClass38_1.method734(arg0, arg1, arg2, (byte) 31);
					if (local129 == -1) {
						break;
					}
					this.aLong9 += (long) local129 * -4777806551621951187L;
	...
	@OriginalMember(owner = "client!abp", name = "o", descriptor = "([BII)V", line = 47)
	public void method829(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws IOException {
		try {
			...
			if (arg2 > this.aByteArray12.length) {
				...
				this.aLong9 = this.aLong8 * -297616410474490659L;
				while (arg2 > 0) {
					local129 = this.aClass38_1.method734(arg0, arg1, arg2, (byte) 105);
					if (local129 == -1) {
						break;
					}
					this.aLong9 += (long) local129 * -4777806551621951187L;
	...
	@OriginalMember(owner = "client!abp", name = "s", descriptor = "()V", line = 128)
	void method830() throws IOException {
		this.anInt131 = 0;
		...
		while (this.anInt131 * 1716434415 < this.aByteArray12.length) {
			...
			@Pc(65) int local65 = this.aClass38_1.method734(this.aByteArray12, this.anInt131 * 1716434415, local48, (byte) 21);
			if (local65 == -1) {
				break;
			}
	...
	@OriginalMember(owner = "client!abp", name = "y", descriptor = "()V", line = 128)
	void method831() throws IOException {
		this.anInt131 = 0;
		if (this.aLong8 * -132147995563560847L != this.aLong9 * -9152026569603950939L) {
			this.aClass38_1.method720(this.aLong8 * -132147995563560847L);
			this.aLong9 = this.aLong8 * -297616410474490659L;
		...
		while (this.anInt131 * 1716434415 < this.aByteArray12.length) {
			...
			@Pc(65) int local65 = this.aClass38_1.method734(this.aByteArray12, this.anInt131 * 1716434415, local48, (byte) -58);
			if (local65 == -1) {
				break;
			}
			this.aLong9 += (long) local65 * -4777806551621951187L;
	...
	@OriginalMember(owner = "client!abp", name = "x", descriptor = "()V", line = 128)
	void method832() throws IOException {
		this.anInt131 = 0;
		if (this.aLong8 * -132147995563560847L != this.aLong9 * -9152026569603950939L) {
			this.aClass38_1.method720(this.aLong8 * -132147995563560847L);
			this.aLong9 = this.aLong8 * -297616410474490659L;
	...
	@OriginalMember(owner = "client!abp", name = "w", descriptor = "(B)V", line = 128)
	void method833(@OriginalArg(0) byte arg0) throws IOException {
		this.anInt131 = 0;
		if (this.aLong8 * -132147995563560847L != this.aLong9 * -9152026569603950939L) {
			this.aClass38_1.method720(this.aLong8 * -132147995563560847L);
			this.aLong9 = this.aLong8 * -297616410474490659L;
		...
		while (this.anInt131 * 1716434415 < this.aByteArray12.length) {
			...
			@Pc(65) int local65 = this.aClass38_1.method734(this.aByteArray12, this.anInt131 * 1716434415, local48, (byte) -3);
			if (local65 == -1) {
				break;
			}
			this.aLong9 += (long) local65 * -4777806551621951187L;
	...
	@OriginalMember(owner = "client!abp", name = "q", descriptor = "()V", line = 128)
	void method834() throws IOException {
		...
		while (this.anInt131 * 1716434415 < this.aByteArray12.length) {
			...
			@Pc(65) int local65 = this.aClass38_1.method734(this.aByteArray12, this.anInt131 * 1716434415, local48, (byte) 22);
			if (local65 == -1) {
				break;
			}
			this.aLong9 += (long) local65 * -4777806551621951187L;
	...
	@OriginalMember(owner = "client!abp", name = "l", descriptor = "([BIII)V", line = 146)
	public void method835(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) throws IOException {
		try {
			...
			if (arg2 > this.aByteArray13.length) {
				...
				this.aClass38_1.method725(arg0, arg1, arg2, -1945672715);
	...
	@OriginalMember(owner = "client!abp", name = "u", descriptor = "(B)V", line = 203)
	void method836(@OriginalArg(0) byte arg0) throws IOException {
		...
		if (this.aLong7 * 5576541888797144539L != this.aLong9 * -9152026569603950939L) {
			this.aClass38_1.method720(this.aLong7 * 5576541888797144539L);
			this.aLong9 = this.aLong7 * 4877476641905341055L;
		}
		this.aClass38_1.method725(this.aByteArray13, 0, this.anInt132 * -966644267, -1699446791);
	...
	@OriginalMember(owner = "client!abp", name = "a", descriptor = "()V", line = 203)
	void method837() throws IOException {
		...
		this.aClass38_1.method725(this.aByteArray13, 0, this.anInt132 * -966644267, 1542220357);
		this.aLong9 += (long) this.anInt132 * -4132142083450567823L;
		if (this.aLong9 * -9152026569603950939L > this.aLong4 * 8757058546879407197L) {
			this.aLong4 = this.aLong9 * 8238481981032781545L;
		}
	...
	@OriginalMember(owner = "client!abp", name = "g", descriptor = "()V", line = 203)
	void method838() throws IOException {
		...
		this.aClass38_1.method725(this.aByteArray13, 0, this.anInt132 * -966644267, 528709178);
		this.aLong9 += (long) this.anInt132 * -4132142083450567823L;
		if (this.aLong9 * -9152026569603950939L > this.aLong4 * 8757058546879407197L) {
			this.aLong4 = this.aLong9 * 8238481981032781545L;
		}
	...
	@OriginalMember(owner = "client!abp", name = "b", descriptor = "()V", line = 203)
	void method839() throws IOException {
		if (this.aLong7 * 5576541888797144539L == -1L) {
			return;
		}
		if (this.aLong7 * 5576541888797144539L != this.aLong9 * -9152026569603950939L) {
		...
		this.aClass38_1.method725(this.aByteArray13, 0, this.anInt132 * -966644267, -1612413244);
		this.aLong9 += (long) this.anInt132 * -4132142083450567823L;
		if (this.aLong9 * -9152026569603950939L > this.aLong4 * 8757058546879407197L) {
			this.aLong4 = this.aLong9 * 8238481981032781545L;
		}
	...
	@OriginalMember(owner = "client!abp", name = "h", descriptor = "()V", line = 203)
	void method840() throws IOException {
		...
		this.aClass38_1.method725(this.aByteArray13, 0, this.anInt132 * -966644267, -1191342186);
		this.aLong9 += (long) this.anInt132 * -4132142083450567823L;
		if (this.aLong9 * -9152026569603950939L > this.aLong4 * 8757058546879407197L) {
			this.aLong4 = this.aLong9 * 8238481981032781545L;
		}
	...
	@OriginalMember(owner = "client!abp", name = "f", descriptor = "(Lclient!dn;[F[FB)V", line = 221)
	static void method841(@OriginalArg(0) Class230 arg0, @OriginalArg(1) float[] arg1, @OriginalArg(2) float[] arg2, @OriginalArg(3) byte arg3) {
		...
		if ((double) local38 > 1.0D || local43 < -1.0F) {
			Class342.method27508(local38, local43, (byte) -75);
		}
		if (local38 != local61) {
		...
		Class670.method32955(0.0F, local38, local43, 1.0F, arg0.aFloatArray99, 752351645);
		Class670.method32955(arg2[0], arg2[1], arg2[2], arg2[3], arg0.aFloatArray97, 7399556);
	}
}
