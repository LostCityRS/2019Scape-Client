...
public class class843 extends class116 {
	...
	public class83 field9659;

	@ObfuscatedName("afk.ay")
	public class83 field9665;

	@ObfuscatedName("afk.ab")
	public class83 field9673;

	@ObfuscatedName("afk.az")
	public class83 field9664;

	@ObfuscatedName("afk.aa")
	public class82 field9663;

	@ObfuscatedName("afk.af")
	public class98 field9654;

	@ObfuscatedName("afk.ak")
	public class79 field9655;
	...
	public class96[] field9656;

	@ObfuscatedName("afk.bz")
	public class80[] field9639;
	...
	public class843(class849 arg0, class120 arg1, int arg2, int arg3, int arg4, int arg5) {
		...
		for (int var14 = 0; var14 < this.field9670 * -1431655765; var14++) {
			...
			if (arg1.field1396 != null) {
				...
				if (var30 != -1) {
					...
					if ((this.field9628 & 0x40) != 0 && var16.field1342) {
						var30 = -1;
						var16 = null;
					} else {
		...
		if (arg1.field1412 != null) {
			...
			for (int var37 = 0; var37 < this.field9660; var37++) {
				...
				this.field9656[var37] = new class96(var40, arg1.field1415[var38.field1654], arg1.field1386[var38.field1654], arg1.field1400[var38.field1654], var39.field3451, var39.field3452, var39.field3455, var39.field3450, var39.field3453, var39.field3456, var39.field3449, var38.field1656);
				this.field9639[var37] = new class80(var43);
			}
		}
		...
		class142 var48 = this.method1687(arg1, var9, this.field9670 * -1431655765);
		...
		for (int var72 = 0; var72 < this.field9670 * -1431655765; var72++) {
			...
			if (var76 != -1 && (this.field9628 & 0x40) != 0 && var7.method2043(var76).field1342) {
				var76 = -1;
			}
			float var77 = 0.0F;
			float var78 = 0.0F;
	...
	public class116 method15550(class843 arg0, class843 arg1, int arg2, boolean arg3, boolean arg4) {
		...
		if (class72.method1128(arg2, this.field9628)) {
			...
			if (this.field9684 == null) {
				...
				if (arg1.field9684 == null) {
					arg1.field9684 = new class95();
				}
				class95 var14 = arg0.field9684 = arg1.field9684;
		...
		if (!class72.method1134(arg2, this.field9628)) {
			...
			arg0.field9639 = arg1.field9639 = new class80[var25];
							...
							for (int var39 = 0; var39 < var7; var39++) {
								if (var8[var39] == var33 && var10[var39] == var34 && var9[var39] == var32) {
									...
									if (var40 != -1) {
										...
										if (var19 == null) {
											class95 var44 = var6.field9684 = new class95();
	...
	public void method1859(short arg0, short arg1) {
		...
		if (this.field9656 != null) {
			for (int var4 = 0; var4 < this.field9660; var4++) {
				class96 var5 = this.field9656[var4];
				class80 var6 = this.field9639[var4];
	...
	public void method1744(short arg0, short arg1) {
		...
		if (this.field9656 != null) {
			for (int var11 = 0; var11 < this.field9660; var11++) {
				class96 var12 = this.field9656[var11];
				class80 var13 = this.field9639[var11];
	...
	public void method1745(int arg0, int arg1, int arg2, int arg3) {
		...
		if (this.field9656 != null) {
			for (int var10 = 0; var10 < this.field9660; var10++) {
				class96 var11 = this.field9656[var10];
				class80 var12 = this.field9639[var10];
			...
			if (this.field9649 != null) {
				...
				if (this.field9656 != null) {
					for (int var183 = 0; var183 < this.field9660; var183++) {
						class96 var184 = this.field9656[var183];
						class80 var185 = this.field9639[var183];
			...
			if (this.field9649 != null) {
				...
				if (this.field9656 != null) {
					for (int var198 = 0; var198 < this.field9660; var198++) {
						class96 var199 = this.field9656[var198];
						class80 var200 = this.field9639[var198];
				...
				for (int var201 = 0; var201 < var9; var201++) {
					...
					if (var202 < this.field9686.length) {
						...
						for (int var204 = 0; var204 < var203.length; var204++) {
							class80 var205 = this.field9639[var203[var204]];
				...
				for (int var206 = 0; var206 < var9; var206++) {
					...
					if (var207 < this.field9686.length) {
						...
						for (int var209 = 0; var209 < var208.length; var209++) {
							class80 var210 = this.field9639[var208[var209]];
			...
			for (int var211 = 0; var211 < var9; var211++) {
				...
				if (var212 < this.field9686.length) {
					...
					for (int var214 = 0; var214 < var213.length; var214++) {
						class80 var215 = this.field9639[var213[var214]];
		...
		if (arg0 == 0) {
			...
			if (this.field9656 != null) {
				for (int var21 = 0; var21 < this.field9660; var21++) {
					class96 var22 = this.field9656[var21];
					class80 var23 = this.field9639[var21];
			...
			if (this.field9656 != null) {
				for (int var32 = 0; var32 < this.field9660; var32++) {
					class96 var33 = this.field9656[var32];
					class80 var34 = this.field9639[var32];
			...
			if (this.field9649 != null) {
				...
				if (this.field9656 != null) {
					for (int var80 = 0; var80 < this.field9660; var80++) {
						class96 var81 = this.field9656[var80];
						class80 var82 = this.field9639[var80];
			...
			if (this.field9649 != null) {
				...
				if (this.field9656 != null) {
					for (int var95 = 0; var95 < this.field9660; var95++) {
						class96 var96 = this.field9656[var95];
						class80 var97 = this.field9639[var95];
				...
				for (int var98 = 0; var98 < var8; var98++) {
					...
					if (var99 < this.field9686.length) {
						...
						for (int var101 = 0; var101 < var100.length; var101++) {
							class80 var102 = this.field9639[var100[var101]];
				...
				for (int var103 = 0; var103 < var8; var103++) {
					...
					if (var104 < this.field9686.length) {
						...
						for (int var106 = 0; var106 < var105.length; var106++) {
							class80 var107 = this.field9639[var105[var106]];
			...
			for (int var108 = 0; var108 < var8; var108++) {
				...
				if (var109 < this.field9686.length) {
					...
					for (int var111 = 0; var111 < var110.length; var111++) {
						class80 var112 = this.field9639[var110[var111]];
	...
	public void method1689(class419 arg0) {
		...
		if (this.field9687 != null) {
			for (int var3 = 0; var3 < this.field9687.length; var3++) {
				...
				var5.field1470 = (int) (var2.field4315[8] * (float) this.field9619[var4.field1476] + var2.field4315[0] * (float) this.field9636[var4.field1476] + var2.field4315[4] * (float) this.field9637[var4.field1476] + var2.field4315[12]);
				var5.field1474 = (int) (var2.field4315[9] * (float) this.field9619[var4.field1476] + var2.field4315[1] * (float) this.field9636[var4.field1476] + var2.field4315[5] * (float) this.field9637[var4.field1476] + var2.field4315[13]);
				var5.field1472 = (int) (var2.field4315[10] * (float) this.field9619[var4.field1476] + var2.field4315[2] * (float) this.field9636[var4.field1476] + var2.field4315[6] * (float) this.field9637[var4.field1476] + var2.field4315[14]);
				var5.field1473 = (int) (var2.field4315[8] * (float) this.field9619[var4.field1467] + var2.field4315[0] * (float) this.field9636[var4.field1467] + var2.field4315[4] * (float) this.field9637[var4.field1467] + var2.field4315[12]);
				var5.field1469 = (int) (var2.field4315[9] * (float) this.field9619[var4.field1467] + var2.field4315[1] * (float) this.field9636[var4.field1467] + var2.field4315[5] * (float) this.field9637[var4.field1467] + var2.field4315[13]);
				var5.field1475 = (int) (var2.field4315[10] * (float) this.field9619[var4.field1467] + var2.field4315[2] * (float) this.field9636[var4.field1467] + var2.field4315[6] * (float) this.field9637[var4.field1467] + var2.field4315[14]);
				var5.field1464 = (int) (var2.field4315[8] * (float) this.field9619[var4.field1468] + var2.field4315[0] * (float) this.field9636[var4.field1468] + var2.field4315[4] * (float) this.field9637[var4.field1468] + var2.field4315[12]);
				var5.field1466 = (int) (var2.field4315[9] * (float) this.field9619[var4.field1468] + var2.field4315[1] * (float) this.field9636[var4.field1468] + var2.field4315[5] * (float) this.field9637[var4.field1468] + var2.field4315[13]);
				var5.field1478 = (int) (var2.field4315[10] * (float) this.field9619[var4.field1468] + var2.field4315[2] * (float) this.field9636[var4.field1468] + var2.field4315[6] * (float) this.field9637[var4.field1468] + var2.field4315[14]);
			}
		}
		...
		for (int var6 = 0; var6 < this.field9641.length; var6++) {
			...
			var8.field1226 = (int) (var2.field4315[8] * (float) this.field9619[var7.field1225] + var2.field4315[0] * (float) this.field9636[var7.field1225] + var2.field4315[4] * (float) this.field9637[var7.field1225] + var2.field4315[12]);
			var8.field1229 = (int) (var2.field4315[9] * (float) this.field9619[var7.field1225] + var2.field4315[1] * (float) this.field9636[var7.field1225] + var2.field4315[5] * (float) this.field9637[var7.field1225] + var2.field4315[13]);
			var8.field1227 = (int) (var2.field4315[10] * (float) this.field9619[var7.field1225] + var2.field4315[2] * (float) this.field9636[var7.field1225] + var2.field4315[6] * (float) this.field9637[var7.field1225] + var2.field4315[14]);
		}
	}
	...
	public boolean method1725(int arg0, int arg1, class419 arg2, boolean arg3, int arg4) {
		...
		for (int var24 = 0; var24 < 8; var24++) {
			...
			float var28 = var6.field4315[10] * (float) var27 + var6.field4315[2] * (float) var25 + var6.field4315[6] * (float) var26 + var6.field4315[14];
			float var29 = var6.field4315[11] * (float) var27 + var6.field4315[3] * (float) var25 + var6.field4315[7] * (float) var26 + var6.field4315[15];
			if (var28 >= -var29) {
				float var30 = var6.field4315[8] * (float) var27 + var6.field4315[0] * (float) var25 + var6.field4315[4] * (float) var26 + var6.field4315[12];
				float var31 = var6.field4315[9] * (float) var27 + var6.field4315[1] * (float) var25 + var6.field4315[5] * (float) var26 + var6.field4315[13];
		...
		if (var7 && arg0 > var8 && arg0 < var9 && arg1 > var10 && arg1 < var11) {
			...
			for (int var36 = 0; var36 < this.field9635; var36++) {
				...
				float var40 = var6.field4315[10] * (float) var39 + var6.field4315[2] * (float) var37 + var6.field4315[6] * (float) var38 + var6.field4315[14];
				float var41 = var6.field4315[11] * (float) var39 + var6.field4315[3] * (float) var37 + var6.field4315[7] * (float) var38 + var6.field4315[15];
				if (var40 >= -var41) {
					float var42 = var6.field4315[8] * (float) var39 + var6.field4315[0] * (float) var37 + var6.field4315[4] * (float) var38 + var6.field4315[12];
					float var43 = var6.field4315[9] * (float) var39 + var6.field4315[1] * (float) var37 + var6.field4315[5] * (float) var38 + var6.field4315[13];
	...
	public void method1813(class419 arg0, class141 arg1, int arg2) {
		...
		if (arg1 != null) {
			...
			if (var19) {
				if (var27 / var28 > var34 / var35) {
					float var44 = var4.field4315[0] * (float) this.field9668 + var25 + var4.field4315[12];
					float var45 = var4.field4315[3] * (float) this.field9668 + var28 + var4.field4315[15];
					arg1.field1687 = (int) (this.field9626.field9867 * var44 / var45 + (this.field9626.field9910 - (float) arg1.field1683));
				} else {
					float var46 = var4.field4315[0] * (float) this.field9668 + var32 + var4.field4315[12];
					float var47 = var4.field4315[3] * (float) this.field9668 + var35 + var4.field4315[15];
		...
		var5.method6720(this.field9626.field9903);
	...
	public void method15557(class426 arg0) {
		...
		for (int var3 = 0; var3 < this.field9660; var3++) {
			class96 var4 = this.field9656[var3];
			class80 var5 = this.field9639[var3];
			if (!var4.field1200 || !this.field9626.method2242()) {
				...
				float var9 = arg0.field4315[8] * var8 + arg0.field4315[0] * var6 + arg0.field4315[4] * var7 + arg0.field4315[12];
				float var10 = arg0.field4315[9] * var8 + arg0.field4315[1] * var6 + arg0.field4315[5] * var7 + arg0.field4315[13];
				float var11 = arg0.field4315[10] * var8 + arg0.field4315[2] * var6 + arg0.field4315[6] * var7 + arg0.field4315[14];
	...
	public void method15553(boolean arg0) {
		if (this.field9626.field10016.field11502.length < this.field9650 * 6) {
			this.field9626.field10016 = new class1189((this.field9650 + 100) * 6);
		} else {
			this.field9626.field10016.field11503 = 0;
		}
		class1189 var2 = this.field9626.field10016;
		if (this.field9626.field10017) {
			for (int var3 = 0; var3 < this.field9650; var3++) {
				var2.method17945(this.field9653[var3]);
				var2.method17945(this.field9652[var3]);
				var2.method17945(this.field9646[var3]);
			}
		} else {
			for (int var4 = 0; var4 < this.field9650; var4++) {
				var2.method17884(this.field9653[var4]);
				var2.method17884(this.field9652[var4]);
				var2.method17884(this.field9646[var4]);
			}
		}
		if (var2.field11503 * 212851357 == 0) {
			return;
		}
		if (arg0) {
			if (this.field9654 == null) {
				this.field9654 = this.field9626.method15766(5123, var2.field11502, var2.field11503 * 212851357, true);
			} else {
				this.field9654.method1410(5123, var2.field11502, var2.field11503 * 212851357);
			}
			this.field9663.field1109 = this.field9654;
		} else {
			this.field9663.field1109 = this.field9626.method15766(5123, var2.field11502, var2.field11503 * 212851357, false);
		}
		if (!arg0) {
			this.field9666 = true;
		}
	...
	public void method15558(boolean arg0) {
		...
		if (this.field9626.field10016.field11502.length < this.field9658 * var6) {
			...
			if (this.field9626.field10017) {
				for (int var12 = 0; var12 < this.field9635; var12++) {
					...
					for (int var18 = var16; var18 < var17 && this.field9680[var18] != 0; var18++) {
						...
						var11.field11503 = var6 * var19 * -1445626955;
						var11.method17886(var13);
						var11.method17886(var14);
						var11.method17886(var15);
					}
				}
			} else {
				for (int var20 = 0; var20 < this.field9635; var20++) {
					...
					for (int var26 = var24; var26 < var25 && this.field9680[var26] != 0; var26++) {
						...
						var11.field11503 = var6 * var27 * -1445626955;
						var11.method17887(var21);
						var11.method17887(var22);
						var11.method17887(var23);
					}
				}
			}
		}
		if (var2) {
			if (this.field9673 == null) {
				...
				for (int var38 = 0; var38 < this.field9670 * -1431655765; var38++) {
					...
					var11.field11503 = (var6 * var43 + var8) * -1445626955;
					var11.method18001(var47);
					var11.method18001(var48);
					var11.method18001(var49);
					var11.method18001(255 - (this.field9683[var38] & 0xFF));
					...
					var11.field11503 = (var6 * var50 + var8) * -1445626955;
					var11.method18001(var54);
					var11.method18001(var55);
					var11.method18001(var56);
					var11.method18001(255 - (this.field9683[var38] & 0xFF));
					...
					var11.field11503 = (var6 * var57 + var8) * -1445626955;
					var11.method18001(var61);
					var11.method18001(var62);
					var11.method18001(var63);
					var11.method18001(255 - (this.field9683[var38] & 0xFF));
				}
			} else {
				for (int var64 = 0; var64 < this.field9670 * -1431655765; var64++) {
					...
					var11.field11503 = ((this.field9653[var64] & 0xFFFF) * var6 + var8) * -1445626955;
					var11.method17886(var65);
					var11.field11503 = ((this.field9652[var64] & 0xFFFF) * var6 + var8) * -1445626955;
					var11.method17886(var65);
					var11.field11503 = ((this.field9646[var64] & 0xFFFF) * var6 + var8) * -1445626955;
					var11.method17886(var65);
				}
			}
		}
		if (var3) {
			...
			var11.field11503 = var9 * -1445626955;
			if (this.field9626.field10017) {
				for (int var72 = 0; var72 < this.field9658; var72++) {
					...
					var11.field11503 += (var6 - 12) * -1445626955;
				}
			} else {
		...
		if (var5) {
			...
			if (this.field9626.field10017) {
				for (int var78 = 0; var78 < this.field9658; var78++) {
					...
					var11.field11503 += (var6 - 8) * -1445626955;
				}
			} else {
		...
		var11.field11503 = this.field9658 * var6 * -1445626955;
		class79 var80;
		if (arg0) {
			if (this.field9655 == null) {
				this.field9655 = this.field9626.method15767(var6, var11.field11502, var11.field11503 * 212851357, true);
			} else {
				this.field9655.method1286(var6, var11.field11502, var11.field11503 * 212851357);
			}
			var80 = this.field9655;
			this.field9629 = 0;
		} else {
			var80 = this.field9626.method15767(var6, var11.field11502, var11.field11503 * 212851357, false);
			this.field9666 = true;
		}
		if (var4) {
