...
public class Class93_Sub34 extends Class93 {
	...
	@OriginalMember(owner = "client!akx", name = "<init>", descriptor = "(Lclient!afc;Lclient!aem;Lclient!akf;[I)V", line = 30)
	Class93_Sub34(@OriginalArg(0) Class104_Sub2 arg0, @OriginalArg(1) Class99_Sub3 arg1, @OriginalArg(2) Class93_Sub16 arg2, @OriginalArg(3) int[] arg3) {
		...
		@Pc(31) int local31 = this.aClass93_Sub16_2.method13528((byte) -58) - (arg1.anInt412 * -1678286317 >> 1);
		...
		this.anInt1629 = this.aClass93_Sub16_2.method13524(1625548853) - local31 >> arg1.anInt415 * -373302705;
		this.anInt1624 = this.aClass93_Sub16_2.method13524(1076320910) + local31 >> arg1.anInt415 * -373302705;
			...
			if (local136 > 0 && local136 < this.aClass99_Sub3_2.anInt413 * -143202029 - 1) {
				for (local149 = 0; local149 <= local91; local149++) {
					...
					if (local157 > 0 && local157 < this.aClass99_Sub3_2.anInt414 * -1667858293 - 1) {
						local184 = arg1.method2480(local157 + 1, local136, -207336516) - arg1.method2480(local157 - 1, local136, -1639608102);
						local200 = arg1.method2480(local157, local136 + 1, -1245380983) - arg1.method2480(local157, local136 - 1, -1611995219);
		...
		if (this.anInt1628 > 0) {
			this.aClass16_12 = new Class16(Class134_Sub2.method10207(this.anInt1628, (byte) 86));
						...
						if (local184 >= 0 && local184 < arg1.anInt414 * -1667858293) {
							...
							if (local447 != null && local200 != 0) {
								if (local200 == 1) {
									...
									label110: while (true) {
										while (true) {
											...
											if (local447[local470] == -1 || local447[local470 + 1] == -1 || local447[local470 + 2] == -1) {
												...
												this.method13955(local157, local136, local184, local149, local461[local470], local468[local470]);
												local470++;
												this.method13955(local157, local136, local184, local149, local461[local470], local468[local470]);
												local470++;
												this.method13955(local157, local136, local184, local149, local461[local470], local468[local470]);
									...
									this.method13955(local157, local136, local184, local149, 0, 0);
									this.method13955(local157, local136, local184, local149, arg1.anInt412 * -1678286317, 0);
									this.method13955(local157, local136, local184, local149, 0, arg1.anInt412 * -1678286317);
								} else if (local200 == 2) {
									this.method13955(local157, local136, local184, local149, arg1.anInt412 * -1678286317, 0);
									this.method13955(local157, local136, local184, local149, arg1.anInt412 * -1678286317, arg1.anInt412 * -1678286317);
									this.method13955(local157, local136, local184, local149, 0, 0);
								} else if (local200 == 5) {
									this.method13955(local157, local136, local184, local149, arg1.anInt412 * -1678286317, arg1.anInt412 * -1678286317);
									this.method13955(local157, local136, local184, local149, 0, arg1.anInt412 * -1678286317);
	...
	@OriginalMember(owner = "client!akx", name = "e", descriptor = "()V", line = 158)
	void method13952() {
		this.anInterface40_2 = this.aClass104_Sub2_27.method21165(false);
		this.anInterface40_2.method29351(this.anInt1623);
		this.anInterface37_11 = this.aClass104_Sub2_27.method21174(false);
		this.anInterface37_11.method29315(this.anInt1627 * 16, 16);
		this.anInterface37_11.method29333(0, this.anInt1627 * 16, this.aClass104_Sub2_27.aLong132);
		this.anInterface40_2.method29333(0, this.anInt1623 * 2, this.aClass104_Sub2_27.aLong132 + (long) (this.aClass104_Sub2_27.anInt2915 >> 1));
	}

	@OriginalMember(owner = "client!akx", name = "f", descriptor = "()V", line = 158)
	void method13953() {
		this.anInterface40_2 = this.aClass104_Sub2_27.method21165(false);
		this.anInterface40_2.method29351(this.anInt1623);
		this.anInterface37_11 = this.aClass104_Sub2_27.method21174(false);
	...
	@OriginalMember(owner = "client!akx", name = "w", descriptor = "()V", line = 158)
	void method13954() {
		this.anInterface40_2 = this.aClass104_Sub2_27.method21165(false);
		this.anInterface40_2.method29351(this.anInt1623);
		this.anInterface37_11 = this.aClass104_Sub2_27.method21174(false);
	...
	@OriginalMember(owner = "client!akx", name = "n", descriptor = "(IIIIII)V", line = 167)
	void method13955(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		@Pc(1) long local1 = -1L;
		...
		@Pc(28) int local28 = this.aClass99_Sub3_2.method2473(local11, local21, 704489502);
		if ((arg4 & 0x7F) == 0 || (arg5 & 0x7F) == 0) {
			local1 = ((long) local21 & 0xFFFFL) << 16 | (long) local11 & 0xFFFFL;
			@Pc(53) Class93 local53 = this.aClass16_12.method214(local1);
			if (local53 != null) {
		...
		if (local1 != -1L) {
			this.aClass16_12.method220(new Class93_Sub20(local91), local1);
		}
		...
		local278 = this.aClass93_Sub16_2.method13524(1481646966) - local21;
		local285 = (float) Math.sqrt((double) (local261 * local261 + local271 * local271 + local278 * local278));
		local292 = 1.0F / local285;
		local261 *= local292;
		local271 *= local292;
		local278 *= local292;
		local301 = local285 / (float) this.aClass93_Sub16_2.method13528((byte) -63);
		...
		@Pc(549) int local549 = this.aClass93_Sub16_2.method13532((byte) -50);
	...
	@OriginalMember(owner = "client!akx", name = "l", descriptor = "(IIIIII)V", line = 167)
	void method13956(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		@Pc(1) long local1 = -1L;
		@Pc(11) int local11 = arg4 + (arg2 << this.aClass99_Sub3_2.anInt415 * -373302705);
		@Pc(21) int local21 = arg5 + (arg3 << this.aClass99_Sub3_2.anInt415 * -373302705);
		@Pc(28) int local28 = this.aClass99_Sub3_2.method2473(local11, local21, 1612666417);
		if ((arg4 & 0x7F) == 0 || (arg5 & 0x7F) == 0) {
			local1 = ((long) local21 & 0xFFFFL) << 16 | (long) local11 & 0xFFFFL;
			@Pc(53) Class93 local53 = this.aClass16_12.method214(local1);
			if (local53 != null) {
		...
		local271 = this.aClass93_Sub16_2.method13521(1655674161) - local28;
		local278 = this.aClass93_Sub16_2.method13524(1887853384) - local21;
		local285 = (float) Math.sqrt((double) (local261 * local261 + local271 * local271 + local278 * local278));
		local292 = 1.0F / local285;
		local261 *= local292;
		local271 *= local292;
		local278 *= local292;
		local301 = local285 / (float) this.aClass93_Sub16_2.method13528((byte) -117);
		local310 = 1.0F - local301 * local301;
		if (local310 < 0.0F) {
			local310 = 0.0F;
		}
		...
		@Pc(549) int local549 = this.aClass93_Sub16_2.method13532((byte) -26);
		@Pc(559) int local559 = (int) (local538 * (float) (local549 >> 16 & 0xFF));
		if (local559 > 255) {
			local559 = 255;
		}
	...
	@OriginalMember(owner = "client!akx", name = "p", descriptor = "(Lclient!jj;III[[ZZ)V", line = 268)
	void method13957(@OriginalArg(0) Class131 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean[][] arg4, @OriginalArg(5) boolean arg5) {
				...
				if (local36 - arg1 >= -arg3 && local36 - arg1 <= arg3) {
					for (@Pc(54) int local54 = this.anInt1629; local54 <= this.anInt1624; local54++) {
						if (local54 - arg2 >= -arg3 && local54 - arg2 <= arg3 && arg4[local36 - arg1 + arg3][local54 - arg2 + arg3]) {
							this.method13961(arg0, this.anInterface40_2, this.anInt1623 / 3);
							return;
						}
					}
				}
		...
		while (true) {
			if (local110 > this.anInt1624) {
				...
				@Pc(212) Interface40 local212 = this.aClass104_Sub2_27.method20957(local110 / 2);
				local212.method29333(0, local110, this.aClass104_Sub2_27.aLong132);
				this.method13961(arg0, local212, local36 / 3);
				break;
			}
	...
	@OriginalMember(owner = "client!akx", name = "m", descriptor = "(Lclient!jj;III[[ZZ)V", line = 268)
	void method13958(@OriginalArg(0) Class131 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean[][] arg4, @OriginalArg(5) boolean arg5) {
		if (this.anInterface40_2 == null || (this.anInt1626 > arg1 + arg3 || (this.anInt1625 < arg1 - arg3 || (this.anInt1629 > arg2 + arg3 || this.anInt1624 < arg2 - arg3)))) {
			return;
		}
		@Pc(36) int local36;
	...
	@OriginalMember(owner = "client!akx", name = "u", descriptor = "(Lclient!jj;III[[ZZ)V", line = 268)
	void method13959(@OriginalArg(0) Class131 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean[][] arg4, @OriginalArg(5) boolean arg5) {
		if (this.anInterface40_2 == null || (this.anInt1626 > arg1 + arg3 || (this.anInt1625 < arg1 - arg3 || (this.anInt1629 > arg2 + arg3 || this.anInt1624 < arg2 - arg3)))) {
			return;
		}
		@Pc(36) int local36;
	...
	@OriginalMember(owner = "client!akx", name = "z", descriptor = "(Lclient!jj;III[[ZZ)V", line = 268)
	...
	@OriginalMember(owner = "client!akx", name = "k", descriptor = "(Lclient!jj;Lclient!ml;I)V", line = 315)
	void method13961(@OriginalArg(0) Class131 arg0, @OriginalArg(1) Interface40 arg1, @OriginalArg(2) int arg2) {
		arg0.anInt1140 = 0;
		...
		@Pc(25) float local25 = this.aClass93_Sub16_2.method13535(1820491933);
		arg0.aClass472_38.method29549(local25, local25, local25);
		this.aClass104_Sub2_27.method21187(0, this.anInterface37_11);
		this.aClass104_Sub2_27.method21208(this.aClass104_Sub2_27.aClass145_22);
		this.aClass104_Sub2_27.method21180(this.anInterface40_2);
		arg0.method10104(0);
	}

	@OriginalMember(owner = "client!akx", name = "d", descriptor = "(Lclient!jj;Lclient!ml;I)V", line = 315)
	void method13962(@OriginalArg(0) Class131 arg0, @OriginalArg(1) Interface40 arg1, @OriginalArg(2) int arg2) {
		...
		arg0.anInt1137 = this.anInt1623 / 3;
		arg0.anInterface38_18 = this.aClass104_Sub2_27.anInterface38_23;
		@Pc(25) float local25 = this.aClass93_Sub16_2.method13535(-327131268);
		arg0.aClass472_38.method29549(local25, local25, local25);
		this.aClass104_Sub2_27.method21187(0, this.anInterface37_11);
		this.aClass104_Sub2_27.method21208(this.aClass104_Sub2_27.aClass145_22);
		this.aClass104_Sub2_27.method21180(this.anInterface40_2);
	...
	@OriginalMember(owner = "client!akx", name = "c", descriptor = "(Lclient!jj;Lclient!ml;I)V", line = 315)
	void method13963(@OriginalArg(0) Class131 arg0, @OriginalArg(1) Interface40 arg1, @OriginalArg(2) int arg2) {
		...
		arg0.anInt1137 = this.anInt1623 / 3;
		arg0.anInterface38_18 = this.aClass104_Sub2_27.anInterface38_23;
		@Pc(25) float local25 = this.aClass93_Sub16_2.method13535(2009973564);
		arg0.aClass472_38.method29549(local25, local25, local25);
		this.aClass104_Sub2_27.method21187(0, this.anInterface37_11);
		this.aClass104_Sub2_27.method21208(this.aClass104_Sub2_27.aClass145_22);
		this.aClass104_Sub2_27.method21180(this.anInterface40_2);
