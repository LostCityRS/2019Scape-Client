...
public class Class93_Sub1_Sub7 extends Class93_Sub1 {
	...
	@OriginalMember(owner = "client!arm", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZJZ)V", line = 2017)
	Class93_Sub1_Sub7(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) long arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) boolean arg8, @OriginalArg(9) boolean arg9, @OriginalArg(10) long arg10, @OriginalArg(11) boolean arg11) {
		...
		this.aBoolean503 = arg9;
		this.aLong155 = arg10 * -6942167405982365783L;
		this.aBoolean504 = arg11;
	}

	@OriginalMember(owner = "client!arm", name = "m", descriptor = "()J", line = 2033)
	public long method21701() {
		return this.aLong154 * 3050087486000948885L;
	}

	@OriginalMember(owner = "client!arm", name = "e", descriptor = "(I)J", line = 2033)
	public long method21702(@OriginalArg(0) int arg0) {
		return this.aLong154 * 3050087486000948885L;
	}

	@OriginalMember(owner = "client!arm", name = "n", descriptor = "(I)J", line = 2037)
	public long method21703(@OriginalArg(0) int arg0) {
