...
public class Class199 {
	...
	@OriginalMember(owner = "client!bz", name = "e", descriptor = "(Lclient!afa;)V", line = 25)
	static void method24626(@OriginalArg(0) Class104_Sub1 arg0) {
		@Pc(11) byte[] local11;
		if (anObject11 == null) {
			@Pc(5) Class140_Sub1_Sub1 local5 = new Class140_Sub1_Sub1();
			local11 = local5.method20259(128, 128, 16);
			anObject11 = Class113.method7407(local11, false, 1215292027);
		}
		if (anObject10 == null) {
			@Pc(22) Class140_Sub2_Sub1 local22 = new Class140_Sub2_Sub1();
			local11 = local22.method20291(128, 128, 16);
			anObject10 = Class113.method7407(local11, false, 1215292027);
		}
		@Pc(36) Class209 local36 = arg0.aClass209_1;
		if (local36.method25405() && anObject12 == null) {
			local11 = Class571.method31325(128, 128, 16, 8, new Class161_Sub1(419684), 4.0F, 4.0F, 16.0F, 0.5F, 0.6F);
			anObject12 = Class113.method7407(local11, false, 1215292027);
		}
	}

	@OriginalMember(owner = "client!bz", name = "m", descriptor = "(Lclient!afa;)V", line = 25)
	static void method24627(@OriginalArg(0) Class104_Sub1 arg0) {
		@Pc(11) byte[] local11;
		if (anObject11 == null) {
			@Pc(5) Class140_Sub1_Sub1 local5 = new Class140_Sub1_Sub1();
			local11 = local5.method20259(128, 128, 16);
	...
	@OriginalMember(owner = "client!bz", name = "n", descriptor = "(Lclient!afa;)V", line = 25)
	static void method24628(@OriginalArg(0) Class104_Sub1 arg0) {
		@Pc(11) byte[] local11;
		if (anObject11 == null) {
			@Pc(5) Class140_Sub1_Sub1 local5 = new Class140_Sub1_Sub1();
			local11 = local5.method20259(128, 128, 16);
	...
	@OriginalMember(owner = "client!bz", name = "<init>", descriptor = "(Lclient!afa;)V", line = 42)
	Class199(@OriginalArg(0) Class104_Sub1 arg0) {
		this.aBoolean577 = arg0.aBoolean75;
		method24626(arg0);
		if (this.aBoolean577) {
			@Pc(103) byte[] local103 = Class331.method27374(anObject11, false, 479524276);
			...
			@Pc(121) byte[] local121 = Class331.method27374(anObject10, false, -207172829);
			...
			if (local137.method25405()) {
				local103 = Class331.method27374(anObject12, false, -1609051994);
				...
				if (local137.method25408(this.aClass88_Sub3_1, local168, 2.0F)) {
					this.aClass88_Sub3_1.method18046();
				} else {
					this.aClass88_Sub3_1.method18055();
					this.aClass88_Sub3_1 = null;
				}
				local168.method18055();
			}
		} else {
			...
			for (local31 = 0; local31 < 16; local31++) {
				local42 = Class441.method28854(anObject11, local31 * 32768, 32768, 1048575);
			...
			for (local31 = 0; local31 < 16; local31++) {
				local42 = Class441.method28854(anObject10, local31 * 32768, 32768, 1048575);
