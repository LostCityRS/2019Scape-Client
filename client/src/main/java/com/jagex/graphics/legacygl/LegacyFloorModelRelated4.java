...
@ObfuscatedName("bt")
public class LegacyFloorModelRelated4 {

	@ObfuscatedName("bt.m")
	public final LegacyOpenGLRenderer field990;

	@ObfuscatedName("bt.k")
	public final LegacyFloorModelRelated3 field995;
	...
	@ObfuscatedName("bt.p")
	public LegacyOpenGLBinding field997;

	@ObfuscatedName("bt.d")
	public LegacyFloorModelRelated2_Sub1 field998;

	@ObfuscatedName("bt.c")
	public LegacyOpenGLRelated field999;

	public LegacyFloorModelRelated4(LegacyOpenGLRenderer arg0, LegacyFloorModelRelated3 arg1, LegacyOpenGLFloorModel arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
		this.field990 = arg0;
		this.field995 = arg1;
		this.field991 = arg6;
		this.field992 = arg7;
		...
		if (var10 > 0) {
			...
			this.field998 = new LegacyFloorModelRelated2_Sub1(this.field990, 5123, null, 1);
		} else {
			this.field999 = null;
		}
	}
	...
	public void method1073(LegacyOpenGLBinding arg0, int arg1) {
		if (arg1 != 0) {
			this.method1069();
	...
	public void method1069() {
		...
		if (this.field999 == null) {
			this.field999 = new LegacyOpenGLRelated(this.field990, 3553, TextureFormat.ALPHA, DataType.UNSIGNED_INT_8, 128, 128, false, this.field990.field10020, TextureFormat.ALPHA, false);
