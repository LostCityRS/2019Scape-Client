...
@ObfuscatedName("bm")
public class LegacyOpenGLShader {
	...
	public static LegacyOpenGLShader method1120(LegacyOpenGLRenderer arg0, int arg1, String arg2) {
		...
		return new LegacyOpenGLShader(arg0, var3, arg1);
	}

	public LegacyOpenGLShader(LegacyOpenGLRenderer arg0, int arg1, int arg2) {
		this.field1018 = arg0;
		this.field1019 = arg1;
	}
