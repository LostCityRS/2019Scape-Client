...
@ObfuscatedName("aqi")
public class LegacyColourRemappingFilter extends PostProcessingFilter {
	...
	public static LegacyOpenGLColourRemapper[] field12179 = new LegacyOpenGLColourRemapper[] { null, null, null };

	@ObfuscatedName("aqi.q")
	public LegacyOpenGLProgram[] field12185 = null;

	public LegacyColourRemappingFilter(LegacyOpenGLRenderer arg0) {
		super(arg0);
	}
	...
	public boolean method17534() {
		...
		this.field12185 = new LegacyOpenGLProgram[3];
		if (this.field11270.field9889) {
			this.field12185[0] = LegacyOpenGLProgram.method1065(this.field11270, new LegacyOpenGLShader[] { LegacyOpenGLShader.method1120(this.field11270, 35632, "#extension GL_ARB_texture_rectangle : enable\nuniform vec4 paramsWeightings;\nuniform sampler2DRect sceneTex;\nuniform sampler3D remap_1, remap_2, remap_3, remap_4;\n\n".concat("void main() {\n\tvec3 col = texture2DRect(sceneTex, gl_TexCoord[0].xy).xyz;\n\tcol = clamp(col,0.0,1.0);\n\tvec3 outCol = col * paramsWeightings.x;\n\t//Clamp the colour coords so we sample correctly\n\tfloat minC = 0.03125; // 0.5/16.0\n\tfloat maxC = 0.96875; // 1.0-(0.5/16.0)\n\tcol = mix(vec3(minC,minC,minC), vec3(maxC,maxC,maxC), col);\n\n\toutCol += texture3D(remap_1, col).rgb * paramsWeightings.y;\n\n\tgl_FragColor = vec4(outCol, 1.0);\n}\n")) });
			this.field12185[1] = LegacyOpenGLProgram.method1065(this.field11270, new LegacyOpenGLShader[] { LegacyOpenGLShader.method1120(this.field11270, 35632, "#extension GL_ARB_texture_rectangle : enable\nuniform vec4 paramsWeightings;\nuniform sampler2DRect sceneTex;\nuniform sampler3D remap_1, remap_2, remap_3, remap_4;\n\n".concat("void main() {\n\tvec3 col = texture2DRect(sceneTex, gl_TexCoord[0].xy).xyz;\n\tcol = clamp(col,0.0,1.0);\n\tvec3 outCol = col * paramsWeightings.x;\n\t//Clamp the colour coords so we sample correctly\n\tfloat minC = 0.03125; // 0.5/16.0\n\tfloat maxC = 0.96875; // 1.0-(0.5/16.0)\n\tcol = mix(vec3(minC,minC,minC), vec3(maxC,maxC,maxC), col);\n\n\toutCol += texture3D(remap_1, col).rgb * paramsWeightings.y;\n\toutCol += texture3D(remap_2, col).rgb * paramsWeightings.z;\n\n\tgl_FragColor = vec4(outCol, 1.0);\n}\n")) });
			this.field12185[2] = LegacyOpenGLProgram.method1065(this.field11270, new LegacyOpenGLShader[] { LegacyOpenGLShader.method1120(this.field11270, 35632, "#extension GL_ARB_texture_rectangle : enable\nuniform vec4 paramsWeightings;\nuniform sampler2DRect sceneTex;\nuniform sampler3D remap_1, remap_2, remap_3, remap_4;\n\n".concat("void main() {\n\tvec3 col = texture2DRect(sceneTex, gl_TexCoord[0].xy).xyz;\n\tcol = clamp(col,0.0,1.0);\n\tvec3 outCol = col * paramsWeightings.x;\n\t//Clamp the colour coords so we sample correctly\n\tfloat minC = 0.03125; // 0.5/16.0\n\tfloat maxC = 0.96875; // 1.0-(0.5/16.0)\n\tcol = mix(vec3(minC,minC,minC), vec3(maxC,maxC,maxC), col);\n\n\toutCol += texture3D(remap_1, col).rgb * paramsWeightings.y;\n\toutCol += texture3D(remap_2, col).rgb * paramsWeightings.z;\n\toutCol += texture3D(remap_3, col).rgb * paramsWeightings.w;\n\n\tgl_FragColor = vec4(outCol, 1.0);\n}\n")) });
	...
	public void method17537(int arg0, LegacyOpenGLRelated arg1, LegacyOpenGLRelated arg2, int arg3, int arg4) {
		...
		for (int var7 = field12175 - 1; var7 >= 0; var7--) {
			if (field12179[var7] != null) {
				...
				LegacyOpenGLTexture var8 = field12179[var7].method15425();
				if (var8 != null) {
