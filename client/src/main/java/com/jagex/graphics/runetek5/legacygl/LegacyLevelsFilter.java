...
@ObfuscatedName("aqo")
public class LegacyLevelsFilter extends PostProcessingFilter {
	...
	public LegacyOpenGLProgram field12169;

	public LegacyLevelsFilter(LegacyOpenGLRenderer arg0) {
		super(arg0);
	}
