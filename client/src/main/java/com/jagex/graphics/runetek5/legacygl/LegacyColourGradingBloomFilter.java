...
import com.jagex.graphics.runetek5.PostProcessingFilter;
import com.jagex.TextureFormat;
import deob.ObfuscatedName;
import jaggl.OpenGL;

@ObfuscatedName("aqf")
public class LegacyColourGradingBloomFilter extends PostProcessingFilter {
	...
	public LegacyOpenGLRelated field12196;

	@ObfuscatedName("aqf.y")
	public LegacyOpenGLRelated field12197;

	@ObfuscatedName("aqf.q")
	public LegacyOpenGLRelated[] field12193;
	...
	public LegacyOpenGLProgram field12203;

	@ObfuscatedName("aqf.i")
	public LegacyOpenGLProgram field12204;

	@ObfuscatedName("aqf.j")
	public LegacyOpenGLProgram field12192;

	@ObfuscatedName("aqf.t")
	public LegacyOpenGLProgram field12206;

	public LegacyColourGradingBloomFilter(LegacyOpenGLRenderer arg0) {
		super(arg0);
	}
	...
	public boolean method17534() {
		...
		this.field11270.method2143(this.field12194);
		this.field12206 = LegacyOpenGLProgram.method1065(this.field11270, new LegacyOpenGLShader[] { LegacyOpenGLShader.method1120(this.field11270, 35632, "#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n") });
		this.field12192 = LegacyOpenGLProgram.method1065(this.field11270, new LegacyOpenGLShader[] { LegacyOpenGLShader.method1120(this.field11270, 35632, "uniform vec3 params;\nuniform sampler2D sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2D(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n") });
		this.field12204 = LegacyOpenGLProgram.method1065(this.field11270, new LegacyOpenGLShader[] { LegacyOpenGLShader.method1120(this.field11270, 35632, "#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform vec3 dimScale;\nuniform sampler2D bloomTex;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n\t vec4 bloomCol = texture2D(bloomTex, gl_TexCoord[1].xy);\n\t vec4 sceneCol = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n\t float preLum = 0.99*dot(lumCoef, sceneCol.rgb)+0.01;\n    float postLum = preLum*(1.0+(preLum/params.y))/(preLum+1.0);\n\t gl_FragColor = clamp(sceneCol*(postLum/preLum)+bloomCol*params.x,0.0,1.0);\n}\n") });
		this.field12203 = LegacyOpenGLProgram.method1065(this.field11270, new LegacyOpenGLShader[] { LegacyOpenGLShader.method1120(this.field11270, 35632, "uniform vec3 step;\nuniform sampler2D baseTex;\nvoid main() {\n\tvec4 fragCol = texture2D(baseTex, gl_TexCoord[0].xy)*0.091396265;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-8.0*step.xy))*0.012369139;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 8.0*step.xy))*0.012369139;\n\tgl_FragColor = fragCol;\n}\n") });
		...
		if (var3 <= 256 && var4 <= 256) {
			...
			label61: while (true) {
				if (var6 <= 256 && var7 <= 256) {
					...
					this.field12193 = new LegacyOpenGLRelated[var8];
					int var9 = var3;
					int var10 = var4;
					int var11 = 0;
					while (true) {
