...
@ObfuscatedName("bu")
public class LegacyShaderCompiler {
	...
	public static LegacyShaderCompiler method1271(LegacyOpenGLRenderer arg0, int arg1, String arg2) {
		...
		if (field1022[0] == -1) {
			...
			return new LegacyShaderCompiler(arg0, arg1, var3);
		} else {
			OpenGL.glBindProgramARB(arg1, 0);
			return null;
		}
	...
	public LegacyShaderCompiler(LegacyOpenGLRenderer arg0, int arg1, int arg2) {
		this.field1023 = arg0;
		this.field1024 = arg2;
	}
