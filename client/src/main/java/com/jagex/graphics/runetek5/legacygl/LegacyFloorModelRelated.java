...
import com.jagex.Material;
import com.jagex.Node;
import com.jagex.WaterFogData;
...
@ObfuscatedName("akn")
public class LegacyFloorModelRelated extends Node {
	...
	public LegacyRelated2 field11298;

	@ObfuscatedName("akn.p")
	public LegacyFloorModelRelated2_Sub1 field11297;
	...
	public LegacyFloorModelRelated(LegacyOpenGLFloorModel arg0, int arg1, int arg2, WaterFogData arg3) {
		...
		this.field11297 = new LegacyFloorModelRelated2_Sub1(this.field11291, 5123, null, 1);
	}
	...
	public void method17597(int arg0) {
		...
		LegacyInterfaceRelated var2 = this.field11291.method15804(4, this.field11299, arg0 * 4, false);
		if (var2 instanceof LegacyFloorRelated6) {
			this.field11299.method81();
		}
		this.field11298 = new LegacyRelated2(var2, 5121, 4, 0);
