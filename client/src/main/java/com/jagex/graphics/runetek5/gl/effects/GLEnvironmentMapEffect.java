...
import com.jagex.*;
import com.jagex.graphics.runetek5.RenderList;
import com.jagex.graphics.runetek5.legacygl.LegacyOpenGLCubeTexture;
...
public class GLEnvironmentMapEffect extends GlEffect {
	...
	public LegacyOpenGLCubeTexture[] field9338;

	public GLEnvironmentMapEffect(LegacyOpenGLRenderer arg0) {
		super(arg0);
		if (arg0.field9952) {
			...
			this.field9338 = new LegacyOpenGLCubeTexture[3];
			this.field9338[0] = new LegacyOpenGLCubeTexture(this.field1021, TextureFormat.ALPHA, DataType.UNSIGNED_INT_8, 128, false, var3, TextureFormat.ALPHA);
			this.field9338[1] = new LegacyOpenGLCubeTexture(this.field1021, TextureFormat.ALPHA, DataType.UNSIGNED_INT_8, 128, false, var4, TextureFormat.ALPHA);
			this.field9338[2] = new LegacyOpenGLCubeTexture(this.field1021, TextureFormat.ALPHA, DataType.UNSIGNED_INT_8, 128, false, var2, TextureFormat.ALPHA);
			this.method15349();
		}
	}
