...
@ObfuscatedName("ajr")
public class LegacyFloorModelRelated5 extends Node {
	...
	public final LegacyOpenGLBinding field11281;

	@ObfuscatedName("ajr.v")
	public final LegacyInterfaceRelated field11282;

	@ObfuscatedName("ajr.o")
	public final LegacyRelated2 field11283;

	@ObfuscatedName("ajr.s")
	public final LegacyRelated2 field11284;
	...
	public LegacyFloorModelRelated5(LegacyOpenGLRenderer arg0, LegacyOpenGLFloorModel arg1, Light arg2, int[] arg3) {
		...
		if (this.field11280 > 0) {
			...
			this.field11283 = new LegacyRelated2(this.field11282, 5126, 3, 0);
			this.field11284 = new LegacyRelated2(this.field11282, 5121, 4, 12);
		} else {
