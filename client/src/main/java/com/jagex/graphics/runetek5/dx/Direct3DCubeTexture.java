...
import com.jagex.graphics.runetek5.GpuCubeTexture;
...
@ObfuscatedName("aif")
public class Direct3DCubeTexture extends Direct3DBaseTexture implements GpuCubeTexture {

	@ObfuscatedName("aif.w")
	public final int field10676;

	public Direct3DCubeTexture(Direct3DRenderer arg0, int arg1, boolean arg2, int[][] arg3) {
		super(arg0, TextureFormat.field1273, DataType.UNSIGNED_INT_8, arg2 && arg0.field11967, arg1 * arg1 * 6);
