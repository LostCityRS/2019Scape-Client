...
import com.jagex.DualLink;
import com.jagex.IntMath;
import com.jagex.Particle;
...
@ObfuscatedName("cu")
public class LegacyRendererRelated {
	...
	@ObfuscatedName("cu.m")
	public LegacyInterfaceRelated field1134;

	@ObfuscatedName("cu.k")
	public LegacyRelated2 field1135;

	@ObfuscatedName("cu.f")
	public LegacyRelated2 field1136;

	@ObfuscatedName("cu.w")
	public LegacyRelated2 field1143;
	...
	public void method1323(LegacyOpenGLRenderer arg0) {
		...
		this.field1143 = new LegacyRelated2(this.field1134, 5126, 2, 0);
		this.field1135 = new LegacyRelated2(this.field1134, 5126, 3, 8);
		this.field1136 = new LegacyRelated2(this.field1134, 5121, 4, 20);
	}
