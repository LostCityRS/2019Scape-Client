...
public class FontMetrics {
	...
	public final FontIconProvider field8575;

	@ObfuscatedName("cz.e(Lpy;III)Laac;")
	public static FontMetrics method1593(Js5 arg0, int arg1, int arg2) {
		return method6068(arg0, arg1, arg2, null);
	}

	@ObfuscatedName("nr.n(Lpy;IILaaw;I)Laac;")
	public static FontMetrics method6068(Js5 arg0, int arg1, int arg2, FontIconProvider arg3) {
		byte[] var4 = arg0.method6879(arg1, arg2);
		return var4 == null ? null : new FontMetrics(var4, arg3);
	}

	@ObfuscatedName("yr.m(Lpy;ILaaw;I)Laac;")
	public static FontMetrics method10677(Js5 arg0, int arg1, FontIconProvider arg2) {
					...
					if (var9.equals("lt")) {
						...
						if (!var9.equals("reg")) {
							if (var9.startsWith("img=") && arg1 != null) {
								try {
									int var10 = StringUtils.method9595(var9.substring(4));
							...
							if (var9.startsWith("sprite=") && this.field8575 != null) {
								try {
									...
									int var14;
									if (var13 == -1) {
										var14 = StringUtils.method9595(var9.substring(7));
									} else {
										var14 = StringUtils.method9595(var9.substring(7, var13));
									}
					...
					if (var12.equals("lt")) {
						...
						if (!var12.equals("reg")) {
							if (var12.startsWith("img=") && arg2 != null) {
								try {
									int var13 = StringUtils.method9595(var12.substring(4));
							...
							if (var12.startsWith("sprite=") && this.field8575 != null) {
								try {
									...
									int var17;
									if (var16 == -1) {
										var17 = StringUtils.method9595(var12.substring(7));
									} else {
										var17 = StringUtils.method9595(var12.substring(7, var16));
									}
			...
			if (var16 == 60) {
				...
				if (var11 == -1) {
					...
					if (var19.equals("lt")) {
						...
						try {
							int var20 = StringUtils.method9595(var19.substring(4));
						...
						try {
							...
							int var24;
							if (var23 == -1) {
								var24 = StringUtils.method9595(var19.substring(7));
							} else {
								var24 = StringUtils.method9595(var19.substring(7, var23));
							}
