...
import com.jagex.HardShadow;
import com.jagex.graphics.runetek5.GpuPacket;
import deob.ObfuscatedName;
import jaggl.OpenGL;

@ObfuscatedName("ci")
public class LegacyFloorModelRelated3 {
	...
	@ObfuscatedName("ci.z")
	public LegacyFloorModelRelated4[][] field1158;

	public LegacyFloorModelRelated3(LegacyOpenGLRenderer arg0, LegacyOpenGLFloorModel arg1) {
		this.field1155 = arg0;
		this.field1151 = arg1;
	...
	public void method1337() {
		this.field1158 = new LegacyFloorModelRelated4[this.field1153][this.field1150];
		for (int var1 = 0; var1 < this.field1150; var1++) {
			for (int var2 = 0; var2 < this.field1153; var2++) {
				this.field1158[var2][var1] = new LegacyFloorModelRelated4(this.field1155, this, this.field1151, var2, var1, this.field1157, var2 * 128 + 1, var1 * 128 + 1);
			}
		}
	}
	...
	public void method1343(int arg0, int arg1, int arg2, int arg3) {
		...
		for (int var9 = var5; var9 <= var6; var9++) {
			LegacyFloorModelRelated4[] var10 = this.field1158[var9];
