...
import com.jagex.graphics.runetek5.PostProcessingRelated;
import com.jagex.TextureFormat;
import deob.ObfuscatedName;
import jaggl.OpenGL;

@ObfuscatedName("cp")
public class LegacyEffectRelated5 {
	...
	public LegacyEffectRelated5(LegacyOpenGLRenderer arg0) {
		this.field1183 = arg0;
	}
	...
	public boolean method1391() {
		if (this.field1183.field9985 && this.field1183.field10002 && this.field1182 == null) {
			LegacyOpenGLShader var1 = LegacyOpenGLShader.method1120(this.field1183, 35632, "uniform float rcpRelief;\nuniform vec2 sampleSize;\nuniform sampler3D heightMap;\nvoid main() {\nfloat dx = texture3D(heightMap, vec3(-sampleSize.x, 0.0, 0.0)+gl_TexCoord[0].xyz).r - texture3D(heightMap, vec3(sampleSize.x, 0.0, 0.0)+gl_TexCoord[0].xyz).r;\nfloat dy = texture3D(heightMap, vec3(0.0, -sampleSize.y, 0.0)+gl_TexCoord[0].xyz).r - texture3D(heightMap, vec3(0.0, sampleSize.y, 0.0)+gl_TexCoord[0].xyz).r;\ngl_FragColor = vec4(0.5+normalize(vec3(dx, dy, rcpRelief))*0.5, texture3D(heightMap, gl_TexCoord[0].xyz).r);\n}\n");
			if (var1 != null) {
				this.field1182 = LegacyOpenGLProgram.method1065(this.field1183, new LegacyOpenGLShader[] { var1 });
			}
		}
	...
	public boolean method1390(LegacyColourRemapperRelated arg0, LegacyColourRemapperRelated arg1, float arg2) {
		if (!this.method1391()) {
			return false;
		}
		LegacyOpenGLFramebuffer var4 = this.field1183.field9877;
		PostProcessingRelated var5 = new PostProcessingRelated(this.field1183, TextureFormat.field1273, DataType.UNSIGNED_INT_8, arg0.field9269, arg0.field9268);
		boolean var6 = false;
