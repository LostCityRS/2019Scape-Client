...
public class EffectInterfaceRelated implements FrameBufferInterface {
	...
	public EffectInterfaceRelated(Direct3DRenderer arg0, DataType arg1, int arg2, int arg3, int arg4) {
		this.field4238 = arg0;
		this.field4236 = arg2;
		this.field4235 = arg3;
		this.field4234 = arg1;
		this.field4237 = IDirect3DDevice.CreateDepthStencilSurface(this.field4238.device, arg2, arg3, Direct3DRenderer.getD3DFormatForDataType(this.field4234), arg4, 0, false);
