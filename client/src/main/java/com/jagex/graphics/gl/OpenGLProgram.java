...
public class OpenGLProgram extends Program {
	...
	public OpenGLProgramManager glProgram;
	...
	public OpenGLProgram(OpenGLRenderer glRenderer, OpenGLProgramManager glProgram, ProgramData programData) {
		this(glRenderer, programData);
		this.glProgram = glProgram;
		this.glRenderer = glRenderer;
	}

	public OpenGLProgram(OpenGLRenderer glRenderer, ProgramData programData) {
		this.field10373 = 0;
