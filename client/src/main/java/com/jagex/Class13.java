...
public final class Class13 {
	...
	@OriginalMember(owner = "client!aak", name = "<init>", descriptor = "()V", line = 44)
	Class13() {
	}

	@OriginalMember(owner = "client!aak", name = "n", descriptor = "(CLclient!zt;I)C", line = 69)
	static char method190(@OriginalArg(0) char arg0, @OriginalArg(1) Class717 arg1, @OriginalArg(2) int arg2) {
		if (arg0 >= 'À' && arg0 <= 'ÿ') {
			if (arg0 >= 'À' && arg0 <= 'Æ') {
				return 'A';
			}
	...
	@OriginalMember(owner = "client!aak", name = "afp", descriptor = "(Lclient!yf;I)V", line = 10625)
	static final void method191(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = local13.indexOf(local27, local37);
	}
}
