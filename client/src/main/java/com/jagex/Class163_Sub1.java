...
public class Class163_Sub1 extends Class163 {
	...
	void method14918() {
		...
		local14.aClass93_Sub41_Sub2_1.method22406(local4.method22875(-1678286317) | local4.method22876((byte) -36) << 16, (byte) -2);
		local14.aClass93_Sub41_Sub2_1.method22595(this.method14908(local4, 65535, 1398211098), (byte) 27);
		local14.aClass93_Sub41_Sub2_1.method22573(local4.method22896(181202022) << 1 | local4.method22894(1461818217) & 0x1, -1591808004);
	...
	void method14920(@OriginalArg(0) int arg0) {
		...
		local14.aClass93_Sub41_Sub2_1.method22406(local4.method22875(-1678286317) | local4.method22876((byte) -101) << 16, (byte) 101);
		local14.aClass93_Sub41_Sub2_1.method22595(this.method14908(local4, 65535, -226537743), (byte) -65);
		local14.aClass93_Sub41_Sub2_1.method22573(local4.method22896(1235421580) << 1 | local4.method22894(1584031211) & 0x1, -1591808004);
	...
	void method14919() {
		...
		local14.aClass93_Sub41_Sub2_1.method22406(local4.method22875(-1678286317) | local4.method22876((byte) -26) << 16, (byte) -40);
		local14.aClass93_Sub41_Sub2_1.method22595(this.method14908(local4, 65535, 1718512283), (byte) 33);
		local14.aClass93_Sub41_Sub2_1.method22573(local4.method22896(-1693652945) << 1 | local4.method22894(886727591) & 0x1, -1591808004);
	...
	void method14849(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) Class93_Sub23_Sub2 arg1, @OriginalArg(2) int arg2) {
		arg0.method22394(arg1.method22894(-1037468677), (byte) -37);
	}
	...
	void method14850(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) Class93_Sub23_Sub2 arg1) {
		arg0.method22394(arg1.method22894(-823045085), (byte) -64);
	}

	@OriginalMember(owner = "client!alp", name = "al", descriptor = "(Lclient!alw;Lclient!asp;)V", line = 42)
	void method14851(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) Class93_Sub23_Sub2 arg1) {
		arg0.method22394(arg1.method22894(-136914149), (byte) -90);
	}
