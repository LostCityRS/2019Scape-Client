...
public class Class694 {
	...
	Interface61 method36624(@OriginalArg(0) int arg0) {
		...
		@Pc(9) Class611 local9 = client.world.method30455(1988559923);
		...
		if (local20 < 0 || local31 < 0 || local20 >= client.world.method30459(-578639380) || local31 >= client.world.method30466((short) 128) || client.world.method30481(-1669107956) == null) {
			return null;
		}
		switch(this.method36619(-1383222052)) {
			case 0:
				return (Interface61) client.world.method30481(-1209332388).method31534(local5, local20, local31, -1309876799);
			case 1:
				return (Interface61) client.world.method30481(-1949294567).method31544(local5, local20, local31, -2024451543);
			case 2:
				return (Interface61) client.world.method30481(-1753294593).method31551(local5, local20, local31, client.anInterface62_1, (byte) 3);
			case 3:
				return (Interface61) client.world.method30481(-1631282216).method31556(local5, local20, local31, -968156135);
			default:
				return null;
		}
	}
	...
	Interface61 method36625() {
		@Pc(5) int local5 = this.aClass611_4.anInt5625 * -78984409;
		@Pc(9) Class611 local9 = client.world.method30455(1729457609);
		@Pc(20) int local20 = this.aClass611_4.anInt5623 * 270611681 - local9.anInt5623 * 270611681;
		@Pc(31) int local31 = this.aClass611_4.anInt5624 * -1994307635 - local9.anInt5624 * -1994307635;
		if (local20 < 0 || local31 < 0 || local20 >= client.world.method30459(267975953) || local31 >= client.world.method30466((short) 128) || client.world.method30481(-1055036015) == null) {
			return null;
		}
		switch(this.method36619(-1696609477)) {
			case 0:
				return (Interface61) client.world.method30481(-1188767444).method31534(local5, local20, local31, -1309876799);
			case 1:
				return (Interface61) client.world.method30481(-1909616057).method31544(local5, local20, local31, -2114854632);
			case 2:
				return (Interface61) client.world.method30481(-1509042913).method31551(local5, local20, local31, client.anInterface62_1, (byte) 3);
			case 3:
				return (Interface61) client.world.method30481(-1854612136).method31556(local5, local20, local31, -968156135);
			default:
				return null;
		}
	}
	...
	Interface61 method36626() {
		@Pc(5) int local5 = this.aClass611_4.anInt5625 * -78984409;
		@Pc(9) Class611 local9 = client.world.method30455(1850210501);
		@Pc(20) int local20 = this.aClass611_4.anInt5623 * 270611681 - local9.anInt5623 * 270611681;
		@Pc(31) int local31 = this.aClass611_4.anInt5624 * -1994307635 - local9.anInt5624 * -1994307635;
		if (local20 < 0 || local31 < 0 || local20 >= client.world.method30459(-281198630) || local31 >= client.world.method30466((short) 128) || client.world.method30481(-926340580) == null) {
			return null;
		}
		switch(this.method36619(1636886417)) {
			case 0:
				return (Interface61) client.world.method30481(-1851804638).method31534(local5, local20, local31, -1309876799);
			case 1:
				return (Interface61) client.world.method30481(-1101792128).method31544(local5, local20, local31, -2050312111);
			case 2:
				return (Interface61) client.world.method30481(-2074447200).method31551(local5, local20, local31, client.anInterface62_1, (byte) 3);
			case 3:
				return (Interface61) client.world.method30481(-1284553634).method31556(local5, local20, local31, -968156135);
			default:
				return null;
		}
	}
