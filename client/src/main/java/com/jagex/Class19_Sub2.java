...
public class Class19_Sub2 extends Class19 {
	...
	@OriginalMember(owner = "client!aou", name = "<init>", descriptor = "()V", line = 8)
	public Class19_Sub2() {
		super(true);
	}

	@OriginalMember(owner = "client!aou", name = "ai", descriptor = "(Lclient!fg;I)V", line = 12)
	@Override
	void method23626(@OriginalArg(0) Class263 arg0, @OriginalArg(1) int arg1) {
		Class274.aClass258_1.method26139(arg0, arg1, 282095088);
	}

	@OriginalMember(owner = "client!aou", name = "ag", descriptor = "(Lclient!fg;II)V", line = 12)
	@Override
	void method23625(@OriginalArg(0) Class263 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		Class274.aClass258_1.method26139(arg0, arg1, -805941607);
	}

	@OriginalMember(owner = "client!aou", name = "m", descriptor = "(Ljava/lang/String;I)Ljava/io/File;", line = 26)
	public static File method17371(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		if (!Class556.aBoolean804) {
