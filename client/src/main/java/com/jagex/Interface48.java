...
public interface Interface48 {
	...
	Class442 method29126(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1);

	@OriginalMember(owner = "client!nx", name = "n", descriptor = "(I)Lclient!nm;")
	Class442 method29127(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!nx", name = "m", descriptor = "(I)Lclient!nm;")
	Class442 method29128(@OriginalArg(0) int arg0);
}
