...
public class Class281 {
	...
	static void method26460(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(16) Class347 local16 = (Class347) Class288.aClass55_Sub2_1.get(arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091], -822969034);
	...
	public static void method26461(@OriginalArg(0) Iterable arg0, @OriginalArg(1) Packet arg1, @OriginalArg(2) int arg2) {
		@Pc(3) int local3 = Class384.method28154(arg0, 1759950388);
		arg1.pSmart1or2(local3, (byte) -58);
		if (local3 == 0) {
			return;
		}
