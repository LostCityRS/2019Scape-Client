...
public class class69 {
	...
	@ObfuscatedName("bt.p")
	public class98 field997;

	@ObfuscatedName("bt.d")
	public class827 field998;

	@ObfuscatedName("bt.c")
	public class812 field999;

	public class69(LegacyOpenGLRenderer arg0, class90 arg1, LegacyOpenGLFloorModel arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
		this.field990 = arg0;
		this.field995 = arg1;
		this.field991 = arg6;
		this.field992 = arg7;
	...
	public void method1073(class98 arg0, int arg1) {
		if (arg1 != 0) {
			this.method1069();
	...
	public void method1069() {
		...
		if (this.field999 == null) {
			this.field999 = new class812(this.field990, 3553, TextureFormat.field1270, DataType.UNSIGNED_INT_8, 128, 128, false, this.field990.field10020, TextureFormat.field1270, false);
