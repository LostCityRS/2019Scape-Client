...
public final class Class74 {
	...
	@OriginalMember(owner = "client!acz", name = "i", descriptor = "(IB)V")
	static void method1261(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		for (@Pc(4) Class93_Sub1_Sub7 local4 = (Class93_Sub1_Sub7) Class454.aClass22_55.method445((byte) 16); local4 != null; local4 = (Class93_Sub1_Sub7) Class454.aClass22_55.method415(123138275)) {
			if (Class702.method36901(local4.anInt3012 * -92627949, (byte) -99) && local4.anInt3009 * -1970204471 >> 16 == arg0) {
				Class632.method32479(local4, -893783590);
			}
		}
	}

	@OriginalMember(owner = "client!acz", name = "ex", descriptor = "(B)V")
	static void method1262(@OriginalArg(0) byte arg0) {
		if (Class694.aClass104_14.method20551()) {
			Class694.aClass104_14.method20503(Class125_Sub3.aCanvas1, 67994844);
			Class84.method1430(-1123473883);
			@Pc(11) Dimension local11 = Class125_Sub3.aCanvas1.getSize();
			Class694.aClass104_14.method20489(Class125_Sub3.aCanvas1, local11.width, local11.height, 25630324);
			Class694.aClass104_14.method20451(Class125_Sub3.aCanvas1, (byte) 14);
		} else {
			Class543.method31129(Class51.aClass93_Sub36_1.aClass166_Sub4_2.method15436((byte) 47), false, 1945646779);
		}
		Class635.method32622((short) 255);
	}

	@OriginalMember(owner = "client!acz", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V")
	...
	@OriginalMember(owner = "client!acz", name = "n", descriptor = "(Lclient!zt;)Ljava/lang/String;")
	public String method1258(@OriginalArg(0) Class717 arg0) {
		return (String) this.aMap4.get(arg0);
	}

	@OriginalMember(owner = "client!acz", name = "e", descriptor = "(Lclient!zt;B)Ljava/lang/String;")
	public String method1259(@OriginalArg(0) Class717 arg0, @OriginalArg(1) byte arg1) {
		return (String) this.aMap4.get(arg0);
	}

	@OriginalMember(owner = "client!acz", name = "m", descriptor = "(Lclient!zt;)Ljava/lang/String;")
