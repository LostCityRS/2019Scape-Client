...
public class Class237 {
	...
	public static void method25770(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (Class50.lobby == null) {
			Class50.lobby = new Class28();
		}
		Class50.lobby.host = arg0;
		Class50.lobby.id = (arg1 + 1099) * 470002905;
		Class50.lobby.port1 = Class250.method25947(Class280.modeWhere, Class703.aClass703_2, Class50.lobby.id * 2142901097, -1850088124) * -1138615973;
		Class50.lobby.port2 = Class654.method32718(Class280.modeWhere, Class703.aClass703_2, Class50.lobby.id * 2142901097, -1904685960) * 702279345;
	}
	...
	static final void method25772(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		if (client.world.method30481(-1152217372) == null) {
			Class694.aClass104_14.method20469(arg0, arg1, arg2, arg3, -16777216, (byte) 115);
			return;
		}
		@Pc(16) Class472 local16 = Class520.selfPlayer.method24220().aClass472_61;
		@Pc(18) boolean local18 = false;
		if (client.anInt3463 * 1819062465 == 3) {
			if ((int) local16.aFloat317 < 0 || (int) local16.aFloat317 >= client.world.method30459(1593640891) * 512 || (int) local16.aFloat319 < 0 || (int) local16.aFloat319 >= client.world.method30466((short) 128) * 512) {
				local18 = true;
			}
		...
		if (Class520.selfPlayer != null && (int) local16.aFloat317 - (Class520.selfPlayer.method19986(-274822650) - 1) * 256 >> 9 == Class172.anInt3179 * -820036969 && (int) local16.aFloat319 - (Class520.selfPlayer.method19986(564816095) - 1) * 256 >> 9 == Class172.anInt3174 * -1293607373) {
		...
		for (local135 = 0; local135 < client.aClass567Array1.length; local135++) {
			if (client.aClass567Array1[local135] != null && !client.aClass567Array1[local135].method31280(-89462490) && client.aClass567Array1[local135].method31282(Class694.aClass104_14, -1895227578)) {
				client.aClass567Array1[local135].method31265(client.world.method30481(-1671370685), (byte) 23);
			}
		}
		...
		@Pc(383) int local383 = IsaacRandom.anInt82 * -20667523;
		@Pc(427) int local427;
		for (@Pc(385) int local385 = 0; local385 < 5; local385++) {
			if (client.aBooleanArray21[local385]) {
				...
				if (local385 == 3) {
					IsaacRandom.anInt82 = (IsaacRandom.anInt82 * -20667523 + local427 & 0x3FFF) * 1056124373;
				}
				if (local385 == 4) {
		...
		if (Class163.anInt2002 * -1331168249 > (client.world.method30481(-1960289076).anInt5443 * -200159665 << 9) - 1) {
			Class163.anInt2002 = ((client.world.method30481(-930676881).anInt5443 * -200159665 << 9) - 1) * 1636217271;
		}
		if (Class270.anInt3884 * 466086187 < 0) {
			Class270.anInt3884 = 0;
		}
		if (Class270.anInt3884 * 466086187 > (client.world.method30481(-1514757946).anInt5444 * -1943751559 << 9) - 1) {
			Class270.anInt3884 = ((client.world.method30481(-1830968116).anInt5444 * -1943751559 << 9) - 1) * -967471741;
		}
		if (Class51.options.aClass166_Sub15_2.method15673(-980493890) == 2) {
			Class129_Sub1.method9405(1821801795);
		} else if (Class51.options.aClass166_Sub15_2.method15673(-1048027228) == 3) {
		...
		@Pc(606) Class672 local606 = client.world.method30494((byte) -101).method32976(65536);
		local427 = local606.method33076((short) -5746);
		@Pc(614) Class368 local614 = new Class368();
		@Pc(618) Class611 local618 = client.world.method30455(1897755705);
		if (Class253.method25991((byte) 11)) {
			...
			client.aClass470_51.method29403(0.0F, -1.0F, 0.0F, Class464.method29281(-(IsaacRandom.anInt82 * -20667523) & 0x3FFF));
		...
		if (local606.method33078(-1252342804) == null) {
			...
			if (Class429.anInt4781 * -1453926679 == 3) {
				...
				local606.method33078(-1832214775).method31178(Class694.aClass104_14, Class121.anInt1003 * 353504223 << 3, local177, local181, local185, local189, Class620.anInt5644 * 607613741, IsaacRandom.anInt82 * -20667523, Class348.anInt4199 * -602770317, local427, true, false, -2113800467);
			}
		...
		client.world.method30494((byte) -48).method32962(client.world, (byte) 3);
		local785 = Class51.options.aClass166_Sub15_2.method15673(530461942);
		...
		if (Class253.method25991((byte) 84) || Class429.anInt4781 * -1453926679 == 3) {
			client.world.method30481(-1085439687).method31572(client.anInt3485, local614.anInt4586 * -1774271657, local614.anInt4587 * -754001767, local614.anInt4588 * 1179660263, client.world.method30504((byte) 2), client.anIntArray327, client.anIntArray312, client.anIntArray313, client.anIntArray314, client.anIntArray302, Class520.selfPlayer.aByte100 + 1, local869, (int) local16.aFloat317 >> 9, (int) local16.aFloat319 >> 9, Class51.options.aClass166_Sub25_1.method15888(-988861719) == 0, true, 0, true);
		} else {
			client.world.method30481(-1151880557).method31572(client.anInt3485, Class163.anInt2002 * -1331168249, Class130_Sub2.anInt1117 * 1055108289, Class270.anInt3884 * 466086187, client.world.method30504((byte) -44), client.anIntArray327, client.anIntArray312, client.anIntArray313, client.anIntArray314, client.anIntArray302, Class520.selfPlayer.aByte100 + 1, local869, (int) local16.aFloat317 >> 9, (int) local16.aFloat319 >> 9, Class51.options.aClass166_Sub25_1.method15888(-988861719) == 0, true, 0, true);
		}
		client.anInt3494 += -22139677;
		if (!Class694.aClass104_14.method20615() && client.state * -849002901 == 18) {
			Class558.method31110(local177, local181, local185, local189, 1351367408);
		}
		client.world.method30481(-1188192890).method31498(-698845241);
		...
		IsaacRandom.anInt82 = local383 * 1056124373;
		...
		if (client.aBoolean630) {
			...
			Class95.method1801(Class74.aClass74_99.method1259(Class106.lang, (byte) -87), false, Class694.aClass104_14, Class82.aClass106_1, Class348.aClass5_14, (byte) -14);
		}
	...
	public static void method25775(@OriginalArg(0) Class320 arg0, @OriginalArg(1) Class312 arg1, @OriginalArg(2) byte arg2) {
		...
		@Pc(15) int local15;
		if (local4 == null) {
			local11 = client.width * -1378711501;
			local15 = client.height * 2091353777;
		} else {
	...
	static final void method25777(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.options.aClass166_Sub38_1.method16324(1120721770);
	}
	...
	static final void method25778(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.options.aClass166_Sub31_1.method16107(17402244) ? 1 : 0;
	}
}
