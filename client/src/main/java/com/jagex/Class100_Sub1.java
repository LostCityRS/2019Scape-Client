...
public class Class100_Sub1 extends Class100 {
	...
	@OriginalMember(owner = "client!aef", name = "<init>", descriptor = "(Lclient!afc;IIZZ)V", line = 30)
	Class100_Sub1(@OriginalArg(0) Class104_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) boolean arg4) {
		...
		this.anInt349 = arg2;
		if (arg4) {
			@Pc(38) Interface42 local38 = arg0.method21175(arg3 ? Class206.aClass206_22 : Class206.aClass206_20, Class226.aClass226_22, arg1, arg2);
			this.anInterface18_1 = local38.method11381(0);
			this.anInterface38_2 = local38;
		} else {
			this.anInterface38_2 = arg0.method21145(arg3 ? Class206.aClass206_22 : Class206.aClass206_20, Class226.aClass226_22, arg1, arg2);
	...
	@OriginalMember(owner = "client!aef", name = "<init>", descriptor = "(Lclient!afc;II[III)V", line = 50)
	Class100_Sub1(@OriginalArg(0) Class104_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		this.anInt349 = arg2;
		this.anInterface18_1 = null;
		this.anInterface38_2 = arg0.method21148(arg1, arg2, false, arg3, arg4, arg5);
		this.anInterface38_2.method11344(true, true);
		this.aBoolean52 = this.anInterface38_2.method11362() != arg1;
		this.aBoolean54 = this.anInterface38_2.method11340() != arg2;
		this.aBoolean55 = !this.aBoolean52 && this.anInterface38_2.method11376();
	...
	@OriginalMember(owner = "client!aef", name = "<init>", descriptor = "(Lclient!afc;Lclient!lz;)V", line = 64)
	...
	@OriginalMember(owner = "client!aef", name = "<init>", descriptor = "(Lclient!afc;Lclient!lz;II)V", line = 67)
	...
	@OriginalMember(owner = "client!aef", name = "p", descriptor = "(IIIIII)V", line = 80)
	@Override
	...
	@OriginalMember(owner = "client!aef", name = "as", descriptor = "(IIIIII)V", line = 80)
	@Override
	...
	@OriginalMember(owner = "client!aef", name = "at", descriptor = "(IIIIII)V", line = 80)
	@Override
	...
	@OriginalMember(owner = "client!aef", name = "d", descriptor = "(III)V", line = 84)
	@Override
	public void method18197(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(9) int[] local9 = this.aClass104_Sub2_1.method20552(arg0, arg1, this.anInt350, this.anInt349);
		...
		this.method18214(0, 0, this.anInt350, this.anInt349, local16, 0, this.anInt350);
	}

	@OriginalMember(owner = "client!aef", name = "am", descriptor = "(III)V", line = 84)
	@Override
	...
	@OriginalMember(owner = "client!aef", name = "au", descriptor = "(III)V", line = 84)
	@Override
	...
	@OriginalMember(owner = "client!aef", name = "ad", descriptor = "(III)V", line = 84)
	@Override
	...
	@OriginalMember(owner = "client!aef", name = "aa", descriptor = "(IIII)V", line = 123)
	@Override
	...
	@OriginalMember(owner = "client!aef", name = "az", descriptor = "(IIII)V", line = 123)
	@Override
	...
	@OriginalMember(owner = "client!aef", name = "e", descriptor = "(IIII)V", line = 123)
	@Override
	...
	@OriginalMember(owner = "client!aef", name = "ak", descriptor = "([I)V", line = 131)
	@Override
	...
	@OriginalMember(owner = "client!aef", name = "af", descriptor = "([I)V", line = 131)
	@Override
	...
	@OriginalMember(owner = "client!aef", name = "n", descriptor = "([I)V", line = 131)
	@Override
	...
	@OriginalMember(owner = "client!aef", name = "m", descriptor = "()I", line = 138)
	@Override
	public int method18205() {
		return this.anInt350;
	}

	@OriginalMember(owner = "client!aef", name = "an", descriptor = "()I", line = 138)
	@Override
	public int method18207() {
		return this.anInt350;
	}

	@OriginalMember(owner = "client!aef", name = "bf", descriptor = "()I", line = 138)
	@Override
	public int method18225() {
		return this.anInt350;
	}

	@OriginalMember(owner = "client!aef", name = "k", descriptor = "()I", line = 142)
	@Override
	public int method18160() {
		return this.anInt350 + this.anInt351 + this.anInt352;
	}

	@OriginalMember(owner = "client!aef", name = "bh", descriptor = "()I", line = 142)
	@Override
	public int method18159() {
		return this.anInt350 + this.anInt351 + this.anInt352;
	}

	@OriginalMember(owner = "client!aef", name = "f", descriptor = "()I", line = 146)
	@Override
	public int method18192() {
		return this.anInt349;
	}

	@OriginalMember(owner = "client!aef", name = "bl", descriptor = "()I", line = 146)
	@Override
	public int method18226() {
		return this.anInt349;
	}

	@OriginalMember(owner = "client!aef", name = "bk", descriptor = "()I", line = 146)
	@Override
	public int method18227() {
		return this.anInt349;
	}

	@OriginalMember(owner = "client!aef", name = "w", descriptor = "()I", line = 150)
	@Override
	public int method18193() {
		return this.anInt349 + this.anInt353 + this.anInt354;
	}

	@OriginalMember(owner = "client!aef", name = "bx", descriptor = "()I", line = 150)
	@Override
	public int method18228() {
		return this.anInt349 + this.anInt353 + this.anInt354;
	}

	@OriginalMember(owner = "client!aef", name = "l", descriptor = "()Lclient!dp;", line = 154)
	@Override
	public Interface18 method18194() {
		return this.anInterface18_1;
	}

	@OriginalMember(owner = "client!aef", name = "ar", descriptor = "()Lclient!dp;", line = 154)
	@Override
	public Interface18 method18234() {
		return this.anInterface18_1;
	}

	@OriginalMember(owner = "client!aef", name = "ap", descriptor = "()Lclient!dp;", line = 154)
	@Override
	public Interface18 method18215() {
		return this.anInterface18_1;
	}

	@OriginalMember(owner = "client!aef", name = "u", descriptor = "(IIII[III)V", line = 158)
	@Override
	...
	@OriginalMember(owner = "client!aef", name = "ac", descriptor = "(IIII[III)V", line = 158)
	@Override
	...
	@OriginalMember(owner = "client!aef", name = "z", descriptor = "(IIII[I[III)V", line = 162)
	@Override
	...
	@OriginalMember(owner = "client!aef", name = "ai", descriptor = "(IIII[I[III)V", line = 162)
	@Override
	...
	@OriginalMember(owner = "client!aef", name = "aw", descriptor = "(IIII[I[III)V", line = 162)
	@Override
	...
	@OriginalMember(owner = "client!aef", name = "r", descriptor = "(IIIII)V", line = 166)
	@Override
	public void method18198(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(9) int local9;
		@Pc(14) int local14;
		if (this.aClass104_Sub2_1.method20942() != Class401.aClass401_3) {
			local9 = arg0 + this.anInt351;
			local14 = arg1 + this.anInt353;
			this.aClass104_Sub2_1.aClass414_3.method28679((float) local9, (float) local14, (float) (local9 + this.anInt350), (float) (local14 + this.anInt349), 0.0F, 0.0F, this.anInterface38_2.method11378(), this.anInterface38_2.method11351(), this.anInterface38_2, arg3);
			return;
		}
		this.aClass104_Sub2_1.method21000();
		this.aClass104_Sub2_1.method21087(arg4);
		...
		local9 = arg0 + this.anInt351;
		local14 = arg1 + this.anInt353;
		@Pc(80) float local80 = (float) this.aClass104_Sub2_1.method20435((byte) -35).method23737();
		@Pc(87) float local87 = (float) this.aClass104_Sub2_1.method20435((byte) -119).method23738();
		local55.aClass489_48.method29875((float) this.anInt350 * 2.0F / local80, (float) this.anInt349 * 2.0F / local87, 1.0F, 1.0F);
		local55.aClass489_48.aFloatArray116[12] = ((float) local9 + this.aClass104_Sub2_1.method21118()) * 2.0F / local80 - 1.0F;
		local55.aClass489_48.aFloatArray116[13] = ((float) local14 + this.aClass104_Sub2_1.method21118()) * 2.0F / local87 - 1.0F;
		local55.aClass489_48.aFloatArray116[14] = -1.0F;
		local55.aClass489_49.method29875(this.anInterface38_2.method11341((float) this.anInt350), this.anInterface38_2.method11342((float) this.anInt349), 1.0F, 1.0F);
	...
	@OriginalMember(owner = "client!aef", name = "aq", descriptor = "(IIIII)V", line = 166)
	@Override
	public void method18236(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		local9 = arg0 + this.anInt351;
		local14 = arg1 + this.anInt353;
		@Pc(80) float local80 = (float) this.aClass104_Sub2_1.method20435((byte) -49).method23737();
		@Pc(87) float local87 = (float) this.aClass104_Sub2_1.method20435((byte) -31).method23738();
		local55.aClass489_48.method29875((float) this.anInt350 * 2.0F / local80, (float) this.anInt349 * 2.0F / local87, 1.0F, 1.0F);
		local55.aClass489_48.aFloatArray116[12] = ((float) local9 + this.aClass104_Sub2_1.method21118()) * 2.0F / local80 - 1.0F;
		local55.aClass489_48.aFloatArray116[13] = ((float) local14 + this.aClass104_Sub2_1.method21118()) * 2.0F / local87 - 1.0F;
		local55.aClass489_48.aFloatArray116[14] = -1.0F;
	...
	@OriginalMember(owner = "client!aef", name = "ax", descriptor = "(IIIII)V", line = 166)
	@Override
	public void method18216(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		local9 = arg0 + this.anInt351;
		local14 = arg1 + this.anInt353;
		@Pc(80) float local80 = (float) this.aClass104_Sub2_1.method20435((byte) -31).method23737();
		@Pc(87) float local87 = (float) this.aClass104_Sub2_1.method20435((byte) -118).method23738();
		local55.aClass489_48.method29875((float) this.anInt350 * 2.0F / local80, (float) this.anInt349 * 2.0F / local87, 1.0F, 1.0F);
		local55.aClass489_48.aFloatArray116[12] = ((float) local9 + this.aClass104_Sub2_1.method21118()) * 2.0F / local80 - 1.0F;
		local55.aClass489_48.aFloatArray116[13] = ((float) local14 + this.aClass104_Sub2_1.method21118()) * 2.0F / local87 - 1.0F;
		local55.aClass489_48.aFloatArray116[14] = -1.0F;
	...
	@OriginalMember(owner = "client!aef", name = "v", descriptor = "(IILclient!ch;II)V", line = 194)
	@Override
	public void method18199(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class96 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		@Pc(31) float local31 = (float) this.aClass104_Sub2_1.method20435((byte) -120).method23737();
		@Pc(38) float local38 = (float) this.aClass104_Sub2_1.method20435((byte) -39).method23738();
		local6.aClass489_48.method29875((float) this.anInt350 * 2.0F / local31, (float) this.anInt349 * 2.0F / local38, 1.0F, 1.0F);
		local6.aClass489_48.aFloatArray116[12] = ((float) local19 + this.aClass104_Sub2_1.method21118()) * 2.0F / local31 - 1.0F;
		local6.aClass489_48.aFloatArray116[13] = ((float) local24 + this.aClass104_Sub2_1.method21118()) * 2.0F / local38 - 1.0F;
		local6.aClass489_48.aFloatArray116[14] = -1.0F;
		local6.aClass489_49.method29875(this.anInterface38_2.method11341((float) this.anInt350), this.anInterface38_2.method11342((float) this.anInt349), 1.0F, 1.0F);
		...
		local6.aClass489_50.method29875(local131.method11341((float) this.anInt350), local131.method11342((float) this.anInt349), 1.0F, 1.0F);
	...
	@OriginalMember(owner = "client!aef", name = "av", descriptor = "(IILclient!ch;II)V", line = 194)
	@Override
	public void method18217(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class96 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		@Pc(19) int local19 = arg0 + this.anInt351;
		@Pc(24) int local24 = arg1 + this.anInt353;
		@Pc(31) float local31 = (float) this.aClass104_Sub2_1.method20435((byte) -29).method23737();
		@Pc(38) float local38 = (float) this.aClass104_Sub2_1.method20435((byte) -107).method23738();
		local6.aClass489_48.method29875((float) this.anInt350 * 2.0F / local31, (float) this.anInt349 * 2.0F / local38, 1.0F, 1.0F);
		local6.aClass489_48.aFloatArray116[12] = ((float) local19 + this.aClass104_Sub2_1.method21118()) * 2.0F / local31 - 1.0F;
		local6.aClass489_48.aFloatArray116[13] = ((float) local24 + this.aClass104_Sub2_1.method21118()) * 2.0F / local38 - 1.0F;
		local6.aClass489_48.aFloatArray116[14] = -1.0F;
	...
	@OriginalMember(owner = "client!aef", name = "ao", descriptor = "(IILclient!ch;II)V", line = 194)
	@Override
	public void method18235(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class96 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		@Pc(19) int local19 = arg0 + this.anInt351;
		@Pc(24) int local24 = arg1 + this.anInt353;
		@Pc(31) float local31 = (float) this.aClass104_Sub2_1.method20435((byte) -81).method23737();
		@Pc(38) float local38 = (float) this.aClass104_Sub2_1.method20435((byte) -20).method23738();
		local6.aClass489_48.method29875((float) this.anInt350 * 2.0F / local31, (float) this.anInt349 * 2.0F / local38, 1.0F, 1.0F);
		local6.aClass489_48.aFloatArray116[12] = ((float) local19 + this.aClass104_Sub2_1.method21118()) * 2.0F / local31 - 1.0F;
		local6.aClass489_48.aFloatArray116[13] = ((float) local24 + this.aClass104_Sub2_1.method21118()) * 2.0F / local38 - 1.0F;
		local6.aClass489_48.aFloatArray116[14] = -1.0F;
	...
	@OriginalMember(owner = "client!aef", name = "y", descriptor = "(IIIIIIII)V", line = 219)
	@Override
	void method18201(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		if (this.aClass104_Sub2_1.method20942() != Class401.aClass401_3) {
			if (this.aBoolean53) {
				arg2 = arg2 * this.anInt350 / this.method18160();
				arg3 = arg3 * this.anInt349 / this.method18193();
				arg0 += this.anInt351 * arg2 / this.anInt350;
				arg1 += this.anInt353 * arg3 / this.anInt349;
			}
			this.aClass104_Sub2_1.aClass414_3.method28679((float) arg0, (float) arg1, (float) (arg0 + arg2), (float) (arg1 + arg3), this.anInterface38_2.method11341(0.0F), this.anInterface38_2.method11342(0.0F), this.anInterface38_2.method11341((float) this.anInt350), this.anInterface38_2.method11342((float) this.anInt349), this.anInterface38_2, arg5);
			return;
		}
		this.aClass104_Sub2_1.method21000();
		this.aClass104_Sub2_1.method21087(arg6);
		...
		@Pc(148) float local148 = (float) this.aClass104_Sub2_1.method20435((byte) -21).method23737();
		@Pc(155) float local155 = (float) this.aClass104_Sub2_1.method20435((byte) -5).method23738();
		local94.aClass489_48.method29875((float) arg2 * 2.0F / local148, (float) arg3 * 2.0F / local155, 1.0F, 1.0F);
		local94.aClass489_48.aFloatArray116[12] = ((float) arg0 + this.aClass104_Sub2_1.method21118()) * 2.0F / local148 - 1.0F;
		local94.aClass489_48.aFloatArray116[13] = ((float) arg1 + this.aClass104_Sub2_1.method21118()) * 2.0F / local155 - 1.0F;
		local94.aClass489_48.aFloatArray116[14] = -1.0F;
		local94.aClass489_49.method29875(this.anInterface38_2.method11341((float) this.anInt350), this.anInterface38_2.method11342((float) this.anInt349), 1.0F, 1.0F);
	...
	@OriginalMember(owner = "client!aef", name = "aj", descriptor = "(IIIIIIII)V", line = 219)
	@Override
	void method18218(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		...
		@Pc(148) float local148 = (float) this.aClass104_Sub2_1.method20435((byte) -117).method23737();
		@Pc(155) float local155 = (float) this.aClass104_Sub2_1.method20435((byte) -113).method23738();
		local94.aClass489_48.method29875((float) arg2 * 2.0F / local148, (float) arg3 * 2.0F / local155, 1.0F, 1.0F);
		local94.aClass489_48.aFloatArray116[12] = ((float) arg0 + this.aClass104_Sub2_1.method21118()) * 2.0F / local148 - 1.0F;
		local94.aClass489_48.aFloatArray116[13] = ((float) arg1 + this.aClass104_Sub2_1.method21118()) * 2.0F / local155 - 1.0F;
		local94.aClass489_48.aFloatArray116[14] = -1.0F;
	...
	@OriginalMember(owner = "client!aef", name = "ay", descriptor = "(IIIIIIII)V", line = 219)
	@Override
	void method18224(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		...
		@Pc(148) float local148 = (float) this.aClass104_Sub2_1.method20435((byte) -88).method23737();
		@Pc(155) float local155 = (float) this.aClass104_Sub2_1.method20435((byte) -56).method23738();
		local94.aClass489_48.method29875((float) arg2 * 2.0F / local148, (float) arg3 * 2.0F / local155, 1.0F, 1.0F);
		local94.aClass489_48.aFloatArray116[12] = ((float) arg0 + this.aClass104_Sub2_1.method21118()) * 2.0F / local148 - 1.0F;
		local94.aClass489_48.aFloatArray116[13] = ((float) arg1 + this.aClass104_Sub2_1.method21118()) * 2.0F / local155 - 1.0F;
		local94.aClass489_48.aFloatArray116[14] = -1.0F;
	...
	@OriginalMember(owner = "client!aef", name = "ab", descriptor = "(IIIIIIII)V", line = 219)
	@Override
	void method18220(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		...
		@Pc(148) float local148 = (float) this.aClass104_Sub2_1.method20435((byte) -20).method23737();
		@Pc(155) float local155 = (float) this.aClass104_Sub2_1.method20435((byte) 1).method23738();
		local94.aClass489_48.method29875((float) arg2 * 2.0F / local148, (float) arg3 * 2.0F / local155, 1.0F, 1.0F);
		local94.aClass489_48.aFloatArray116[12] = ((float) arg0 + this.aClass104_Sub2_1.method21118()) * 2.0F / local148 - 1.0F;
		local94.aClass489_48.aFloatArray116[13] = ((float) arg1 + this.aClass104_Sub2_1.method21118()) * 2.0F / local155 - 1.0F;
		local94.aClass489_48.aFloatArray116[14] = -1.0F;
	...
	@OriginalMember(owner = "client!aef", name = "bd", descriptor = "(IIIIIII)V", line = 255)
	@Override
	public void method18229(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		if (this.aClass104_Sub2_1.method20942() != Class401.aClass401_3) {
			...
			@Pc(15) int local15 = this.method18160();
			@Pc(18) int local18 = this.method18193();
			...
			for (local28 = local23 + this.anInt349; local28 <= local8; local28 += local18) {
				...
				for (local41 = local36 + this.anInt350; local41 <= local12; local41 += local15) {
					this.aClass104_Sub2_1.aClass414_3.method28679((float) local36, (float) local23, (float) (local36 + this.anInt350), (float) (local23 + this.anInt349), 0.0F, 0.0F, this.anInterface38_2.method11378(), this.anInterface38_2.method11351(), this.anInterface38_2, arg5);
					local36 += local15;
				}
				if (local36 < local12) {
					local89 = local12 - local36;
					this.aClass104_Sub2_1.aClass414_3.method28679((float) local36, (float) local23, (float) (local36 + local89), (float) (local23 + this.anInt349), 0.0F, 0.0F, (float) local89 / (float) this.anInt350 * this.anInterface38_2.method11378(), this.anInterface38_2.method11351(), this.anInterface38_2, arg5);
				}
				local23 += local18;
			}
			if (local23 < local8) {
				...
				for (local161 = local89 + this.anInt350; local161 <= local12; local161 += local15) {
					this.aClass104_Sub2_1.aClass414_3.method28679((float) local89, (float) local23, (float) (local89 + this.anInt350), (float) (local23 + local36), 0.0F, 0.0F, this.anInterface38_2.method11378(), local151, this.anInterface38_2, arg5);
					local89 += local15;
				}
				if (local89 < local12) {
					local206 = local12 - local89;
					this.aClass104_Sub2_1.aClass414_3.method28679((float) local89, (float) local23, (float) (local89 + local206), (float) (local23 + local36), 0.0F, 0.0F, (float) local206 / (float) this.anInt350 * this.anInterface38_2.method11378(), local151, this.anInterface38_2, arg5);
				}
			}
			return;
		}
		...
		@Pc(265) float local265 = (float) this.aClass104_Sub2_1.method20435((byte) -97).method23737();
		@Pc(272) float local272 = (float) this.aClass104_Sub2_1.method20435((byte) -14).method23738();
		...
		if (local311 & local298) {
			local250.aClass489_48.method29875((float) arg2 * 2.0F / local265, (float) arg3 * 2.0F / local272, 1.0F, 1.0F);
			local250.aClass489_48.aFloatArray116[12] = ((float) arg0 + this.aClass104_Sub2_1.method21118()) * 2.0F / local265 - 1.0F;
			local250.aClass489_48.aFloatArray116[13] = ((float) arg1 + this.aClass104_Sub2_1.method21118()) * 2.0F / local272 - 1.0F;
			local250.aClass489_48.aFloatArray116[14] = -1.0F;
			local250.aClass489_49.method29875(this.anInterface38_2.method11341((float) arg2), this.anInterface38_2.method11342((float) arg3), 1.0F, 1.0F);
			local250.method10198();
		} else if (local311) {
			local28 = arg1 + arg3;
			local36 = this.method18193();
			local250.aClass489_49.method29875(this.anInterface38_2.method11341((float) arg2), this.anInterface38_2.method11342((float) this.anInt349), 1.0F, 1.0F);
			local41 = arg1 + this.anInt353;
			for (local89 = local41 + this.anInt349; local89 <= local28; local89 += local36) {
				local250.aClass489_48.method29875((float) arg2 * 2.0F / local265, (float) this.anInt349 * 2.0F / local272, 1.0F, 1.0F);
				local250.aClass489_48.aFloatArray116[12] = ((float) arg0 + this.aClass104_Sub2_1.method21118()) * 2.0F / local265 - 1.0F;
				local250.aClass489_48.aFloatArray116[13] = ((float) local41 + this.aClass104_Sub2_1.method21118()) * 2.0F / local272 - 1.0F;
				local250.aClass489_48.aFloatArray116[14] = -1.0F;
				local250.method10198();
				local41 += local36;
			}
			if (local41 < local28) {
				...
				local250.aClass489_49.method29875(this.anInterface38_2.method11341((float) arg2), this.anInterface38_2.method11342((float) local161), 1.0F, 1.0F);
				local250.aClass489_48.method29875((float) arg2 * 2.0F / local265, (float) local161 * 2.0F / local272, 1.0F, 1.0F);
				local250.aClass489_48.aFloatArray116[12] = ((float) arg0 + this.aClass104_Sub2_1.method21118()) * 2.0F / local265 - 1.0F;
				local250.aClass489_48.aFloatArray116[13] = ((float) local41 + this.aClass104_Sub2_1.method21118()) * 2.0F / local272 - 1.0F;
				local250.aClass489_48.aFloatArray116[14] = -1.0F;
				local250.method10198();
			...
			local28 = arg0 + arg2;
			local36 = this.method18160();
			local250.aClass489_49.method29875(this.anInterface38_2.method11341((float) this.anInt350), this.anInterface38_2.method11342((float) arg3), 1.0F, 1.0F);
			local41 = arg0 + this.anInt351;
			for (local89 = local41 + this.anInt350; local89 <= local28; local89 += local36) {
				local250.aClass489_48.method29875((float) this.anInt350 * 2.0F / local265, (float) arg3 * 2.0F / local272, 1.0F, 1.0F);
				local250.aClass489_48.aFloatArray116[12] = ((float) local41 + this.aClass104_Sub2_1.method21118()) * 2.0F / local265 - 1.0F;
				local250.aClass489_48.aFloatArray116[13] = ((float) arg1 + this.aClass104_Sub2_1.method21118()) * 2.0F / local272 - 1.0F;
				local250.aClass489_48.aFloatArray116[14] = -1.0F;
				local250.method10198();
				local41 += local36;
			...
			if (local41 < local28) {
				local161 = local28 - local41;
				local250.aClass489_49.method29875(this.anInterface38_2.method11341((float) local161), this.anInterface38_2.method11342((float) arg3), 1.0F, 1.0F);
				local250.aClass489_48.method29875((float) local161 * 2.0F / local265, (float) arg3 * 2.0F / local272, 1.0F, 1.0F);
				local250.aClass489_48.aFloatArray116[12] = ((float) local41 + this.aClass104_Sub2_1.method21118()) * 2.0F / local265 - 1.0F;
				local250.aClass489_48.aFloatArray116[13] = ((float) arg1 + this.aClass104_Sub2_1.method21118()) * 2.0F / local272 - 1.0F;
				local250.aClass489_48.aFloatArray116[14] = -1.0F;
				local250.method10198();
			...
			local28 = arg1 + arg3;
			local36 = arg0 + arg2;
			local41 = this.method18160();
			local89 = this.method18193();
			local161 = arg1 + this.anInt353;
			@Pc(817) int local817;
			@Pc(822) int local822;
			@Pc(902) int local902;
			for (local206 = local161 + this.anInt349; local206 <= local28; local206 += local89) {
				local250.aClass489_49.method29875(this.anInterface38_2.method11341((float) this.anInt350), this.anInterface38_2.method11342((float) this.anInt349), 1.0F, 1.0F);
				local817 = arg0 + this.anInt351;
				for (local822 = local817 + this.anInt350; local822 <= local36; local822 += local41) {
					local250.aClass489_48.method29875((float) this.anInt350 * 2.0F / local265, (float) this.anInt349 * 2.0F / local272, 1.0F, 1.0F);
					local250.aClass489_48.aFloatArray116[12] = ((float) local817 + this.aClass104_Sub2_1.method21118()) * 2.0F / local265 - 1.0F;
					local250.aClass489_48.aFloatArray116[13] = ((float) local161 + this.aClass104_Sub2_1.method21118()) * 2.0F / local272 - 1.0F;
					local250.aClass489_48.aFloatArray116[14] = -1.0F;
					local250.method10198();
					local817 += local41;
				}
				if (local817 < local36) {
					...
					local250.aClass489_49.method29875(this.anInterface38_2.method11341((float) local902), this.anInterface38_2.method11342((float) this.anInt349), 1.0F, 1.0F);
					local250.aClass489_48.method29875((float) local902 * 2.0F / local265, (float) this.anInt349 * 2.0F / local272, 1.0F, 1.0F);
					local250.aClass489_48.aFloatArray116[12] = ((float) local817 + this.aClass104_Sub2_1.method21118()) * 2.0F / local265 - 1.0F;
					local250.aClass489_48.aFloatArray116[13] = ((float) local161 + this.aClass104_Sub2_1.method21118()) * 2.0F / local272 - 1.0F;
					local250.aClass489_48.aFloatArray116[14] = -1.0F;
					local250.method10198();
			...
			if (local161 < local28) {
				...
				local250.aClass489_49.method29875(this.anInterface38_2.method11341((float) this.anInt350), this.anInterface38_2.method11342((float) local817), 1.0F, 1.0F);
				local822 = arg0 + this.anInt351;
				for (local902 = local822 + this.anInt350; local902 <= local36; local902 += local41) {
					local250.aClass489_48.method29875((float) this.anInt350 * 2.0F / local265, (float) local817 * 2.0F / local272, 1.0F, 1.0F);
					local250.aClass489_48.aFloatArray116[12] = ((float) local822 + this.aClass104_Sub2_1.method21118()) * 2.0F / local265 - 1.0F;
					local250.aClass489_48.aFloatArray116[13] = ((float) local161 + this.aClass104_Sub2_1.method21118()) * 2.0F / local272 - 1.0F;
					local250.aClass489_48.aFloatArray116[14] = -1.0F;
					local250.method10198();
					local822 += local41;
				...
				if (local822 < local36) {
					...
					local250.aClass489_49.method29875(this.anInterface38_2.method11341((float) local1099), this.anInterface38_2.method11342((float) local817), 1.0F, 1.0F);
					local250.aClass489_48.method29875((float) local1099 * 2.0F / local265, (float) local817 * 2.0F / local272, 1.0F, 1.0F);
					local250.aClass489_48.aFloatArray116[12] = ((float) local822 + this.aClass104_Sub2_1.method21118()) * 2.0F / local265 - 1.0F;
					local250.aClass489_48.aFloatArray116[13] = ((float) local161 + this.aClass104_Sub2_1.method21118()) * 2.0F / local272 - 1.0F;
					local250.aClass489_48.aFloatArray116[14] = -1.0F;
					local250.method10198();
	...
	@OriginalMember(owner = "client!aef", name = "x", descriptor = "(IIIIIII)V", line = 255)
	@Override
	public void method18202(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		local250.anInterface38_20 = this.anInterface38_2;
		local250.method10197(arg4, arg5);
		@Pc(265) float local265 = (float) this.aClass104_Sub2_1.method20435((byte) -99).method23737();
		@Pc(272) float local272 = (float) this.aClass104_Sub2_1.method20435((byte) -32).method23738();
		local250.anInterface37_9 = this.aClass104_Sub2_1.anInterface37_17;
		local250.anInt1174 = 0;
		local250.aClass145_10 = this.aClass104_Sub2_1.aClass145_17;
		@Pc(298) boolean local298 = this.aBoolean56 && this.anInt353 == 0 && this.anInt354 == 0;
	...
	@OriginalMember(owner = "client!aef", name = "bc", descriptor = "(IIIIIII)V", line = 255)
	@Override
	public void method18230(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		local250.anInterface38_20 = this.anInterface38_2;
		local250.method10197(arg4, arg5);
		@Pc(265) float local265 = (float) this.aClass104_Sub2_1.method20435((byte) -15).method23737();
		@Pc(272) float local272 = (float) this.aClass104_Sub2_1.method20435((byte) -91).method23738();
		local250.anInterface37_9 = this.aClass104_Sub2_1.anInterface37_17;
		local250.anInt1174 = 0;
		local250.aClass145_10 = this.aClass104_Sub2_1.aClass145_17;
		@Pc(298) boolean local298 = this.aBoolean56 && this.anInt353 == 0 && this.anInt354 == 0;
	...
	@OriginalMember(owner = "client!aef", name = "ag", descriptor = "(FFFFFFIIII)V", line = 425)
	@Override
	void method18191(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9) {
		if (this.aClass104_Sub2_1.method20942() != Class401.aClass401_3) {
			this.aClass104_Sub2_1.aClass414_3.method28682(arg0, arg1, arg2, arg3, arg4, arg5, arg2 + arg4 - arg0, arg3 + arg5 - arg1, 0.0F, 0.0F, this.anInterface38_2.method11378(), 0.0F, 0.0F, this.anInterface38_2.method11351(), this.anInterface38_2.method11378(), this.anInterface38_2.method11351(), this.anInterface38_2, arg7);
			return;
		}
		this.aClass104_Sub2_1.method21000();
		this.aClass104_Sub2_1.method21087(arg8);
		@Pc(62) float local62;
		@Pc(68) float local68;
		if (this.aBoolean53) {
			@Pc(58) float local58 = (float) this.method18160();
			local62 = this.method18193();
		...
		local62 = this.aClass104_Sub2_1.method20435((byte) -103).method23737();
		local68 = this.aClass104_Sub2_1.method20435((byte) 0).method23738();
		local178.aClass489_48.method29850();
		...
		local178.aClass489_48.aFloatArray116[12] = (arg0 + this.aClass104_Sub2_1.method21118()) * 2.0F / local62 - 1.0F;
		local178.aClass489_48.aFloatArray116[13] = (arg1 + this.aClass104_Sub2_1.method21118()) * 2.0F / local68 - 1.0F;
		local178.aClass489_48.aFloatArray116[14] = -1.0F;
		local178.aClass489_49.method29875(this.anInterface38_2.method11341((float) this.anInt350), this.anInterface38_2.method11342((float) this.anInt349), 1.0F, 1.0F);
	...
	@OriginalMember(owner = "client!aef", name = "bn", descriptor = "(FFFFFFIIII)V", line = 425)
	@Override
	void method18231(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9) {
		...
		local178.anInterface38_20 = this.anInterface38_2;
		local178.method10197(arg6, arg7);
		local62 = this.aClass104_Sub2_1.method20435((byte) -7).method23737();
		local68 = this.aClass104_Sub2_1.method20435((byte) -23).method23738();
		local178.aClass489_48.method29850();
		local178.aClass489_48.aFloatArray116[0] = (arg2 - arg0) * 2.0F / local62;
		local178.aClass489_48.aFloatArray116[1] = (arg3 - arg1) * 2.0F / local68;
		local178.aClass489_48.aFloatArray116[4] = (arg4 - arg0) * 2.0F / local62;
	...
	@OriginalMember(owner = "client!aef", name = "bi", descriptor = "(FFFFFFIIII)V", line = 425)
	@Override
	void method18233(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9) {
		...
		local178.anInterface38_20 = this.anInterface38_2;
		local178.method10197(arg6, arg7);
		local62 = this.aClass104_Sub2_1.method20435((byte) -68).method23737();
		local68 = this.aClass104_Sub2_1.method20435((byte) -22).method23738();
		local178.aClass489_48.method29850();
		local178.aClass489_48.aFloatArray116[0] = (arg2 - arg0) * 2.0F / local62;
		local178.aClass489_48.aFloatArray116[1] = (arg3 - arg1) * 2.0F / local68;
		local178.aClass489_48.aFloatArray116[4] = (arg4 - arg0) * 2.0F / local62;
	...
	@OriginalMember(owner = "client!aef", name = "bt", descriptor = "(FFFFFFIIII)V", line = 425)
	@Override
	void method18232(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9) {
		...
		local178.anInterface38_20 = this.anInterface38_2;
		local178.method10197(arg6, arg7);
		local62 = this.aClass104_Sub2_1.method20435((byte) -115).method23737();
		local68 = this.aClass104_Sub2_1.method20435((byte) -108).method23738();
		local178.aClass489_48.method29850();
		local178.aClass489_48.aFloatArray116[0] = (arg2 - arg0) * 2.0F / local62;
		local178.aClass489_48.aFloatArray116[1] = (arg3 - arg1) * 2.0F / local68;
		local178.aClass489_48.aFloatArray116[4] = (arg4 - arg0) * 2.0F / local62;
	...
	@OriginalMember(owner = "client!aef", name = "al", descriptor = "(FFFFFFILclient!ch;II)V", line = 475)
	@Override
	void method18203(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) int arg6, @OriginalArg(7) Class96 arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9) {
		...
		local6.anInterface38_20 = this.anInterface38_2;
		local6.method10197(1, -1);
		@Pc(21) float local21 = (float) this.aClass104_Sub2_1.method20435((byte) -117).method23737();
		@Pc(28) float local28 = (float) this.aClass104_Sub2_1.method20435((byte) -50).method23738();
		local6.aClass489_48.method29850();
		if (this.aBoolean53) {
			@Pc(42) float local42 = (float) this.anInt350 / (float) this.method18160();
			@Pc(50) float local50 = (float) this.anInt349 / (float) this.method18193();
			...
			local6.aClass489_48.aFloatArray116[12] = (arg0 + (float) this.anInt351) * local42 + this.aClass104_Sub2_1.method21118();
			local6.aClass489_48.aFloatArray116[13] = (arg1 + (float) this.anInt353) * local50 + this.aClass104_Sub2_1.method21118();
		} else {
			...
			local6.aClass489_48.aFloatArray116[12] = arg0 + this.aClass104_Sub2_1.method21118();
			local6.aClass489_48.aFloatArray116[13] = arg1 + this.aClass104_Sub2_1.method21118();
		}
		@Pc(179) Class489 local179 = this.aClass104_Sub2_1.aClass489_78;
		local179.method29850();
		...
		local6.aClass489_48.method29862(local179);
		local6.aClass489_49.method29875(this.anInterface38_2.method11341((float) this.anInt350), this.anInterface38_2.method11342((float) this.anInt349), 1.0F, 1.0F);
		local6.anInterface37_9 = this.aClass104_Sub2_1.anInterface37_17;
		local6.anInt1174 = 0;
		local6.aClass145_10 = this.aClass104_Sub2_1.aClass145_17;
		...
		local6.aClass489_50.method29850();
	...
	@OriginalMember(owner = "client!aef", name = "bq", descriptor = "(FFFFFFILclient!ch;II)V", line = 475)
	@Override
	void method18200(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) int arg6, @OriginalArg(7) Class96 arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9) {
		...
		local6.anInterface38_20 = this.anInterface38_2;
		local6.method10197(1, -1);
		@Pc(21) float local21 = (float) this.aClass104_Sub2_1.method20435((byte) -25).method23737();
		@Pc(28) float local28 = (float) this.aClass104_Sub2_1.method20435((byte) -7).method23738();
		local6.aClass489_48.method29850();
		if (this.aBoolean53) {
			@Pc(42) float local42 = (float) this.anInt350 / (float) this.method18160();
			@Pc(50) float local50 = (float) this.anInt349 / (float) this.method18193();
