...
public class Class136 {
	...
	@OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(I)V", line = 74)
	Class136(@OriginalArg(0) int arg0) {
		this.anInt1187 = arg0 * 1914221871;
	}

	@OriginalMember(owner = "client!ai", name = "m", descriptor = "(II)Z", line = 76)
	public static boolean method10213(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg0 == 1 || arg0 == 3 || arg0 == 5;
	}

	@OriginalMember(owner = "client!ai", name = "p", descriptor = "(Ljava/lang/String;I)V", line = 239)
	public static void method10214(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		Class168.aString61 = arg0;
		Class168.anInt2445 = Class168.aString61.length() * -1799421149;
	}

	@OriginalMember(owner = "client!ai", name = "yt", descriptor = "(Lclient!yf;I)V", line = 9373)
	static final void method10215(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(2) Class93_Sub1_Sub7 local2 = Class370.method27997(2012376485);
		if (Class166_Sub14.method15657(local2, 1835877544) == 7) {
			@Pc(12) int local12 = (int) local2.method21703(955280622);
