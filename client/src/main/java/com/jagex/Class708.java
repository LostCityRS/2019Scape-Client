...
public class Class708 {
	...
	static {
		...
		aCharArray7[62] = '-';
		aCharArray7[63] = '_';
		anIntArray527 = new int[128];
		for (local4 = 0; local4 < anIntArray527.length; local4++) {
			anIntArray527[local4] = -1;
		}
		for (local4 = 65; local4 <= 90; local4++) {
			anIntArray527[local4] = local4 - 65;
		}
		for (local4 = 97; local4 <= 122; local4++) {
			anIntArray527[local4] = local4 - 97 + 26;
		}
		for (local4 = 48; local4 <= 57; local4++) {
			anIntArray527[local4] = local4 - 48 + 52;
		}
		@Pc(230) int[] local230 = anIntArray527;
		anIntArray527[43] = 62;
		local230[42] = 62;
		@Pc(240) int[] local240 = anIntArray527;
		anIntArray527[47] = 63;
		local240[45] = 63;
	}

	@OriginalMember(owner = "client!zk", name = "e", descriptor = "(I)[Lclient!kv;", line = 12)
	public static Class390[] method36753(@OriginalArg(0) int arg0) {
		return new Class390[] { Class390.aClass390_13, Class390.aClass390_11, Class390.aClass390_12 };
	}

	@OriginalMember(owner = "client!zk", name = "<init>", descriptor = "()V", line = 53)
	Class708() throws Throwable {
		throw new Error();
	}

	@OriginalMember(owner = "client!zk", name = "k", descriptor = "([B)Ljava/lang/String;", line = 58)
	public static String method36754(@OriginalArg(0) byte[] arg0) {
		return Class189.method24582(arg0, 0, arg0.length, 535657697);
	}

	@OriginalMember(owner = "client!zk", name = "m", descriptor = "([B)Ljava/lang/String;", line = 58)
	public static String method36755(@OriginalArg(0) byte[] arg0) {
		return Class189.method24582(arg0, 0, arg0.length, 1966777607);
	}

	@OriginalMember(owner = "client!zk", name = "f", descriptor = "([BII)Ljava/lang/String;", line = 62)
	static String method36756(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	@OriginalMember(owner = "client!zk", name = "bdf", descriptor = "(Lclient!yf;B)V", line = 14788)
	static final void method36757(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = client.aClass270_1.method26277(local12, -68158500);
	}
}
