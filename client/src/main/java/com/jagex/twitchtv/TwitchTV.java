...
public final class TwitchTV {

	@OriginalMember(owner = "client!com/jagex/twitchtv/TwitchTV", name = "t", descriptor = "I")
	...
	public static final int l = 2072;

	@OriginalMember(owner = "client!com/jagex/twitchtv/TwitchTV", name = "g", descriptor = "I")
	public static final int g = -995;

	@OriginalMember(owner = "client!com/jagex/twitchtv/TwitchTV", name = "i", descriptor = "I")
	...
	@OriginalMember(owner = "client!com/jagex/twitchtv/TwitchTV", name = "j", descriptor = "I")
	public static final int j = 10;

	@OriginalMember(owner = "client!com/jagex/twitchtv/TwitchTV", name = "a", descriptor = "I")
	...
	@OriginalMember(owner = "client!com/jagex/twitchtv/TwitchTV", name = "x", descriptor = "I")
	...
	@OriginalMember(owner = "client!com/jagex/twitchtv/TwitchTV", name = "q", descriptor = "I")
