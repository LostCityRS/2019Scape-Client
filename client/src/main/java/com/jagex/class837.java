...
public class class837 extends class104 {
	...
	public class330 field9509;

	@ObfuscatedName("aem.ac")
	public class332 field9493;
	...
	public void method1557(int arg0, int arg1, int[] arg2, int[] arg3, int[] arg4, int[] arg5, int[] arg6, int[] arg7, int[] arg8, int[] arg9, class131 arg10, boolean arg11) {
		...
		for (int var15 = 0; var15 < arg6.length; var15++) {
			...
			if ((this.field9491 & 0x20) != 0 && var16 != -1 && var13.method2043(var16).field1342) {
				var17 = 128;
				var16 = -1;
			}
	...
	public void method15413() {
		...
		this.field9509.method5553(this.field9492 * 4, 4);
		this.field9509.method5738(0, this.field9492 * 4, this.field9516.method15963(this.field9520));
		this.field9508 = this.field9516.method16085(false);
		this.field9508.method5553(this.field9522 * this.field9492, this.field9522);
		this.field9508.method5738(0, this.field9522 * this.field9492, this.field9516.method15963(this.field9521));
	...
	public void method15415(int arg0, int arg1, byte[][] arg2, class981[] arg3, class729 arg4, class981[] arg5) {
		...
		for (int var35 = 0; var35 < var11.length; var35++) {
			...
			if (var66 == null) {
				...
				arg4.method14501(new class985(var34[var35]), var43);
			} else {
				var34[var35] = ((class985) var66).field11437;
	...
	public void method1548(int arg0, int arg1, int arg2, boolean[][] arg3, boolean arg4, int arg5) {
		...
		if (var21 != 0) {
			class360 var23 = this.field9516.method15988(var21 / 2);
	...
	public void method1526(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, boolean[][] arg7) {
		...
		class360 var9 = this.field9516.method15988(this.field9517);
		int var10 = 0;
		int var11 = 32767;
		int var12 = -32768;
		ByteBuffer var13 = this.field9516.field10071;
		var13.clear();
		...
		var9.method5738(0, var13.position(), this.field9516.field10046);
		if (var10 <= 0) {
			return;
		}
		this.field9516.method16022();
