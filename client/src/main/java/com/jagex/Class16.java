...
public final class Class16 implements Iterable {
	...
	public Class93 method214(@OriginalArg(0) long arg0) {
	...
	public int method218(@OriginalArg(0) Class93[] arg0, @OriginalArg(1) byte arg1) {
		@Pc(1) int local1 = 0;
	...
	public void method220(@OriginalArg(0) Class93 arg0, @OriginalArg(1) long arg1) {
		if (arg0.aClass93_228 != null) {
			arg0.method23969(1962911979);
		}
	...
	public void method222(@OriginalArg(0) Class93 arg0, @OriginalArg(1) long arg1) {
		if (arg0.aClass93_228 != null) {
			arg0.method23969(1692842222);
		}
		@Pc(20) Class93 local20 = this.aClass93Array1[(int) (arg1 & (long) (this.anInt58 * 1214539343 - 1))];
		arg0.aClass93_228 = local20.aClass93_228;
		arg0.aClass93_227 = local20;
	...
	public void method223(@OriginalArg(0) Class93 arg0, @OriginalArg(1) long arg1) {
		if (arg0.aClass93_228 != null) {
			arg0.method23969(-542279658);
		}
		@Pc(20) Class93 local20 = this.aClass93Array1[(int) (arg1 & (long) (this.anInt58 * 1214539343 - 1))];
		arg0.aClass93_228 = local20.aClass93_228;
		arg0.aClass93_227 = local20;
	...
	public void method224(@OriginalArg(0) Class93 arg0, @OriginalArg(1) long arg1) {
		if (arg0.aClass93_228 != null) {
			arg0.method23969(-419811159);
		}
		@Pc(20) Class93 local20 = this.aClass93Array1[(int) (arg1 & (long) (this.anInt58 * 1214539343 - 1))];
		arg0.aClass93_228 = local20.aClass93_228;
		arg0.aClass93_227 = local20;
	...
	public void method225(@OriginalArg(0) byte arg0) {
		for (@Pc(1) int local1 = 0; local1 < this.anInt58 * 1214539343; local1++) {
			...
			while (true) {
				...
				local15.method23969(1287869112);
			}
		}
		this.aClass93_4 = null;
	...
	public void method226() {
		for (@Pc(1) int local1 = 0; local1 < this.anInt58 * 1214539343; local1++) {
			...
			while (true) {
				...
				local15.method23969(1969596159);
			}
		}
		this.aClass93_4 = null;
		this.aClass93_3 = null;
	...
	public Class93 method227(@OriginalArg(0) byte arg0) {
		this.anInt57 = 0;
		return this.method229(2013303506);
	}

	@OriginalMember(owner = "client!aan", name = "x", descriptor = "()Lclient!tj;", line = 105)
	public Class93 method228() {
		this.anInt57 = 0;
		return this.method229(1688425274);
	}

	@OriginalMember(owner = "client!aan", name = "u", descriptor = "(I)Lclient!tj;", line = 110)
	public Class93 method229(@OriginalArg(0) int arg0) {
