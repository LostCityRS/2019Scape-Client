...
public class Class93_Sub2 extends Class93 {
	...
	@OriginalMember(owner = "client!aje", name = "<init>", descriptor = "(III[IZ)V", line = 15)
	...
	@OriginalMember(owner = "client!aje", name = "e", descriptor = "()[I", line = 111)
	int[] method11798() {
		return this.anIntArray164;
	}

	@OriginalMember(owner = "client!aje", name = "m", descriptor = "()[I", line = 111)
	int[] method11799() {
		return this.anIntArray164;
	}

	@OriginalMember(owner = "client!aje", name = "f", descriptor = "()[I", line = 111)
	int[] method11800() {
		return this.anIntArray164;
	}

	@OriginalMember(owner = "client!aje", name = "k", descriptor = "()[I", line = 111)
	int[] method11801() {
		return this.anIntArray164;
	}

	@OriginalMember(owner = "client!aje", name = "l", descriptor = "(II)V", line = 115)
	void method11802(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 == 0 && arg1 == 0) {
			return;
		}
		if (anIntArray165 == null || anIntArray165.length != this.anIntArray164.length) {
	...
	@OriginalMember(owner = "client!aje", name = "n", descriptor = "(II)V", line = 115)
	void method11803(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 == 0 && arg1 == 0) {
			return;
		}
		if (anIntArray165 == null || anIntArray165.length != this.anIntArray164.length) {
	...
	@OriginalMember(owner = "client!aje", name = "w", descriptor = "(II)V", line = 115)
	void method11804(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 == 0 && arg1 == 0) {
			return;
		}
		if (anIntArray165 == null || anIntArray165.length != this.anIntArray164.length) {
