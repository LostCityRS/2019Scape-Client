...
class Class276 implements Interface39 {
	...
	public float method26346() {
		return (float) Class51.options.aClass166_Sub35_2.method16226(1732022890) / 255.0F;
	}

	@OriginalMember(owner = "client!fv", name = "e", descriptor = "(I)F", line = 472)
	@Override
	public float method26345(@OriginalArg(0) int arg0) {
		return (float) Class51.options.aClass166_Sub35_2.method16226(-1215622030) / 255.0F;
	}
	...
	static final void method26349(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		Class51.options.method14363(Class51.options.aClass166_Sub3_1, arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091] == 1 ? 1 : 0, (byte) 18);
