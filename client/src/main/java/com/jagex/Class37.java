...
public final class Class37 {
	...
	@OriginalMember(owner = "client!abk", name = "<init>", descriptor = "(IIIII)V")
	...
	@OriginalMember(owner = "client!abk", name = "rm", descriptor = "()I")
	public int method717() {
		return this.anInt120 * 614744811;
	}

	@OriginalMember(owner = "client!abk", name = "hashCode", descriptor = "()I")
	@Override
	public int hashCode() {
		return this.anInt120 * 614744811;
	}

	@OriginalMember(owner = "client!abk", name = "rk", descriptor = "()I")
	public int method718() {
		return this.anInt120 * 614744811;
	}

	@OriginalMember(owner = "client!abk", name = "ri", descriptor = "()I")
