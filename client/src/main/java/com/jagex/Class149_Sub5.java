...
public class Class149_Sub5 extends Class149 {
	...
	@OriginalMember(owner = "client!ajq", name = "<init>", descriptor = "()V", line = 16)
	Class149_Sub5() {
	}

	@OriginalMember(owner = "client!ajq", name = "k", descriptor = "()Lclient!ajq;", line = 19)
	static Class149_Sub5 method12716() {
		@Pc(4) Class149_Sub5 local4 = (Class149_Sub5) aClass21_3.method386(-972089962);
		if (local4 == null) {
	...
	@OriginalMember(owner = "client!ajq", name = "f", descriptor = "()Lclient!ajq;", line = 19)
	static Class149_Sub5 method12717() {
		@Pc(4) Class149_Sub5 local4 = (Class149_Sub5) aClass21_3.method386(-2019457593);
		if (local4 == null) {
			return new Class149_Sub5();
		} else {
			anInt1448 -= 1630361431;
	...
	@OriginalMember(owner = "client!ajq", name = "w", descriptor = "(Lclient!ajq;)V", line = 28)
	static void method12718(@OriginalArg(0) Class149_Sub5 arg0) {
		arg0.aClass132_Sub1_Sub1_Sub1_1 = null;
		if (anInt1448 * 829391975 < 20) {
			aClass21_3.method380(arg0, (byte) 4);
			anInt1448 += 1630361431;
		}
	}

	@OriginalMember(owner = "client!ajq", name = "l", descriptor = "(Lclient!ajq;)V", line = 28)
	...
	@OriginalMember(owner = "client!ajq", name = "ae", descriptor = "(IIIIB)Lclient!asp;", line = 53)
	public static Class93_Sub23_Sub2 method12720(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte arg4) {
		...
		synchronized (Class93_Sub23_Sub2.aClass93_Sub23_Sub2Array1) {
			...
			if (Class640.anInt5755 * -757688083 == 0) {
				...
				local11 = Class93_Sub23_Sub2.aClass93_Sub23_Sub2Array1[(Class640.anInt5755 -= 1091273957) * -757688083];
			}
			...
			local11.aLong199 = Class305.method26797(1475800309) * -1149401875204728019L;
			return local11;
		}
	}
}
