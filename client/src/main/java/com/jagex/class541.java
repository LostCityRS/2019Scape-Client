...
public class class541 {
	...
	@ObfuscatedName("tf.e")
	public static class51 field6839 = null;

	@ObfuscatedName("tf.n")
	public static class51 field6849 = null;

	@ObfuscatedName("tf.c")
	public static class729 field6796 = new class729(16);
	...
	@ObfuscatedName("tf.a")
	public static class715 field6806 = new class715();
	...
	public static final int field6822 = class689.field8311.method1303();

	@ObfuscatedName("tf.ar")
	public static final int field6823 = class689.field8305.method1303();

	@ObfuscatedName("tf.ap")
	public static final int field6824 = class689.field8303.method1303();

	@ObfuscatedName("tf.aq")
	public static final int field6825 = class689.field8306.method1303();

	@ObfuscatedName("tf.ax")
	public static final int field6826 = class689.field8307.method1303();

	@ObfuscatedName("tf.av")
	public static final int field6827 = class689.field8308.method1303();

	@ObfuscatedName("tf.ao")
	public static final int field6843 = class689.field8309.method1303();

	@ObfuscatedName("tf.aj")
	public static final int field6829 = class689.field8310.method1303();

	@ObfuscatedName("tf.ab")
	public static class162 field6831 = new class162(4096, 256);

	@ObfuscatedName("tf.az")
	public static class162 field6832 = new class162(4096, 1024);

	@ObfuscatedName("tf.aa")
	public static class162 field6833 = field6831;
	...
	public static void method8619() {
		...
		Statics.field6854 = new int[field6839.method963() + 1];
	...
	public static void method8514(class125 arg0, int arg1, int arg2) {
		for (int var3 = 0; var3 < field6839.method963(); var3++) {
	...
	public static int method8587(class51 arg0, class125 arg1, int arg2, int arg3, int arg4) {
		class663 var5 = (class663) arg0.method962(arg2);
		if (var5 == null) {
			return 0;
		}
					...
					if (var2 instanceof class989) {
						...
						if (var3 != null) {
							for (int var4 = 0; var4 < var3.field11444.length; var4++) {
								class598 var5 = (class598) Statics.field6785.method962(var3.field11444[var4]);
						...
						class598 var10 = (class598) Statics.field6785.method962(var9);
					...
					if (var17 != null) {
						...
						while (true) {
							...
							for (int var20 = 0; var20 < var19.field6773.length; var20++) {
								class598 var21 = (class598) Statics.field6785.method962(var19.field6773[var20]);
		...
		for (int var10 = -5; var10 < Statics.field6812; var10++) {
			...
			for (int var13 = 0; var13 < Statics.field6810; var13++) {
				...
				if (var11 < Statics.field6812) {
					...
					if (var14 > 0) {
						class728 var15 = (class728) field6849.method962(var14 - 1);
				...
				if (var12 >= 0) {
					...
					if (var16 > 0) {
						class728 var17 = (class728) field6849.method962(var16 - 1);
	...
	public static void method8612(int[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5, boolean arg6, int arg7, int arg8, int arg9, int[] arg10, byte[] arg11, boolean arg12) {
		...
		for (int var20 = 0; var20 < arg10.length; var20++) {
			...
			if (class601.field7554.field7562 == var21 || class601.field7545.field7562 == var21 || class601.field7546.field7562 == var21 || class601.field7547.field7562 == var21) {
				class598 var22 = (class598) Statics.field6785.method962(arg10[var20]);
	...
	public static void method8529(class133 arg0, int[] arg1, int arg2, int arg3, int arg4, int[] arg5, byte[] arg6) {
		...
		for (int var7 = 0; var7 < arg5.length; var7++) {
			class598 var8 = (class598) Statics.field6785.method962(arg5[var7]);
			int var9 = var8.field7486;
			if (var9 != -1) {
				class781 var10 = (class781) Statics.field6789.method962(var9);
	...
	public static class715 method8602(class133 arg0) {
	...
	public static class715 method8531(class133 arg0, int arg1, int arg2, int arg3, int arg4) {
