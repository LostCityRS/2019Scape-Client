...
public class Class49_Sub1 extends Class49 {
	...
	@OriginalMember(owner = "client!aob", name = "<init>", descriptor = "()V", line = 15)
	Class49_Sub1() {
	}

	@OriginalMember(owner = "client!aob", name = "n", descriptor = "(I)Ljava/net/Socket;", line = 20)
	@Override
	public Socket method16610(@OriginalArg(0) int arg0) throws IOException {
		...
		for (@Pc(82) int local82 = 0; local82 < local80.length; local82++) {
			...
			try {
				@Pc(98) Socket local98 = this.method16612(local93, (byte) 76);
				if (local98 != null) {
					return local98;
				}
		...
		return this.method16599(2095754772);
	}

	@OriginalMember(owner = "client!aob", name = "k", descriptor = "()Ljava/net/Socket;", line = 20)
	@Override
	public Socket method16608() throws IOException {
		@Pc(3) boolean local3 = Boolean.parseBoolean(System.getProperty("java.net.useSystemProxies"));
		if (!local3) {
			System.setProperty("java.net.useSystemProxies", "true");
		}
		...
		try {
			...
			return this.method16599(2055233548);
		}
		local41.addAll(local63);
		@Pc(76) Object[] local76 = local41.toArray();
		@Pc(78) IOException_Sub1 local78 = null;
		...
		for (@Pc(82) int local82 = 0; local82 < local80.length; local82++) {
			...
			@Pc(93) Proxy local93 = (Proxy) local90;
			try {
				@Pc(98) Socket local98 = this.method16612(local93, (byte) 22);
				if (local98 != null) {
					return local98;
				}
			} catch (@Pc(104) IOException_Sub1 local104) {
		...
		return this.method16599(2114740619);
	}

	@OriginalMember(owner = "client!aob", name = "f", descriptor = "()Ljava/net/Socket;", line = 20)
	@Override
	public Socket method16611() throws IOException {
		@Pc(3) boolean local3 = Boolean.parseBoolean(System.getProperty("java.net.useSystemProxies"));
		if (!local3) {
			System.setProperty("java.net.useSystemProxies", "true");
		}
		...
		try {
			...
			return this.method16599(2023867919);
		}
		local41.addAll(local63);
		@Pc(76) Object[] local76 = local41.toArray();
		@Pc(78) IOException_Sub1 local78 = null;
		...
		for (@Pc(82) int local82 = 0; local82 < local80.length; local82++) {
			...
			@Pc(93) Proxy local93 = (Proxy) local90;
			try {
				@Pc(98) Socket local98 = this.method16612(local93, (byte) 13);
				if (local98 != null) {
					return local98;
				}
			} catch (@Pc(104) IOException_Sub1 local104) {
		...
		return this.method16599(2116811866);
	}

	@OriginalMember(owner = "client!aob", name = "w", descriptor = "()Ljava/net/Socket;", line = 20)
	@Override
	public Socket method16609() throws IOException {
		...
		try {
			...
			return this.method16599(2073201035);
		}
		local41.addAll(local63);
		@Pc(76) Object[] local76 = local41.toArray();
		@Pc(78) IOException_Sub1 local78 = null;
		...
		for (@Pc(82) int local82 = 0; local82 < local80.length; local82++) {
			...
			@Pc(93) Proxy local93 = (Proxy) local90;
			try {
				@Pc(98) Socket local98 = this.method16612(local93, (byte) 64);
				if (local98 != null) {
					return local98;
				}
			} catch (@Pc(104) IOException_Sub1 local104) {
		...
		return this.method16599(2028304160);
	}

	@OriginalMember(owner = "client!aob", name = "l", descriptor = "()Ljava/net/Socket;", line = 20)
	@Override
	public Socket method16607() throws IOException {
		...
		try {
			...
			return this.method16599(2094547765);
		}
		local41.addAll(local63);
		@Pc(76) Object[] local76 = local41.toArray();
		@Pc(78) IOException_Sub1 local78 = null;
		...
		for (@Pc(82) int local82 = 0; local82 < local80.length; local82++) {
			...
			@Pc(93) Proxy local93 = (Proxy) local90;
			try {
				@Pc(98) Socket local98 = this.method16612(local93, (byte) 4);
				if (local98 != null) {
					return local98;
				}
			} catch (@Pc(104) IOException_Sub1 local104) {
		...
		return this.method16599(2093991578);
	}

	@OriginalMember(owner = "client!aob", name = "o", descriptor = "(Ljava/net/Proxy;B)Ljava/net/Socket;", line = 59)
	Socket method16612(@OriginalArg(0) Proxy arg0, @OriginalArg(1) byte arg1) throws IOException {
		if (arg0.type() == Type.DIRECT) {
			return this.method16599(2127330538);
		}
		...
		if (arg0.type() == Type.HTTP) {
			...
			return this.method16616(local18.getHostName(), local18.getPort(), local24, -337914294);
	...
	@OriginalMember(owner = "client!aob", name = "y", descriptor = "(Ljava/net/Proxy;)Ljava/net/Socket;", line = 59)
	Socket method16613(@OriginalArg(0) Proxy arg0) throws IOException {
		if (arg0.type() == Type.DIRECT) {
			return this.method16599(2074283699);
		}
		@Pc(10) SocketAddress local10 = arg0.address();
		if (!(local10 instanceof InetSocketAddress)) {
			return null;
		...
		if (arg0.type() == Type.HTTP) {
			...
			return this.method16616(local18.getHostName(), local18.getPort(), local24, 2115244260);
		} else if (arg0.type() == Type.SOCKS) {
			@Pc(175) Socket local175 = new Socket(arg0);
			local175.connect(new InetSocketAddress(this.aString58, this.anInt2384 * -872061967));
			return local175;
	...
	@OriginalMember(owner = "client!aob", name = "q", descriptor = "(Ljava/net/Proxy;)Ljava/net/Socket;", line = 59)
	Socket method16614(@OriginalArg(0) Proxy arg0) throws IOException {
		if (arg0.type() == Type.DIRECT) {
			return this.method16599(2135888376);
		}
		@Pc(10) SocketAddress local10 = arg0.address();
		if (!(local10 instanceof InetSocketAddress)) {
			return null;
		...
		if (arg0.type() == Type.HTTP) {
			...
			return this.method16616(local18.getHostName(), local18.getPort(), local24, -1409837262);
		} else if (arg0.type() == Type.SOCKS) {
			@Pc(175) Socket local175 = new Socket(arg0);
			local175.connect(new InetSocketAddress(this.aString58, this.anInt2384 * -872061967));
			return local175;
	...
	@OriginalMember(owner = "client!aob", name = "x", descriptor = "(Ljava/lang/String;ILjava/lang/String;)Ljava/net/Socket;", line = 97)
	Socket method16615(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2) throws IOException {
	...
	@OriginalMember(owner = "client!aob", name = "s", descriptor = "(Ljava/lang/String;ILjava/lang/String;I)Ljava/net/Socket;", line = 97)
	Socket method16616(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2, @OriginalArg(3) int arg3) throws IOException {
		@Pc(5) Socket local5 = new Socket(arg0, arg1);
		local5.setSoTimeout(10000);
		@Pc(11) OutputStream local11 = local5.getOutputStream();
		if (arg2 == null) {
	...
	@OriginalMember(owner = "client!aob", name = "b", descriptor = "(Ljava/lang/String;ILjava/lang/String;)Ljava/net/Socket;", line = 97)
	Socket method16617(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2) throws IOException {
		@Pc(5) Socket local5 = new Socket(arg0, arg1);
		local5.setSoTimeout(10000);
		@Pc(11) OutputStream local11 = local5.getOutputStream();
		if (arg2 == null) {
	...
	@OriginalMember(owner = "client!aob", name = "h", descriptor = "(Ljava/lang/String;ILjava/lang/String;)Ljava/net/Socket;", line = 97)
	Socket method16618(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2) throws IOException {
		@Pc(5) Socket local5 = new Socket(arg0, arg1);
		local5.setSoTimeout(10000);
		@Pc(11) OutputStream local11 = local5.getOutputStream();
		if (arg2 == null) {
	...
	@OriginalMember(owner = "client!aob", name = "zj", descriptor = "(Lclient!yf;I)V", line = 9419)
	static final void method16619(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
