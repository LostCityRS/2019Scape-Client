...
@ObfuscatedName("adc")
public final class class790 {

	@ObfuscatedName("adc.e")
	public int field9176;

	@ObfuscatedName("adc.n")
	public class1207[] field9177 = new class1207[16];
	...
	public void method15159(Object arg0, Object arg1) {
		...
		class1207 var5 = this.field9177[var4];
		if (var5 == null) {
			this.field9177[var4] = new class1207(arg0, this.field9175, var3, arg1);
			this.field9176++;
		...
		while (var5.get() != arg0) {
			if (var5.field12488 == null) {
				var5.field12488 = new class1207(arg0, this.field9175, var3, arg1);
				this.field9176++;
				if (this.field9176 >= this.field9177.length) {
					this.method15162();
				}
	...
	public void method15160(Object arg0) {
		...
		class1207 var4 = this.field9177[var3];
		if (var4 == null) {
			return;
		}
		if (var4.get() == arg0) {
		...
		while (true) {
			class1207 var5 = var4.field12488;
			if (var5 == null) {
				break;
			}
			if (var5.get() == arg0) {
	...
	public ArrayList method15161() {
		...
		class1207[] var2 = this.field9177;
		for (int var3 = 0; var3 < var2.length; var3++) {
			for (class1207 var4 = var2[var3]; var4 != null; var4 = var4.field12488) {
	...
	public void method15162() {
		class1207[] var1 = this.field9177;
		this.field9177 = new class1207[var1.length * 2];
		class1207[] var2 = var1;
		class1207 var5;
		for (int var3 = 0; var3 < var2.length; var3++) {
			for (class1207 var4 = var2[var3]; var4 != null; var4 = var5) {
	...
	public void method15163() {
		while (true) {
			class1207 var1 = (class1207) this.field9175.poll();
			if (var1 == null) {
				return;
			}
			int var2 = var1.field12489 & this.field9177.length - 1;
			class1207 var3 = this.field9177[var2];
			if (var1 == var3) {
