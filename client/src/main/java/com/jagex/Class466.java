...
public class Class466 {
	...
	public static Class383 method29326(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		@Pc(3) int local3 = arg0.method22465((short) 16384);
		@Pc(10) Class390 local10 = Class708.method36753(745941502)[arg0.method22465((short) 16384)];
		@Pc(17) Class392 local17 = Class252.method25976(2012199832)[arg0.method22465((short) 16384)];
		@Pc(21) int local21 = arg0.method22475((byte) -98);
		@Pc(25) int local25 = arg0.method22475((byte) -64);
	...
	static final void method29327(@OriginalArg(0) int arg0) {
		...
		for (@Pc(4) int local4 = 0; local4 < client.anInt3472 * 146012633; local4++) {
			...
			local2.method22472(-1434290800);
			@Pc(29) int local29 = local2.method22465((short) 16384);
			if ((local29 & 0x2) != 0) {
				local29 += local2.method22465((short) 16384) << 8;
			}
			if ((local29 & 0x200) != 0) {
				local29 += local2.method22465((short) 16384) << 16;
			}
			if ((local29 & 0x100000) != 0) {
				local29 += local2.method22465((short) 16384) << 24;
			}
			@Pc(75) int local75;
			@Pc(79) int local79;
			@Pc(88) int local88;
			...
			if ((local29 & 0x4000000) != 0) {
				local75 = local2.method22602(2095838198);
				local79 = local2.method22651(1306646565);
				if (local75 == 65535) {
					local75 = -1;
				}
				local88 = local2.method22465((short) 16384);
				local92 = local88 & 0x7;
			...
			if ((local29 & 0x2000) != 0) {
				local75 = local2.method22602(2143941252);
				local79 = local2.method22651(-542301339);
				if (local75 == 65535) {
					local75 = -1;
				}
				local88 = local2.method22588(1674129695);
				local92 = local88 & 0x7;
				local98 = local88 >> 3 & 0xF;
				if (local98 == 15) {
					local98 = -1;
			...
			@Pc(205) int local205;
			if ((local29 & 0x1000) != 0) {
				local75 = local2.method22588(1898014329);
				local190 = new int[local75];
				local193 = new int[local75];
				local196 = new int[local75];
				for (local98 = 0; local98 < local75; local98++) {
					local205 = local2.method22542(-1721952417);
					local190[local98] = local205;
					local193[local98] = local2.method22465((short) 16384);
					local196[local98] = local2.method22605(2073931757);
				}
				Class133_Sub1.method10075(local21, local190, local193, local196, (short) 8650);
			}
			if ((local29 & 0x4000) != 0) {
				local75 = local2.method22588(1353614121);
				local190 = new int[local75];
				local193 = new int[local75];
				for (local92 = 0; local92 < local75; local92++) {
					local98 = local2.method22605(1678932452);
					if ((local98 & 0xC000) == 49152) {
						local205 = local2.method22611(16711680);
						local190[local92] = local98 << 16 | local205;
					} else {
						local190[local92] = local98;
					}
					local193[local92] = local2.method22472(-1434290800);
				}
				local21.method19957(local190, local193, 586855086);
			}
			if ((local29 & 0x1000000) != 0) {
				local21.anInt2651 = local2.method22582(1188826845) * -2009901847;
			}
			if ((local29 & 0x1) != 0) {
				local21.anInt2642 = local2.method22602(654892928) * 757135575;
				local21.anInt2643 = local2.method22602(883912003) * -1574519779;
			}
			@Pc(427) int local427;
			if ((local29 & 0x80000) != 0) {
				...
				if ((local88 & 0x1) != 1) {
					...
					local196 = null;
					if ((local88 & 0x2) == 2) {
						local98 = local2.method22465((short) 16384);
						local196 = new int[local98];
						for (local205 = 0; local205 < local98; local205++) {
							local196[local205] = local2.method22542(-1172539681);
						}
					}
					...
					if ((local88 & 0x4) == 4) {
						...
						for (local205 = 0; local205 < local75; local205++) {
							local393[local205] = (short) local2.method22602(1144009982);
						}
					}
					...
					if ((local88 & 0x8) == 8) {
						...
						for (local427 = 0; local427 < local338; local427++) {
							local417[local427] = (short) local2.method22611(16711680);
						}
					}
			...
			if ((local29 & 0x2000000) != 0) {
				local75 = local2.method22472(-1434290800);
				local79 = local2.method22651(2073256971);
				if (local75 == 65535) {
					local75 = -1;
				}
				local88 = local2.method22584(710206131);
				local92 = local88 & 0x7;
				local98 = local88 >> 3 & 0xF;
				if (local98 == 15) {
					local98 = -1;
			...
			if ((local29 & 0x40) != 0) {
				...
				for (local79 = 0; local79 < 4; local79++) {
					local526[local79] = local2.method22542(-372414947);
				}
				local79 = local2.method22584(976186492);
				Class623.method32150(local21, local526, local79, true, 1077554581);
			}
			if ((local29 & 0x800000) != 0) {
				local21.anInt2647 = local2.method22611(16711680) * -1192456509;
			...
			if ((local29 & 0x10) != 0) {
				...
				local21.method18596((Class336) Class162.aClass32_Sub3_2.method18261(local2.method22542(-647151788), 36099140), (local29 & 0x10000) == 0, (local29 & 0x800000) == 0, true, (short) -13155);
			...
			if ((local29 & 0x8000) != 0) {
				local21.anInt2775 = local2.method22591(1634272420) * -1449351677;
				local21.anInt2777 = local2.method22590((byte) 108) * -2034096445;
				local21.anInt2793 = local2.method22590((byte) 97) * -688148243;
				local21.anInt2778 = local2.method22591(-88111444) * 501346955;
				local21.anInt2773 = local2.method22594(-2098689753) * -1861667641;
				local21.anInt2779 = local2.method22594(-324840679) * -1832474127;
				local21.anInt2780 = (local2.method22472(-1434290800) + client.anInt3485) * 755240883;
				local21.anInt2762 = (local2.method22602(1376132446) + client.anInt3485) * 1838812733;
				local21.anInt2782 = local2.method22602(1917824852) * 862199857;
			...
			if ((local29 & 0x10000000) != 0) {
				local21.aByte71 = local2.method22591(-1523047973);
				local21.aByte72 = local2.method22590((byte) 93);
				local21.aByte73 = local2.method22468(2142564635);
				local21.aByte74 = (byte) local2.method22465((short) 16384);
				local21.anInt2789 = (client.anInt3485 + local2.method22472(-1434290800)) * 782633717;
				local21.anInt2796 = (client.anInt3485 + local2.method22602(1879460348)) * 1198097015;
			}
			if ((local29 & 0x20) != 0) {
				local21.anInt2772 = local2.method22611(16711680) * -1158576417;
			...
			if ((local29 & 0x40000) != 0) {
				...
				for (local79 = 0; local79 < local75; local79++) {
					local88 = local2.method22465((short) 16384);
					local92 = local2.method22649(-2097425386);
					local98 = local2.method22631((short) 255);
					local21.method18620(local88, local92, local98, (byte) -67);
				}
			}
			@Pc(1012) int local1012;
			if ((local29 & 0x8) != 0) {
				local75 = local2.method22582(961417425);
				if (local75 > 0) {
					for (local79 = 0; local79 < local75; local79++) {
						local92 = -1;
						@Pc(919) boolean local919 = true;
						local205 = -1;
						local88 = local2.method22528((byte) -13);
						if (local88 == 32767) {
							local88 = local2.method22528((byte) -79);
							local98 = local2.method22528((byte) -13);
							local92 = local2.method22528((byte) -1);
							local205 = local2.method22528((byte) -115);
						} else if (local88 == 32766) {
							local88 = -1;
							local98 = local2.method22584(1042859134);
						} else {
							local98 = local2.method22528((byte) -5);
						}
						local427 = local2.method22528((byte) -22);
						local21.method19972(local88, local98, local92, local205, client.anInt3485, local427, 1078054698);
					}
				}
				local79 = local2.method22582(2032787974);
				if (local79 > 0) {
					for (local88 = 0; local88 < local79; local88++) {
						local92 = local2.method22528((byte) -70);
						local98 = local2.method22528((byte) -81);
						if (local98 == 32767) {
							local21.method19977(local92, -1286239838);
						} else {
							local205 = local2.method22528((byte) -88);
							local427 = local2.method22588(1670788659);
							local1012 = local98 > 0 ? local2.method22465((short) 16384) : local427;
			...
			if ((local29 & 0x200000) != 0) {
				...
				local75 = local2.aByteArray58[(local2.anInt3070 += -1445626955) * 212851357 - 1] & 0xFF;
				for (local79 = 0; local79 < local75; local79++) {
					local88 = local2.method22584(231523518);
			...
			if ((local29 & 0x20000) != 0) {
				local75 = local2.method22582(1308659611);
				local190 = new int[8];
				...
				for (local92 = 0; local92 < 8; local92++) {
					if ((local75 & 0x1 << local92) == 0) {
						...
						local190[local92] = local2.method22542(-2106255594);
						local1108[local92] = (short) local2.method22529((byte) -117);
					}
				}
				local21.aClass334_1 = new Class334(local190, local1108);
			}
			if ((local29 & 0x800) != 0) {
				local21.anInt2646 = local2.method22611(16711680) * 28943715;
				if (local21.anInt2646 * -1509096373 == 65535) {
					local21.anInt2646 = -28943715;
				}
			}
			if ((local29 & 0x4) != 0) {
				local21.method18624(local2.method22509(1248193645), 0, 0, -1233901070);
			}
			if ((local29 & 0x80) != 0) {
				local75 = local2.method22472(-1434290800);
				local79 = local2.method22651(490348612);
				if (local75 == 65535) {
					local75 = -1;
				}
				local88 = local2.method22582(1188811960);
				local92 = local88 & 0x7;
				local98 = local88 >> 3 & 0xF;
				if (local98 == 15) {
					local98 = -1;
			...
			if ((local29 & 0x400) != 0) {
				...
				local88 = local2.method22584(1139090863);
				if ((local88 & 0x1) == 1) {
					...
					if ((local88 & 0x2) == 2) {
						local1012 = local2.method22584(1231939947);
						...
						for (local1328 = 0; local1328 < local1012; local1328++) {
							local196[local1328] = local2.method22542(-513970127);
							if ((local88 & 0x10) == 16 && local196[local1328] != -1) {
								local1292[local1328] = local2.method22504(743708755);
								for (local1355 = 0; local1355 < 3; local1355++) {
									local1295[local1328][local1355] = local2.method22615(-482934812);
								}
								for (local1355 = 0; local1355 < 3; local1355++) {
									local1298[local1328][local1355] = local2.method22475((byte) -64);
								}
							}
						}
					}
					...
					if ((local88 & 0x4) == 4) {
						...
						for (local1328 = 0; local1328 < local75; local1328++) {
							local1387[local1328] = (short) local2.method22472(-1434290800);
						}
					}
					...
					if ((local88 & 0x8) == 8) {
						...
						for (local1355 = 0; local1355 < local79; local1355++) {
							local1411[local1355] = (short) local2.method22472(-1434290800);
						}
					}
			...
			if ((local29 & 0x10000) != 0) {
				local21.aString66 = local2.method22509(334387251);
			...
			if ((local29 & 0x20000000) != 0) {
				local21.aBoolean451 = local2.method22465((short) 16384) == 1;
			}
			if ((local29 & 0x8000000) != 0) {
				local75 = local2.method22472(-1434290800);
				local79 = local2.method22651(1283648522);
				if (local75 == 65535) {
					local75 = -1;
				}
				local88 = local2.method22465((short) 16384);
			...
			if ((local29 & 0x400000) != 0) {
				...
				local75 = local2.aByteArray58[(local2.anInt3070 += -1445626955) * 212851357 - 1] & 0xFF;
				for (local79 = 0; local79 < local75; local79++) {
					local88 = local2.method22588(1418372123);
