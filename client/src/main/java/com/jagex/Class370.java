...
public final class Class370 {
	...
	final boolean aBoolean746;

	@OriginalMember(owner = "client!jw", name = "n", descriptor = "()[Lclient!jw;")
	static Class370[] method28173() {
	...
	@OriginalMember(owner = "client!jw", name = "e", descriptor = "(I)[Lclient!jw;")
	static Class370[] method28174(@OriginalArg(0) int arg0) {
		return new Class370[] { aClass370_15, aClass370_13, aClass370_7, aClass370_8, aClass370_9, aClass370_10, aClass370_22, aClass370_11, aClass370_12, aClass370_5, aClass370_14, aClass370_20, aClass370_16, aClass370_17, aClass370_18, aClass370_19, aClass370_6, aClass370_21 };
	}

	@OriginalMember(owner = "client!jw", name = "m", descriptor = "()[Lclient!jw;")
	static Class370[] method28175() {
		return new Class370[] { aClass370_15, aClass370_13, aClass370_7, aClass370_8, aClass370_9, aClass370_10, aClass370_22, aClass370_11, aClass370_12, aClass370_5, aClass370_14, aClass370_20, aClass370_16, aClass370_17, aClass370_18, aClass370_19, aClass370_6, aClass370_21 };
	}

	@OriginalMember(owner = "client!jw", name = "w", descriptor = "(Lclient!un;I)V")
	static void method28176(@OriginalArg(0) Interface63 arg0, @OriginalArg(1) int arg1) {
		while (Class602.aLinkedList6.size() > 10) {
			Class602.aLinkedList6.remove();
		}
		Class602.aLinkedList6.add(arg0);
	}

	@OriginalMember(owner = "client!jw", name = "n", descriptor = "([Ljava/lang/String;[IIII)V")
	static void method28177(@OriginalArg(0) String[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg2 >= arg3) {
			return;
		}
		...
		method28177(arg0, arg1, arg2, local10 - 1, -1781939446);
		method28177(arg0, arg1, local10 + 1, arg3, -1789319955);
	}

	@OriginalMember(owner = "client!jw", name = "ad", descriptor = "(I)Lclient!arm;")
	public static Class93_Sub1_Sub7 method28178(@OriginalArg(0) int arg0) {
		return Class112_Sub1_Sub1.aClass93_Sub1_Sub7_4;
	}

	@OriginalMember(owner = "client!jw", name = "adm", descriptor = "(Lclient!yf;I)V")
	static void method28179(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anInt6052 -= -1915563430;
		@Pc(13) int local13 = arg0.anIntArray521[arg0.anInt6052 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray521[arg0.anInt6052 * -1497248091 + 1];
		@Pc(31) int local31 = client.aClass531ArrayArray1[local23][local13].method30607(1054603989);
		arg0.anIntArray521[(arg0.anInt6052 += 1189701933) * -1497248091 - 1] = local31 == 0 ? 1 : 0;
	}

	@OriginalMember(owner = "client!jw", name = "nj", descriptor = "(Lclient!hf;Lclient!hq;Lclient!yf;B)V")
	static void method28180(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) byte arg3) {
		...
		arg0.anObjectArray6 = Class499.method30329(local13, arg2, 166262505);
		arg0.aBoolean684 = true;
	}

	@OriginalMember(owner = "client!jw", name = "<init>", descriptor = "(ILclient!acz;I)V")
	...
	@OriginalMember(owner = "client!jw", name = "<init>", descriptor = "(ILclient!acz;Lclient!acz;II)V")
	...
	@OriginalMember(owner = "client!jw", name = "<init>", descriptor = "(ILclient!acz;Lclient!acz;IIZZ)V")
	Class370(@OriginalArg(0) int arg0, @OriginalArg(1) Class74 arg1, @OriginalArg(2) Class74 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) boolean arg6) {
		this.anInt4751 = arg0 * -1713782973;
		this.aClass74_177 = arg1;
		this.aClass74_178 = arg2;
		this.anInt4752 = arg3 * -780450739;
		this.anInt4753 = arg4 * -614044493;
		this.aBoolean745 = arg5;
		this.aBoolean746 = arg6;
	}
}
