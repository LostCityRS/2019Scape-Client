...
public interface Interface47 {
	...
	Class431 method29056(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1);

	@OriginalMember(owner = "client!np", name = "m", descriptor = "(I)Lclient!na;")
	Class431 method29057(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!np", name = "k", descriptor = "(I)Lclient!na;")
	Class431 method29058(@OriginalArg(0) int arg0);
}
