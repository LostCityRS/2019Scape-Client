...
public class Class93_Sub1_Sub2 extends Class93_Sub1 implements Interface13, Interface5 {
	...
	void method1784(@OriginalArg(0) Packet arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg1 == 2) {
			this.anInt316 = arg0.g2(-1434290800) * -21466175;
		} else if (arg1 == 4) {
			this.anInt317 = arg0.g1((short) 16384) * 1466249681;
			...
			for (@Pc(36) int local36 = 0; local36 < this.anInt317 * 795395889; local36++) {
				this.anIntArray25[local36] = arg0.g2(-1434290800);
				this.anIntArray24[local36] = arg0.g2(-1434290800);
			}
		}
	}

	@OriginalMember(owner = "client!ady", name = "p", descriptor = "(Lclient!alw;I)V", line = 26)
	void method1785(@OriginalArg(0) Packet arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 2) {
			this.anInt316 = arg0.g2(-1434290800) * -21466175;
		} else if (arg1 == 4) {
			this.anInt317 = arg0.g1((short) 16384) * 1466249681;
	...
	void method1786(@OriginalArg(0) Packet arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 2) {
			this.anInt316 = arg0.g2(-1434290800) * -21466175;
		} else if (arg1 == 4) {
			this.anInt317 = arg0.g1((short) 16384) * 1466249681;
