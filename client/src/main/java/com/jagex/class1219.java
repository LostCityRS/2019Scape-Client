...
@ObfuscatedName("atz")
public class class1219 extends class1144 {
	...
	public class1219(class632 arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13, boolean arg14, boolean arg15) {
		this.field12526 = arg0;
		this.field12159 = arg1 << 12;
		this.field12163 = arg2 << 12;
		this.field12161 = arg3 << 12;
	...
	public void method19665(class632 arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13, boolean arg14, boolean arg15) {
		this.field12526 = arg0;
		this.field12159 = arg1 << 12;
		this.field12163 = arg2 << 12;
		this.field12161 = arg3 << 12;
	...
	public void method19666() {
		...
		this.field12526.field7775.method14243(this);
	}
	...
	public void method19667(long arg0, int arg1) {
		...
		int var4 = this.field12159 >> 12;
		int var5 = this.field12163 >> 12;
		int var6 = this.field12161 >> 12;
		class634 var7 = this.field12526.field7785;
						...
						if (!(var47 < (double) var34.field3554)) {
							...
							if (var34.field3561 != 0) {
								...
								if (var34.field3542 == 0) {
									...
									this.field12159 = (int) ((double) this.field12159 + (double) arg1 * var51);
									this.field12163 = (int) ((double) this.field12163 + (double) arg1 * var53);
									this.field12161 = (int) ((double) this.field12161 + (double) arg1 * var55);
								}
								...
								this.field12159 = (int) ((double) this.field12159 + ((double) var33.field11486 - var49) * (double) arg1);
								this.field12163 = (int) ((double) this.field12163 + ((double) var34.field3552 - var49) * (double) arg1);
								this.field12161 = (int) ((double) this.field12161 + ((double) var33.field11487 - var49) * (double) arg1);
							}
						}
					}
				}
		...
		if (var8.field3487 != null) {
			label207: for (int var57 = 0; var57 < var8.field3487.length; var57++) {
				class995 var58 = (class995) class633.field7800.method14495((long) var8.field3487[var57]);
				while (true) {
					while (true) {
						if (var58 == null) {
							continue label207;
						...
						if (var66 > (double) var59.field3560) {
							var58 = (class995) class633.field7800.method14496();
						} else {
							...
							if (var59.field3561 != 0) {
								...
								if (var59.field3542 == 0) {
									...
									this.field12159 = (int) ((double) this.field12159 + (double) arg1 * var74);
									this.field12163 = (int) ((double) this.field12163 + (double) arg1 * var76);
									this.field12161 = (int) ((double) this.field12161 + (double) arg1 * var78);
								}
								...
								this.field12159 = (int) ((double) this.field12159 + ((double) var58.field11486 - var72) * (double) arg1);
								this.field12163 = (int) ((double) this.field12163 + ((double) var59.field3552 - var72) * (double) arg1);
								this.field12161 = (int) ((double) this.field12161 + ((double) var58.field11487 - var72) * (double) arg1);
							}
							var58 = (class995) class633.field7800.method14496();
						}
					}
		...
		if (var8.field3512 != null) {
			if (var8.field3489 == null) {
				...
				for (int var80 = 0; var80 < var8.field3512.length; var80++) {
					...
					var8.field3489[var80] = class633.method9543(var8.field3512[var80]);
				}
			}
			for (int var81 = 0; var81 < var8.field3489.length; var81++) {
				...
				if (var82.field3542 == 0) {
					...
					this.field12159 += var82.field3551 * arg1;
					this.field12163 += var82.field3552 * arg1;
					this.field12161 += var82.field3553 * arg1;
				}
			}
		}
		if (var19) {
		...
		this.field12159 = (int) ((long) this.field12159 + ((long) (this.field12522 << 2) * (long) this.field12530 >> 23) * (long) arg1);
		this.field12163 = (int) ((long) this.field12163 + ((long) (this.field12522 << 2) * (long) this.field12529 >> 23) * (long) arg1);
		this.field12161 = (int) ((long) this.field12161 + ((long) (this.field12522 << 2) * (long) this.field12528 >> 23) * (long) arg1);
	}
	...
	public void method19668(class550 arg0, class133 arg1, long arg2) {
		...
		class634 var8 = this.field12526.field7785;
		...
		if (var9.field3526 && var15 == 0 && var7 > var10[0].method1529(var5, var6)) {
			...
			var8.field7816.field1367.method14270(this);
		}
	}
	...
	public void method19669() {
		...
		Statics.field7794[class633.field7797] = this;
		class633.field7797 = class633.field7797 + 1 & 0x3FF;
		this.method8433();
		this.method17453();
	}
}
