...
@ObfuscatedName("jg")
public class LZMABitTreeDecoder {
	...
	public LZMABitTreeDecoder(int arg0) {
		this.field3004 = arg0;
	...
	public void method5057() {
		LZMARangeDecoder.method3545(this.field3003);
	}

	@ObfuscatedName("jg.n(Ljp;B)I")
	public int method5058(LZMARangeDecoder arg0) throws IOException {
		int var2 = 1;
	...
	public int method5061(LZMARangeDecoder arg0) throws IOException {
		int var2 = 1;
		int var3 = 0;
