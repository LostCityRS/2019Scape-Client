...
public final class Class99_Sub2 extends Class99 {
	...
	@OriginalMember(owner = "client!aek", name = "<init>", descriptor = "(Lclient!afa;IIII[[I[[II)V")
	...
	@OriginalMember(owner = "client!aek", name = "q", descriptor = "(II[I[I[I[I[I[I[I[ILclient!dy;Z)V")
	@Override
	public void method2473(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) Class237 arg10, @OriginalArg(11) boolean arg11) {
		...
		for (@Pc(96) int local96 = 0; local96 < arg6.length; local96++) {
			...
			if ((this.anInt371 & 0x20) != 0 && local104 != -1 && local3.method25690(local104, -91128412).aBoolean660) {
				local108 = 128;
				local104 = -1;
			}
			...
			for (local163 = this.aClass16_4.method215(local158); local163 != null; local163 = this.aClass16_4.method216(-1796956099)) {
				@Pc(168) Class93_Sub24 local168 = (Class93_Sub24) local163;
				if (local168.anInt1580 == local104 && local168.aFloat149 == (float) local108 && local168.aClass237_4.method25862(arg10, 828378821)) {
					break;
				}
			}
			if (local163 == null) {
				local94[local96] = new Class93_Sub24(this, local104, local108, arg10);
				this.aClass16_4.method221(local94[local96], local158);
			} else {
	...
	@OriginalMember(owner = "client!aek", name = "e", descriptor = "(III)V")
	@Override
	...
	@OriginalMember(owner = "client!aek", name = "o", descriptor = "(Lclient!akf;[I)V")
	@Override
	public void method2502(@OriginalArg(0) Class93_Sub16 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass22_3.method407(new Class93_Sub7(this.aClass104_Sub1_12, this, arg0, arg1), -1689919484);
	}

	@OriginalMember(owner = "client!aek", name = "ah", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[ILclient!dy;Z)V")
	@Override
	public void method2476(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) int[] arg10, @OriginalArg(11) int[] arg11, @OriginalArg(12) int[] arg12, @OriginalArg(13) Class237 arg13, @OriginalArg(14) boolean arg14) {
		...
		this.method2510(arg0, arg1, local7, local45, local12, local54, local17, local26, local31, local36, arg13, arg14);
	}

	@OriginalMember(owner = "client!aek", name = "k", descriptor = "()V")
	@Override
	public void method2508() {
		if (this.anInt375 > 0) {
			...
			this.aClass93Array2 = new Class93[this.aClass16_4.method218(9120952)];
			this.aClass16_4.method217(this.aClass93Array2, (byte) 0);
			for (local18 = 0; local18 < this.aClass93Array2.length; local18++) {
				((Class93_Sub24) this.aClass93Array2[local18]).method13759(this.anInt375);
			}
			local18 = 24;
			if (this.anIntArrayArrayArray5 != null) {
				local18 += 4;
			...
			@Pc(147) NativeHeapBuffer local147 = this.aClass104_Sub1_12.aNativeHeap1.method27847(this.anInt375 * local18, false);
			@Pc(152) Stream local152 = new Stream(local147);
			@Pc(156) Class93_Sub24[] local156 = new Class93_Sub24[this.anInt375];
			@Pc(163) int local163 = Class278.method26458(this.anInt375 / 4, 423254006);
			if (local163 < 1) {
				local163 = 1;
			}
					...
					if (this.anIntArrayArrayArray2[local179][local187] != null) {
						...
						for (@Pc(462) int local462 = 0; local462 < local236.length; local462++) {
							...
							if (local502 != -1) {
								...
								local544 = Class685.anIntArray526[local502 & 0xFF80 | local764];
								if ((this.anInt371 & 0x7) == 0) {
							...
							if ((local477 & this.anInt370 - 1) == 0 && (local488 & this.anInt370 - 1) == 0) {
								local832 = local173.method215(local532);
							}
							@Pc(882) int local882;
							if (local832 == null) {
								if (local506 == local502) {
									...
									local882 = Class685.anIntArray526[local506 & 0xFF80 | local863];
									if ((this.anInt371 & 0x7) == 0) {
								...
								if (this.aClass104_Sub1_12.aBoolean106) {
									local152.method27824((float) local477);
									local152.method27824((float) (this.method2480(local477, local488, 1750322892) + local514));
									local152.method27824((float) local488);
									local152.method27823((byte) (local882 >> 16));
									local152.method27823((byte) (local882 >> 8));
									local152.method27823((byte) local882);
									local152.method27823(-1);
									local152.method27824((float) local477);
									local152.method27824((float) local488);
									if (this.anIntArrayArrayArray5 != null) {
										local152.method27824(local260 == null ? 0.0F : (float) (local260[local462] - 1));
									}
									if ((this.anInt371 & 0x7) != 0) {
										local152.method27824(local552);
										local152.method27824(local554);
										local152.method27824(local556);
									}
								} else {
									local152.method27825((float) local477);
									local152.method27825((float) (this.method2480(local477, local488, 259227285) + local514));
									local152.method27825((float) local488);
									local152.method27823((byte) (local882 >> 16));
									local152.method27823((byte) (local882 >> 8));
									local152.method27823((byte) local882);
									local152.method27823(-1);
									...
									local152.method27825((float) local488);
									if (this.anIntArrayArrayArray5 != null) {
										local152.method27825(local260 == null ? 0.0F : (float) (local260[local462] - 1));
									}
									if ((this.anInt371 & 0x7) != 0) {
										local152.method27825(local552);
										local152.method27825(local554);
										local152.method27825(local556);
									}
								}
								...
								local173.method221(new Class93_Sub20(local460[local462]), local532);
							} else {
							...
							for (local882 = 0; local882 < local414; local882++) {
								local177[local882].method13763(local426, local544, local560, local546);
							}
							this.anInt372++;
						}
					}
			...
			for (local179 = 0; local179 < this.anInt373; local179++) {
				...
				if (local1263 != null) {
					local1263.method13762(local179);
				}
			}
			for (local179 = 0; local179 < this.anInt414 * -1667858293; local179++) {
				for (local187 = 0; local187 < this.anInt413 * -143202029; local187++) {
					...
					if (local1298 != null) {
						...
						while (local1304 < local1298.length) {
							...
							if (local1343 != null) {
								if (local1333 != null) {
									local1343.method13762(local1315);
								}
								if (local1337 != null) {
									local1343.method13762(local1322);
								}
								if (local1341 != null) {
									local1343.method13762(local1329);
								}
			...
			local152.method27826();
			this.anInterface14_1 = this.aClass104_Sub1_12.method3831(local18, local147, local152.method27821(), false);
			if (this.anInterface14_1 instanceof Class98_Sub2) {
				local147.method27867();
			}
			...
			for (@Pc(1510) int local1510 = 0; local1510 < this.aClass93Array2.length; local1510++) {
				...
				local1521.method13778(this.anInt373);
			}
			Class659.method32994(local1508, this.aClass93Array2, -918281734);
			if (this.aClass205_1 != null) {
				this.aClass205_1.method24686();
			}
		} else {
	...
	@OriginalMember(owner = "client!aek", name = "f", descriptor = "(III[[ZZI)V")
	@Override
	...
	@OriginalMember(owner = "client!aek", name = "av", descriptor = "(III[[ZZI)V")
	void method2375(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		...
		this.aClass104_Sub1_12.method3791((this.anInt371 & 0x7) != 0);
		for (local109 = 0; local109 < this.aClass93Array2.length; local109++) {
			((Class93_Sub24) this.aClass93Array2[local109]).method13764(local107, local103);
		}
		if (!this.aClass22_3.method418(2030795427)) {
			local109 = this.aClass104_Sub1_12.anInt562;
			@Pc(191) int local191 = this.aClass104_Sub1_12.anInt563;
			this.aClass104_Sub1_12.method20883(0, local191, this.aClass104_Sub1_12.anInt564);
			this.aClass104_Sub1_12.method3791(false);
			this.aClass104_Sub1_12.method3816(false);
			this.aClass104_Sub1_12.method3818(128);
			this.aClass104_Sub1_12.method3801(-2);
			this.aClass104_Sub1_12.method3804(this.aClass104_Sub1_12.aClass88_Sub2_2);
			this.aClass104_Sub1_12.method3837(8448, 7681);
			this.aClass104_Sub1_12.method3807(0, 34166, 770);
			this.aClass104_Sub1_12.method3808(0, 34167, 770);
			for (@Pc(243) Class93 local243 = this.aClass22_3.method445((byte) 25); local243 != null; local243 = this.aClass22_3.method415(1743816892)) {
				@Pc(248) Class93_Sub7 local248 = (Class93_Sub7) local243;
				local248.method12730(arg0, arg1, arg2, arg3);
			}
			this.aClass104_Sub1_12.method3807(0, 5890, 768);
			this.aClass104_Sub1_12.method3808(0, 5890, 770);
			this.aClass104_Sub1_12.method3804(null);
			this.aClass104_Sub1_12.method20883(local109, local191, this.aClass104_Sub1_12.anInt564);
		}
		if (this.aClass205_1 == null) {
			return;
		}
		...
		this.aClass104_Sub1_12.method3836(this.aClass193_1, null, null, this.aClass193_3);
		this.aClass205_1.method24688(arg0, arg1, arg2, arg3, arg4);
		OpenGL.glPopMatrix();
	}

	@OriginalMember(owner = "client!aek", name = "w", descriptor = "(IIIIIII[[Z)V")
	@Override
	public void method2479(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean[][] arg7) {
		@Pc(4) Class112 local4 = this.aClass104_Sub1_12.method20446((byte) -19);
		if (this.anInt375 <= 0 || local4 == null) {
			return;
		}
		this.aClass104_Sub1_12.method3775();
		this.aClass104_Sub1_12.method3765(false);
		this.aClass104_Sub1_12.method3791(false);
		this.aClass104_Sub1_12.method3815(false);
		this.aClass104_Sub1_12.method3816(false);
		this.aClass104_Sub1_12.method3818(0);
		this.aClass104_Sub1_12.method3801(-2);
		this.aClass104_Sub1_12.method3804(null);
		aFloatArray2[0] = (float) arg2 / ((float) (this.anInt412 * -1678286317) * 128.0F * (float) local4.method23748());
		aFloatArray2[1] = 0.0F;
		aFloatArray2[2] = 0.0F;
		aFloatArray2[3] = 0.0F;
		aFloatArray2[4] = 0.0F;
		aFloatArray2[5] = (float) arg2 / ((float) (this.anInt412 * -1678286317) * 128.0F * (float) local4.method23749());
		aFloatArray2[6] = 0.0F;
		aFloatArray2[7] = 0.0F;
		aFloatArray2[8] = 0.0F;
		aFloatArray2[9] = 0.0F;
		...
		aFloatArray2[12] = -1.0F - ((float) (arg3 * arg2) / 128.0F - (float) (arg0 * 2)) / (float) local4.method23748();
		aFloatArray2[13] = 1.0F - ((float) (arg1 * 2) + (float) (arg6 * arg2) / 128.0F) / (float) local4.method23749();
		...
		if ((this.anInt371 & 0x7) == 0) {
			...
			this.aClass104_Sub1_12.method3791(true);
			this.aClass104_Sub1_12.method3785();
		}
		this.aClass104_Sub1_12.method3836(this.aClass193_1, this.aClass193_4, this.aClass193_2, this.aClass193_3);
		if (this.aClass104_Sub1_12.aClass93_Sub41_Sub1_1.aByteArray58.length < this.anInt372 * 2) {
			this.aClass104_Sub1_12.aClass93_Sub41_Sub1_1 = new Class93_Sub41_Sub1(this.anInt372 * 2);
		} else {
					...
					if (arg7[local317 - arg3][local303 - arg4]) {
						...
						if (local335 != null) {
							for (local339 = 0; local339 < local335.length; local339++) {
								local297.method22466(local335[local339] & 0xFFFF, 2128220850);
								local293++;
							}
						}
					}
			...
			for (local303 = arg4; local303 < arg6; local303++) {
				...
				for (local317 = arg3; local317 < arg5; local317++) {
					if (arg7[local317 - arg3][local303 - arg4]) {
						...
						if (local335 != null) {
							for (local339 = 0; local339 < local335.length; local339++) {
								local297.method22405(local335[local339] & 0xFFFF, -1264950894);
								local293++;
							}
						}
					}
		...
		if (local293 > 0) {
			...
			this.aClass104_Sub1_12.method3948(local433, 4, 0, local293);
		}
	}

	@OriginalMember(owner = "client!aek", name = "d", descriptor = "(IILclient!ara;)Lclient!ara;")
	@Override
	public Class93_Sub1_Sub4 method2484(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class93_Sub1_Sub4 arg2) {
		...
		local31.method23531(0, 0, local19, local19);
		this.method2378(local31, arg0, arg1);
		return local31;
	}

	@OriginalMember(owner = "client!aek", name = "v", descriptor = "(Lclient!ara;IIIIZ)Z")
	@Override
	public boolean method2488(@OriginalArg(0) Class93_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		if (this.aClass205_1 == null || arg0 == null) {
			...
			return this.aClass205_1.method24698(arg0, local20, local34);
		}
	}

	@OriginalMember(owner = "client!aek", name = "c", descriptor = "(Lclient!ara;IIIIZ)V")
	@Override
	public void method2485(@OriginalArg(0) Class93_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		if (this.aClass205_1 != null && arg0 != null) {
			...
			this.aClass205_1.method24689(arg0, local19, local33);
		}
	}

	@OriginalMember(owner = "client!aek", name = "n", descriptor = "(II[I[I[I[I[I[I[I[ILclient!dy;Z)V")
	@Override
	public void method2510(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) Class237 arg10, @OriginalArg(11) boolean arg11) {
		...
		for (@Pc(96) int local96 = 0; local96 < arg6.length; local96++) {
			@Pc(104) int local104 = arg8[local96];
			@Pc(108) int local108 = arg9[local96];
			if ((this.anInt371 & 0x20) != 0 && local104 != -1 && local3.method25690(local104, -700060366).aBoolean660) {
				local108 = 128;
				local104 = -1;
			}
			@Pc(158) long local158 = (long) (arg10.anInt3860 * -94478965) << 48 | (long) (arg10.anInt3856 * -2052057497) << 42 | (long) (arg10.anInt3858 * -1393096381) << 28 | (long) (local108 << 14) | (long) local104;
			...
			for (local163 = this.aClass16_4.method215(local158); local163 != null; local163 = this.aClass16_4.method216(-1796956099)) {
				@Pc(168) Class93_Sub24 local168 = (Class93_Sub24) local163;
				if (local168.anInt1580 == local104 && local168.aFloat149 == (float) local108 && local168.aClass237_4.method25862(arg10, -1314162580)) {
					break;
				}
			}
			if (local163 == null) {
	...
	@OriginalMember(owner = "client!aek", name = "s", descriptor = "(III)V")
	@Override
	...
	@OriginalMember(owner = "client!aek", name = "aw", descriptor = "(Lclient!ara;IIIIZ)Z")
	@Override
	...
	@OriginalMember(owner = "client!aek", name = "r", descriptor = "(Lclient!ara;IIIIZ)V")
	@Override
	public void method2496(@OriginalArg(0) Class93_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		if (this.aClass205_1 != null && arg0 != null) {
			@Pc(19) int local19 = arg1 - (arg2 * this.aClass104_Sub1_12.anInt545 >> 8) >> this.aClass104_Sub1_12.anInt532;
			@Pc(33) int local33 = arg3 - (arg2 * this.aClass104_Sub1_12.anInt561 >> 8) >> this.aClass104_Sub1_12.anInt532;
			this.aClass205_1.method24690(arg0, local19, local33);
		}
	}

	@OriginalMember(owner = "client!aek", name = "a", descriptor = "(III[[ZZI)V")
	@Override
	...
	@OriginalMember(owner = "client!aek", name = "at", descriptor = "(Lclient!ara;IIIIZ)V")
	@Override
	...
	@OriginalMember(owner = "client!aek", name = "b", descriptor = "()V")
	@Override
	public void method2493() {
		if (this.anInt375 > 0) {
			...
			this.aClass93Array2 = new Class93[this.aClass16_4.method218(-357268688)];
			this.aClass16_4.method217(this.aClass93Array2, (byte) 0);
			for (local18 = 0; local18 < this.aClass93Array2.length; local18++) {
				((Class93_Sub24) this.aClass93Array2[local18]).method13759(this.anInt375);
			}
					...
					if (this.anIntArrayArrayArray2[local179][local187] != null) {
						...
						for (@Pc(462) int local462 = 0; local462 < local236.length; local462++) {
							...
							if (local832 == null) {
								...
								if (this.aClass104_Sub1_12.aBoolean106) {
									local152.method27824((float) local477);
									local152.method27824((float) (this.method2480(local477, local488, 1865195099) + local514));
									local152.method27824((float) local488);
									local152.method27823((byte) (local882 >> 16));
									local152.method27823((byte) (local882 >> 8));
									local152.method27823((byte) local882);
									...
									local152.method27825((float) local477);
									local152.method27825((float) (this.method2480(local477, local488, 233266667) + local514));
									local152.method27825((float) local488);
									local152.method27823((byte) (local882 >> 16));
									local152.method27823((byte) (local882 >> 8));
									local152.method27823((byte) local882);
			...
			Class659.method32994(local1508, this.aClass93Array2, 508634997);
			if (this.aClass205_1 != null) {
				this.aClass205_1.method24686();
			}
		} else {
	...
	@OriginalMember(owner = "client!aek", name = "h", descriptor = "(III[[ZZI)V")
	@Override
	...
	@OriginalMember(owner = "client!aek", name = "x", descriptor = "()V")
	@Override
	public void method2492() {
		if (this.anInt375 > 0) {
			...
			this.aClass93Array2 = new Class93[this.aClass16_4.method218(-410959358)];
			this.aClass16_4.method217(this.aClass93Array2, (byte) 0);
			for (local18 = 0; local18 < this.aClass93Array2.length; local18++) {
				((Class93_Sub24) this.aClass93Array2[local18]).method13759(this.anInt375);
			}
					...
					if (this.anIntArrayArrayArray2[local179][local187] != null) {
						...
						for (@Pc(462) int local462 = 0; local462 < local236.length; local462++) {
							...
							if (local832 == null) {
								...
								if (this.aClass104_Sub1_12.aBoolean106) {
									local152.method27824((float) local477);
									local152.method27824((float) (this.method2480(local477, local488, 463942841) + local514));
									local152.method27824((float) local488);
									local152.method27823((byte) (local882 >> 16));
									local152.method27823((byte) (local882 >> 8));
									local152.method27823((byte) local882);
									...
									local152.method27825((float) local477);
									local152.method27825((float) (this.method2480(local477, local488, 965784631) + local514));
									local152.method27825((float) local488);
									local152.method27823((byte) (local882 >> 16));
									local152.method27823((byte) (local882 >> 8));
									local152.method27823((byte) local882);
			...
			Class659.method32994(local1508, this.aClass93Array2, -795209226);
			if (this.aClass205_1 != null) {
				this.aClass205_1.method24686();
			}
		} else {
	...
	@OriginalMember(owner = "client!aek", name = "g", descriptor = "(IILclient!ara;)Lclient!ara;")
	@Override
	...
	@OriginalMember(owner = "client!aek", name = "i", descriptor = "(IILclient!ara;)Lclient!ara;")
	@Override
	...
	@OriginalMember(owner = "client!aek", name = "j", descriptor = "(Lclient!ara;IIIIZ)V")
	@Override
	...
	@OriginalMember(owner = "client!aek", name = "t", descriptor = "(Lclient!ara;IIIIZ)V")
	@Override
	...
	@OriginalMember(owner = "client!aek", name = "ae", descriptor = "(Lclient!akf;[I)V")
	@Override
	public void method2489(@OriginalArg(0) Class93_Sub16 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass22_3.method407(new Class93_Sub7(this.aClass104_Sub1_12, this, arg0, arg1), -920408881);
	}

	@OriginalMember(owner = "client!aek", name = "ag", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[ILclient!dy;Z)V")
	@Override
	...
	@OriginalMember(owner = "client!aek", name = "m", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[ILclient!dy;Z)V")
	@Override
	...
	@OriginalMember(owner = "client!aek", name = "al", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[ILclient!dy;Z)V")
	@Override
	...
	@OriginalMember(owner = "client!aek", name = "ac", descriptor = "(IIIIIII[[Z)V")
	@Override
	public void method2490(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean[][] arg7) {
		@Pc(4) Class112 local4 = this.aClass104_Sub1_12.method20446((byte) -32);
		if (this.anInt375 <= 0 || local4 == null) {
			return;
		}
		this.aClass104_Sub1_12.method3775();
			...
			for (local303 = arg4; local303 < arg6; local303++) {
				...
				for (local317 = arg3; local317 < arg5; local317++) {
					if (arg7[local317 - arg3][local303 - arg4]) {
						...
						if (local335 != null) {
							for (local339 = 0; local339 < local335.length; local339++) {
								local297.method22466(local335[local339] & 0xFFFF, 2137778762);
								local293++;
							}
						}
					}
			...
			for (local303 = arg4; local303 < arg6; local303++) {
				...
				for (local317 = arg3; local317 < arg5; local317++) {
					if (arg7[local317 - arg3][local303 - arg4]) {
						...
						if (local335 != null) {
							for (local339 = 0; local339 < local335.length; local339++) {
								local297.method22405(local335[local339] & 0xFFFF, -1511005770);
								local293++;
							}
						}
					}
	...
	@OriginalMember(owner = "client!aek", name = "y", descriptor = "(III)V")
	@Override
	...
	@OriginalMember(owner = "client!aek", name = "aj", descriptor = "(Lclient!atk;II)V")
	void method2376(@OriginalArg(0) Class93_Sub1_Sub4_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		while (local42 < local16) {
			...
			if ((local76 - local85) * (local90 - local99) - (local90 - local81) * (local94 - local85) > 0) {
				arg0.method23534(local81, local90, local99, local76, local85, local94);
			}
		}
	}

	@OriginalMember(owner = "client!aek", name = "ay", descriptor = "(Lclient!atk;II)V")
	...
	@OriginalMember(owner = "client!aek", name = "ai", descriptor = "(IIIIIII[[Z)V")
	@Override
	public void method2504(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean[][] arg7) {
		@Pc(4) Class112 local4 = this.aClass104_Sub1_12.method20446((byte) -114);
		if (this.anInt375 <= 0 || local4 == null) {
			return;
		}
		this.aClass104_Sub1_12.method3775();
			...
			for (local303 = arg4; local303 < arg6; local303++) {
				...
				for (local317 = arg3; local317 < arg5; local317++) {
					if (arg7[local317 - arg3][local303 - arg4]) {
						...
						if (local335 != null) {
							for (local339 = 0; local339 < local335.length; local339++) {
								local297.method22466(local335[local339] & 0xFFFF, 2147368472);
								local293++;
							}
						}
					}
			...
			for (local303 = arg4; local303 < arg6; local303++) {
				...
				for (local317 = arg3; local317 < arg5; local317++) {
					if (arg7[local317 - arg3][local303 - arg4]) {
						...
						if (local335 != null) {
							for (local339 = 0; local339 < local335.length; local339++) {
								local297.method22405(local335[local339] & 0xFFFF, -1813383815);
								local293++;
							}
						}
					}
	...
	@OriginalMember(owner = "client!aek", name = "as", descriptor = "(Lclient!ara;IIIIZ)Z")
	@Override
	...
	@OriginalMember(owner = "client!aek", name = "ao", descriptor = "(Lclient!atk;II)V")
