...
public class LookatSpline_Sub1 extends LookatSpline {
	...
	public float method18835(float arg0, float arg1, float arg2) {
		...
		if (this.camera.method4794().x == Float.POSITIVE_INFINITY) {
			arg1 = this.camera.method4728().length();
		} else {
			float var5 = arg1 / this.camera.method4794().length();
			float var6 = arg1 / 2.0F * var5;
			if (var6 > var4) {
				arg1 -= this.camera.method4794().length() * arg2;
				if (arg1 < 0.0F) {
					arg1 = 0.0F;
				}
			} else if (arg1 < this.camera.method4728().length()) {
				arg1 += this.camera.method4794().length() * arg2;
				if (arg1 > this.camera.method4728().length()) {
					arg1 = this.camera.method4728().length();
				}
			}
		}
