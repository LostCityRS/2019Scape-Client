...
public class GWC {
	...
	public static void method10593(Packet arg0) {
		...
		Statics.field7647 = new GWCLocation[var1];
		for (int var2 = 0; var2 < var1; var2++) {
			Statics.field7647[var2] = new GWCLocation();
		...
		Statics.field7644 = new GWCWorld[Statics.field3011 - Statics.field7414 + 1];
		for (int var3 = 0; var3 < Statics.field533; var3++) {
			int var4 = arg0.gSmart1or2();
			GWCWorld var5 = Statics.field7644[var4] = new GWCWorld();
