...
public final class CutsceneVarDomain implements VarIntDomain {
	...
	public int getVarValueInt(VarType arg0) {
		IntNode var2 = (IntNode) CutsceneManager.varPlayerOverrides.getNode((long) arg0.id);
	...
	public int getVarBitValue(VarBitType arg0) {
		IntNode var2 = (IntNode) CutsceneManager.varPlayerOverrides.getNode((long) arg0.id | 0x100000000L);
