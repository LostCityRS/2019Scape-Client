...
public final class CutsceneVarDomain implements VarIntDomain {
	...
	public int getVarValueInt(VarType arg0) {
		...
		return var2 == null ? Client.localPlayerGameState.getVarValueInt(arg0) : var2.field11442;
	}
	...
	public int getVarBitValue(VarBitType arg0) {
		...
		return var2 == null ? Client.localPlayerGameState.getVarBitValue(arg0) : var2.field11442;
	}
}
