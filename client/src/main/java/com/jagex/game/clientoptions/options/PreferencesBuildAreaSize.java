...
public class PreferencesBuildAreaSize extends PreferencesOption {
	...
	public void method18687() {
		if (this.field8417.hardwareInfo().unused()) {
			if (this.field8416 < BuildAreaRelated.field2669.field2666 || this.field8416 > BuildAreaRelated.field2670.field2666) {
	...
	public int method14069() {
		return this.field8417.hardwareInfo().unused() ? BuildAreaRelated.field2667.field2666 : DrawDistance.field2671.field2674;
	}
