...
public class PlayerModel {
					...
					if (var38) {
						...
						for (int var48 = 0; var48 < var19.length; var48++) {
							...
							if ((var49 & 0x40000000) != 0) {
								...
								ModelUnlit var53 = ((IDKType) arg3.list(var49 & 0x3FFFFFFF)).method5000();
								if (var53 != null) {
									var47[var48] = var53;
								}
							}
	...
	public Model method10120(Renderer arg0, int arg1, IDKTypeList arg2, NPCTypeList arg3, ObjTypeList arg4, VariableTypeProvider arg5, VarIntDomain arg6, AnimationWrapper arg7) {
		if (this.field7892 != -1) {
			return ((NPCType) arg3.list(this.field7892)).method4544(arg0, arg1, arg5, arg6, arg7, null);
		}
		...
		if (var11 == null || arg0.method2394(var11.method1691(), var9) != 0) {
			...
			for (int var20 = 0; var20 < this.field7890.length; var20++) {
				...
				if ((var21 & 0x40000000) != 0) {
					...
					ModelUnlit var24 = ((IDKType) arg2.list(var21 & 0x3FFFFFFF)).method5002();
					if (var24 != null) {
						var18[var19++] = var24;
					}
				}
	...
	public Model method10130(Renderer arg0, int arg1, IDKTypeList arg2, SeqTypeList arg3, AnimationWrapper arg4, int arg5, int arg6, int arg7) {
		...
		if (var13 == null || arg0.method2394(var13.method1691(), var9) != 0) {
			...
			ModelUnlit var18 = ((IDKType) arg2.list(arg5)).method5002();
			if (var18 != null) {
				var16[var17++] = var18;
			}
			ModelUnlit var19 = ((IDKType) arg2.list(arg6)).method5002();
			if (var19 != null) {
				var16[var17++] = var19;
			}
			ModelUnlit var20 = ((IDKType) arg2.list(arg7)).method5002();
			if (var20 != null) {
				var16[var17++] = var20;
			}
