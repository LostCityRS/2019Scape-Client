...
public class WorldSwitcher {
	...
	public static WorldListEntryInfo[] field8748 = new WorldListEntryInfo[0];
	...
	public static void method2778() {
		...
		while (true) {
			while (field8757 < Statics.field3011) {
				WorldListEntryInfo var0 = WorldList.method4944(field8757);
	...
	public static WorldListEntryInfo method13782() {
		field8756 = 0;
		return method6048();
	}

	@ObfuscatedName("nn.l(I)Lalc;")
	public static WorldListEntryInfo method6048() {
		return field8756 < field8748.length ? field8748[++field8756 - 1] : null;
	}

	@ObfuscatedName("o.u(I)Lalc;")
	public static WorldListEntryInfo method477() {
	...
	public static int method3592(WorldListEntryInfo arg0, WorldListEntryInfo arg1, int arg2, boolean arg3, int arg4, boolean arg5) {
	...
	public static int method2856(WorldListEntryInfo arg0, WorldListEntryInfo arg1, int arg2, boolean arg3) {
		if (arg2 == 1) {
