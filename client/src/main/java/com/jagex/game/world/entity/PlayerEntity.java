...
public class PlayerEntity extends PathingEntity {
	...
	public void method19121(Packet arg0, byte arg1) {
		...
		ObjTypeCustomisation[] var5 = new ObjTypeCustomisation[Statics.field1709.field7766.length];
	...
	public final void method19117(int arg0, int arg1, byte arg2) {
		...
		for (int var4 = 0; var4 < this.field10422.length; var4++) {
			if (this.field10422[var4].field6657 != -1) {
				...
				if (var5.field8261 && var5.field8260 != -1 && ((SeqType) Statics.field8797.list(var5.field8260)).field1782 == 1) {
