...
public class DynamicWallDecorEntity extends WallDecorLayerEntity implements Location {
	...
	public PickableEntity draw(Toolkit toolkit) {
		Model var2 = this.field11174.method8238(toolkit, 2048, false, true);
		if (var2 == null) {
			return null;
		}
		...
		this.field11174.method8239(toolkit, var2, var3, var6, var6, var7, var7, true);
	...
	public void method17373(Toolkit toolkit) {
		Model var2 = this.field11174.method8238(toolkit, 262144, false, true);
		if (var2 == null) {
			return;
		}
		...
		this.field11174.method8239(toolkit, var2, var3, var5, var5, var6, var6, false);
	}
	...
	public boolean method17375(Toolkit toolkit, int arg1, int arg2) {
		...
		if (var4.clickbox == null) {
			Model var5 = this.field11174.method8238(toolkit, 131072, false, false);
