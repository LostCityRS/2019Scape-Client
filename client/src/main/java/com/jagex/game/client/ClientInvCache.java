...
public class ClientInvCache extends Node {
	...
	public VarContainerSparse[] field11225 = null;
	...
	public static int method15241(int arg0, int arg1, int arg2, boolean arg3) {
		VarBitType var4 = (VarBitType) Statics.field8736.getById(arg2);
	...
	public static int method7077(int arg0, int arg1, boolean arg2, boolean arg3) {
		...
		for (int var6 = 0; var6 < var4.field11223.length; var6++) {
			if (var4.field11223[var6] >= 0 && var4.field11223[var6] < Statics.field1842.length) {
				ObjType var7 = (ObjType) Statics.field1842.getById(var4.field11223[var6]);
				int var8 = var7.method14677(arg1, ((ParamType) Statics.field3086.getById(arg1)).defaultInt);
				if (arg2) {
	...
	public static int method7007(int arg0, boolean arg1) {
		...
		if (var2 == null) {
			return ((InvType) Statics.field7762.getById(arg0)).size;
		}
		int var3 = 0;
		...
		return var3 + (((InvType) Statics.field7762.getById(arg0)).size - var2.field11223.length);
	}

	@ObfuscatedName("hg.z(IIIILabn;ZI)V")
	public static void method3912(int arg0, int arg1, int arg2, int arg3, VarContainerSparse arg4, boolean arg5) {
		long var6 = (long) (arg0 | (arg5 ? Integer.MIN_VALUE : 0));
		ClientInvCache var8 = (ClientInvCache) field11220.method14495(var6);
		if (var8 == null) {
		...
		if (arg4 != null) {
			if (var8.field11225 == null) {
				var8.field11225 = new VarContainerSparse[var8.field11223.length];
			}
	...
	public final Model method17475(Renderer arg0, int arg1, AnimationWrapper arg2, int arg3, boolean arg4, PlayerModel arg5) {
		...
		BASType var9 = null;
		if (arg3 != -1) {
			var9 = (BASType) Statics.field11742.getById(arg3);
		}
		...
		if (var7 == null || arg0.method2394(var7.method1691(), var8) != 0) {
			...
			for (int var17 = 0; var17 < var10.length; var17++) {
				if (var10[var17] != -1 && !((ObjType) Statics.field1842.getById(var10[var17])).method14649(arg4, null)) {
					var16 = true;
				}
			}
			if (var16) {
			...
			for (int var19 = 0; var19 < var10.length; var19++) {
				if (var10[var19] != -1) {
					var18[var19] = ((ObjType) Statics.field1842.getById(var10[var19])).method14650(arg4, null);
				}
			}
