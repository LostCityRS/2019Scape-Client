...
public class ClientInvCache extends Node {
	...
	public static int method7077(int arg0, int arg1, boolean arg2, boolean arg3) {
		...
		for (int var6 = 0; var6 < var4.field11223.length; var6++) {
			if (var4.field11223[var6] >= 0 && var4.field11223[var6] < Statics.field1842.field8794) {
				...
				int var8 = var7.method14677(arg1, ((ParamType) Statics.field3086.list(arg1)).field9172);
				if (arg2) {
	...
	public static int method7007(int arg0, boolean arg1) {
		...
		if (var2 == null) {
			return ((InvType) Statics.field7762.list(arg0)).field9263;
		}
		int var3 = 0;
		...
		return var3 + (((InvType) Statics.field7762.list(arg0)).field9263 - var2.field11223.length);
	}
