...
public class Component {
	...
	public Model method3944(Renderer arg0, int arg1, BASTypeList arg2, IDKTypeList arg3, NPCTypeList arg4, ObjTypeList arg5, SeqTypeList arg6, VariableTypeProvider arg7, VarIntDomain arg8, AnimationWrapper arg9, PlayerModel arg10) {
		...
		if (this.field2224 == 0) {
			...
			Model var36 = ((NPCType) arg4.getById(this.field2294)).getHeadModel(arg0, arg1, arg7, arg8, arg9, this.field2363);
			if (var36 == null) {
				field2338 = true;
				return null;
			} else {
			...
			ObjType var38 = (ObjType) arg5.getById(this.field2294);
			...
			Model var40 = ((NPCType) arg4.getById(this.field2294)).method4542(arg0, arg1, arg2, arg7, arg8, arg9, null, null, null, 0, this.field2363);
			if (var40 == null) {
				field2338 = true;
				return null;
			} else {
