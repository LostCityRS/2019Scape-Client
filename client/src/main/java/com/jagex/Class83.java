...
public class Class83 implements Interface75 {
	...
	@OriginalMember(owner = "client!adi", name = "<init>", descriptor = "(IILjava/lang/String;Ljava/lang/String;)V", line = 20)
	...
	@OriginalMember(owner = "client!adi", name = "<init>", descriptor = "(IILjava/lang/String;Ljava/lang/String;Z[Lclient!adi;)V", line = 26)
	...
	@OriginalMember(owner = "client!adi", name = "k", descriptor = "()I", line = 33)
	@Override
	public int method36919() {
		return this.anInt252 * -178785547;
	}

	@OriginalMember(owner = "client!adi", name = "toString", descriptor = "()Ljava/lang/String;", line = 37)
	@Override
	public String toString() {
		return this.aString10;
	}

	@OriginalMember(owner = "client!adi", name = "rj", descriptor = "()Ljava/lang/String;", line = 37)
