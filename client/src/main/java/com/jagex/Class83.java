...
public final class Class83 {
	...
	public byte[] method1560(@OriginalArg(0) byte[] arg0) {
		...
		local4.pos = (arg0.length - 4) * 1034180571;
		@Pc(16) int local16 = local4.ip4();
	...
	public void method1562(@OriginalArg(0) Packet arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2) {
		if (arg0.data[arg0.pos * -1380987821] != 31 || arg0.data[arg0.pos * -1380987821 + 1] != -117) {
		...
		try {
			this.anInflater1.setInput(arg0.data, arg0.pos * -1380987821 + 10, arg0.data.length - (arg0.pos * -1380987821 + 8 + 10));
	...
	public void method1565(@OriginalArg(0) Packet arg0, @OriginalArg(1) byte[] arg1) {
		if (arg0.data[arg0.pos * -1380987821] != 31 || arg0.data[arg0.pos * -1380987821 + 1] != -117) {
			throw new RuntimeException("");
		}
		if (this.anInflater1 == null) {
