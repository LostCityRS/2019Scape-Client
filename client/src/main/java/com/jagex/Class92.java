...
public class Class92 {
	...
	@OriginalMember(owner = "client!adw", name = "<init>", descriptor = "()V", line = 6)
	Class92() throws Throwable {
		throw new Error();
	}

	@OriginalMember(owner = "client!adw", name = "n", descriptor = "(Ljava/lang/CharSequence;)Ljava/lang/String;", line = 11)
