...
public abstract class Class110 {
	...
	public static boolean method20138(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2, @OriginalArg(3) short arg3) {
		if (arg1 == 0) {
			try {
			...
			try {
				@Pc(80) Object local80 = Class70.method1238(Class564.anApplet3, arg2, new Object[] { (new URL(Class564.anApplet3.getCodeBase(), arg0)).toString() }, -1732239815);
				return local80 != null;
			...
			try {
				Class70.method1237(Class564.anApplet3, "loggedout", 1648660558);
	...
	static void method20144(@OriginalArg(0) Class132_Sub1_Sub1_Sub1 arg0, @OriginalArg(1) byte arg1) {
	...
	public static final void method20145(@OriginalArg(0) byte arg0) {
	...
	static final void method20147(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class557.aClass297_1.method26639((byte) 61);
	}
	...
	public abstract void method20149(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!ew", name = "f", descriptor = "()V")
	public abstract void method20150();
}
