...
public class Class59 {
	...
	@OriginalMember(owner = "client!aci", name = "<init>", descriptor = "()V", line = 6)
	public Class59() {
		System.nanoTime();
	}

	@OriginalMember(owner = "client!aci", name = "f", descriptor = "()J", line = 11)
	public long method1104() {
		return System.nanoTime();
	}

	@OriginalMember(owner = "client!aci", name = "e", descriptor = "(I)J", line = 11)
	public long method1105(@OriginalArg(0) int arg0) {
		return System.nanoTime();
	}

	@OriginalMember(owner = "client!aci", name = "m", descriptor = "()J", line = 11)
	public long method1106() {
		return System.nanoTime();
	}

	@OriginalMember(owner = "client!aci", name = "k", descriptor = "()J", line = 11)
	public long method1107() {
		return System.nanoTime();
	}

	@OriginalMember(owner = "client!aci", name = "n", descriptor = "()J", line = 11)
	public long method1108() {
		return System.nanoTime();
	}

	@OriginalMember(owner = "client!aci", name = "e", descriptor = "(B)[Lclient!oh;", line = 65)
