...
public class Class646 {
	...
	public static String method32607(@OriginalArg(0) int arg0) {
	...
	public static void method32608(@OriginalArg(0) String arg0, @OriginalArg(1) Throwable arg1, @OriginalArg(2) int arg2) {
		try {
			@Pc(1) String local1 = "";
			if (arg1 != null) {
			...
			Class273.method26325(local1, (short) 27038);
			...
			if (Class69.anApplet1 != null) {
				...
				local41 = RuntimeException_Sub1.anInterface59_1.method30757((byte) -65);
			}
			if (local41 == null) {
				return;
			}
	...
	static void method32609(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte arg4) {
		...
		Class358.method27776(-1310338920);
	}

	@OriginalMember(owner = "client!wt", name = "alg", descriptor = "(Lclient!yf;B)V", line = 11859)
	static final void method32610(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		if (Class4.aBoolean2) {
			@Pc(17) Class14[] local17 = Class124_Sub3.method21443(16711935);
