...
public final class Class93_Sub22 extends Class93 {
	...
	@OriginalMember(owner = "client!akl", name = "w", descriptor = "()Lclient!akl;")
	...
	@OriginalMember(owner = "client!akl", name = "p", descriptor = "()Lclient!akl;")
	public static Class93_Sub22 method13713() {
		@Pc(2) Class93_Sub22 local2 = Class527.method30572(25568396);
	...
	@OriginalMember(owner = "client!akl", name = "z", descriptor = "()Lclient!akl;")
	public static Class93_Sub22 method13714() {
		@Pc(2) Class93_Sub22 local2 = Class527.method30572(1668852778);
		local2.aClass446_1 = null;
		local2.anInt1570 = 0;
		local2.aClass93_Sub41_Sub2_1 = new Class93_Sub41_Sub2(5000);
		return local2;
	...
	@OriginalMember(owner = "client!akl", name = "u", descriptor = "()Lclient!akl;")
	static Class93_Sub22 method13715() {
		return anInt1571 * -1803982567 == 0 ? new Class93_Sub22() : aClass93_Sub22Array1[(anInt1571 -= -1780096215) * -1803982567];
	}

	@OriginalMember(owner = "client!akl", name = "f", descriptor = "()Lclient!akl;")
	static Class93_Sub22 method13717() {
		return anInt1571 * -1803982567 == 0 ? new Class93_Sub22() : aClass93_Sub22Array1[(anInt1571 -= -1780096215) * -1803982567];
	}

	@OriginalMember(owner = "client!akl", name = "l", descriptor = "()Lclient!akl;")
	static Class93_Sub22 method13718() {
		return anInt1571 * -1803982567 == 0 ? new Class93_Sub22() : aClass93_Sub22Array1[(anInt1571 -= -1780096215) * -1803982567];
	}
	...
	@OriginalMember(owner = "client!akl", name = "k", descriptor = "(I)V")
	public void method13712(@OriginalArg(0) int arg0) {
		if (anInt1571 * -1803982567 < aClass93_Sub22Array1.length) {
			aClass93_Sub22Array1[(anInt1571 += -1780096215) * -1803982567 - 1] = this;
		}
	}

	@OriginalMember(owner = "client!akl", name = "d", descriptor = "()V")
	...
	@OriginalMember(owner = "client!akl", name = "c", descriptor = "()V")
	...
	@OriginalMember(owner = "client!akl", name = "r", descriptor = "()V")
