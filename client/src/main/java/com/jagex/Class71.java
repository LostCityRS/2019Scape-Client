...
public class Class71 {
	...
	static final void method1247(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) Class458 arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) byte arg10) {
		if (arg2 < 1 || arg3 < 1 || arg2 > client.world.method30459(-1664407314) - 2 || arg3 > client.world.method30466((short) 128) - 2) {
			return;
		}
		@Pc(21) int local21 = arg0;
		if (arg0 < 3 && client.world.method30487(-955291898).method30330(arg2, arg3, -662808309)) {
			local21 = arg0 + 1;
		}
		if (client.world.method30481(-1273454175) == null) {
			return;
		}
		client.world.method30511(-310507201).method10981(Class694.aClass104_14, arg0, arg1, arg2, arg3, (byte) -82);
		if (arg4 >= 0) {
			@Pc(55) int local55 = Class51.options.aClass166_Sub3_1.method15405(-286073295);
			...
			Class51.options.method14363(Class51.options.aClass166_Sub3_1, local55, (byte) 83);
		}
		Class110_Sub15.method20152(Class520.selfPlayer.aByte100, 1611540913);
	}
