...
public class RuntimeException_Sub1 extends RuntimeException {
	...
	public static void method23313(@OriginalArg(0) String arg0, @OriginalArg(1) Throwable arg1) {
		try {
			@Pc(1) String local1 = "";
			if (arg1 != null) {
				local1 = Class166_Sub35.method16229(arg1, Integer.MIN_VALUE);
			}
			if (arg0 != null) {
				if (arg1 != null) {
					local1 = local1 + " | ";
			...
			Class273.method26325(local1, (short) 1698);
			local1 = Class25_Sub2.method16018(local1, (byte) 73);
			@Pc(41) URL local41 = null;
			if (Class69.anApplet1 != null) {
				local41 = Class69.anApplet1.getCodeBase();
			} else if (anInterface59_1 != null) {
				local41 = anInterface59_1.method30757((byte) 35);
			}
			if (local41 == null) {
				return;
			}
			...
			@Pc(126) URL local126 = new URL(local41, "clienterror.ws?c=" + anInt3188 * 978703369 + "&cs=" + anInt3189 * -1468759271 + "&u=" + (aString116 == null ? "" + aLong210 * -7577937061430114655L : Class25_Sub2.method16018(aString116, (byte) 73)) + "&v1=" + Class25_Sub2.method16018(local60, (byte) 73) + "&v2=" + Class25_Sub2.method16018(local62, (byte) 73) + "&e=" + local1);
	...
	public static void method23314(@OriginalArg(0) String arg0, @OriginalArg(1) Throwable arg1) {
		try {
			...
			Class273.method26325(local1, (short) 10559);
			local1 = Class25_Sub2.method16018(local1, (byte) 73);
			@Pc(41) URL local41 = null;
			if (Class69.anApplet1 != null) {
				local41 = Class69.anApplet1.getCodeBase();
			} else if (anInterface59_1 != null) {
				local41 = anInterface59_1.method30757((byte) -38);
			}
			if (local41 == null) {
				return;
			}
	...
	static String method23315(@OriginalArg(0) Throwable arg0) throws IOException {
	...
	static final void method23316(@OriginalArg(0) String arg0) {
	...
	static final String method23318(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2) {
