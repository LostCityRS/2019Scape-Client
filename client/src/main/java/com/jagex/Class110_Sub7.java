...
public final class Class110_Sub7 extends Class110 {
	...
	@OriginalMember(owner = "client!agd", name = "hv", descriptor = "(IIII)Lclient!ahm;")
	static Class132_Sub1_Sub1_Sub1 method7943(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(10) Class572 local10 = client.aClass532_1.method30640(-910933729).aClass572ArrayArrayArray3[arg0][arg1][arg2];
		if (local10 == null) {
			return null;
		}
		...
		for (@Pc(21) Class590 local21 = local10.aClass590_1; local21 != null; local21 = local21.aClass590_2) {
			...
			if (local27 instanceof Class132_Sub1_Sub1_Sub1) {
				...
				@Pc(43) int local43 = (local33.method20009(-1772760255) - 1) * 256 + 252;
				@Pc(47) Class472 local47 = local33.method24241().aClass472_61;
				@Pc(55) int local55 = (int) local47.aFloat325 - local43 >> 9;
				@Pc(63) int local63 = (int) local47.aFloat327 - local43 >> 9;
				@Pc(71) int local71 = local43 + (int) local47.aFloat325 >> 9;
				@Pc(79) int local79 = (int) local47.aFloat327 + local43 >> 9;
	...
	@OriginalMember(owner = "client!agd", name = "oo", descriptor = "(Lclient!yf;I)V")
	static void method7944(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray521[(arg0.anInt6052 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32986(local12, 1161216956);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class696.method36830(local16, local22, arg0, 1726868414);
	}

	@OriginalMember(owner = "client!agd", name = "<init>", descriptor = "(Lclient!alw;)V")
	Class110_Sub7(@OriginalArg(0) Class93_Sub41 arg0) {
		super(arg0);
		this.anInt908 = arg0.method22427(-1434290800) * -1675416095;
		this.anInt906 = arg0.method22427(-1434290800) * -307172735;
		this.aString28 = arg0.method22439(1044052563);
		this.anInt907 = arg0.method22431(-118643075) * 1048079171;
		this.anInt909 = arg0.method22427(-1434290800) * -1986684691;
	}
