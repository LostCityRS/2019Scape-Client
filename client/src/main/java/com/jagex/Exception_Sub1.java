...
public final class Exception_Sub1 extends Exception {
	...
	@OriginalMember(owner = "client!apb", name = "l", descriptor = "(I)V")
	public static void method17643(@OriginalArg(0) int arg0) {
	...
	@OriginalMember(owner = "client!apb", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/Throwable;)V")
	...
	@OriginalMember(owner = "client!apb", name = "<init>", descriptor = "(ILjava/lang/String;)V")
