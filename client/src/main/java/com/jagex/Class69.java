...
public class Class69 {
	...
	@OriginalMember(owner = "client!acs", name = "s", descriptor = "(I)V", line = 20)
	static void method1207(@OriginalArg(0) int arg0) {
	...
	@OriginalMember(owner = "client!acs", name = "<init>", descriptor = "()V", line = 25)
	Class69() throws Throwable {
		throw new Error();
	}

	@OriginalMember(owner = "client!acs", name = "r", descriptor = "(JI)Ljava/lang/String;", line = 30)
	public static String method1208(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1) {
		...
		return arg1 == 3 ? Class474.method29664(arg0, arg1, (byte) -110) : Integer.toString(local5 / 10) + local5 % 10 + "-" + aStringArrayArray1[arg1][local9] + "-" + local13;
	}

	@OriginalMember(owner = "client!acs", name = "c", descriptor = "(JI)Ljava/lang/String;", line = 30)
	public static String method1209(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1) {
		Class337.method27454(arg0);
		@Pc(5) int local5 = aCalendar1.get(5);
		@Pc(9) int local9 = aCalendar1.get(2);
		@Pc(13) int local13 = aCalendar1.get(1);
		return arg1 == 3 ? Class474.method29664(arg0, arg1, (byte) -19) : Integer.toString(local5 / 10) + local5 % 10 + "-" + aStringArrayArray1[arg1][local9] + "-" + local13;
	}

	@OriginalMember(owner = "client!acs", name = "v", descriptor = "(JIZ)Ljava/lang/String;", line = 40)
	public static String method1210(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		...
		return arg1 == 3 ? Class362.method27809(arg0, arg1, arg2, (byte) 24) : Integer.toString(local14 / 10) + local14 % 10 + "-" + aStringArrayArray1[arg1][local18] + "-" + local22 + " " + local26 / 10 + local26 % 10 + ":" + local30 / 10 + local30 % 10;
	}

	@OriginalMember(owner = "client!acs", name = "o", descriptor = "(JIZ)Ljava/lang/String;", line = 40)
	public static String method1211(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		@Pc(5) Calendar local5;
		if (arg2) {
			Class543.method30943(arg0);
			local5 = aCalendar2;
	...
	@OriginalMember(owner = "client!acs", name = "y", descriptor = "(JI)Ljava/lang/String;", line = 76)
	...
	@OriginalMember(owner = "client!acs", name = "s", descriptor = "(JI)Ljava/lang/String;", line = 76)
	static String method1213(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1) {
		Class337.method27454(arg0);
		@Pc(5) int local5 = aCalendar1.get(5);
		@Pc(11) int local11 = aCalendar1.get(2) + 1;
		@Pc(15) int local15 = aCalendar1.get(1);
	...
	@OriginalMember(owner = "client!acs", name = "q", descriptor = "(JI)Ljava/lang/String;", line = 84)
	...
	@OriginalMember(owner = "client!acs", name = "x", descriptor = "(JI)Ljava/lang/String;", line = 84)
	public static String method1215(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1) {
		Class337.method27454(arg0);
		@Pc(5) int local5 = aCalendar1.get(11);
		@Pc(9) int local9 = aCalendar1.get(12);
		@Pc(13) int local13 = aCalendar1.get(13);
	...
	@OriginalMember(owner = "client!acs", name = "b", descriptor = "(J)V", line = 96)
	static void method1216(@OriginalArg(0) long arg0) {
		aCalendar2.setTime(new Date(arg0));
	}

	@OriginalMember(owner = "client!acs", name = "h", descriptor = "(J)V", line = 96)
	static void method1217(@OriginalArg(0) long arg0) {
		aCalendar2.setTime(new Date(arg0));
	}

	@OriginalMember(owner = "client!acs", name = "a", descriptor = "(J)V", line = 96)
	static void method1218(@OriginalArg(0) long arg0) {
		aCalendar2.setTime(new Date(arg0));
	}

	@OriginalMember(owner = "client!acs", name = "t", descriptor = "(J)V", line = 100)
	static void method1219(@OriginalArg(0) long arg0) {
		aCalendar1.setTime(new Date(arg0));
	}

	@OriginalMember(owner = "client!acs", name = "g", descriptor = "(J)V", line = 100)
	static void method1220(@OriginalArg(0) long arg0) {
		aCalendar1.setTime(new Date(arg0));
	}

	@OriginalMember(owner = "client!acs", name = "i", descriptor = "(J)V", line = 100)
	static void method1221(@OriginalArg(0) long arg0) {
		aCalendar1.setTime(new Date(arg0));
	}

	@OriginalMember(owner = "client!acs", name = "j", descriptor = "(J)V", line = 100)
	static void method1222(@OriginalArg(0) long arg0) {
		aCalendar1.setTime(new Date(arg0));
	}

	@OriginalMember(owner = "client!acs", name = "ag", descriptor = "(IIIIII)J", line = 104)
	public static long method1223(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		aCalendar2.clear();
		aCalendar2.set(arg5, arg4, arg3, arg2, arg1, arg0);
		return aCalendar2.getTime().getTime();
	}

	@OriginalMember(owner = "client!acs", name = "ae", descriptor = "(IIIIII)J", line = 104)
	...
	@OriginalMember(owner = "client!acs", name = "ah", descriptor = "(IIIIII)J", line = 104)
	public static long method1225(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		aCalendar2.clear();
		aCalendar2.set(arg5, arg4, arg3, arg2, arg1, arg0);
		return aCalendar2.getTime().getTime();
	}

	@OriginalMember(owner = "client!acs", name = "al", descriptor = "(I)J", line = 110)
	public static long method1226(@OriginalArg(0) int arg0) {
		return (long) (arg0 + 11745) * 86400000L;
	}

	@OriginalMember(owner = "client!acs", name = "ai", descriptor = "(J)I", line = 114)
	public static int method1227(@OriginalArg(0) long arg0) {
		Class337.method27454(arg0);
		return aCalendar1.get(1);
	}

	@OriginalMember(owner = "client!acs", name = "ac", descriptor = "(J)I", line = 114)
	public static int method1228(@OriginalArg(0) long arg0) {
		Class337.method27454(arg0);
		return aCalendar1.get(1);
	}
