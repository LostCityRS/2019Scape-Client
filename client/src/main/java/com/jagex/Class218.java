...
public class Class218 implements Interface75 {
	...
	public static String method25506(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Class717 arg3, @OriginalArg(4) int arg4) {
		@Pc(1) char local1 = ',';
		@Pc(3) char local3 = '.';
	...
	static Class218 method25507(@OriginalArg(0) int arg0) {
		@Pc(6) Class218 local6 = (Class218) Class107.method18116(Class104.method20430((byte) -65), arg0, -1915563430);
		if (local6 == null) {
			local6 = aClass218_9;
		}
		return local6;
	...
	static final void method25508(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
