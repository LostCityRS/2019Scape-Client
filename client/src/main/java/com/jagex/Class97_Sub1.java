...
public class Class97_Sub1 extends Class97 {
	...
	@OriginalMember(owner = "client!aeb", name = "<init>", descriptor = "(Lclient!afa;)V", line = 25)
			...
			for (@Pc(31) int local31 = 0; local31 < 128; local31++) {
				for (@Pc(36) int local36 = 0; local36 < 128; local36++) {
					...
					for (@Pc(82) int local82 = 0; local82 < 6; local82++) {
						...
						@Pc(158) float local158 = local96.method29583(local29);
	...
	@OriginalMember(owner = "client!aeb", name = "p", descriptor = "()Z", line = 96)
	@Override
	boolean method2791() {
		return true;
	}

	@OriginalMember(owner = "client!aeb", name = "e", descriptor = "()Z", line = 96)
	@Override
	boolean method2790() {
		return true;
	}

	@OriginalMember(owner = "client!aeb", name = "l", descriptor = "()Z", line = 96)
	@Override
	boolean method2796() {
		return true;
	}

	@OriginalMember(owner = "client!aeb", name = "z", descriptor = "()Z", line = 96)
	@Override
	boolean method2798() {
		return true;
	}

	@OriginalMember(owner = "client!aeb", name = "d", descriptor = "()Z", line = 96)
	@Override
	boolean method2799() {
		return true;
	}

	@OriginalMember(owner = "client!aeb", name = "u", descriptor = "()Z", line = 96)
	@Override
	boolean method2802() {
		return true;
	}

	@OriginalMember(owner = "client!aeb", name = "b", descriptor = "()V", line = 100)
	void method1853() {
		this.aClass182_1 = new Class182(this.aClass104_Sub1_25, 2);
		this.aClass182_1.method24557(0);
		...
		if (this.aBoolean44) {
			...
			this.aClass104_Sub1_25.method3898(0, 5890, 770);
			this.aClass104_Sub1_25.method3903(0, 34167, 770);
		} else {
			this.aClass104_Sub1_25.method3894(7681, 8448);
			this.aClass104_Sub1_25.method3898(0, 34168, 768);
			this.aClass104_Sub1_25.method3882(2);
			this.aClass104_Sub1_25.method3894(260, 7681);
			this.aClass104_Sub1_25.method3898(0, 34168, 768);
			this.aClass104_Sub1_25.method3898(1, 34168, 770);
			this.aClass104_Sub1_25.method3903(0, 34167, 770);
		}
		this.aClass104_Sub1_25.method3882(0);
		this.aClass182_1.method24559();
		this.aClass182_1.method24557(1);
		this.aClass104_Sub1_25.method3882(1);
		...
		if (this.aBoolean44) {
			...
			this.aClass104_Sub1_25.method3894(8448, 8448);
			this.aClass104_Sub1_25.method3898(0, 5890, 768);
			this.aClass104_Sub1_25.method3898(1, 34168, 768);
			this.aClass104_Sub1_25.method3903(0, 5890, 770);
		}
		this.aClass104_Sub1_25.method3882(0);
		this.aClass182_1.method24559();
	...
	@OriginalMember(owner = "client!aeb", name = "h", descriptor = "()V", line = 100)
	void method1854() {
		this.aClass182_1 = new Class182(this.aClass104_Sub1_25, 2);
		this.aClass182_1.method24557(0);
		this.aClass104_Sub1_25.method3882(1);
	...
	@OriginalMember(owner = "client!aeb", name = "n", descriptor = "(Z)V", line = 158)
	@Override
	void method2801(@OriginalArg(0) boolean arg0) {
		...
		this.aClass182_1.method24563('\u0000');
		this.aBoolean43 = true;
	}

	@OriginalMember(owner = "client!aeb", name = "c", descriptor = "(Z)V", line = 158)
	@Override
	...
	@OriginalMember(owner = "client!aeb", name = "m", descriptor = "(Z)V", line = 171)
	@Override
	void method2792(@OriginalArg(0) boolean arg0) {
		this.aClass104_Sub1_25.method3894(8448, 7681);
	}

	@OriginalMember(owner = "client!aeb", name = "r", descriptor = "(Z)V", line = 171)
	@Override
	void method2797(@OriginalArg(0) boolean arg0) {
		this.aClass104_Sub1_25.method3894(8448, 7681);
	}

	@OriginalMember(owner = "client!aeb", name = "k", descriptor = "()V", line = 175)
	@Override
	void method2793() {
		if (this.aBoolean43) {
			if (!this.aBoolean44) {
	...
	@OriginalMember(owner = "client!aeb", name = "v", descriptor = "()V", line = 175)
	@Override
	void method2795() {
		if (this.aBoolean43) {
			if (!this.aBoolean44) {
	...
	@OriginalMember(owner = "client!aeb", name = "s", descriptor = "(II)V", line = 191)
	@Override
	void method2804(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.aBoolean43) {
			this.aClass104_Sub1_25.method3882(1);
			this.aClass104_Sub1_25.method3887(this.aClass88_Sub1Array1[arg0 - 1]);
			this.aClass104_Sub1_25.method3882(0);
		}
	}

	@OriginalMember(owner = "client!aeb", name = "o", descriptor = "(II)V", line = 191)
	@Override
	...
	@OriginalMember(owner = "client!aeb", name = "y", descriptor = "(II)V", line = 191)
	@Override
	...
	@OriginalMember(owner = "client!aeb", name = "f", descriptor = "(II)V", line = 191)
	@Override
	...
	@OriginalMember(owner = "client!aeb", name = "w", descriptor = "(Lclient!bq;I)V", line = 199)
	@Override
	...
	@OriginalMember(owner = "client!aeb", name = "q", descriptor = "(Lclient!bq;I)V", line = 199)
	@Override
	...
	@OriginalMember(owner = "client!aeb", name = "x", descriptor = "(Lclient!bq;I)V", line = 199)
	@Override
