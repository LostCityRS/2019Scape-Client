...
public class Class93_Sub9 extends Class93 {
	...
	@OriginalMember(owner = "client!ajw", name = "k", descriptor = "(Ljava/lang/CharSequence;IZI)Z", line = 47)
	static boolean method13151(@OriginalArg(0) CharSequence arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) int arg3) {
		if (arg1 < 2 || arg1 > 36) {
	...
	@OriginalMember(owner = "client!ajw", name = "<init>", descriptor = "(Lclient!aks;)V", line = 996)
	Class93_Sub9(@OriginalArg(0) Class93_Sub29 arg0) {
		this.aClass93_Sub29_1 = arg0;
	}

	@OriginalMember(owner = "client!ajw", name = "n", descriptor = "(II)Z", line = 1001)
	boolean method13152(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	@OriginalMember(owner = "client!ajw", name = "e", descriptor = "(III)Z", line = 1001)
	boolean method13153(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg0 >= this.anInt1488 * -113120923 && arg0 <= this.anInt1486 * 255075307 && arg1 >= this.anInt1483 * 125260925 && arg1 <= this.anInt1485 * 925701095) {
			return true;
		} else {
			return arg0 >= this.anInt1481 * -1689773403 && arg0 <= this.anInt1484 * 1086189553 && arg1 >= this.anInt1487 * 636370241 && arg1 <= this.anInt1482 * -1246489691;
	...
	@OriginalMember(owner = "client!ajw", name = "m", descriptor = "(II)Z", line = 1001)
	boolean method13154(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 >= this.anInt1488 * -113120923 && arg0 <= this.anInt1486 * 255075307 && arg1 >= this.anInt1483 * 125260925 && arg1 <= this.anInt1485 * 925701095) {
			return true;
		} else {
			return arg0 >= this.anInt1481 * -1689773403 && arg0 <= this.anInt1484 * 1086189553 && arg1 >= this.anInt1487 * 636370241 && arg1 <= this.anInt1482 * -1246489691;
