...
class Class534 implements Interface41 {
	...
	static final void method30625(@OriginalArg(0) Class93_Sub41_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class132_Sub1_Sub1_Sub1_Sub2 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(8) int local8;
		if ((arg3 & 0x80) != 0) {
			@Pc(6) int[] local6 = new int[4];
			for (local8 = 0; local8 < 4; local8++) {
				local6[local8] = arg0.method22542(-917884288);
			}
			local8 = arg0.method22584(-169642142);
		...
		if ((arg3 & 0x40000) != 0) {
			...
			for (local8 = 0; local8 < local57; local8++) {
				local66 = arg0.method22588(1282515777);
		...
		if ((arg3 & 0x10000) != 0) {
			arg2.aBoolean455 = arg0.method22588(1437468065) == 1;
		}
		@Pc(155) int local155;
		@Pc(151) int local151;
		@Pc(170) int local170;
		if ((arg3 & 0x20) != 0) {
			local57 = arg0.method22582(2131635157);
			@Pc(197) int local197;
			if (local57 > 0) {
				for (local8 = 0; local8 < local57; local8++) {
					local151 = -1;
					...
					local155 = -1;
					local66 = arg0.method22528((byte) -81);
					if (local66 == 32767) {
						local66 = arg0.method22528((byte) -81);
						local170 = arg0.method22528((byte) -10);
						local151 = arg0.method22528((byte) -7);
						local155 = arg0.method22528((byte) -115);
					} else if (local66 == 32766) {
						local66 = -1;
						local170 = arg0.method22465((short) 16384);
					} else {
						local170 = arg0.method22528((byte) -47);
					}
					local197 = arg0.method22528((byte) -85);
					arg2.method19972(local66, local170, local151, local155, client.anInt3485, local197, 273974416);
				}
			}
			local8 = arg0.method22588(1299380120);
			if (local8 > 0) {
				for (local66 = 0; local66 < local8; local66++) {
					local151 = arg0.method22528((byte) -94);
					local170 = arg0.method22528((byte) -29);
					if (local170 == 32767) {
						arg2.method19977(local151, -1286239838);
					} else {
						local155 = arg0.method22528((byte) -75);
						local197 = arg0.method22588(1773547438);
						@Pc(246) int local246 = local170 > 0 ? arg0.method22584(333148475) : local197;
		...
		@Pc(277) int[] local277;
		if ((arg3 & 0x8000) != 0) {
			local57 = arg0.method22588(1685704594);
			...
			for (local170 = 0; local170 < local57; local170++) {
				local274[local170] = arg0.method22542(-324314197);
				local277[local170] = arg0.method22582(1859352114);
		...
		if ((arg3 & 0x100000) != 0) {
			...
			local8 = arg0.method22644(-1324297022);
			if (local57 == 65535) {
				local57 = -1;
			}
			local66 = arg0.method22582(1492500547);
		...
		if ((arg3 & 0x2) != 0) {
			local57 = arg0.method22611(16711680);
			local8 = arg0.method22651(-1072530967);
			if (local57 == 65535) {
				local57 = -1;
			}
			local66 = arg0.method22582(1281954527);
			local151 = local66 & 0x7;
			local170 = local66 >> 3 & 0xF;
			if (local170 == 15) {
				local170 = -1;
		...
		if ((arg3 & 0x800) != 0) {
			...
			local379 = new byte[local57];
			local384 = new Class93_Sub41(local379);
			arg0.method22656(local379, 0, local57, (byte) 31);
		...
		if ((arg3 & 0x20000) != 0) {
			...
			local57 = arg0.aByteArray58[(arg0.anInt3070 += -1445626955) * 212851357 - 1] & 0xFF;
			for (local8 = 0; local8 < local57; local8++) {
				local66 = arg0.method22588(1406553697);
		...
		if ((arg3 & 0x200) != 0) {
			local673 = arg0.method22509(310956939);
		...
		if ((arg3 & 0x8) != 0) {
			arg2.anInt2775 = arg0.method22591(752227073) * -1449351677;
			arg2.anInt2777 = arg0.method22468(1729726077) * -2034096445;
			arg2.anInt2793 = arg0.method22591(-1090484644) * -688148243;
			arg2.anInt2778 = arg0.method22590((byte) 102) * 501346955;
			arg2.anInt2773 = arg0.method22590((byte) 76) * -1861667641;
			arg2.anInt2779 = arg0.method22468(746110096) * -1832474127;
			arg2.anInt2780 = (arg0.method22611(16711680) + client.anInt3485) * 755240883;
			arg2.anInt2762 = (arg0.method22602(1539513897) + client.anInt3485) * 1838812733;
			arg2.anInt2782 = arg0.method22602(1591926049) * 862199857;
		...
		if ((arg3 & 0x800000) != 0) {
			arg2.aByte71 = arg0.method22591(-1931926509);
			arg2.aByte72 = arg0.method22594(-896318173);
			arg2.aByte73 = arg0.method22591(-724281707);
			arg2.aByte74 = (byte) arg0.method22582(1717494693);
		...
		if ((arg3 & 0x400) != 0) {
			arg2.aClass286_1 = (Class286) Class107.method18116(Class286.method26522((byte) 85), arg0.method22584(1472452770), -1915563430);
		...
		if ((arg3 & 0x100) != 0) {
			local57 = arg0.method22611(16711680);
			local8 = arg0.method22649(937448499);
			if (local57 == 65535) {
				local57 = -1;
			}
			local66 = arg0.method22584(1151075287);
			local151 = local66 & 0x7;
			local170 = local66 >> 3 & 0xF;
			if (local170 == 15) {
				local170 = -1;
		...
		if ((arg3 & 0x200000) != 0) {
			local673 = arg0.method22509(1075193584);
		...
		local66 = arg0.method22582(1120567204);
		local151 = local66 & 0x7;
		local170 = local66 >> 3 & 0xF;
		if (local170 == 15) {
			local170 = -1;
