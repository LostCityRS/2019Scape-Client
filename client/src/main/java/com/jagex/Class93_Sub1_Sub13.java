...
public class Class93_Sub1_Sub13 extends Class93_Sub1 {
	...
	public Class93_Sub1_Sub13(@OriginalArg(0) Packet arg0, @OriginalArg(1) Interface21 arg1) {
		...
		while (arg0.pos * 212851357 < local9) {
	...
	Class560 method22338(@OriginalArg(0) Packet arg0, @OriginalArg(1) Class560[] arg1, @OriginalArg(2) int arg2) {
	...
	Class560 method22339(@OriginalArg(0) Packet arg0, @OriginalArg(1) Class560[] arg1) {
		@Pc(3) int local3 = arg0.g2(-1434290800);
		if (local3 < 0 || local3 >= arg1.length) {
			throw new RuntimeException("");
		}
	...
	int method22340(@OriginalArg(0) Packet arg0, @OriginalArg(1) int arg1) {
		arg0.pos = (arg0.data.length - 2) * -1445626955;
		@Pc(12) int local12 = arg0.g2(-1434290800);
		@Pc(22) int local22 = arg0.data.length - 2 - local12 - 16;
		arg0.pos = local22 * -1445626955;
		@Pc(31) int local31 = arg0.g4(-118643075);
		this.anInt3065 = arg0.g2(-1434290800) * 1021108073;
		this.anInt3064 = arg0.g2(-1434290800) * 1216778353;
		this.anInt3066 = arg0.g2(-1434290800) * 2025161781;
		this.anInt3067 = arg0.g2(-1434290800) * 1141903489;
		this.anInt3068 = arg0.g2(-1434290800) * -116941733;
		this.anInt3063 = arg0.g2(-1434290800) * -14211277;
		@Pc(77) int local77 = arg0.g1((short) 16384);
		if (local77 > 0) {
			this.aClass16Array1 = new Class16[local77];
			for (@Pc(85) int local85 = 0; local85 < local77; local85++) {
				@Pc(92) int local92 = arg0.g2(-1434290800);
	...
	int method22342(@OriginalArg(0) Packet arg0) {
		arg0.pos = (arg0.data.length - 2) * -1445626955;
		@Pc(12) int local12 = arg0.g2(-1434290800);
		@Pc(22) int local22 = arg0.data.length - 2 - local12 - 16;
		arg0.pos = local22 * -1445626955;
		...
		arg0.pos = 0;
		this.aString106 = arg0.fastgstr((byte) 85);
		this.aClass560Array1 = new Class560[local31];
		return local22;
	}

	@OriginalMember(owner = "client!asc", name = "l", descriptor = "(Lclient!alw;)I", line = 52)
	int method22343(@OriginalArg(0) Packet arg0) {
		arg0.pos = (arg0.data.length - 2) * -1445626955;
		@Pc(12) int local12 = arg0.g2(-1434290800);
		@Pc(22) int local22 = arg0.data.length - 2 - local12 - 16;
		arg0.pos = local22 * -1445626955;
		...
		arg0.pos = 0;
		this.aString106 = arg0.fastgstr((byte) 55);
		this.aClass560Array1 = new Class560[local31];
		return local22;
	}

	@OriginalMember(owner = "client!asc", name = "m", descriptor = "(Lclient!alw;ILclient!ss;I)V", line = 84)
	void method22344(@OriginalArg(0) Packet arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class560 arg2, @OriginalArg(3) int arg3) {
		@Pc(3) int local3 = this.aClass560Array1.length;
		if (arg2 == Class560.aClass560_799 || arg2 == Class560.aClass560_513) {
			@Pc(18) Class138 local18 = (Class138) Class107.method18116(Class138.method11522(700594235), arg0.g1((short) 16384), -1915563430);
			@Pc(22) int local22 = arg0.g2(-1434290800);
			...
			this.anIntArray259[arg1] = arg0.g1((short) 16384);
		} else if (Class560.aClass560_6 == arg2) {
			@Pc(68) Class500 local68 = (Class500) Class107.method18116(Class500.method30156(-1706625330), arg0.g1((short) 16384), -1915563430);
			switch(local68.anInt5196 * -1217885029) {
				case 1:
					if (this.anObjectArray5 == null) {
						this.anObjectArray5 = new Object[local3];
					}
					this.anObjectArray5[arg1] = arg0.gjstr(2127243193).intern();
					break;
				case 2:
					if (this.anIntArray259 == null) {
						this.anIntArray259 = new int[local3];
					...
					this.anIntArray259[arg1] = arg0.g4(-118643075);
					break;
				case 3:
				default:
					throw new RuntimeException();
				case 4:
					...
					this.anObjectArray5[arg1] = arg0.g8(199402262);
			}
		} else if (arg2 == Class560.aClass560_4 || Class560.aClass560_5 == arg2) {
			@Pc(139) int local139 = arg0.g2(-1434290800);
			if (this.anObjectArray5 == null) {
				this.anObjectArray5 = new Object[local3];
			}
	...
	void method22345(@OriginalArg(0) Packet arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class560 arg2) {
		@Pc(3) int local3 = this.aClass560Array1.length;
		if (arg2 == Class560.aClass560_799 || arg2 == Class560.aClass560_513) {
			@Pc(18) Class138 local18 = (Class138) Class107.method18116(Class138.method11522(1850021684), arg0.g1((short) 16384), -1915563430);
			@Pc(22) int local22 = arg0.g2(-1434290800);
			if (this.anObjectArray5 == null) {
				this.anObjectArray5 = new Object[local3];
			}
			...
			@Pc(68) Class500 local68 = (Class500) Class107.method18116(Class500.method30156(-1731000292), arg0.g1((short) 16384), -1915563430);
			switch(local68.anInt5196 * -1217885029) {
				case 1:
					if (this.anObjectArray5 == null) {
						this.anObjectArray5 = new Object[local3];
					}
					this.anObjectArray5[arg1] = arg0.gjstr(1650714087).intern();
					break;
				case 2:
					if (this.anIntArray259 == null) {
						this.anIntArray259 = new int[local3];
				...
				case 4:
					...
					arg2 = Class560.aClass560_26;
					this.anObjectArray5[arg1] = arg0.g8(-69510889);
			}
		} else if (arg2 == Class560.aClass560_4 || Class560.aClass560_5 == arg2) {
			@Pc(139) int local139 = arg0.g2(-1434290800);
			if (this.anObjectArray5 == null) {
	...
	void method22346(@OriginalArg(0) Packet arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class560 arg2) {
		@Pc(3) int local3 = this.aClass560Array1.length;
		if (arg2 == Class560.aClass560_799 || arg2 == Class560.aClass560_513) {
			@Pc(18) Class138 local18 = (Class138) Class107.method18116(Class138.method11522(727415029), arg0.g1((short) 16384), -1915563430);
			@Pc(22) int local22 = arg0.g2(-1434290800);
			if (this.anObjectArray5 == null) {
				this.anObjectArray5 = new Object[local3];
			}
			...
			@Pc(68) Class500 local68 = (Class500) Class107.method18116(Class500.method30156(-2066490338), arg0.g1((short) 16384), -1915563430);
			switch(local68.anInt5196 * -1217885029) {
				case 1:
					if (this.anObjectArray5 == null) {
						this.anObjectArray5 = new Object[local3];
					}
					this.anObjectArray5[arg1] = arg0.gjstr(257452899).intern();
					break;
				case 2:
					if (this.anIntArray259 == null) {
						this.anIntArray259 = new int[local3];
				...
				case 4:
					...
					arg2 = Class560.aClass560_26;
					this.anObjectArray5[arg1] = arg0.g8(1140699309);
			}
		} else if (arg2 == Class560.aClass560_4 || Class560.aClass560_5 == arg2) {
			@Pc(139) int local139 = arg0.g2(-1434290800);
			if (this.anObjectArray5 == null) {
	...
	void method22347(@OriginalArg(0) Packet arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class560 arg2) {
		@Pc(3) int local3 = this.aClass560Array1.length;
		if (arg2 == Class560.aClass560_799 || arg2 == Class560.aClass560_513) {
			@Pc(18) Class138 local18 = (Class138) Class107.method18116(Class138.method11522(1185339558), arg0.g1((short) 16384), -1915563430);
			@Pc(22) int local22 = arg0.g2(-1434290800);
			if (this.anObjectArray5 == null) {
				this.anObjectArray5 = new Object[local3];
			}
			...
			@Pc(68) Class500 local68 = (Class500) Class107.method18116(Class500.method30156(-1916976035), arg0.g1((short) 16384), -1915563430);
			switch(local68.anInt5196 * -1217885029) {
				case 1:
					if (this.anObjectArray5 == null) {
						this.anObjectArray5 = new Object[local3];
					}
					this.anObjectArray5[arg1] = arg0.gjstr(1010229395).intern();
					break;
				case 2:
					if (this.anIntArray259 == null) {
						this.anIntArray259 = new int[local3];
				...
				case 4:
					...
					arg2 = Class560.aClass560_26;
					this.anObjectArray5[arg1] = arg0.g8(-743358261);
			}
		} else if (arg2 == Class560.aClass560_4 || Class560.aClass560_5 == arg2) {
			@Pc(139) int local139 = arg0.g2(-1434290800);
			if (this.anObjectArray5 == null) {
