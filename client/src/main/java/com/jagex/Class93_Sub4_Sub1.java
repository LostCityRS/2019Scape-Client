...
public final class Class93_Sub4_Sub1 extends Class93_Sub4 {
	...
	@OriginalMember(owner = "client!aqf", name = "<init>", descriptor = "(Lclient!afa;)V")
	Class93_Sub4_Sub1(@OriginalArg(0) Class104_Sub1 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!aqf", name = "c", descriptor = "()Z")
	@Override
	boolean method20192() {
		return false;
	}

	@OriginalMember(owner = "client!aqf", name = "ao", descriptor = "()Z")
	boolean method19708() {
		return this.aClass104_Sub1_38.aBoolean90 && this.aClass104_Sub1_38.aBoolean103 && this.aClass104_Sub1_38.aBoolean98;
	}

	@OriginalMember(owner = "client!aqf", name = "e", descriptor = "()Z")
	@Override
	boolean method20180() {
		return this.aClass112_Sub1_Sub2_2 != null;
	}

	@OriginalMember(owner = "client!aqf", name = "n", descriptor = "()Z")
	@Override
	boolean method20175() {
		...
		this.aClass88_Sub2_3 = new Class88_Sub2(this.aClass104_Sub1_38, 3553, Class206.aClass206_22, this.method20183(), 256, 256);
		this.aClass88_Sub2_3.method18092(false, false);
		this.aClass88_Sub2_4 = new Class88_Sub2(this.aClass104_Sub1_38, 3553, Class206.aClass206_22, this.method20183(), 256, 256);
		this.aClass88_Sub2_4.method18092(false, false);
		this.aClass104_Sub1_38.method20453(this.aClass112_Sub1_Sub2_2, (byte) 1);
		this.aClass112_Sub1_Sub2_2.method23446(0, this.aClass88_Sub2_3.method18097(0));
		this.aClass112_Sub1_Sub2_2.method23446(1, this.aClass88_Sub2_4.method18097(0));
		this.aClass112_Sub1_Sub2_2.method18026(0);
		if (!this.aClass112_Sub1_Sub2_2.method23453()) {
			this.aClass104_Sub1_38.method20454(this.aClass112_Sub1_Sub2_2, -1497248091);
			return false;
		}
		this.aClass104_Sub1_38.method20454(this.aClass112_Sub1_Sub2_2, -1497248091);
		this.aClass191_6 = Class191.method24602(this.aClass104_Sub1_38, new Class190[] { Class190.method24597(this.aClass104_Sub1_38, 35632, "#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n") });
		this.aClass191_3 = Class191.method24602(this.aClass104_Sub1_38, new Class190[] { Class190.method24597(this.aClass104_Sub1_38, 35632, "uniform vec3 params;\nuniform sampler2D sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2D(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n") });
		this.aClass191_5 = Class191.method24602(this.aClass104_Sub1_38, new Class190[] { Class190.method24597(this.aClass104_Sub1_38, 35632, "#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform vec3 dimScale;\nuniform sampler2D bloomTex;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n\t vec4 bloomCol = texture2D(bloomTex, gl_TexCoord[1].xy);\n\t vec4 sceneCol = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n\t float preLum = 0.99*dot(lumCoef, sceneCol.rgb)+0.01;\n    float postLum = preLum*(1.0+(preLum/params.y))/(preLum+1.0);\n\t gl_FragColor = clamp(sceneCol*(postLum/preLum)+bloomCol*params.x,0.0,1.0);\n}\n") });
		this.aClass191_4 = Class191.method24602(this.aClass104_Sub1_38, new Class190[] { Class190.method24597(this.aClass104_Sub1_38, 35632, "uniform vec3 step;\nuniform sampler2D baseTex;\nvoid main() {\n\tvec4 fragCol = texture2D(baseTex, gl_TexCoord[0].xy)*0.091396265;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-8.0*step.xy))*0.012369139;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 8.0*step.xy))*0.012369139;\n\tgl_FragColor = fragCol;\n}\n") });
		return this.aClass191_3 != null && this.aClass191_6 != null && this.aClass191_5 != null && this.aClass191_4 != null;
	}

	@OriginalMember(owner = "client!aqf", name = "h", descriptor = "()Z")
	@Override
	boolean method20177() {
		if (!this.aClass104_Sub1_38.aBoolean90 || !this.aClass104_Sub1_38.aBoolean103 || !this.aClass104_Sub1_38.aBoolean98) {
			return false;
	...
	@OriginalMember(owner = "client!aqf", name = "m", descriptor = "()V")
	@Override
	void method20211() {
		this.anInt2755 = -1;
		this.anInt2754 = -1;
	...
	@OriginalMember(owner = "client!aqf", name = "f", descriptor = "(ILclient!adt;Lclient!adt;II)V")
	@Override
	void method20178(@OriginalArg(0) int arg0, @OriginalArg(1) Class88_Sub2 arg1, @OriginalArg(2) Class88_Sub2 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (this.aClass88_Sub2Array1 == null) {
			...
			local26 = Class278.method26458(this.anInt2751, 423254006);
			local31 = Class278.method26458(this.anInt2753, 423254006);
			@Pc(33) int local33 = 0;
			while (local26 > 256 || local31 > 256) {
				OpenGL.glViewport(0, 0, local26, local31);
				this.aClass112_Sub1_Sub2_3.method23446(0, this.aClass88_Sub2Array1[local33].method18097(0));
				if (local33 == 0) {
					this.aClass104_Sub1_38.method3804(arg1);
					OpenGL.glBegin(7);
			...
			this.aClass104_Sub1_38.method20454(this.aClass112_Sub1_Sub2_3, -1497248091);
			this.aClass104_Sub1_38.method3804(this.aClass88_Sub2Array1[local33 - 1]);
			this.aClass104_Sub1_38.method20453(this.aClass112_Sub1_Sub2_2, (byte) 1);
			this.aClass112_Sub1_Sub2_2.method18026(0);
			OpenGL.glViewport(0, 0, 256, 256);
		...
		this.aClass112_Sub1_Sub2_2.method18026(1);
	...
	@OriginalMember(owner = "client!aqf", name = "r", descriptor = "()Z")
	@Override
	boolean method20186() {
		return this.aClass112_Sub1_Sub2_2 != null;
	}

	@OriginalMember(owner = "client!aqf", name = "ag", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "client!aqf", name = "u", descriptor = "()I")
	@Override
	int method20187() {
		return 0;
	}

	@OriginalMember(owner = "client!aqf", name = "g", descriptor = "()V")
	@Override
	void method20176() {
		this.anInt2755 = -1;
		this.anInt2754 = -1;
	...
	@OriginalMember(owner = "client!aqf", name = "w", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "client!aqf", name = "y", descriptor = "()Z")
	@Override
	boolean method20188() {
		if (!this.aClass104_Sub1_38.aBoolean90 || !this.aClass104_Sub1_38.aBoolean103 || !this.aClass104_Sub1_38.aBoolean98) {
			return false;
	...
	@OriginalMember(owner = "client!aqf", name = "p", descriptor = "()Lclient!dg;")
	@Override
	Class226 method20183() {
		return Class226.aClass226_24;
	}

	@OriginalMember(owner = "client!aqf", name = "aq", descriptor = "(ILclient!adt;Lclient!adt;II)V")
	@Override
	...
	@OriginalMember(owner = "client!aqf", name = "a", descriptor = "()V")
	@Override
	void method20185() {
		this.anInt2755 = -1;
		this.anInt2754 = -1;
	...
	@OriginalMember(owner = "client!aqf", name = "au", descriptor = "()Z")
	@Override
	boolean method20193() {
		return false;
	}

	@OriginalMember(owner = "client!aqf", name = "i", descriptor = "()V")
	@Override
	void method20173() {
		this.anInt2755 = -1;
		this.anInt2754 = -1;
	...
	@OriginalMember(owner = "client!aqf", name = "j", descriptor = "(II)V")
	@Override
	void method20194(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.anInt2751 = arg0;
		this.anInt2753 = arg1;
		@Pc(10) int local10 = Class278.method26458(this.anInt2751, 423254006);
		@Pc(15) int local15 = Class278.method26458(this.anInt2753, 423254006);
		...
		if (this.aClass88_Sub2Array1 != null) {
			for (local28 = 0; local28 < this.aClass88_Sub2Array1.length; local28++) {
				this.aClass88_Sub2Array1[local28].method18060();
			}
			this.aClass88_Sub2Array1 = null;
		}
			...
			label59: while (true) {
				if (local28 <= 256 && local53 <= 256) {
					...
					while (true) {
						...
						this.aClass88_Sub2Array1[local55++] = new Class88_Sub2(this.aClass104_Sub1_38, 3553, Class206.aClass206_22, this.method20183(), local28, local53);
						if (local28 > 256) {
							local28 >>= 0x1;
						}
						if (local53 > 256) {
	...
	@OriginalMember(owner = "client!aqf", name = "t", descriptor = "(II)V")
	@Override
	...
	@OriginalMember(owner = "client!aqf", name = "ae", descriptor = "(II)V")
	@Override
	...
	@OriginalMember(owner = "client!aqf", name = "al", descriptor = "()I")
	@Override
	int method20199() {
		return 0;
	}

	@OriginalMember(owner = "client!aqf", name = "ax", descriptor = "(ILclient!adt;Lclient!adt;II)V")
	@Override
	...
	@OriginalMember(owner = "client!aqf", name = "aw", descriptor = "()Lclient!dg;")
	@Override
	Class226 method20201() {
		return Class226.aClass226_24;
	}

	@OriginalMember(owner = "client!aqf", name = "as", descriptor = "()Lclient!dg;")
	@Override
	Class226 method20202() {
		return Class226.aClass226_24;
	}

	@OriginalMember(owner = "client!aqf", name = "am", descriptor = "()Z")
	@Override
	boolean method20205() {
		return false;
	}

	@OriginalMember(owner = "client!aqf", name = "k", descriptor = "(II)V")
	@Override
	...
	@OriginalMember(owner = "client!aqf", name = "ar", descriptor = "()Z")
	@Override
	boolean method20207() {
		return false;
	}

	@OriginalMember(owner = "client!aqf", name = "ap", descriptor = "(ILclient!adt;Lclient!adt;II)V")
	@Override
	...
	@OriginalMember(owner = "client!aqf", name = "x", descriptor = "()Z")
	@Override
	boolean method20189() {
		if (!this.aClass104_Sub1_38.aBoolean90 || !this.aClass104_Sub1_38.aBoolean103 || !this.aClass104_Sub1_38.aBoolean98) {
			return false;
	...
	@OriginalMember(owner = "client!aqf", name = "av", descriptor = "(ILclient!adt;Lclient!adt;II)V")
	@Override
	...
	@OriginalMember(owner = "client!aqf", name = "v", descriptor = "()Z")
	@Override
	boolean method20174() {
		return this.aClass112_Sub1_Sub2_2 != null;
	}

	@OriginalMember(owner = "client!aqf", name = "aj", descriptor = "()Z")
	boolean method19709() {
		return this.aClass104_Sub1_38.aBoolean90 && this.aClass104_Sub1_38.aBoolean103 && this.aClass104_Sub1_38.aBoolean98;
	}
}
