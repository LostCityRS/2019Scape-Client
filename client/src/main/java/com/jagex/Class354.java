...
public class Class354 {
	...
	@OriginalMember(owner = "client!iz", name = "<init>", descriptor = "(I)V", line = 21)
	Class354(@OriginalArg(0) int arg0) {
		this.anInt4216 = arg0 * 283476463;
	}

	@OriginalMember(owner = "client!iz", name = "e", descriptor = "(I)[Lclient!zb;", line = 30)
	public static Class700[] method27692(@OriginalArg(0) int arg0) {
	...
	@OriginalMember(owner = "client!iz", name = "wt", descriptor = "(Lclient!yf;I)V", line = 9052)
	static final void method27693(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anInt5891 -= -1915563430;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class431.method28772(local13, local23, false, (byte) 113);
	}
	...
	@OriginalMember(owner = "client!iz", name = "avg", descriptor = "(Lclient!yf;S)V", line = 13485)
	static final void method27695(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
