...
public class Class161_Sub1 extends Class161 {
	...
	@OriginalMember(owner = "client!aln", name = "u", descriptor = "(F)F", line = 19)
	static final float method14750(@OriginalArg(0) float arg0) {
		return arg0 * arg0 * arg0 * ((arg0 * 6.0F - 15.0F) * arg0 + 10.0F);
	}

	@OriginalMember(owner = "client!aln", name = "z", descriptor = "(F)F", line = 19)
	static final float method14751(@OriginalArg(0) float arg0) {
		return arg0 * arg0 * arg0 * ((arg0 * 6.0F - 15.0F) * arg0 + 10.0F);
	}

	@OriginalMember(owner = "client!aln", name = "l", descriptor = "(F)F", line = 19)
	static final float method14752(@OriginalArg(0) float arg0) {
		return arg0 * arg0 * arg0 * ((arg0 * 6.0F - 15.0F) * arg0 + 10.0F);
	}

	@OriginalMember(owner = "client!aln", name = "k", descriptor = "(F)F", line = 19)
	static final float method14753(@OriginalArg(0) float arg0) {
		return arg0 * arg0 * arg0 * ((arg0 * 6.0F - 15.0F) * arg0 + 10.0F);
	}

	@OriginalMember(owner = "client!aln", name = "f", descriptor = "(FFF)F", line = 23)
	static final float method14754(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2) {
		return arg0 + (arg1 - arg0) * arg2;
	}

	@OriginalMember(owner = "client!aln", name = "d", descriptor = "(FFF)F", line = 23)
	static final float method14755(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2) {
		return arg0 + (arg1 - arg0) * arg2;
	}

	@OriginalMember(owner = "client!aln", name = "p", descriptor = "(FFF)F", line = 23)
	static final float method14756(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2) {
		return arg0 + (arg1 - arg0) * arg2;
	}

	@OriginalMember(owner = "client!aln", name = "c", descriptor = "(FFF)F", line = 23)
	static final float method14757(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2) {
		return arg0 + (arg1 - arg0) * arg2;
	}

	@OriginalMember(owner = "client!aln", name = "v", descriptor = "(IFFF)F", line = 27)
	static final float method14758(@OriginalArg(0) int arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3) {
		@Pc(3) float[] local3 = aFloatArrayArray20[arg0];
		return local3[0] * arg1 + local3[1] * arg2 + local3[2] * arg3;
	}

	@OriginalMember(owner = "client!aln", name = "r", descriptor = "(IFFF)F", line = 27)
	static final float method14759(@OriginalArg(0) int arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3) {
		@Pc(3) float[] local3 = aFloatArrayArray20[arg0];
		return local3[0] * arg1 + local3[1] * arg2 + local3[2] * arg3;
	}

	@OriginalMember(owner = "client!aln", name = "w", descriptor = "(IFFF)F", line = 27)
	static final float method14760(@OriginalArg(0) int arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3) {
		@Pc(3) float[] local3 = aFloatArrayArray20[arg0];
		return local3[0] * arg1 + local3[1] * arg2 + local3[2] * arg3;
	}

	@OriginalMember(owner = "client!aln", name = "<init>", descriptor = "(I)V", line = 31)
	...
	@OriginalMember(owner = "client!aln", name = "e", descriptor = "(IIIIFFFF[FI)V", line = 45)
	@Override
	void method14747(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6, @OriginalArg(7) float arg7, @OriginalArg(8) float[] arg8, @OriginalArg(9) int arg9) {
		...
		@Pc(59) float local59 = method14753(local52);
		...
		for (@Pc(79) int local79 = 0; local79 < arg2; local79++) {
			...
			@Pc(106) float local106 = method14753(local99);
			...
			for (@Pc(144) int local144 = 0; local144 < arg1; local144++) {
				...
				@Pc(171) float local171 = method14753(local164);
				@Pc(175) int local175 = local155 & local11;
				@Pc(179) int local179 = local159 & local11;
				arg8[arg9++] = arg7 * method14754(method14754(method14754(method14760(this.anIntArray197[local175 + local121] & 0x7, local168, local103, local56), method14760(this.anIntArray197[local179 + local121] & 0x7, local164, local103, local56), local171), method14754(method14760(this.anIntArray197[local175 + local128] & 0x7, local168, local99, local56), method14760(this.anIntArray197[local179 + local128] & 0x7, local164, local99, local56), local171), local106), method14754(method14754(method14760(this.anIntArray197[local175 + local135] & 0x7, local168, local103, local52), method14760(this.anIntArray197[local179 + local135] & 0x7, local164, local103, local52), local171), method14754(method14760(this.anIntArray197[local175 + local142] & 0x7, local168, local99, local52), method14760(this.anIntArray197[local179 + local142] & 0x7, local164, local99, local52), local171), local106), local59);
			}
		}
	}

	@OriginalMember(owner = "client!aln", name = "m", descriptor = "(IIIIFFFF[FI)V", line = 45)
	@Override
	...
	@OriginalMember(owner = "client!aln", name = "n", descriptor = "(IIIIFFFF[FI)V", line = 45)
	@Override
