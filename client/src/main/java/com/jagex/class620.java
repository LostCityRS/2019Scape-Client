...
public class class620 implements Iterable {
	...
	public void method9777(byte[] arg0) {
		...
		if (arg0 == null) {
			...
			this.method9776(new class997(arg0));
		}
	}

	@ObfuscatedName("wq.m(Lalw;I)V")
	public void method9776(class997 arg0) {
		while (true) {
			...
			if (var2 == 1) {
				...
				for (int var6 = 0; var6 < var3; var6++) {
					...
					if ((var9 & 0x2) != 0) {
						var10 = arg0.method17904();
					}
					if ((var9 & 0x4) != 0) {
						var11 = this.field7649[arg0.method17904()];
					}
					if ((var9 & 0x8) != 0) {
						var12 = arg0.method17905();
					}
				...
				this.field7649 = new class627[arg0.method17904()];
				for (int var17 = arg0.method17904(); var17 != 255; var17 = arg0.method17904()) {
					int[] var18 = new int[arg0.method17906()];
					for (int var19 = 0; var19 < var18.length; var19++) {
						var18[var19] = arg0.method17910();
					}
