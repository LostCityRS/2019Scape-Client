...
public class Class88_Sub3 extends Class88 {
	...
	@OriginalMember(owner = "client!adu", name = "<init>", descriptor = "(Lclient!afa;Lclient!ck;Lclient!dg;III)V", line = 13)
	Class88_Sub3(@OriginalArg(0) Class104_Sub1 arg0, @OriginalArg(1) Class206 arg1, @OriginalArg(2) Class226 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		OpenGL.glTexImage3Dub(this.anInt2543, 0, Class104_Sub1.method3978(this.aClass206_16, this.aClass226_17), this.anInt314, this.anInt313, this.anInt315, 0, Class104_Sub1.method3977(this.aClass206_16), 5121, null, 0);
		this.method18040(true);
	}

	@OriginalMember(owner = "client!adu", name = "<init>", descriptor = "(Lclient!afa;Lclient!ck;Lclient!dg;III[BLclient!ck;)V", line = 23)
	Class88_Sub3(@OriginalArg(0) Class104_Sub1 arg0, @OriginalArg(1) Class206 arg1, @OriginalArg(2) Class226 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) byte[] arg6, @OriginalArg(7) Class206 arg7) {
		...
		OpenGL.glTexImage3Dub(this.anInt2543, 0, Class104_Sub1.method3978(this.aClass206_16, this.aClass226_17), this.anInt314, this.anInt313, this.anInt315, 0, Class104_Sub1.method3977(arg7), 5121, arg6, 0);
		OpenGL.glPixelStorei(3317, 4);
		this.method18040(true);
	}

	@OriginalMember(owner = "client!adu", name = "ar", descriptor = "(IIIIIII)V", line = 35)
