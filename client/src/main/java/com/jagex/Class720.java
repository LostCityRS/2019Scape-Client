...
public class Class720 {
	...
	public static int method36907(@OriginalArg(0) CharSequence arg0, @OriginalArg(1) CharSequence arg1, @OriginalArg(2) Class717 arg2) {
		...
		while (local7 - local11 < local2 || local9 - local13 < local5) {
			...
			local11 = Class379.method28097(local43, 411557452);
			local13 = Class379.method28097(local55, -1890237118);
			local43 = Class13.method190(local43, arg2, 174677212);
			local55 = Class13.method190(local55, arg2, 887941996);
			if (local55 != local43 && Character.toUpperCase(local43) != Character.toUpperCase(local55)) {
				...
				if (local55 != local43) {
					return Class75.method1266(local43, arg2, -212280896) - Class75.method1266(local55, arg2, 1590727142);
				}
			}
		}
		...
		for (local115 = 0; local115 < local113; local115++) {
			...
			if (local146 != local142 && Character.toUpperCase(local142) != Character.toUpperCase(local146)) {
				...
				if (local142 != local146) {
					return Class75.method1266(local142, arg2, 1465439415) - Class75.method1266(local146, arg2, 1006910519);
				}
			}
		}
		...
		for (@Pc(185) int local185 = 0; local185 < local113; local185++) {
			...
			if (local196 != local146) {
				return Class75.method1266(local146, arg2, -1833051189) - Class75.method1266(local196, arg2, 1657692029);
			}
		}
		return 0;
	}
	...
	public static int method36908(@OriginalArg(0) CharSequence arg0, @OriginalArg(1) CharSequence arg1, @OriginalArg(2) Class717 arg2) {
		...
		while (local7 - local11 < local2 || local9 - local13 < local5) {
			...
			local11 = Class379.method28097(local43, 742635315);
			local13 = Class379.method28097(local55, -1672736702);
			local43 = Class13.method190(local43, arg2, 1360779888);
			local55 = Class13.method190(local55, arg2, 184625520);
			if (local55 != local43 && Character.toUpperCase(local43) != Character.toUpperCase(local55)) {
				local43 = Character.toLowerCase(local43);
				local55 = Character.toLowerCase(local55);
				if (local55 != local43) {
					return Class75.method1266(local43, arg2, 60716865) - Class75.method1266(local55, arg2, 1326815200);
				}
			}
		}
		@Pc(113) int local113 = Math.min(local2, local5);
		...
		for (local115 = 0; local115 < local113; local115++) {
			...
			if (local146 != local142 && Character.toUpperCase(local142) != Character.toUpperCase(local146)) {
				...
				local146 = Character.toLowerCase(local146);
				if (local142 != local146) {
					return Class75.method1266(local142, arg2, 938492969) - Class75.method1266(local146, arg2, -177217029);
				}
			}
		}
		local115 = local2 - local5;
		...
		for (@Pc(185) int local185 = 0; local185 < local113; local185++) {
			...
			@Pc(196) char local196 = arg1.charAt(local185);
			if (local196 != local146) {
				return Class75.method1266(local146, arg2, -1245980696) - Class75.method1266(local196, arg2, 2102300903);
			}
		}
		return 0;
	}
	...
	static char method36912(@OriginalArg(0) char arg0, @OriginalArg(1) Class717 arg1) {
		if (arg0 >= 'À' && arg0 <= 'ÿ') {
			if (arg0 >= 'À' && arg0 <= 'Æ') {
				return 'A';
			}
	...
	static char method36914(@OriginalArg(0) char arg0) {
		if (arg0 == 'Æ') {
			return 'E';
		} else if (arg0 == 'æ') {
			return 'e';
	...
	static char method36916(@OriginalArg(0) char arg0) {
		if (arg0 == 'Æ') {
			return 'E';
		} else if (arg0 == 'æ') {
			return 'e';
	...
	static int method36917(@OriginalArg(0) char arg0, @OriginalArg(1) Class717 arg1) {
	...
	public static String method36918(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Class717 arg3) {
		@Pc(1) char local1 = ',';
		@Pc(3) char local3 = '.';
