...
public final class Class118_Sub1 extends Class118 {
	...
	@OriginalMember(owner = "client!agr", name = "f", descriptor = "([Lclient!hf;I)V")
	public static void method8416(@OriginalArg(0) Class312[] arg0, @OriginalArg(1) int arg1) {
		for (@Pc(1) int local1 = 0; local1 < arg0.length; local1++) {
			...
			if (local9.anObjectArray13 != null) {
				...
				Class689.method36704(local16, 5000000, 1728468786);
			}
		}
	}

	@OriginalMember(owner = "client!agr", name = "<init>", descriptor = "(Lclient!py;I)V")
	Class118_Sub1(@OriginalArg(0) Class497 arg0, @OriginalArg(1) int arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!agr", name = "x", descriptor = "()Ljava/lang/Class;")
	@Override
	public Class method27798() {
		return Class322.class;
	}

	@OriginalMember(owner = "client!agr", name = "v", descriptor = "(ILclient!ao;I)Lclient!ay;")
	@Override
	...
	@OriginalMember(owner = "client!agr", name = "y", descriptor = "(ILclient!ao;)Lclient!ay;")
	@Override
	public Interface13 method27795(@OriginalArg(0) int arg0, @OriginalArg(1) Interface11 arg1) {
		return new Class322(arg0, arg1, this);
	}

	@OriginalMember(owner = "client!agr", name = "s", descriptor = "(ILclient!ao;)Lclient!ay;")
	@Override
	public Interface13 method27793(@OriginalArg(0) int arg0, @OriginalArg(1) Interface11 arg1) {
		return new Class322(arg0, arg1, this);
	}

	@OriginalMember(owner = "client!agr", name = "o", descriptor = "(B)Ljava/lang/Class;")
	@Override
	public Class method27794(@OriginalArg(0) byte arg0) {
		return Class322.class;
	}

	@OriginalMember(owner = "client!agr", name = "q", descriptor = "(ILclient!ao;)Lclient!ay;")
	@Override
