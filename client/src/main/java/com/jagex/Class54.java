...
public abstract class Class54 {
	...
	@OriginalMember(owner = "client!acc", name = "<init>", descriptor = "()V", line = 25)
	Class54() {
	}

	@OriginalMember(owner = "client!acc", name = "l", descriptor = "()I", line = 28)
	public int method14853() {
		return this.anInt1983 * 2047260205;
	}

	@OriginalMember(owner = "client!acc", name = "w", descriptor = "(I)I", line = 28)
	public int method14854(@OriginalArg(0) int arg0) {
		return this.anInt1983 * 2047260205;
	}

	@OriginalMember(owner = "client!acc", name = "u", descriptor = "()I", line = 28)
	public int method14855() {
		return this.anInt1983 * 2047260205;
	}

	@OriginalMember(owner = "client!acc", name = "m", descriptor = "(S)V", line = 38)
	public static void method14856(@OriginalArg(0) short arg0) {
	...
	@OriginalMember(owner = "client!acc", name = "dj", descriptor = "(Lclient!dh;Lclient!aks;Lclient!hs;I)V", line = 572)
	static void method14857(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class93_Sub29 arg1, @OriginalArg(2) Class322 arg2, @OriginalArg(3) int arg3) {
		@Pc(4) Class100 local4 = arg2.method27260(arg0, -1644056994);
		if (local4 == null) {
			return;
		}
		...
		if (arg2.aString174 != null) {
			...
			if (arg2.anInt4108 * -664150941 != 0) {
				arg0.method20469(local194, local71, local198 - local194, local200 - local71, arg2.anInt4108 * -664150941, (byte) 20);
			}
			if (arg2.anInt4109 * 989664399 != 0) {
				arg0.method20465(local194, local71, local198 - local194, local200 - local71, arg2.anInt4109 * 989664399, 863156789);
			}
			Class171.aClass106_9.method7534(arg2.aString174, local66, local71, local31, local33, arg2.anInt4099 * 2016508123 | 0xFF000000, Class159_Sub1.aClass637_2.anInt5738 * 2079115473, 1, 0, 0, null, null, null, 0, 0, (short) 657);
		}
		...
		Class93_Sub9.aClass22_20.method408(local309, -1314847324);
	}
}
