...
public final class Class78 {
	...
	@OriginalMember(owner = "client!adc", name = "atv", descriptor = "(Lclient!yf;I)V")
	static void method1315(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anInt6052 -= 1189701933;
	}

	@OriginalMember(owner = "client!adc", name = "fg", descriptor = "(III)I")
	public static int method1316(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (Class93_Sub26.aClass645_15.anInt5934 * -742728449 == -1) {
			return 1;
		}
		if (arg0 != Class51.aClass93_Sub36_1.aClass166_Sub4_2.method15436((byte) 59)) {
			Class704.method36913(arg0, Class74.aClass74_100.method1259(Class106.aClass717_8, (byte) -116), true, (byte) -18);
			if (Class51.aClass93_Sub36_1.aClass166_Sub4_2.method15436((byte) 116) != arg0) {
				return -1;
			}
		}
		try {
			...
			@Pc(50) Class231 local50 = Class231.method25748(Class86.aClass497_15, Class93_Sub26.aClass645_15.anInt5934 * -742728449, 0);
			@Pc(53) long local53 = Class305.method26889(1680301932);
			Class694.aClass104_14.method20478();
			client.aClass470_51.method29566(0.0F, 256.0F, 0.0F);
			Class694.aClass104_14.method20528(client.aClass470_51);
			@Pc(66) Class489 local66 = Class694.aClass104_14.method20519();
			local66.method30117((float) (local32.width / 2), (float) (local32.height / 2), 512.0F, 512.0F, (float) client.aClass532_1.method30657(-1086647736), (float) client.aClass532_1.method30631(575023203), (float) local32.width, (float) local32.height);
			Class694.aClass104_14.method20531(local66);
			Class694.aClass104_14.method20533(1.0F);
			Class694.aClass104_14.method20534(16777215, 0.5F, 0.5F, 20.0F, -50.0F, 30.0F);
			@Pc(116) Class109 local116 = Class694.aClass104_14.method20522(local50, 2048, 64, 64, 768);
			@Pc(118) int local118 = 0;
			label42: for (@Pc(120) int local120 = 0; local120 < 500; local120++) {
				Class694.aClass104_14.method20786(3, 0);
				for (@Pc(129) int local129 = 15; local129 >= 0; local129--) {
					for (@Pc(133) int local133 = 0; local133 <= local129; local133++) {
						client.aClass470_52.method29566((float) (((float) local133 - (float) local129 / 2.0F) * 512.0F), 0.0F, (float) ((local129 + 1) * 512));
						local116.method6947(client.aClass470_52, null, 0);
						local118++;
						if (Class305.method26889(-167998623) - local53 >= (long) arg1) {
							break label42;
						}
					}
				}
			}
			Class694.aClass104_14.method20428();
			@Pc(189) long local189 = (long) (local118 * 1000) / (Class305.method26889(1104549670) - local53);
			Class694.aClass104_14.method20786(3, 0);
			return (int) local189;
	...
	@OriginalMember(owner = "client!adc", name = "eg", descriptor = "(II)V")
	public static void method1317(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 < 1) {
	...
	@OriginalMember(owner = "client!adc", name = "l", descriptor = "()Ljava/util/ArrayList;")
	public ArrayList method1302() {
		this.method1307((byte) -118);
	...
	@OriginalMember(owner = "client!adc", name = "e", descriptor = "(Ljava/lang/Object;Ljava/lang/Object;I)V")
	public void method1303(@OriginalArg(0) Object arg0, @OriginalArg(1) Object arg1, @OriginalArg(2) int arg2) {
		if (arg0 == null) {
			throw new NullPointerException();
		}
		this.method1307((byte) -71);
	...
	@OriginalMember(owner = "client!adc", name = "n", descriptor = "(Ljava/lang/Object;I)V")
	public void method1304(@OriginalArg(0) Object arg0, @OriginalArg(1) int arg1) {
		if (arg0 == null) {
			throw new NullPointerException();
		}
		this.method1307((byte) -101);
		@Pc(12) int local12 = System.identityHashCode(arg0);
		@Pc(20) int local20 = local12 & this.aWeakReference_Sub1Array1.length - 1;
		@Pc(25) WeakReference_Sub1 local25 = this.aWeakReference_Sub1Array1[local20];
		if (local25 == null) {
	...
	@OriginalMember(owner = "client!adc", name = "m", descriptor = "(I)Ljava/util/ArrayList;")
	public ArrayList method1305(@OriginalArg(0) int arg0) {
		this.method1307((byte) -104);
		@Pc(10) ArrayList local10 = new ArrayList(this.anInt243 * 1245608703);
		@Pc(13) WeakReference_Sub1[] local13 = this.aWeakReference_Sub1Array1;
		for (@Pc(15) int local15 = 0; local15 < local13.length; local15++) {
			for (@Pc(23) WeakReference_Sub1 local23 = local13[local15]; local23 != null; local23 = local23.aWeakReference_Sub1_1) {
	...
	@OriginalMember(owner = "client!adc", name = "k", descriptor = "(B)V")
	void method1306(@OriginalArg(0) byte arg0) {
	...
	@OriginalMember(owner = "client!adc", name = "f", descriptor = "(B)V")
	...
	@OriginalMember(owner = "client!adc", name = "c", descriptor = "()V")
	void method1308() {
		while (true) {
			@Pc(4) WeakReference_Sub1 local4 = (WeakReference_Sub1) this.aReferenceQueue1.poll();
			if (local4 == null) {
	...
	@OriginalMember(owner = "client!adc", name = "w", descriptor = "(Ljava/lang/Object;)V")
	public void method1309(@OriginalArg(0) Object arg0) {
		if (arg0 == null) {
			throw new NullPointerException();
		}
		this.method1307((byte) -24);
		@Pc(12) int local12 = System.identityHashCode(arg0);
		@Pc(20) int local20 = local12 & this.aWeakReference_Sub1Array1.length - 1;
		@Pc(25) WeakReference_Sub1 local25 = this.aWeakReference_Sub1Array1[local20];
		if (local25 == null) {
	...
	@OriginalMember(owner = "client!adc", name = "d", descriptor = "()V")
	void method1310() {
		@Pc(2) WeakReference_Sub1[] local2 = this.aWeakReference_Sub1Array1;
		this.aWeakReference_Sub1Array1 = new WeakReference_Sub1[local2.length * 2];
		@Pc(11) WeakReference_Sub1[] local11 = local2;
	...
	@OriginalMember(owner = "client!adc", name = "p", descriptor = "()V")
	void method1311() {
		@Pc(2) WeakReference_Sub1[] local2 = this.aWeakReference_Sub1Array1;
		this.aWeakReference_Sub1Array1 = new WeakReference_Sub1[local2.length * 2];
		@Pc(11) WeakReference_Sub1[] local11 = local2;
	...
	@OriginalMember(owner = "client!adc", name = "r", descriptor = "()V")
	void method1312() {
		while (true) {
			@Pc(4) WeakReference_Sub1 local4 = (WeakReference_Sub1) this.aReferenceQueue1.poll();
			if (local4 == null) {
	...
	@OriginalMember(owner = "client!adc", name = "z", descriptor = "()V")
	void method1313() {
		@Pc(2) WeakReference_Sub1[] local2 = this.aWeakReference_Sub1Array1;
		this.aWeakReference_Sub1Array1 = new WeakReference_Sub1[local2.length * 2];
		@Pc(11) WeakReference_Sub1[] local11 = local2;
	...
	@OriginalMember(owner = "client!adc", name = "u", descriptor = "()V")
	void method1314() {
		@Pc(2) WeakReference_Sub1[] local2 = this.aWeakReference_Sub1Array1;
		this.aWeakReference_Sub1Array1 = new WeakReference_Sub1[local2.length * 2];
		@Pc(11) WeakReference_Sub1[] local11 = local2;
