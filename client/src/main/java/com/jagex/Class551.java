...
public final class Class551 {
	...
	@OriginalMember(owner = "client!si", name = "movemouse", descriptor = "(II)V")
	public void movemouse(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aRobot1.mouseMove(arg0, arg1);
	}

	@OriginalMember(owner = "client!si", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V")
