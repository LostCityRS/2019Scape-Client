...
public class Class190 {
	...
	@OriginalMember(owner = "client!bm", name = "e", descriptor = "(Lclient!afa;ILjava/lang/String;)Lclient!bm;", line = 14)
	static Class190 method24585(@OriginalArg(0) Class104_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2) {
	...
	@OriginalMember(owner = "client!bm", name = "n", descriptor = "(Lclient!afa;ILjava/lang/String;)Lclient!bm;", line = 14)
	static Class190 method24586(@OriginalArg(0) Class104_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2) {
		@Pc(2) int local2 = OpenGL.glCreateShader(arg1);
		OpenGL.glShaderSource(local2, arg2);
		OpenGL.glCompileShader(local2);
		OpenGL.glGetShaderiv(local2, 35713, anIntArray298, 0);
	...
	@OriginalMember(owner = "client!bm", name = "<init>", descriptor = "(Lclient!afa;II)V", line = 38)
	Class190(@OriginalArg(0) Class104_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.aClass104_Sub1_39 = arg0;
		this.anInt3348 = arg1;
	}

	@OriginalMember(owner = "client!bm", name = "finalize", descriptor = "()V", line = 44)
	@Override
	protected void finalize() throws Throwable {
		this.aClass104_Sub1_39.method3966((long) this.anInt3348);
		super.finalize();
	}

	@OriginalMember(owner = "client!bm", name = "hl", descriptor = "()V", line = 44)
	void method24587() throws Throwable {
		this.aClass104_Sub1_39.method3966((long) this.anInt3348);
		super.finalize();
	}
}
