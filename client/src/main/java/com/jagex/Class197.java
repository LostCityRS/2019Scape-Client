...
public class Class197 {
	...
	@OriginalMember(owner = "client!bw", name = "<init>", descriptor = "(Lclient!afa;)V", line = 15)
	...
	@OriginalMember(owner = "client!bw", name = "e", descriptor = "(I)Z", line = 33)
	boolean method24619(@OriginalArg(0) int arg0) {
		return this.aClass97Array1[arg0].method2790();
	}

	@OriginalMember(owner = "client!bw", name = "k", descriptor = "(I)Z", line = 33)
	boolean method24620(@OriginalArg(0) int arg0) {
		return this.aClass97Array1[arg0].method2790();
	}

	@OriginalMember(owner = "client!bw", name = "f", descriptor = "(I)Z", line = 33)
	boolean method24621(@OriginalArg(0) int arg0) {
		return this.aClass97Array1[arg0].method2790();
	}

	@OriginalMember(owner = "client!bw", name = "n", descriptor = "(IIIZZ)V", line = 37)
	void method24622(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) boolean arg4) {
		@Pc(5) boolean local5 = arg4 & this.aClass104_Sub1_43.method3762();
	...
	@OriginalMember(owner = "client!bw", name = "w", descriptor = "(IIIZZ)V", line = 37)
	void method24623(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) boolean arg4) {
		@Pc(5) boolean local5 = arg4 & this.aClass104_Sub1_43.method3762();
		if (!local5 && (arg0 == 4 || arg0 == 8 || arg0 == 9)) {
			if (arg0 == 4) {
				arg2 = arg1;
	...
	@OriginalMember(owner = "client!bw", name = "m", descriptor = "(Lclient!bq;I)Z", line = 65)
	boolean method24624(@OriginalArg(0) Class88 arg0, @OriginalArg(1) int arg1) {
		if (this.anInt3367 == 0) {
			return false;
		} else {
	...
	@OriginalMember(owner = "client!bw", name = "l", descriptor = "(Lclient!bq;I)Z", line = 65)
	boolean method24625(@OriginalArg(0) Class88 arg0, @OriginalArg(1) int arg1) {
		if (this.anInt3367 == 0) {
			return false;
		} else {
			this.aClass97Array1[this.anInt3367 & Integer.MAX_VALUE].method2789(arg0, arg1);
