	...
	static void method30393() {
		...
		try {
			...
			if (Class411.aClass411_1 == aClass411_3) {
				...
				if (!client.aClass75_2.method1321((byte) 2).hasBytes(1, (byte) 83)) {
					return;
				}
				client.aClass75_2.method1321((byte) 2).read(client.aClass75_2.aPacketBit_1.data, 0, 1, -1538233007);
	...
	static void method30394() {
		...
		try {
			...
			if (Class411.aClass411_1 == aClass411_3) {
				...
				if (!client.aClass75_2.method1321((byte) 2).hasBytes(1, (byte) -85)) {
					return;
				}
				client.aClass75_2.method1321((byte) 2).read(client.aClass75_2.aPacketBit_1.data, 0, 1, -1697298636);
