...
public class Class26 implements Interface13, Interface5 {
	...
	@OriginalMember(owner = "client!aaz", name = "<init>", descriptor = "()V", line = 20)
	Class26() {
	}
	...
	@OriginalMember(owner = "client!aaz", name = "p", descriptor = "(II)V", line = 46)
	void method574(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	@OriginalMember(owner = "client!aaz", name = "c", descriptor = "(I)V", line = 46)
	...
	@OriginalMember(owner = "client!aaz", name = "o", descriptor = "(I)V", line = 46)
	...
	@OriginalMember(owner = "client!aaz", name = "s", descriptor = "(I)V", line = 46)
	void method577(@OriginalArg(0) int arg0) {
		@Pc(8) double local8 = (double) (arg0 >> 16 & 0xFF) / 256.0D;
		@Pc(17) double local17 = (double) (arg0 >> 8 & 0xFF) / 256.0D;
		@Pc(24) double local24 = (double) (arg0 & 0xFF) / 256.0D;
		@Pc(26) double local26 = local8;
	...
	@OriginalMember(owner = "client!aaz", name = "y", descriptor = "(I)V", line = 46)
	...
	@OriginalMember(owner = "client!aaz", name = "n", descriptor = "(I)V", line = 78)
	@Override
	public void method36653(@OriginalArg(0) int arg0) {
	}

	@OriginalMember(owner = "client!aaz", name = "l", descriptor = "()V", line = 78)
	@Override
	public void method36659() {
	}

	@OriginalMember(owner = "client!aaz", name = "z", descriptor = "(IB)V", line = 79)
	@Override
	public void method36513(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
	}

	@OriginalMember(owner = "client!aaz", name = "v", descriptor = "(I)V", line = 79)
	@Override
	public void method36511(@OriginalArg(0) int arg0) {
	}

	@OriginalMember(owner = "client!aaz", name = "r", descriptor = "(I)V", line = 79)
	@Override
	public void method36512(@OriginalArg(0) int arg0) {
	}

	@OriginalMember(owner = "client!aaz", name = "l", descriptor = "(Lclient!dh;IB)Z", line = 102)
	static boolean method579(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		arg0.method20489();
		Class305.method26797(825107433);
		...
		for (local78 = local72; local78 < local14 + local72; local78++) {
			for (@Pc(85) int local85 = local74; local85 < local18 + local74; local85++) {
				for (local92 = local28; local92 <= 3; local92++) {
					if (local92 < arg1 || local22.method30335(arg1, local92, local78, local85, (byte) -54)) {
		...
		if (Class172.aBoolean519) {
			Class172.aClass100_40 = arg0.method20587(local78, local78, false, true);
			local162 = arg0.method20548();
			local162.method23435(0, Class172.aClass100_40.method18194());
		...
		for (@Pc(304) int local304 = local72; local304 < local14 + local72; local304 += local70) {
			for (@Pc(311) int local311 = local74; local311 < local18 + local74; local311 += local70) {
				...
				for (@Pc(384) int local384 = local28; local384 <= 3; local384++) {
					...
					for (local389 = 0; local389 <= local373; local389++) {
						for (local394 = 0; local394 <= local373; local394++) {
							local297[local389][local394] = local384 < arg1 || local22.method30335(arg1, local384, local389 + local322, local328 + local394, (byte) -108);
						}
					}
					...
					for (local389 = -4; local389 < local70; local389++) {
						for (local394 = -4; local394 < local70; local394++) {
							...
							if (local451 >= local72 && local455 >= local74 && (local384 < arg1 || local22.method30335(arg1, local384, local451, local455, (byte) -76))) {
								@Pc(474) int local474 = local384;
								if (local22.method30330(local451, local455, -662808309)) {
									local474 = local384 - 1;
								}
								if (local474 >= 0) {
									Class352.method27669(arg0, local474, local451, local455, local389 * 4 + local318, (local70 - local394) * 4 + local320 - 4, local253, local266, -1566612262);
								}
							}
						}
					}
				...
				arg0.method20489();
				if (!Class172.aBoolean519) {
					Class172.aClass100_40.method18196((local304 - local72) * 4 + 48, local18 * 4 + 48 - (local311 - local74) * 4 - local70 * 4, local70 * 4, local70 * 4, local318, local320);
					if (Class172.aBoolean520) {
						Class172.aClass100_40.method18161(256, 0);
						try {
							arg0.method20421(-1733131800);
		...
		if (!Class172.aBoolean522) {
			...
			if (local637 != null) {
				...
				Class542.aClass32_Sub2_3.method16652(128, 64, -1812397653);
			}
		}
		return true;
	}
