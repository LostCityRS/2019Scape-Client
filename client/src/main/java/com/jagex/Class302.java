...
public class Class302 implements Interface75 {
	...
	@OriginalMember(owner = "client!gw", name = "m", descriptor = "()[Lclient!gw;", line = 30)
	static Class302[] method26736() {
	...
	@OriginalMember(owner = "client!gw", name = "<init>", descriptor = "(II)V", line = 33)
	Class302(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.anInt3933 = arg0 * -1373136625;
		this.anInt3932 = arg1 * -1267620133;
	}

	@OriginalMember(owner = "client!gw", name = "k", descriptor = "()I", line = 39)
	@Override
	...
	static void method26738(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) boolean arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17) {
		if (arg1 != 0 && arg3 != -1) {
			...
			if (arg1 < 0) {
				...
				local14 = arg1 - 1;
				@Pc(37) Class93_Sub15 local37 = (Class93_Sub15) client.aClass16_18.method214((long) local14);
				if (local37 != null) {
					local7 = (Class132_Sub1_Sub1_Sub1) local37.anObject5;
				}
			}
			if (local7 != null) {
				@Pc(50) Class622 local50 = local7.method19997(470642541);
	...
	@OriginalMember(owner = "client!gw", name = "avz", descriptor = "(Lclient!yf;I)V", line = 13533)
	static final void method26739(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anInt5891 -= 463840436;
		client.aShort155 = (short) arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		if (client.aShort155 <= 0) {
			client.aShort155 = 1;
		}
		client.aShort156 = (short) arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		if (client.aShort156 <= 0) {
			client.aShort156 = 32767;
		} else if (client.aShort156 < client.aShort155) {
			client.aShort156 = client.aShort155;
		}
		client.aShort150 = (short) arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 2];
		if (client.aShort150 <= 0) {
			client.aShort150 = 1;
		}
		client.aShort151 = (short) arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 3];
