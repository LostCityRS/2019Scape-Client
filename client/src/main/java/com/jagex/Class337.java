...
public class Class337 {
	...
	int method27451(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		@Pc(1) int local1 = 0;
	...
	static void method27454(@OriginalArg(0) long arg0) {
	...
	int method27458(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) byte arg5) {
		if (arg4 == 0) {
			return 0;
		}
		@Pc(6) int local6 = 0;
	...
	static void method27459(@OriginalArg(0) Class320 arg0, @OriginalArg(1) Class312 arg1, @OriginalArg(2) int arg2) {
		if (arg1 == null) {
			return;
		}
		@Pc(77) int local77;
		if (arg1.anInt3970 * 532402067 == -1) {
			@Pc(112) Class312[] local112 = arg0.method27233(1784818234);
			for (local77 = 0; local77 < local112.length && local112[local77] != arg1; local77++) {
			}
			if (local77 >= local112.length) {
				return;
			}
			Class713.method36858(local112, 0, local112, 1, local77);
			local112[0] = arg1;
			return;
		}
		...
		if (local18.aClass312Array2 == local18.aClass312Array1) {
			...
			Class713.method36858(local18.aClass312Array2, 0, local18.aClass312Array1, 1, arg1.anInt3970 * 532402067);
			Class713.method36858(local18.aClass312Array2, arg1.anInt3970 * 532402067 + 1, local18.aClass312Array1, arg1.anInt3970 * 532402067 + 1, local18.aClass312Array2.length - arg1.anInt3970 * 532402067 - 1);
			return;
		}
		local77 = 0;
		...
		Class713.method36858(local80, 0, local80, 1, local77);
		local80[0] = arg1;
	}

	@OriginalMember(owner = "client!ig", name = "bp", descriptor = "(Lclient!yf;B)V", line = 5264)
	static final void method27460(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32808(local12, 276869949);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class391.method28289(local16, local22, arg0, 1617869834);
	}

	@OriginalMember(owner = "client!ig", name = "kq", descriptor = "(Lclient!yf;I)V", line = 6756)
	static final void method27461(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class420.method28741(local11, local14, arg0, (byte) -27);
	}

	@OriginalMember(owner = "client!ig", name = "axo", descriptor = "(Lclient!yf;I)V", line = 13858)
	static final void method27462(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anInt5891 -= -1915563430;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		Class334.method27403(10, local13, local23, "", (short) 22218);
	}
}
