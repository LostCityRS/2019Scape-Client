...
public abstract class Class56 implements Interface4 {
	...
	static Class328[] method18022(@OriginalArg(0) int arg0) {
	...
	void method18023(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
	...
	void method18025(@OriginalArg(0) int arg0) {
		this.aClass240_63 = new Class240(arg0);
	}
	...
	void method18027(@OriginalArg(0) int arg0) {
		...
		synchronized (this.aClass240_63) {
			this.aClass240_63.method25847((byte) -8);
		}
	}
	...
	void method18028() {
		@Pc(3) Class240 local3 = this.aClass240_63;
		synchronized (this.aClass240_63) {
			this.aClass240_63.method25847((byte) -123);
		}
	}
	...
	void method18029() {
		@Pc(3) Class240 local3 = this.aClass240_63;
		synchronized (this.aClass240_63) {
			this.aClass240_63.method25847((byte) -42);
		}
	}

	@OriginalMember(owner = "client!ace", name = "m", descriptor = "(II)V", line = 113)
	void method18030(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(3) Class240 local3 = this.aClass240_63;
		synchronized (this.aClass240_63) {
			this.aClass240_63.method25843(arg0, (byte) -21);
		}
	}

	@OriginalMember(owner = "client!ace", name = "k", descriptor = "(I)V", line = 119)
	void method18031(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_63;
		synchronized (this.aClass240_63) {
			this.aClass240_63.method25860(1161602830);
		}
	}
	...
	static void method18035(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class96 arg1, @OriginalArg(2) Class312 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) byte arg8) {
		...
		if (local5.anIntArray399 != null) {
			...
			for (local45 = 0; local45 < local43.length / 2; local45++) {
				if (Class429.anInt4781 * -1453926679 == 3) {
					local70 = (int) ((double) Class65.aClass123_Sub1_2.method9042((byte) -66) * 2607.5945876176133D) + client.anInt3477 * -1357343303 & 0x3FFF;
			...
			@Pc(219) Class327 local219 = arg2.method26904(arg0, (byte) 24);
			if (local219 != null) {
				Class232.method25701(arg0, local43, local5.anInt4124 * 1475506287, local219.anIntArray406, local219.anIntArray407);
			}
			if (local5.anInt4125 * -204583541 > 0) {
				...
				for (local70 = 0; local70 < local43.length / 2 - 1; local70++) {
					...
					if (arg1 == null) {
						arg0.method20579(local95, local99, local269, local279, local5.anIntArray400[local5.aByteArray80[local70] & 0xFF], 1, local5.anInt4125 * -204583541, local5.anInt4101 * 812190215, local5.anInt4127 * -404138527);
					} else {
						arg0.method20868(local95, local99, local269, local279, local5.anIntArray400[local5.aByteArray80[local70] & 0xFF], 1, arg1, arg3, arg4, local5.anInt4125 * -204583541, local5.anInt4101 * 812190215, local5.anInt4127 * -404138527);
					}
				}
				...
				if (arg1 == null) {
					arg0.method20579(local70, local95, local99, local269, local5.anIntArray400[local5.aByteArray80[local5.aByteArray80.length - 1] & 0xFF], 1, local5.anInt4125 * -204583541, local5.anInt4101 * 812190215, local5.anInt4127 * -404138527);
				} else {
					arg0.method20868(local70, local95, local99, local269, local5.anIntArray400[local5.aByteArray80[local5.aByteArray80.length - 1] & 0xFF], 1, arg1, arg3, arg4, local5.anInt4125 * -204583541, local5.anInt4101 * 812190215, local5.anInt4127 * -404138527);
				}
			} else if (arg1 == null) {
				for (local70 = 0; local70 < local43.length / 2 - 1; local70++) {
					arg0.method20578(local43[local70 * 2], local43[local70 * 2 + 1], local43[(local70 + 1) * 2], local43[(local70 + 1) * 2 + 1], local5.anIntArray400[local5.aByteArray80[local70] & 0xFF], 1);
				}
				arg0.method20578(local43[local43.length - 2], local43[local43.length - 1], local43[0], local43[1], local5.anIntArray400[local5.aByteArray80[local5.aByteArray80.length - 1] & 0xFF], 1);
			} else {
				for (local70 = 0; local70 < local43.length / 2 - 1; local70++) {
					arg0.method20576(local43[local70 * 2], local43[local70 * 2 + 1], local43[(local70 + 1) * 2], local43[(local70 + 1) * 2 + 1], local5.anIntArray400[local5.aByteArray80[local70] & 0xFF], 1, arg1, arg3, arg4);
				}
				arg0.method20576(local43[local43.length - 2], local43[local43.length - 1], local43[0], local43[1], local5.anIntArray400[local5.aByteArray80[local5.aByteArray80.length - 1] & 0xFF], 1, arg1, arg3, arg4);
			}
		}
		@Pc(677) Class100 local677 = null;
		if (local5.anInt4126 * -498063801 != -1) {
			local677 = local5.method27255(arg0, false, 2142970087);
			if (local677 != null) {
				local45 = local5.anInt4130 * -971620039 > 0 ? local5.anInt4130 * -971620039 : Class93_Sub26.aClass645_15.anInt5769 * -409062297;
				Class323.method27276(arg2, arg1, arg3, arg4, arg5, arg6, local677, (double) local45, local5.aClass319_4, local5.aClass328_1, 1471701722);
			}
		}
		...
		Class285.method26514(arg2, arg1, arg3, arg4, arg5, arg6, local45, local5.aString174, local736, local738, local5.anInt4099 * 2016508123, 866499998);
	}

	@OriginalMember(owner = "client!ace", name = "ej", descriptor = "(II)Z", line = 1772)
	public static boolean method18036(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg0 == 13 || arg0 == 6 || arg0 == 15 || arg0 == 16;
	}

	@OriginalMember(owner = "client!ace", name = "aw", descriptor = "(Lclient!yf;I)V", line = 4919)
	static final void method18037(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) throws Exception_Sub7 {
		...
		try {
			local33.method33469(local9, arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091], -1245021829);
		} catch (@Pc(51) Exception_Sub7 local51) {
			if (!(local33 instanceof Class647)) {
				throw local51;
			}
			Class361.method27803(arg0, Class560.aClass560_5, local51, "VO", 433817837);
		}
	}

	@OriginalMember(owner = "client!ace", name = "sl", descriptor = "(Lclient!yf;I)V", line = 8251)
	static final void method18038(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method18039(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(18) Class5 local18 = Class157.aClass462_2.method29259(client.anInterface50_1, local12, -1034275569);
