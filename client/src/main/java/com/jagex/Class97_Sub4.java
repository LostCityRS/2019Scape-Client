...
public class Class97_Sub4 extends Class97 {
	...
	@OriginalMember(owner = "client!aer", name = "<init>", descriptor = "(Lclient!afa;Lclient!bz;)V", line = 16)
	Class97_Sub4(@OriginalArg(0) Class104_Sub1 arg0, @OriginalArg(1) Class199 arg1) {
		...
		if (this.aClass199_2.aClass88_Sub3_1 != null && this.aClass104_Sub1_25.aBoolean101 && this.aClass104_Sub1_25.aBoolean103) {
			...
			this.aClass191_1 = Class191.method24589(this.aClass104_Sub1_25, new Class190[] { local29, local35 });
			this.aBoolean58 = this.aClass191_1 != null;
		}
	}

	@OriginalMember(owner = "client!aer", name = "e", descriptor = "()Z", line = 27)
	@Override
	boolean method2790() {
		return this.aBoolean58;
	}

	@OriginalMember(owner = "client!aer", name = "u", descriptor = "()Z", line = 27)
	@Override
	boolean method2802() {
		return this.aBoolean58;
	}

	@OriginalMember(owner = "client!aer", name = "z", descriptor = "()Z", line = 27)
	@Override
	boolean method2798() {
		return this.aBoolean58;
	}

	@OriginalMember(owner = "client!aer", name = "d", descriptor = "()Z", line = 27)
	@Override
	boolean method2799() {
		return this.aBoolean58;
	}

	@OriginalMember(owner = "client!aer", name = "p", descriptor = "()Z", line = 27)
	@Override
	boolean method2791() {
		return this.aBoolean58;
	}

	@OriginalMember(owner = "client!aer", name = "l", descriptor = "()Z", line = 27)
	@Override
	boolean method2796() {
		return this.aBoolean58;
	}

	@OriginalMember(owner = "client!aer", name = "n", descriptor = "(Z)V", line = 31)
	@Override
	void method2801(@OriginalArg(0) boolean arg0) {
		...
		this.aClass104_Sub1_25.method3887(this.aClass199_2.aClass88_Sub3_1);
	...
	@OriginalMember(owner = "client!aer", name = "c", descriptor = "(Z)V", line = 31)
	@Override
	...
	@OriginalMember(owner = "client!aer", name = "m", descriptor = "(Z)V", line = 49)
	@Override
	void method2792(@OriginalArg(0) boolean arg0) {
	}

	@OriginalMember(owner = "client!aer", name = "r", descriptor = "(Z)V", line = 49)
	@Override
	void method2797(@OriginalArg(0) boolean arg0) {
	}

	@OriginalMember(owner = "client!aer", name = "k", descriptor = "()V", line = 52)
	@Override
	void method2793() {
		if (!this.aBoolean59) {
			return;
	...
	@OriginalMember(owner = "client!aer", name = "v", descriptor = "()V", line = 52)
	@Override
	void method2795() {
		if (!this.aBoolean59) {
			return;
	...
	@OriginalMember(owner = "client!aer", name = "f", descriptor = "(II)V", line = 63)
	@Override
	...
	@OriginalMember(owner = "client!aer", name = "o", descriptor = "(II)V", line = 63)
	@Override
	...
	@OriginalMember(owner = "client!aer", name = "y", descriptor = "(II)V", line = 63)
	@Override
	...
	@OriginalMember(owner = "client!aer", name = "s", descriptor = "(II)V", line = 63)
	@Override
	...
	@OriginalMember(owner = "client!aer", name = "q", descriptor = "(Lclient!bq;I)V", line = 82)
	@Override
	...
	@OriginalMember(owner = "client!aer", name = "w", descriptor = "(Lclient!bq;I)V", line = 82)
	@Override
	...
	@OriginalMember(owner = "client!aer", name = "x", descriptor = "(Lclient!bq;I)V", line = 82)
	@Override
