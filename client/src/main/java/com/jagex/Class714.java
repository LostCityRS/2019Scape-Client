...
public final class Class714 {
	...
	@OriginalMember(owner = "client!zq", name = "f", descriptor = "(J)Ljava/lang/String;")
	static String method37042(@OriginalArg(0) long arg0) {
	...
	@OriginalMember(owner = "client!zq", name = "k", descriptor = "(J)Ljava/lang/String;")
	static String method37043(@OriginalArg(0) long arg0) {
		if (arg0 <= 0L || arg0 >= 6582952005840035281L) {
			return null;
		} else if (arg0 % 37L == 0L) {
			return null;
	...
	@OriginalMember(owner = "client!zq", name = "w", descriptor = "(J)Ljava/lang/String;")
	static String method37044(@OriginalArg(0) long arg0) {
		if (arg0 <= 0L || arg0 >= 6582952005840035281L) {
			return null;
		} else if (arg0 % 37L == 0L) {
			return null;
	...
	@OriginalMember(owner = "client!zq", name = "l", descriptor = "(Ljava/lang/CharSequence;)Ljava/lang/String;")
	public static String method37045(@OriginalArg(0) CharSequence arg0) {
	...
	@OriginalMember(owner = "client!zq", name = "oq", descriptor = "(Lclient!hf;Lclient!hq;Lclient!yf;B)V")
	static void method37046(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) byte arg3) {
		...
		arg0.anObjectArray18 = Class499.method30329(local13, arg2, 632480741);
		arg0.aBoolean684 = true;
	}

	@OriginalMember(owner = "client!zq", name = "<init>", descriptor = "()V")
