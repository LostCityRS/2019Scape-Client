...
public class Class696 {
	...
	static void method36644(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (arg0 != -1) {
			@Pc(21) Class661 local21 = (Class661) Class311.aClass32_Sub6_1.get(arg0, -577268731);
	...
	static final boolean readLobbyPackets(@OriginalArg(0) Class175 connection, @OriginalArg(1) byte arg1) throws IOException {
		@Pc(3) Class160 local3 = connection.getStream((byte) 89);
		@Pc(6) PacketBit buf = connection.packet;
		if (local3 == null) {
			return false;
		}
		@Pc(88) int local88;
		if (connection.serverPacketType == null) {
			if (connection.aBoolean563) {
				if (!local3.available(1, 1700286379)) {
					return false;
				}
				local3.read(connection.packet.data, 0, 1, (byte) -112);
				connection.anInt3304 += 1539455077;
				connection.anInt3298 = 0;
				connection.aBoolean563 = false;
			}
			buf.pos = 0;
			if (buf.peekIsaacBit(-1682603128)) {
				if (!local3.available(1, 517964733)) {
					return false;
				}
				local3.read(connection.packet.data, 1, 1, (byte) -93);
				connection.anInt3304 += 1539455077;
				connection.anInt3298 = 0;
			}
			connection.aBoolean563 = true;
			@Pc(84) ServerProt[] local84 = ServerProt.values(1774311473);
			local88 = buf.gIsaac1or2(-454422400);
			if (local88 < 0 || local88 >= local84.length) {
				throw new IOException(local88 + " " + buf.pos * 212851357);
			}
		...
		if (connection.length * 2010044839 == -1) {
			...
			local3.read(buf.data, 0, 1, (byte) -64);
			connection.length = (buf.data[0] & 0xFF) * -852738537;
			connection.anInt3304 += 1539455077;
			connection.anInt3298 = 0;
		}
		if (connection.length * 2010044839 == -2) {
			...
			local3.read(buf.data, 0, 2, (byte) -86);
			buf.pos = 0;
			connection.length = buf.g2(-1434290800) * -852738537;
			connection.anInt3304 += -1216057142;
			connection.anInt3298 = 0;
		}
		if (connection.length * 2010044839 > 0) {
			if (!local3.available(connection.length * 2010044839, 1348285860)) {
				return false;
			}
			buf.pos = 0;
			local3.read(buf.data, 0, connection.length * 2010044839, (byte) -71);
			connection.anInt3304 += connection.length * -775526685;
			connection.anInt3298 = 0;
		}
		connection.prevServerPacketType3 = connection.prevServerPacketType2;
		connection.prevServerPacketType2 = connection.prevServerPacketType1;
		connection.prevServerPacketType1 = connection.serverPacketType;
		@Pc(264) int local264;
		@Pc(273) boolean local273;
		if (connection.serverPacketType == ServerProt.aServerProt_56) {
			local264 = buf.g4_alt3(-1394944635);
			local273 = buf.g1((short) 16384) == 1;
		...
		if (connection.serverPacketType == ServerProt.aServerProt_64) {
			client.anInt3548 = client.anInt3565 * 287027887;
			local302 = buf.g1((short) 16384) == 1;
			if (connection.length * 2010044839 != 1) {
				if (local302) {
					Class121.aClass93_Sub28_2 = new Class93_Sub28(buf);
				} else {
					Class253.aClass93_Sub28_3 = new Class93_Sub28(buf);
				}
				connection.serverPacketType = null;
				return true;
			}
		...
		if (ServerProt.aServerProt_80 == connection.serverPacketType) {
			...
			connection.serverPacketType = null;
			return true;
		} else if (ServerProt.aServerProt_23 == connection.serverPacketType) {
			Class511.aString220 = connection.length * 2010044839 > 2 ? buf.gjstr(1390391231) : Class74.aClass74_133.method1259(Class106.lang, (byte) -35);
			client.anInt3518 = (connection.length * 2010044839 > 0 ? buf.g2(-1434290800) : -1) * 804945147;
			if (client.anInt3518 * -2102645197 == 65535) {
				client.anInt3518 = -804945147;
			}
			connection.serverPacketType = null;
			return true;
		} else if (ServerProt.aServerProt_15 == connection.serverPacketType) {
			Class376.method28047(buf.gjstr(-199116566), (byte) 1);
			connection.serverPacketType = null;
			return true;
		} else if (ServerProt.aServerProt_113 == connection.serverPacketType) {
			local302 = buf.g1_alt3(1409863869) == 1;
			Class704.incrementVerifyId((short) 255);
			Class620.aBoolean843 = local302;
			connection.serverPacketType = null;
			return true;
		} else if (connection.serverPacketType == ServerProt.aServerProt_79) {
			Class118_Sub1.aClass12_4 = Class266.method26226(buf.g1((short) 16384), (byte) 8);
			connection.serverPacketType = null;
			return true;
		} else if (ServerProt.aServerProt_182 == connection.serverPacketType) {
			connection.serverPacketType = null;
			return true;
		} else {
			...
			if (ServerProt.aServerProt_65 == connection.serverPacketType) {
				...
				local611 = new byte[connection.length * 2010044839 - 1];
				local273 = buf.g1((short) 16384) == 1;
				buf.gIsaacArrayBuffer(local611, 0, connection.length * 2010044839 - 1, 1936873316);
				...
				connection.serverPacketType = null;
				return true;
			} else if (connection.serverPacketType == ServerProt.aServerProt_168) {
				local264 = buf.g2_alt1(653375419);
				local88 = buf.g2(-1434290800);
				Class704.incrementVerifyId((short) 255);
				Class123.method9082(local88, local264, 0, -1223039695);
				connection.serverPacketType = null;
				return true;
			} else if (connection.serverPacketType == ServerProt.aServerProt_109) {
				Class704.incrementVerifyId((short) 255);
				...
				if (ServerProt.aServerProt_21 == connection.serverPacketType) {
					local264 = buf.g2(-1434290800);
					local88 = buf.g1((short) 16384);
					local742 = (local88 & 0x1) != 0;
					local750 = (local88 & 0x2) != 0;
					while (buf.pos * 212851357 < connection.length * 2010044839) {
						local396 = buf.gSmart1or2((byte) -20);
						local398 = buf.g2(-1434290800);
						local416 = 0;
						@Pc(771) Class40 local771 = null;
						if (local398 != 0) {
							local416 = buf.g1((short) 16384);
							if (local416 == 255) {
								local416 = buf.g4(-118643075);
							}
							if (local750) {
								local444 = buf.g1((short) 16384);
								if (local444 > 0) {
									local771 = new Class40(Class265.aClass79_Sub1_Sub2_4);
									while (local444-- > 0) {
										@Pc(806) Class466 local806 = Class265.aClass79_Sub1_Sub2_4.method1468(buf, (byte) 118);
					...
					connection.serverPacketType = null;
					return true;
				} else if (ServerProt.aServerProt_118 == connection.serverPacketType) {
					Class641.readZonePacket(ZoneProt.aZoneProt_1, -190991633);
					connection.serverPacketType = null;
					return true;
				} else if (ServerProt.aServerProt_20 == connection.serverPacketType) {
					if (!client.aBoolean636) {
						try {
							local264 = buf.g1((short) 16384);
							local88 = buf.g1_alt3(2134753621);
							local382 = buf.g1_alt3(1946571451);
							...
							Class332.method27394(connection, 1059639619);
						}
					}
					connection.serverPacketType = null;
					return true;
				} else if (connection.serverPacketType == ServerProt.aServerProt_122) {
					Class641.readZonePacket(ZoneProt.aZoneProt_9, -339722943);
					connection.serverPacketType = null;
					return true;
				} else if (ServerProt.aServerProt_196 == connection.serverPacketType) {
					local264 = buf.g2_alt2(2107279448);
					local88 = buf.g4(-118643075);
					Class704.incrementVerifyId((short) 255);
					Class273.method26326(local88, local264, 1565371483);
					connection.serverPacketType = null;
					return true;
				} else if (ServerProt.aServerProt_91 == connection.serverPacketType) {
					client.aClass67_15 = (Class67) Class107.method18116(Class680.method33239((byte) 79), buf.g1((short) 16384), -1915563430);
					Class642.logout(Class411.aBoolean752, (short) 2779);
					connection.serverPacketType = null;
					return false;
				} else if (ServerProt.aServerProt_189 == connection.serverPacketType) {
					if (!client.aBoolean636) {
						try {
							local346 = buf.g1b_alt1((byte) 109);
							local88 = buf.g4(-118643075);
							local382 = buf.g1_alt3(1879921514);
							...
							Class332.method27394(connection, -1675338115);
						}
					}
					connection.serverPacketType = null;
					return true;
					...
					if (ServerProt.aServerProt_19 == connection.serverPacketType) {
						local264 = buf.g1_alt2(-35008779);
						local88 = buf.g2_alt3(16711680);
						if (local88 == 65535) {
							local88 = -1;
						}
						local1018 = buf.gjstr(190885939);
						local1022 = buf.g1_alt3(1407296258);
						...
						connection.serverPacketType = null;
						return true;
					} else if (ServerProt.aServerProt_70 == connection.serverPacketType) {
						local264 = buf.g1_alt1(1855696728);
						local88 = buf.g2(-1434290800);
						...
						connection.serverPacketType = null;
						return true;
					} else if (connection.serverPacketType == ServerProt.aServerProt_198) {
						Class637.aClass113_1 = null;
						connection.serverPacketType = null;
						return true;
					} else if (connection.serverPacketType == ServerProt.aServerProt_75) {
						@Pc(1123) int[] local1123 = new int[4];
						for (local88 = 0; local88 < 4; local88++) {
							local1123[local88] = buf.g4_alt1(-359345991);
						}
						local88 = buf.g2(-1434290800);
						local382 = buf.g1_alt2(1367897093);
						...
						connection.serverPacketType = null;
						return true;
					} else if (connection.serverPacketType == ServerProt.aServerProt_120) {
						local264 = buf.g4_alt2(-138550381);
						local88 = buf.g2_alt1(2103272100);
						local382 = buf.g2_alt1(1346086504);
						local1022 = buf.g2_alt2(1690629750);
						Class704.incrementVerifyId((short) 255);
						Class125_Sub2.method21464(local264, local88, local382, local1022, -441802256);
						connection.serverPacketType = null;
						return true;
					} else if (ServerProt.aServerProt_33 == connection.serverPacketType) {
						client.anInt3447 = client.anInt3565 * 2096178751;
						local302 = buf.g1((short) 16384) == 1;
						if (connection.length * 2010044839 != 1) {
							if (local302) {
								Class279.aClass386_1 = new Class386(buf);
							} else {
								Class581.aClass386_2 = new Class386(buf);
							}
							connection.serverPacketType = null;
							return true;
						}
						...
						connection.serverPacketType = null;
						return true;
					} else if (connection.serverPacketType == ServerProt.aServerProt_123) {
						local264 = buf.g1((short) 16384);
						local88 = buf.gSmart2or4null(-801855645);
						...
						if (local88 != -1) {
							client.aClass567Array1[local264] = new Class567(Class694.aClass104_14, buf, local88);
						}
						connection.serverPacketType = null;
						return true;
					} else {
						...
						if (connection.serverPacketType == ServerProt.aServerProt_87) {
							local302 = buf.g1((short) 16384) == 1;
							local1316 = buf.g2(-1434290800);
							local1321 = buf.g3((short) 9219);
							...
							if (!local1329) {
								...
								@Pc(1379) String local1379 = Class433.method28791(buf, 672487471);
								local1385 = local302 ? 43 : 46;
								Class60.method1118(local1385, 0, "", "", "", local1379, local1335.aString44, -1, null, 84687310);
							}
							connection.serverPacketType = null;
							return true;
						} else if (ServerProt.aServerProt_41 == connection.serverPacketType) {
							Class552.method31036(buf, connection.length * 2010044839, 1956542640);
							connection.serverPacketType = null;
							return true;
							...
							if (ServerProt.aServerProt_169 == connection.serverPacketType) {
								local264 = buf.g4_alt1(-1247714423);
								local1457 = new Class611(buf.g4_alt3(1912041466));
								local382 = buf.g2(-1434290800);
								local1022 = buf.g1_alt3(1277019472);
								local396 = buf.g4_alt3(-245665451);
								local398 = buf.g4(-118643075);
								local416 = buf.g4_alt2(-484293036);
								local1481 = buf.g4_alt3(66913047);
								local444 = buf.g1((short) 16384);
								local1343 = buf.g4(-118643075);
								@Pc(1496) Class629 local1496 = new Class629(buf, local444, false);
								Class704.incrementVerifyId((short) 255);
								Class348.openSubInterface(local264, new Class93_Sub40_Sub1(local382, local1022, new Class694(local1457, local1496.anInt5709 * 1175627307, local1496.anInt5708 * -1626288991, local1343)), new int[] { local396, local398, local416, local1481 }, false, (byte) 0);
								connection.serverPacketType = null;
								return true;
							}
							...
							if (connection.serverPacketType == ServerProt.aServerProt_51) {
								while (buf.pos * 212851357 < connection.length * 2010044839) {
									local302 = buf.g1((short) 16384) == 1;
									local1571 = buf.gjstr(631966309);
									local1018 = buf.gjstr(1893917905);
									local1022 = buf.g2(-1434290800);
									local396 = buf.g1((short) 16384);
									local398 = buf.g1((short) 16384);
									...
									local1385 = 0;
									if (local1022 > 0) {
										local1606 = buf.gjstr(2113607965);
										local1343 = buf.g1((short) 16384);
										local1385 = buf.g4(-118643075);
									}
									local1628 = buf.gjstr(289673832);
							...
							if (ServerProt.aServerProt_27 == connection.serverPacketType) {
								local264 = buf.g2_alt2(2141410661);
								if (local264 == 65535) {
									local264 = -1;
								}
								local88 = buf.g4(-118643075);
								local382 = buf.g2_alt3(16711680);
								if (local382 == 65535) {
									local382 = -1;
								}
								local1022 = buf.g4_alt1(-1073008285);
								Class704.incrementVerifyId((short) 255);
								...
								connection.serverPacketType = null;
								return true;
							} else if (ServerProt.aServerProt_55 == connection.serverPacketType) {
								Class641.readZonePacket(ZoneProt.aZoneProt_4, -466980108);
								connection.serverPacketType = null;
								return true;
							} else {
								@Pc(2070) byte local2070;
								if (ServerProt.aServerProt_72 == connection.serverPacketType) {
									local264 = buf.g1((short) 16384);
									local264 = -local264 - 2;
									local2070 = buf.g1b(829318938);
									...
									local2076.method20047(buf, local2070, -237524841);
									connection.serverPacketType = null;
									return true;
								} else if (connection.serverPacketType == ServerProt.aServerProt_60) {
									local264 = buf.g1_alt1(1876424432);
									local88 = buf.g2_alt1(606349608);
									if (local88 == 65535) {
										local88 = -1;
									}
									...
									if (ServerProt.aServerProt_89 == connection.serverPacketType) {
										local264 = buf.g4_alt1(988263617);
										...
										local398 = buf.g4(-118643075);
										local416 = buf.g1((short) 16384);
										@Pc(2175) Class629 local2175 = new Class629(buf, local416, false);
										...
										connection.serverPacketType = null;
										return true;
									} else if (connection.serverPacketType == ServerProt.aServerProt_24) {
										local264 = buf.g1((short) 16384);
										...
										connection.serverPacketType = null;
										return true;
									} else if (connection.serverPacketType == ServerProt.aServerProt_81) {
										local264 = buf.g2(-1434290800);
										Class274.aClass258_1.method26058(local264, (byte) 23);
										connection.serverPacketType = null;
										return true;
									} else if (connection.serverPacketType == ServerProt.aServerProt_69) {
										local264 = buf.g4_alt2(-1777385325);
										Class704.incrementVerifyId((short) 255);
										if (local264 == -1) {
										...
										connection.serverPacketType = null;
										return true;
									} else if (connection.serverPacketType == ServerProt.aServerProt_18) {
										Class641.readZonePacket(ZoneProt.aZoneProt_3, -225905306);
										connection.serverPacketType = null;
										return true;
									} else if (connection.serverPacketType == ServerProt.aServerProt_114) {
										local264 = buf.g4(-118643075);
										local88 = buf.g1_alt2(1047760670);
										Class704.incrementVerifyId((short) 255);
										...
										if (connection.serverPacketType == ServerProt.aServerProt_194) {
											local302 = buf.g1((short) 16384) == 1;
											local1571 = buf.gjstr(1877367144);
											local2422 = buf.g2(-1434290800);
											local2427 = buf.g3((short) 18791);
											local2436 = (Class443) Class107.method18116(Class443.method28866(1812282459), buf.g1((short) 16384), -1915563430);
											...
											if (!local2444) {
												...
												local1628 = Class657.method32750(Class433.method28791(buf, 672487471), (byte) 8);
											...
											connection.serverPacketType = null;
											return true;
										} else if (ServerProt.aServerProt_111 == connection.serverPacketType) {
											Class637.aClass113_1 = new Class113(Class39.aClass79_Sub1_Sub2_1);
											connection.serverPacketType = null;
											return true;
										} else if (connection.serverPacketType == ServerProt.aServerProt_115) {
											local264 = buf.g4(-118643075);
											...
											connection.serverPacketType = null;
											return true;
										} else if (connection.serverPacketType == ServerProt.aServerProt_186) {
											local264 = buf.g2(-1434290800);
											if (local264 == 65535) {
												local264 = -1;
											}
											local88 = buf.g1((short) 16384);
											local382 = buf.g2(-1434290800);
											local1022 = buf.g1((short) 16384);
											local396 = buf.g2(-1434290800);
											...
											if (connection.serverPacketType == ServerProt.aServerProt_170) {
												local302 = buf.g1((short) 16384) == 1;
												local1571 = buf.gjstr(1679314768);
												local1018 = local1571;
												if (local302) {
													local1018 = buf.gjstr(1771771768);
												}
												local1321 = buf.g2(-1434290800);
												local1327 = buf.g3((short) 671);
												local2719 = (Class443) Class107.method18116(Class443.method28866(1306362893), buf.g1((short) 16384), -1915563430);
												local444 = buf.g2(-1434290800);
												...
												if (!local2731) {
													...
													client.anInt3564 = (client.anInt3564 * -254980857 + 1) % 100 * -1639542601;
													local2782 = Class372.aClass58_2.method1094(local444, -737304293).method22928(buf, (byte) -126);
												...
												connection.serverPacketType = null;
												return true;
											} else if (connection.serverPacketType == ServerProt.aServerProt_14) {
												Class641.readZonePacket(ZoneProt.aZoneProt_2, -293241541);
												connection.serverPacketType = null;
												return true;
											} else if (connection.serverPacketType == ServerProt.aServerProt_128) {
												Class641.readZonePacket(ZoneProt.aZoneProt_8, -1962835107);
												connection.serverPacketType = null;
												return true;
											} else if (ServerProt.aServerProt_157 == connection.serverPacketType) {
												Class357.method27768(-1343475456);
												connection.serverPacketType = null;
												return false;
											} else if (connection.serverPacketType == ServerProt.aServerProt_151) {
												...
												connection.serverPacketType = null;
												return true;
											} else if (connection.serverPacketType == ServerProt.aServerProt_192) {
												local264 = buf.g4_alt3(1730011325);
												...
												connection.serverPacketType = null;
												return true;
											} else if (ServerProt.aServerProt_134 == connection.serverPacketType) {
												local264 = buf.g2(-1434290800);
												local88 = buf.g4_alt2(-196844014);
												local382 = buf.g2_alt1(1206320326);
												local1022 = buf.g2_alt1(826617743);
												Class704.incrementVerifyId((short) 255);
												Class132_Sub1_Sub4_Sub2.method13432(local88, 7, local1022 << 16 | local264, local382, -19442568);
												connection.serverPacketType = null;
												return true;
											} else if (connection.serverPacketType == ServerProt.aServerProt_37) {
												if (!client.aBoolean636) {
													try {
														local264 = buf.g1_alt2(-316289143);
														local88 = buf.g1_alt3(1734681998);
														...
														Class332.method27394(connection, -1861087385);
													}
												}
												connection.serverPacketType = null;
												return true;
												...
												if (ServerProt.aServerProt_38 == connection.serverPacketType) {
													local3022 = buf.gjstr(158923043);
													Class202.method24645(local3022, 462404467);
													connection.serverPacketType = null;
													return true;
												} else if (connection.serverPacketType == ServerProt.aServerProt_86) {
													local302 = buf.g1((short) 16384) == 1;
													if (local302) {
													...
													connection.serverPacketType = null;
													return true;
												} else if (ServerProt.aServerProt_155 == connection.serverPacketType) {
													local264 = buf.g1_alt2(1183398587);
													local88 = buf.g4_alt1(306086621);
													local382 = buf.g1_alt3(2012896507);
													Class336.aClass644_1.method32591(local382, (byte) 24);
													Class624.playerVariableManager.aClass675Array1[local382].method33143(local88, 388168353);
													Class624.playerVariableManager.aClass675Array1[local382].method33157(local264, 479175137);
													client.anIntArray320[(client.anInt3542 += 1791453411) * 1101864139 - 1 & 0x3F] = local382;
													connection.serverPacketType = null;
													return true;
												} else if (connection.serverPacketType == ServerProt.aServerProt_119) {
													Class274.aClass258_1.method26072(Class280.aClass280_3.method26450(-1728957832), (byte) -50);
													connection.serverPacketType = null;
													return true;
												} else if (connection.serverPacketType == ServerProt.aServerProt_124) {
													local264 = buf.gSmart1or2((byte) -27);
													local88 = buf.g4(-118643075);
													local382 = buf.g1((short) 16384);
													local640 = "";
													local646 = local640;
													if ((local382 & 0x1) != 0) {
														local640 = buf.gjstr(601770650);
														if ((local382 & 0x2) == 0) {
															local646 = local640;
														} else {
															local646 = buf.gjstr(1927203846);
														}
													}
													@Pc(3170) String local3170 = buf.gjstr(1510049215);
													if (local264 == 99) {
													...
													connection.serverPacketType = null;
													return true;
												} else if (ServerProt.aServerProt_171 == connection.serverPacketType) {
													local302 = buf.g1((short) 16384) == 1;
													@Pc(3232) byte[] local3232 = new byte[connection.length * 2010044839 - 1];
													buf.gdata(local3232, 0, connection.length * 2010044839 - 1, (short) 26379);
													Class490.method29971(local302, local3232, 957530791);
													connection.serverPacketType = null;
													return true;
												} else if (ServerProt.aServerProt_184 == connection.serverPacketType) {
													local264 = buf.g4_alt3(972597358);
													local88 = buf.g1_alt1(1719079023);
													local88 = -local88 - 2;
													Class704.incrementVerifyId((short) 255);
													Class132_Sub1_Sub4_Sub2.method13432(local264, 5, local88, 0, -19442568);
													connection.serverPacketType = null;
													return true;
												} else if (ServerProt.aServerProt_97 == connection.serverPacketType) {
													local264 = buf.g4(-118643075);
													Class704.incrementVerifyId((short) 255);
													...
													if (ServerProt.aServerProt_13 == connection.serverPacketType) {
														local264 = buf.g2(-1434290800);
														...
														local382 = buf.g2(-1434290800);
														@Pc(3347) Class443 local3347 = (Class443) Class107.method18116(Class443.method28866(1029966223), buf.g1((short) 16384), -1915563430);
														...
														if (local3322.name2 != null && local3322.aClass658_1 != null) {
															...
															if (!local3365) {
																...
																if (local3355) {
																	local382 &= 0x7FFF;
																	@Pc(3400) Class434 local3400 = Class5.method31(buf, (byte) 1);
																	local1481 = local3400.anInt4807 * 526894191;
																	local3411 = local3400.aClass93_Sub1_Sub18_1.method22928(buf, (byte) -78);
																} else {
																	local3411 = Class657.method32750(Class433.method28791(buf, 672487471), (byte) 104);
																}
														...
														connection.serverPacketType = null;
														return true;
													} else if (ServerProt.aServerProt_197 == connection.serverPacketType) {
														local264 = buf.g4_alt2(-1653829219);
														local88 = buf.g4(-118643075);
														Class704.incrementVerifyId((short) 255);
														...
														connection.serverPacketType = null;
														return true;
													} else if (ServerProt.aServerProt_92 == connection.serverPacketType) {
														Class704.incrementVerifyId((short) 255);
														Class301.method26730((byte) 0);
														connection.serverPacketType = null;
														return true;
													} else if (connection.serverPacketType == ServerProt.aServerProt_77) {
														Class641.readZonePacket(ZoneProt.aZoneProt_13, -2112302429);
														connection.serverPacketType = null;
														return true;
													} else if (connection.serverPacketType == ServerProt.aServerProt_34) {
														local264 = buf.g2_alt1(1278625759);
														if (local264 == 65535) {
															local264 = -1;
														}
														...
														connection.serverPacketType = null;
														return true;
													} else if (connection.serverPacketType == ServerProt.aServerProt_102) {
														Class274.aClass258_1.method26076(buf.g2(-1434290800), (byte) 3);
														connection.serverPacketType = null;
														return true;
													} else if (connection.serverPacketType == ServerProt.aServerProt_165) {
														client.anInt3560 = buf.g1((short) 16384) * 175759505;
														client.anInt3550 = client.anInt3565 * -1649412131;
														connection.serverPacketType = null;
														return true;
													} else if (ServerProt.aServerProt_187 == connection.serverPacketType) {
														local264 = buf.g4_alt2(1479496861);
														local88 = buf.g4_alt1(-1239569098);
														Class704.incrementVerifyId((short) 255);
														Class647.method32648(local88, local264, -1850432993);
														connection.serverPacketType = null;
														return true;
													} else if (connection.serverPacketType == ServerProt.aServerProt_98) {
														local3022 = buf.gjstr(-220731705);
														local88 = buf.g2(-1434290800);
														local1018 = Class372.aClass58_2.method1094(local88, -737304293).method22928(buf, (byte) -122);
														Class60.method1118(19, 0, local3022, local3022, local3022, local1018, null, local88, null, 774873463);
														connection.serverPacketType = null;
														return true;
													} else if (ServerProt.UPDATE_ZONE_PARTIAL_ENCLOSED == connection.serverPacketType) {
														Class113_Sub1.zoneUpdateX = buf.g1_alt1(1601450854) * -443032363;
														Class127_Sub1.zoneUpdateZ = (buf.g1b_alt2(914682215) << 3) * 109640353;
														Class252.zoneUpdateLevel = (buf.g1b_alt2(-362655304) << 3) * 578904527;
														while (buf.pos * 212851357 < connection.length * 2010044839) {
															@Pc(3752) ZoneProt local3752 = ZoneProt.values(1226839941)[buf.g1((short) 16384)];
															Class641.readZonePacket(local3752, 47758259);
														}
														connection.serverPacketType = null;
														return true;
													} else if (connection.serverPacketType == ServerProt.aServerProt_147) {
														local264 = buf.g2(-1434290800);
														if (local264 == 65535) {
															local264 = -1;
														}
														...
														connection.serverPacketType = null;
														return true;
													} else if (connection.serverPacketType == ServerProt.aServerProt_135) {
														local264 = buf.g1((short) 16384);
														...
														connection.serverPacketType = null;
														return true;
													} else if (connection.serverPacketType == ServerProt.aServerProt_145) {
														client.aClass660_2 = (Class660) Class107.method18116(Class660.method32819(-469245072), buf.g1_alt3(1664250854), -1915563430);
														if (client.aClass660_2 == null) {
															client.aClass660_2 = Class660.aClass660_5;
														}
														connection.serverPacketType = null;
														return true;
													} else if (ServerProt.aServerProt_73 == connection.serverPacketType) {
														if (!client.aBoolean636) {
															try {
																local264 = buf.g1((short) 16384);
																...
																Class332.method27394(connection, -1824597658);
															}
														}
														connection.serverPacketType = null;
														return true;
													} else if (connection.serverPacketType == ServerProt.aServerProt_61) {
														Class113_Sub1.zoneUpdateX = buf.g1((short) 16384) * -443032363;
														Class127_Sub1.zoneUpdateZ = (buf.g1b_alt2(1791850876) << 3) * 109640353;
														Class252.zoneUpdateLevel = (buf.g1b(1499862713) << 3) * 578904527;
														connection.serverPacketType = null;
														return true;
													} else if (connection.serverPacketType == ServerProt.aServerProt_183) {
														local264 = buf.g4(-118643075);
														local88 = buf.g2(-1434290800);
														if (local88 == 65535) {
															local88 = -1;
														}
														local382 = buf.g2_alt2(1940919633);
														local1022 = buf.g2_alt2(2021399983);
														if (local1022 == 65535) {
															local1022 = -1;
														}
														Class704.incrementVerifyId((short) 255);
														...
														connection.serverPacketType = null;
														return true;
													} else if (ServerProt.aServerProt_140 == connection.serverPacketType) {
														local264 = buf.g2(-1434290800);
														...
														Class36.aPacket_1.pdata(buf.data, buf.pos * 212851357, local382, 2026842986);
														buf.pos += local382 * -1445626955;
														connection.serverPacketType = null;
														return false;
													} else if (ServerProt.aServerProt_131 == connection.serverPacketType) {
														Class641.readZonePacket(ZoneProt.aZoneProt_15, -566224322);
														connection.serverPacketType = null;
														return true;
													} else if (ServerProt.aServerProt_5 == connection.serverPacketType) {
														if (Class4.aBoolean2 && Class125_Sub2_Sub1.aFrame1 != null) {
															Class717.method36895(Class51.options.aClass166_Sub23_1.method15844(1404386831), -1, -1, false, (byte) 116);
														}
														local611 = new byte[connection.length * 2010044839];
														buf.gIsaacArrayBuffer(local611, 0, connection.length * 2010044839, 405047961);
														local1571 = Class155.method15306(local611, 0, connection.length * 2010044839, (byte) -38);
														...
														connection.serverPacketType = null;
														return true;
													} else if (connection.serverPacketType == ServerProt.aServerProt_139) {
														local264 = buf.g4_alt2(-526180383);
														local88 = buf.g4_alt2(-1977085613);
														Class704.incrementVerifyId((short) 255);
														@Pc(4194) SubInterface local4194 = (SubInterface) client.aClass16_22.method214((long) local264);
														@Pc(4200) SubInterface local4200 = (SubInterface) client.aClass16_22.method214((long) local88);
														if (local4200 != null) {
														...
														if (client.topLevelInterface * -703563959 != -1) {
															Class189.method24583(client.topLevelInterface * -703563959, 1, 1879122973);
														}
														connection.serverPacketType = null;
														return true;
													} else if (connection.serverPacketType == ServerProt.aServerProt_67) {
														local264 = buf.g4_alt1(-1852824935);
														local88 = buf.g2_alt2(1877270906);
														local382 = buf.g4_alt3(-1620217792);
														Class704.incrementVerifyId((short) 255);
														Class132_Sub1_Sub4_Sub2.method13432(local382, 3, local88, local264, -19442568);
														connection.serverPacketType = null;
														return true;
													} else if (ServerProt.aServerProt_110 == connection.serverPacketType) {
														local346 = buf.g1b(524803479);
														Class520.selfPlayer.method20047(buf, local346, -237524841);
														connection.serverPacketType = null;
														return true;
													} else if (connection.serverPacketType == ServerProt.aServerProt_193) {
														while (buf.pos * 212851357 < connection.length * 2010044839) {
															local264 = buf.g1((short) 16384);
															local273 = (local264 & 0x1) == 1;
															local1018 = buf.gjstr(573192536);
															local640 = buf.gjstr(1212981529);
															local646 = buf.gjstr(597998901);
														...
														connection.serverPacketType = null;
														return true;
													} else if (connection.serverPacketType == ServerProt.aServerProt_185) {
														local264 = buf.g4_alt1(-381041351);
														local1571 = buf.gjstr(208378147);
														Class704.incrementVerifyId((short) 255);
														Class239.method25820(local264, local1571, (byte) -40);
														connection.serverPacketType = null;
														return true;
													} else if (ServerProt.aServerProt_191 == connection.serverPacketType) {
														client.anInt3551 = client.anInt3565 * 1524761337;
														@Pc(4498) Class303 local4498 = new Class303(buf, client.anInterface27_1);
														local4498.method26741(Class557.aClass297_1, -894576729);
														connection.serverPacketType = null;
														return true;
													} else if (connection.serverPacketType == ServerProt.aServerProt_150) {
														local264 = buf.g4_alt1(-440259584);
														local88 = buf.g2_alt2(1742699273);
														local382 = buf.g2_alt1(1998562807);
														local1022 = buf.g1_alt1(1692157547);
														Class704.incrementVerifyId((short) 255);
														...
														connection.serverPacketType = null;
														return true;
													} else if (connection.serverPacketType == ServerProt.aServerProt_130) {
														Class626.userDob = buf.g3s(-87715282) * 889370685;
														client.userQuickChat1 = buf.g1((short) 16384) == 1;
														connection.serverPacketType = null;
														return true;
													} else if (connection.serverPacketType == ServerProt.aServerProt_161) {
														if (!client.aBoolean636) {
															try {
																local264 = buf.g4_alt1(-1237998224);
																local2070 = buf.g1b_alt1((byte) 51);
																...
																Class332.method27394(connection, 1621563870);
															}
														}
														connection.serverPacketType = null;
														return true;
														...
														if (connection.serverPacketType == ServerProt.aServerProt_94) {
															local302 = buf.g1((short) 16384) == 1;
															local1571 = buf.gjstr(2008455286);
															local2422 = buf.g2(-1434290800);
															local2427 = buf.g3((short) 2573);
															local2436 = (Class443) Class107.method18116(Class443.method28866(1526847246), buf.g1((short) 16384), -1915563430);
															local1481 = buf.g2(-1434290800);
															...
															if (!local4667) {
																...
																client.anInt3564 = (client.anInt3564 * -254980857 + 1) % 100 * -1639542601;
																local2782 = Class372.aClass58_2.method1094(local1481, -737304293).method22928(buf, (byte) -12);
															...
															connection.serverPacketType = null;
															return true;
														} else if (ServerProt.aServerProt_141 == connection.serverPacketType) {
															Class172.anInt3177 = buf.g1((short) 16384) * 676443409;
															connection.serverPacketType = null;
															return true;
														} else if (ServerProt.aServerProt_179 == connection.serverPacketType) {
															Class127_Sub1.zoneUpdateZ = (buf.g1b_alt2(122392661) << 3) * 109640353;
															Class113_Sub1.zoneUpdateX = buf.g1_alt2(445436525) * -443032363;
															Class252.zoneUpdateLevel = (buf.g1b_alt3(56848332) << 3) * 578904527;
															...
															connection.serverPacketType = null;
															return true;
														} else if (connection.serverPacketType == ServerProt.aServerProt_30) {
															client.anInt3572 = 671281251;
															client.anInt3547 = client.anInt3565 * -541355657;
															connection.serverPacketType = null;
															return true;
														} else if (connection.serverPacketType == ServerProt.aServerProt_76) {
															local264 = buf.g4_alt1(-1943851137);
															Class704.incrementVerifyId((short) 255);
															Class132_Sub1_Sub4_Sub2.method13432(local264, 3, client.selfPlayerSlot * -859840571, 0, -19442568);
															connection.serverPacketType = null;
															return true;
														} else if (connection.serverPacketType == ServerProt.aServerProt_163) {
															client.anInt3517 = client.anInt3565 * -879973135;
															local264 = buf.pos * 212851357;
															local88 = buf.g2(-1434290800);
															local742 = buf.g1((short) 16384) == 1;
															...
															while (connection.length * 2010044839 - (buf.pos * 212851357 - local264) > 0) {
																@Pc(5206) Class466 local5206 = Class21.varPlayerTypes.method1468(buf, (byte) 25);
																local5177.method776(local5206.anInt5092 * -1181855333, local5206.anObject19, (byte) 104);
															}
															connection.serverPacketType = null;
															return true;
														} else if (connection.serverPacketType == ServerProt.aServerProt_162) {
															local264 = buf.g4_alt2(-752923859);
															...
															connection.serverPacketType = null;
															return true;
														} else if (ServerProt.aServerProt_53 == connection.serverPacketType) {
															local264 = buf.g4(-118643075);
															local88 = buf.g4(-118643075);
															@Pc(5266) ClientMessage local5266 = Class102.createGameMessage(ClientProt.aClientProt_114, connection.clientIsaac, (byte) 124);
															...
															connection.send(local5266, -2138973824);
															connection.serverPacketType = null;
															return true;
														} else if (ServerProt.IF_OPENTOP == connection.serverPacketType) {
															int xtea4 = buf.g4_alt2(720755282);
															int xtea3 = buf.g4_alt1(1257529704);
															int xtea1 = buf.g4_alt2(-1651721613);
															...
															@Pc(5342) int[] key = new int[] { xtea1, xtea2, xtea3, xtea4 };
															client.topLevelInterface = toplevel * 823798521;
															Class93_Sub31.resetInterfaceAnims(toplevel, key, (byte) 53);
															Class618.computeTopLevelInterfaceLayout(false, -1468269186);
															Class56.runOnLoad(client.topLevelInterface * -703563959, key, 1601801992);

															for (int i = 0; i < 114; i++) {
																client.topLevelComponentRedrawRequestedTemp[i] = true;
															}

															connection.serverPacketType = null;
															return true;
														} else if (ServerProt.aServerProt_7 == connection.serverPacketType) {
															local264 = buf.g4_alt3(697297611);
															local88 = buf.g4(-118643075);
															local382 = buf.g1_alt1(990163983);
															local1022 = buf.g1((short) 16384);
															local396 = buf.g1_alt2(-212046991);
															...
															connection.serverPacketType = null;
															return true;
														} else if (ServerProt.aServerProt_57 == connection.serverPacketType) {
															local264 = buf.g2(-1434290800);
															local88 = buf.g2(-1434290800);
															local382 = buf.g2(-1434290800);
															Class704.incrementVerifyId((short) 255);
															...
															connection.serverPacketType = null;
															return true;
														} else if (connection.serverPacketType == ServerProt.aServerProt_166) {
															local264 = buf.g2(-1434290800);
															local88 = buf.g2(-1434290800);
															Class274.aClass258_1.method26064(local264, local88, -898208304);
															connection.serverPacketType = null;
															return true;
														} else if (ServerProt.aServerProt_181 == connection.serverPacketType) {
															if (Class56.method18036(client.state * -849002901, -1497248091)) {
																client.anInt3453 = (int) ((float) buf.g2(-1434290800) * 2.5F) * -172784017;
															} else {
																client.anInt3453 = buf.g2(-1434290800) * -888553214;
															}
															client.anInt3550 = client.anInt3565 * -1649412131;
															connection.serverPacketType = null;
															return true;
														} else if (connection.serverPacketType == ServerProt.aServerProt_88) {
															if (Class637.aClass113_1 == null) {
																Class637.aClass113_1 = new Class113(Class39.aClass79_Sub1_Sub2_1);
															}
															@Pc(5577) Class466 local5577 = Class39.aClass79_Sub1_Sub2_1.method1468(buf, (byte) 17);
															...
															connection.serverPacketType = null;
															return true;
														} else if (connection.serverPacketType == ServerProt.aServerProt_199) {
															local264 = buf.g2(-1434290800);
															if (local264 == 65535) {
																local264 = -1;
															}
															...
															connection.serverPacketType = null;
															return true;
														} else if (connection.serverPacketType == ServerProt.aServerProt_148) {
															client.anInt3581 = buf.g2s((byte) -76) * 726203003;
															client.anInt3550 = client.anInt3565 * -1649412131;
															connection.serverPacketType = null;
															return true;
														} else {
															@Pc(5706) PacketBit local5706;
															if (connection.serverPacketType == ServerProt.REBUILD_REGION) {
																local5706 = new PacketBit(connection.length * 2010044839);
																System.arraycopy(connection.packet.data, connection.packet.pos * 212851357, local5706.data, 0, connection.length * 2010044839);
															...
															if (connection.serverPacketType == ServerProt.aServerProt_117) {
																local3022 = buf.gjstr(-142622958);
																local1316 = buf.g2(-1434290800);
																local1321 = buf.g3((short) 7810);
																local5779 = (Class443) Class107.method18116(Class443.method28866(1954657315), buf.g1((short) 16384), -1915563430);
																local1596 = buf.g1((short) 16384) == 1;
																...
																if (!local2444) {
																	client.aLongArray23[client.anInt3564 * -254980857] = local2442;
																	client.anInt3564 = (client.anInt3564 * -254980857 + 1) % 100 * -1639542601;
																	@Pc(5860) String local5860 = Class657.method32750(Class433.method28791(buf, 672487471), (byte) 12);
																...
																connection.serverPacketType = null;
																return true;
															} else if (connection.serverPacketType == ServerProt.aServerProt_133) {
																connection.serverPacketType = null;
																return false;
															} else if (connection.serverPacketType == ServerProt.aServerProt_83) {
																local264 = buf.g1((short) 16384);
																local88 = local264 >> 5;
																...
																local5968.anInt3253 = buf.g1((short) 16384) * -1863451725;
																if (local5968.anInt3253 * -2053428357 >= 0 && local5968.anInt3253 * -2053428357 < Class707.aClass100Array9.length) {
																	if (local5968.anInt3247 * 1661685955 == 1 || local5968.anInt3247 * 1661685955 == 10) {
																		local5968.anInt3246 = buf.g2(-1434290800) * -1525725567;
																		local5968.anInt3245 = buf.g2(-1434290800) * -628817299;
																		buf.pos += -1487540524;
																		...
																		local5968.anInt3251 = buf.g1((short) 16384) * 423246855;
																		@Pc(6111) Class611 local6111 = client.world.method30455(2105964725);
																		local5968.anInt3248 += (buf.g2(-1434290800) - local6111.anInt5623 * 270611681 << 9) * -950361367;
																		local5968.anInt3249 += (buf.g2(-1434290800) - local6111.anInt5624 * -1994307635 << 9) * 1909141105;
																		local5968.anInt3244 = (buf.g1((short) 16384) << 2) * -687642585;
																		local5968.anInt3250 = buf.g2(-1434290800) * -590747563;
																	}
																	local5968.anInt3252 = buf.g4(-118643075) * 1490595561;
																...
																if (connection.serverPacketType == ServerProt.aServerProt_74) {
																	local264 = buf.g1((short) 16384);
																	local88 = buf.g2_alt2(1921715726);
																	local382 = buf.g4_alt1(820918448);
																	local1022 = buf.g2(-1434290800);
																	if (local1022 == 65535) {
																		local1022 = -1;
																	}
																	local396 = buf.g2(-1434290800);
																	local398 = buf.g1_alt2(1955994316);
																			...
																			if (local6387 != null) {
																				...
																				if (local1022 != -1 && local6319 != -1) {
																					if (local1022 == local6319) {
																						local6426 = (Class697) Class501.aClass32_Sub18_1.get(local1022, 1976847151);
																						if (local6426.aBoolean881 && local6426.anInt5949 * 1477426425 != -1) {
																							local6444 = (Class263) Class32.aClass32_Sub17_23.get(local6426.anInt5949 * 1477426425, 1837841847);
																						...
																						local6426 = (Class697) Class501.aClass32_Sub18_1.get(local1022, 1304716190);
																						@Pc(6476) Class697 local6476 = (Class697) Class501.aClass32_Sub18_1.get(local6319, -1428184760);
																						if (local6426.anInt5949 * 1477426425 != -1 && local6476.anInt5949 * 1477426425 != -1) {
																							local6497 = (Class263) Class32.aClass32_Sub17_23.get(local6426.anInt5949 * 1477426425, -1244049067);
																							@Pc(6506) Class263 local6506 = (Class263) Class32.aClass32_Sub17_23.get(local6476.anInt5949 * 1477426425, -1975605848);
																				...
																				if (local6406) {
																					...
																					if (local1022 == -1) {
																						...
																						local6426 = (Class697) Class501.aClass32_Sub18_1.get(local1022, -1482443758);
																			...
																			if (local6587 != null) {
																				...
																				if (local1022 != -1 && local4737 != -1) {
																					if (local4737 == local1022) {
																						local6626 = (Class697) Class501.aClass32_Sub18_1.get(local1022, 24990014);
																						if (local6626.aBoolean881 && local6626.anInt5949 * 1477426425 != -1) {
																							@Pc(6644) Class263 local6644 = (Class263) Class32.aClass32_Sub17_23.get(local6626.anInt5949 * 1477426425, -847696505);
																						...
																						local6626 = (Class697) Class501.aClass32_Sub18_1.get(local1022, 1739710540);
																						local6426 = (Class697) Class501.aClass32_Sub18_1.get(local4737, 115928935);
																						if (local6626.anInt5949 * 1477426425 != -1 && local6426.anInt5949 * 1477426425 != -1) {
																							local6444 = (Class263) Class32.aClass32_Sub17_23.get(local6626.anInt5949 * 1477426425, -594630281);
																							local6497 = (Class263) Class32.aClass32_Sub17_23.get(local6426.anInt5949 * 1477426425, 1341201013);
																				...
																				if (local6606) {
																					...
																					if (local1022 == -1) {
																						...
																						local6626 = (Class697) Class501.aClass32_Sub18_1.get(local1022, 419216227);
																	...
																	connection.serverPacketType = null;
																	return true;
																} else if (ServerProt.aServerProt_9 == connection.serverPacketType) {
																	local264 = buf.g2_alt2(1832067719);
																	local88 = buf.g1_alt1(1587300189);
																	local382 = buf.g1_alt2(1064732489);
																	local1022 = buf.g1_alt3(1748971524);
																	local396 = buf.g1((short) 16384);
																	Class704.incrementVerifyId((short) 255);
																	...
																	connection.serverPacketType = null;
																	return true;
																} else if (connection.serverPacketType == ServerProt.aServerProt_22) {
																	local264 = buf.g2_alt3(16711680);
																	if (local264 == 65535) {
																		local264 = -1;
																	}
																	local88 = buf.g1_alt2(1509181772);
																	Class274.aClass258_1.method26119(local264, local88, (byte) 0);
																	connection.serverPacketType = null;
																	return true;
																} else if (connection.serverPacketType == ServerProt.aServerProt_12) {
																	local3022 = buf.gjstr(2121452210);
																	local1571 = Class657.method32750(Class433.method28791(buf, 672487471), (byte) 29);
																	Class227.method25612(6, 0, local3022, local3022, local3022, local1571, null, -1921814674);
																	connection.serverPacketType = null;
																	return true;
																} else if (connection.serverPacketType == ServerProt.aServerProt_172) {
																	client.aClass67_15 = (Class67) Class107.method18116(Class680.method33239((byte) 89), buf.g1((short) 16384), -1915563430);
																	Class642.logout(false, (short) 23739);
																	connection.serverPacketType = null;
																	return false;
																} else if (ServerProt.aServerProt_125 == connection.serverPacketType) {
																	buf.pos += -1822849076;
																	if (buf.checkcrc(1269271142)) {
																		Class176.method24386(buf, buf.pos * 212851357 - 28, -18120227);
																	}
																	connection.serverPacketType = null;
																	return true;
																} else if (ServerProt.aServerProt_47 == connection.serverPacketType) {
																	Class274.aClass258_1.method26127(-130336377);
																	connection.serverPacketType = null;
																	return true;
																} else if (ServerProt.aServerProt_10 == connection.serverPacketType) {
																	if (!client.aBoolean636) {
																		try {
																			local264 = buf.g1_alt1(1218202393);
																			local88 = buf.g1_alt3(1399833873);
																			local382 = buf.g1((short) 16384);
																			...
																			Class332.method27394(connection, -1449214767);
																		}
																	}
																	connection.serverPacketType = null;
																	return true;
																} else if (ServerProt.aServerProt_136 == connection.serverPacketType) {
																	local264 = buf.g2(-1434290800);
																	local88 = buf.g4_alt3(1808922260);
																	@Pc(7007) Class611 local7007 = new Class611(buf.g4_alt2(779859850));
																	local1022 = buf.g4_alt1(-1587034844);
																	local396 = buf.g4(-118643075);
																	local398 = buf.g2_alt1(730955648);
																	local416 = buf.g4_alt3(-452793074);
																	local1481 = buf.g1_alt1(1412149972);
																	local444 = buf.g4_alt2(926877027);
																	Class704.incrementVerifyId((short) 255);
																	Class348.openSubInterface(local1022, new Class93_Sub40_Sub2(local264, local1481, new Class679(local7007, local398)), new int[] { local416, local444, local88, local396 }, false, (byte) 0);
																	connection.serverPacketType = null;
																	return true;
																} else if (connection.serverPacketType == ServerProt.aServerProt_50) {
																	Class641.readZonePacket(ZoneProt.aZoneProt_14, 874772925);
																	connection.serverPacketType = null;
																	return true;
																} else if (connection.serverPacketType == ServerProt.aServerProt_105) {
																	Class513.method30264(client.world.anInt5238 * -968359209, -363536418);
																	connection.serverPacketType = null;
																	return true;
																} else if (ServerProt.aServerProt_112 == connection.serverPacketType) {
																	local264 = buf.g4_alt3(-527653201);
																	local88 = buf.g2_alt1(645137483);
																	local382 = buf.g2_alt3(16711680);
																	client.world.method30481(-1411368838).method31604(local382, local264, local88, 1933418643);
																	connection.serverPacketType = null;
																	return true;
																} else if (ServerProt.aServerProt_101 == connection.serverPacketType) {
																	local264 = buf.g1((short) 16384);
																	local88 = buf.g1((short) 16384);
																	if (buf.g1((short) 16384) == 0) {
																		...
																		buf.pos -= -1445626955;
																		client.aClass531ArrayArray1[local264][local88] = new Class531(buf, null);
																	}
																	client.anInt3440 = client.anInt3565 * 1301882723;
																	connection.serverPacketType = null;
																	return true;
																} else if (connection.serverPacketType == ServerProt.aServerProt_164) {
																	if (!client.aBoolean636) {
																		try {
																			local264 = buf.g1_alt3(1833833931);
																			local88 = buf.g1((short) 16384);
																			...
																			Class332.method27394(connection, -147100024);
																		}
																	}
																	connection.serverPacketType = null;
																	return true;
																	...
																	if (connection.serverPacketType == ServerProt.aServerProt_149) {
																		local302 = buf.g1((short) 16384) == 1;
																		local1571 = buf.gjstr(997347521);
																		local1018 = local1571;
																		if (local302) {
																			local1018 = buf.gjstr(199454271);
																		}
																		local640 = buf.gjstr(2106492675);
																		local2427 = buf.g2(-1434290800);
																		local7252 = buf.g3((short) 3590);
																		local7261 = (Class443) Class107.method18116(Class443.method28866(-1005511096), buf.g1((short) 16384), -1915563430);
																		local1343 = buf.g2(-1434290800);
																		...
																		if (!local6606) {
																			...
																			client.anInt3564 = (-254980857 * client.anInt3564 + 1) % 100 * -1639542601;
																			@Pc(7324) String local7324 = Class372.aClass58_2.method1094(local1343, -737304293).method22928(buf, (byte) -125);
																		...
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_66 == connection.serverPacketType) {
																		local264 = buf.g4_alt2(876979913);
																		local88 = buf.g4_alt3(1720922824);
																		local382 = buf.g4_alt2(30500595);
																		local1022 = buf.g4(-118643075);
																		local396 = buf.g1((short) 16384);
																		local398 = buf.g2(-1434290800);
																		local416 = buf.g4_alt3(1536553686);
																		local1481 = buf.g2_alt3(16711680);
																		Class704.incrementVerifyId((short) 255);
																		Class348.openSubInterface(local382, new Class93_Sub40_Sub3(local1481, local396, local398), new int[] { local264, local416, local88, local1022 }, false, (byte) 0);
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_180 == connection.serverPacketType) {
																		local3022 = buf.gjstr(957386437);
																		local1316 = buf.g2(-1434290800);
																		local1321 = buf.g3((short) 7138);
																		local5779 = (Class443) Class107.method18116(Class443.method28866(1925916099), buf.g1((short) 16384), -1915563430);
																		local1596 = buf.g1((short) 16384) == 1;
																		local1481 = buf.g2(-1434290800);
																		...
																		if (!local4667) {
																			client.aLongArray23[client.anInt3564 * -254980857] = local4665;
																			client.anInt3564 = (client.anInt3564 * -254980857 + 1) % 100 * -1639542601;
																			local1628 = Class372.aClass58_2.method1094(local1481, -737304293).method22928(buf, (byte) -59);
																		...
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_96 == connection.serverPacketType) {
																		local264 = buf.g4_alt2(-821921582);
																		Class704.incrementVerifyId((short) 255);
																		@Pc(7645) SubInterface local7645 = (SubInterface) client.aClass16_22.method214((long) local264);
																		if (local7645 != null) {
																		...
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_190 == connection.serverPacketType) {
																		if (!client.aBoolean636) {
																			try {
																				for (local346 = buf.g1b(542085474); local346 != -1; local346 = buf.g1b(1804982516)) {
																					for (local2070 = buf.g1b(485901377); local2070 != -1; local2070 = buf.g1b(537728454)) {
																						for (@Pc(7689) byte local7689 = buf.g1b(1731363964); local7689 != -1; local7689 = buf.g1b(1678833469)) {
																							client.aClass270_1.method26280(local346, -1328210001).method26443(local2070, local7689, buf.g4(-118643075), -2009705364);
																						}
																					}
																				}
																			} catch (@Pc(7721) RuntimeException local7721) {
																				Class646.method32608(null, local7721, 324176659);
																				Class332.method27394(connection, 54753761);
																			}
																		}
																		connection.serverPacketType = null;
																		return true;
																	} else if (connection.serverPacketType == ServerProt.aServerProt_142) {
																		client.anInt3548 = client.anInt3565 * 287027887;
																		local302 = buf.g1((short) 16384) == 1;
																		@Pc(7755) Class374 local7755 = new Class374(buf);
																		...
																		connection.serverPacketType = null;
																		return true;
																	} else if (connection.serverPacketType == ServerProt.aServerProt_175) {
																		local302 = buf.g1((short) 16384) == 1;
																		local1571 = buf.gjstr(779962962);
																		local1018 = local1571;
																		if (local302) {
																			local1018 = buf.gjstr(472328802);
																		}
																		local640 = buf.gjstr(-36216686);
																		local2427 = buf.g2(-1434290800);
																		local7252 = buf.g3((short) -30853);
																		local7261 = (Class443) Class107.method18116(Class443.method28866(-1489117307), buf.g1((short) 16384), -1915563430);
																		...
																		if (!local2731) {
																			client.aLongArray23[client.anInt3564 * -254980857] = local2729;
																			client.anInt3564 = (-254980857 * client.anInt3564 + 1) % 100 * -1639542601;
																			local2782 = Class657.method32750(Class433.method28791(buf, 672487471), (byte) 8);
																			if (local7261.anInt4893 * -508329009 == -1) {
																		...
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_17 == connection.serverPacketType) {
																		...
																		connection.serverPacketType = null;
																		return true;
																	} else if (connection.serverPacketType == ServerProt.aServerProt_99) {
																		local264 = buf.g1_alt1(1207605548);
																		local88 = buf.g1((short) 16384);
																		if (local264 == 255) {
																			local264 = -1;
																			local88 = -1;
																		...
																		connection.serverPacketType = null;
																		return true;
																	} else if (connection.serverPacketType == ServerProt.aServerProt_195) {
																		local264 = buf.g1((short) 16384);
																		local264 = -local264 - 2;
																		client.aMap18.remove(local264);
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_71 == connection.serverPacketType) {
																		local264 = buf.g4(-118643075);
																		local88 = buf.g4_alt1(886974535);
																		Class704.incrementVerifyId((short) 255);
																		@Pc(8098) Class312 local8098 = Class659.method32808(local264, -653256145);
																		local8098.anInt3973 = local88 * 1528274801;
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_48 == connection.serverPacketType) {
																		local264 = buf.g2(-1434290800);
																		if (local264 == 65535) {
																			local264 = -1;
																		}
																		local88 = buf.g4_alt3(-1081843268);
																		local382 = buf.g4_alt1(932380141);
																		Class704.incrementVerifyId((short) 255);
																		Class125.method21460(local88, local264, local382, (byte) -42);
																		@Pc(8143) Class47 local8143 = (Class47) Class277.aClass32_Sub12_1.get(local264, -1365720263);
																		...
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_177 == connection.serverPacketType) {
																		if (!client.aBoolean636) {
																			try {
																				local264 = buf.g1_alt1(1420671195);
																				local88 = buf.g1_alt1(1220447160);
																				local742 = buf.g1_alt3(2138110795) == 1;
																				...
																				Class332.method27394(connection, -607789614);
																			}
																		}
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_63 == connection.serverPacketType) {
																		local264 = buf.g2(-1434290800);
																		local88 = buf.g2(-1434290800);
																		local382 = buf.g2(-1434290800);
																		...
																		connection.serverPacketType = null;
																		return true;
																	} else if (connection.serverPacketType == ServerProt.aServerProt_11) {
																		local264 = buf.g2(-1434290800);
																		local88 = buf.g1((short) 16384);
																		local742 = (local88 & 0x1) != 0;
																		local750 = (local88 & 0x2) != 0;
																		...
																		local396 = buf.g2(-1434290800);
																		for (local398 = 0; local398 < local396; local398++) {
																			local416 = buf.g2(-1434290800);
																			local1481 = buf.g1((short) 16384);
																			if (local1481 == 255) {
																				local1481 = buf.g4(-118643075);
																			}
																			...
																			if (local750) {
																				...
																				if (local1343 > 0) {
																					...
																					while (local1343-- > 0) {
																						local2446 = Class265.aClass79_Sub1_Sub2_4.method1468(buf, (byte) 90);
																		...
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_106 == connection.serverPacketType) {
																		local302 = buf.g1((short) 16384) == 1;
																		local1571 = buf.gjstr(17462522);
																		local1018 = local1571;
																		if (local302) {
																			local1018 = buf.gjstr(-75698244);
																		}
																		local1321 = buf.g2(-1434290800);
																		local1327 = buf.g3((short) -16712);
																		local2719 = (Class443) Class107.method18116(Class443.method28866(2030640571), buf.g1((short) 16384), -1915563430);
																		...
																		if (!local4667) {
																			client.aLongArray23[client.anInt3564 * -254980857] = local4665;
																			client.anInt3564 = (-254980857 * client.anInt3564 + 1) % 100 * -1639542601;
																			local1628 = Class657.method32750(Class433.method28791(buf, 672487471), (byte) 2);
																		...
																		connection.serverPacketType = null;
																		return true;
																	} else if (connection.serverPacketType == ServerProt.aServerProt_78) {
																		local264 = buf.g2_alt2(1624807307);
																		local88 = buf.g2_alt2(2106129700);
																		local382 = buf.g1((short) 16384);
																		if (local382 == 255) {
																			local382 = -1;
																		}
																		...
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_152 == connection.serverPacketType) {
																		Class596.aClass113_Sub1_1.method7426(242024593);
																		connection.serverPacketType = null;
																		return false;
																	} else if (ServerProt.aServerProt_8 == connection.serverPacketType) {
																		local264 = buf.g1((short) 16384);
																		...
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_103 == connection.serverPacketType) {
																		local264 = buf.g1_alt2(1680819991);
																		local88 = buf.g1_alt1(2010386657);
																		local382 = buf.g1((short) 16384);
																		local1022 = buf.g1_alt3(1657353203);
																		local396 = buf.g2(-1434290800) << 2;
																		Class704.incrementVerifyId((short) 255);
																		Class104_Sub3.method5765(local264, local382, local396, local88, local1022, true, 969851959);
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_143 == connection.serverPacketType) {
																		Class641.readZonePacket(ZoneProt.aZoneProt_11, 93794078);
																		connection.serverPacketType = null;
																		return true;
																	} else if (connection.serverPacketType == ServerProt.aServerProt_36) {
																		local264 = buf.g4_alt1(-1534374753);
																		local88 = buf.g4_alt3(-1451454285);
																		Class704.incrementVerifyId((short) 255);
																		Class121_Sub1.method8711(local264, local88, (byte) 93);
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.IF_OPENSUB == connection.serverPacketType) {
																		int xtea3 = buf.g4_alt2(46467313);
																		int toplevelCom = buf.g4_alt1(-1561080489);
																		int overlay = buf.g1_alt2(-365915474);
																		int xtea4 = buf.g4(-118643075);
																		int id = buf.g2(-1434290800);
																		int xtea2 = buf.g4_alt2(-345739418);
																		int xtea1 = buf.g4_alt2(1640921238);

																		Class704.incrementVerifyId((short) 255);
																		Class348.openSubInterface(toplevelCom, new SubInterface(id, overlay), new int[] { xtea1, xtea2, xtea3, xtea4 }, false, (byte) 0);
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_58 == connection.serverPacketType) {
																		local264 = buf.g1_alt3(1989143514);
																		Class704.incrementVerifyId((short) 255);
																		...
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_82 == connection.serverPacketType) {
																		client.anInt3552 = buf.g1_alt2(499926140) * 630676823;
																		client.anInt3561 = buf.g1_alt2(1636117962) * -2128488861;
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_116 == connection.serverPacketType) {
																		Class686.method33484(buf, connection.length * 2010044839, (byte) 70);
																		connection.serverPacketType = null;
																		return true;
																	} else if (connection.serverPacketType == ServerProt.aServerProt_28) {
																		...
																		client.aString144 = buf.gjstr(433695814);
																		local302 = buf.g1((short) 16384) == 1;
																		if (local302) {
																			buf.gjstr(-124120431);
																		}
																		client.aString146 = buf.gjstr(-198356123);
																		Class320.aByte129 = buf.g1b(1258612190);
																		local88 = buf.g1((short) 16384);
																		if (local88 == 255) {
																			connection.serverPacketType = null;
																			return true;
																		...
																		for (local1022 = 0; local1022 < Class623.anInt5682 * 1581594575; local1022++) {
																			...
																			local8922[local1022].aString90 = buf.gjstr(1967535272);
																			local302 = buf.g1((short) 16384) == 1;
																			if (local302) {
																				local8922[local1022].aString91 = buf.gjstr(1720548764);
																			} else {
																			...
																			local8922[local1022].anInt2996 = buf.g2(-1434290800) * 394880997;
																			local8922[local1022].aByte77 = buf.g1b(1669630943);
																			local8922[local1022].aString92 = buf.gjstr(1024887069);
																		...
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_52 == connection.serverPacketType) {
																		local264 = buf.g2_alt1(1325377384);
																		local2070 = buf.g1b_alt2(-828649107);
																		local382 = buf.g2_alt3(16711680);
																		local1022 = buf.g2(-1434290800);
																		local396 = buf.g2_alt2(1784623724);
																		local398 = buf.g1_alt2(843963926);
																		if (local398 == 255) {
																			local398 = -1;
																		}
																		local416 = buf.g2s_alt(-1725165388);
																		local1481 = buf.g1_alt3(1994332627);
																		local444 = buf.g1((short) 16384);
																		local1343 = buf.g2s_alt(-1086815010);
																		local1385 = buf.g2(-1434290800);
																		@Pc(9135) byte local9135 = buf.g1b_alt3(-2124857804);
																		local1630 = buf.g1_alt1(1191854676) * 4;
																		local4737 = buf.g1((short) 16384);
																		local6319 = buf.g2_alt1(1155646438);
																		...
																		connection.serverPacketType = null;
																		return true;
																	} else if (connection.serverPacketType == ServerProt.aServerProt_107) {
																		local264 = buf.g2_alt3(16711680);
																		local88 = buf.g4_alt1(-1440621219);
																		local382 = buf.g4_alt3(-1279423367);
																		local1022 = buf.g4_alt3(1568058975);
																		local396 = buf.g2_alt1(1572829419);
																		local398 = buf.g1((short) 16384);
																		local416 = buf.g4(-118643075);
																		local1481 = buf.g4_alt1(1851425716);
																		Class704.incrementVerifyId((short) 255);
																		Class348.openSubInterface(local1481, new Class93_Sub40_Sub4(local264, local398, local396), new int[] { local88, local382, local416, local1022 }, false, (byte) 0);
																		connection.serverPacketType = null;
																		return true;
																	} else if (connection.serverPacketType == ServerProt.aServerProt_173) {
																		client.anInt3447 = client.anInt3565 * 2096178751;
																		local302 = buf.g1((short) 16384) == 1;
																		@Pc(9397) Class375 local9397 = new Class375(buf);
																		...
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_158 == connection.serverPacketType) {
																		local3022 = buf.gjstr(535196699);
																		local88 = buf.g2(-1434290800);
																		local382 = buf.g2(-1434290800);
																		local1022 = buf.g2(-1434290800);
																		...
																		connection.serverPacketType = null;
																		return true;
																	} else if (connection.serverPacketType == ServerProt.aServerProt_39) {
																		Class641.readZonePacket(ZoneProt.aZoneProt_12, -867043738);
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_138 == connection.serverPacketType) {
																		local264 = buf.g2s_alt(1480554767);
																		local88 = buf.g2s_alt2(1898923797);
																		local382 = buf.g4_alt1(-78297754);
																		Class704.incrementVerifyId((short) 255);
																		Class350.method27636(local382, local264, local88, 1863778376);
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_121 == connection.serverPacketType) {
																		client.aClass660_1 = (Class660) Class107.method18116(Class660.method32819(489855685), buf.g1((short) 16384), -1915563430);
																		if (client.aClass660_1 == null) {
																			client.aClass660_1 = Class660.aClass660_5;
																		}
																		connection.serverPacketType = null;
																		return true;
																	} else if (connection.serverPacketType == ServerProt.aServerProt_100) {
																		local264 = buf.g2(-1434290800);
																		Class274.aClass258_1.method26054(local264, -1564241652);
																		connection.serverPacketType = null;
																		return true;
																	} else if (connection.serverPacketType == ServerProt.aServerProt_49) {
																		local3022 = buf.gjstr(675677981);
																		local742 = buf.g1((short) 16384) == 1;
																		if (local742) {
																			local1571 = buf.gjstr(2025508252);
																		} else {
																			local1571 = local3022;
																		}
																		local1022 = buf.g2(-1434290800);
																		@Pc(9570) byte local9570 = buf.g1b(1281422089);
																		local3365 = false;
																		if (local9570 == -128) {
																			local3365 = true;
																		}
																		...
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_108 == connection.serverPacketType) {
																		local264 = buf.g4(-118643075);
																		local88 = buf.g4_alt3(-1427466778);
																		Class704.incrementVerifyId((short) 255);
																		Class264.method26207(local264, local88, -146455832);
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_44 == connection.serverPacketType) {
																		if (!client.aBoolean636) {
																			try {
																				local264 = buf.g1_alt2(230600728);
																				local88 = buf.g1((short) 16384);
																				local382 = buf.g1((short) 16384);
																				...
																				Class332.method27394(connection, -1262307861);
																			}
																		}
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_188 == connection.serverPacketType) {
																		local264 = buf.g4_alt3(-1678284684);
																		local273 = buf.g1_alt2(85739265) == 1;
																		Class704.incrementVerifyId((short) 255);
																		Class558.method31108(local264, local273, (byte) 78);
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_16 == connection.serverPacketType) {
																		if (!client.aBoolean636) {
																			try {
																				local346 = buf.g1b_alt1((byte) 98);
																				local88 = buf.g4(-118643075);
																				local382 = buf.g1_alt3(1322587572);
																				...
																				Class332.method27394(connection, 658672190);
																			}
																		}
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_54 == connection.serverPacketType) {
																		...
																		connection.serverPacketType = null;
																		return true;
																	} else if (connection.serverPacketType == ServerProt.aServerProt_6) {
																		@Pc(9977) Class684 local9977 = new Class684();
																		local273 = local9977.method33358(buf, -1532342642);
																		...
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_159 == connection.serverPacketType) {
																		local3022 = buf.gjstr(-116043590);
																		Class32_Sub7.method16823(local3022, false, false, (byte) 3);
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_90 == connection.serverPacketType) {
																		Class641.readZonePacket(ZoneProt.aZoneProt_10, 59656232);
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_129 == connection.serverPacketType) {
																		local264 = buf.g4(-118643075);
																		local88 = buf.g2s((byte) -65);
																		local382 = buf.g1_alt1(1241340759);
																		local1022 = buf.g2_alt3(16711680);
																		...
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_137 == connection.serverPacketType) {
																		if (client.topLevelInterface * -703563959 != -1) {
																			Class189.method24583(client.topLevelInterface * -703563959, 0, 140070734);
																		}
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_84 == connection.serverPacketType) {
																		local264 = buf.g4(-118643075);
																		local88 = buf.g2_alt2(1818120282);
																		Class704.incrementVerifyId((short) 255);
																		Class361.method27802(local264, local88, 1866345287);
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_31 == connection.serverPacketType) {
																		local264 = buf.g4_alt3(610680277);
																		local88 = buf.g4_alt2(-1703695273);
																		Class704.incrementVerifyId((short) 255);
																		Class132_Sub1_Sub4_Sub2.method13432(local264, 2, local88, -1, -19442568);
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_62 == connection.serverPacketType) {
																		local264 = buf.g2(-1434290800);
																		local1571 = buf.gjstr(1082001991);
																		local382 = buf.g2(-1434290800);
																		local1022 = buf.g2(-1434290800);
																		local3355 = buf.g1((short) 16384) == 1;
																		...
																		connection.serverPacketType = null;
																		return false;
																	} else if (ServerProt.aServerProt_127 == connection.serverPacketType) {
																		local264 = buf.g2(-1434290800);
																		Class274.aClass258_1.method26053(local264, (byte) -118);
																		connection.serverPacketType = null;
																		return true;
																	} else if (connection.serverPacketType == ServerProt.aServerProt_45) {
																		client.anInt3551 = client.anInt3565 * 1524761337;
																		if (connection.length * 2010044839 == 0) {
																			Class557.aClass297_1 = null;
																		} else {
																			Class557.aClass297_1 = new Class297(0L, buf, true, client.anInterface27_1);
																		}
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_42 == connection.serverPacketType) {
																		local264 = buf.g2(-1434290800);
																		if (local264 == 65535) {
																			local264 = -1;
																		}
																		...
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_144 == connection.serverPacketType) {
																		local264 = buf.g1_alt2(1424328025);
																		local88 = buf.g1((short) 16384);
																		local382 = buf.g1_alt3(2078794943);
																		local1022 = buf.g1_alt2(553717955);
																		local396 = buf.g2_alt2(1839622855) << 2;
																		Class704.incrementVerifyId((short) 255);
																		Class29.method606(local264, local88, local396, local1022, local382, (byte) 40);
																		connection.serverPacketType = null;
																		return true;
																	} else if (connection.serverPacketType == ServerProt.aServerProt_176) {
																		local264 = buf.g2_alt3(16711680);
																		local88 = buf.g2_alt1(692866387);
																		local382 = buf.g4(-118643075);
																		local1022 = buf.g1_alt1(1101231922);
																		Class704.incrementVerifyId((short) 255);
																		Class388.method28249(local382, local1022, local264, local88, (short) 589);
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_93 == connection.serverPacketType) {
																		local5706 = new PacketBit(connection.length * 2010044839);
																		System.arraycopy(connection.packet.data, connection.packet.pos * 212851357, local5706.data, 0, connection.length * 2010044839);
																		...
																		connection.serverPacketType = null;
																		return false;
																	} else if (connection.serverPacketType == ServerProt.aServerProt_154) {
																		client.anInt3433 = buf.g2s_alt2(1404945275) * -68428119;
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_167 == connection.serverPacketType) {
																		local264 = buf.g1((short) 16384);
																		...
																		connection.serverPacketType = null;
																		return true;
																	} else if (connection.serverPacketType == ServerProt.aServerProt_85) {
																		local264 = buf.g2_alt1(1835293980);
																		local88 = buf.g4(-118643075);
																		local382 = buf.g4(-118643075);
																		Class704.incrementVerifyId((short) 255);
																		...
																		connection.serverPacketType = null;
																		return true;
																	} else if (ServerProt.aServerProt_156 == connection.serverPacketType) {
																		Class65.aClass123_Sub1_2.method9092(buf, connection.length * 2010044839, 1907226290);
																		client.anInt3489 = client.anInt3565 * 640617007;
																		connection.serverPacketType = null;
																		return true;
																	} else if (connection.serverPacketType == ServerProt.aServerProt_29) {
																		local264 = buf.g2(-1434290800);
																		...
																		Class646.method32608((connection.serverPacketType == null ? -1 : connection.serverPacketType.opcode * 1430738181) + Class430.aString204 + (connection.prevServerPacketType2 == null ? -1 : connection.prevServerPacketType2.opcode * 1430738181) + Class430.aString204 + (connection.prevServerPacketType3 == null ? -1 : connection.prevServerPacketType3.opcode * 1430738181) + " " + connection.length * 2010044839, new RuntimeException(), 1385686991);
