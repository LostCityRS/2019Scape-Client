...
final class Class505 implements Interface9 {
	...
	static final void method30206(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		local19.aPacketBit_1.p1(local13.length() + 1, (byte) -52);
		local19.aPacketBit_1.pjstr(local13, -2146699166);
	...
	static final void method30208(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		...
		local22.aPacketBit_1.p1(0, (byte) -49);
		@Pc(33) int local33 = local22.aPacketBit_1.pos * 212851357;
		local22.aPacketBit_1.pjstr(local13, -1701741077);
		local22.aPacketBit_1.p2(arg0.aClass434_1.anInt4807 * 526894191, 2125000671);
		arg0.aClass434_1.aClass93_Sub1_Sub18_1.method22924(local22.aPacketBit_1, arg0.aClass434_1.anIntArray445, -1437735568);
		local22.aPacketBit_1.psize1(local22.aPacketBit_1.pos * 212851357 - local33, (byte) 103);
