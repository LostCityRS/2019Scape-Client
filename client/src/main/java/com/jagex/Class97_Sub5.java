...
public class Class97_Sub5 extends Class97 {
	...
	@OriginalMember(owner = "client!aes", name = "<init>", descriptor = "(Lclient!afa;)V", line = 26)
	Class97_Sub5(@OriginalArg(0) Class104_Sub1 arg0) {
		super(arg0);
		if (this.aClass104_Sub1_25.aBoolean100) {
			this.aClass196_4 = Class196.method24614(this.aClass104_Sub1_25, 34336, "!!ARBvp1.0\nATTRIB  iPos         = vertex.position;\nATTRIB  iColour      = vertex.color;\nATTRIB  iTexCoord    = vertex.texcoord[0];\nOUTPUT  oPos         = result.position;\nOUTPUT  oColour      = result.color;\nOUTPUT  oTexCoord0   = result.texcoord[0];\nOUTPUT  oTexCoord1   = result.texcoord[1];\nOUTPUT  oFogCoord    = result.fogcoord;\nPARAM   fogParams    = program.local[0];\nPARAM   waterPlane   = program.local[1];\nPARAM   tMatrix[4]   = { state.matrix.texture[0] };\nPARAM   pMatrix[4]   = { state.matrix.projection };\nPARAM   mvMatrix[4]  = { state.matrix.modelview };\nTEMP    viewPos, fogFactor;\nDP4   viewPos.x, mvMatrix[0], iPos;\nDP4   viewPos.y, mvMatrix[1], iPos;\nDP4   viewPos.z, mvMatrix[2], iPos;\nDP4   viewPos.w, mvMatrix[3], iPos;\nSUB   fogFactor.x, viewPos.z, fogParams.x;\nMUL   fogFactor.x, fogFactor.x, 0.001953125;\nMAD   fogFactor.y, iTexCoord.z, fogParams.z, fogParams.w;\nSUB   fogFactor.z, viewPos.z, fogParams.y;\nMUL   fogFactor.z, fogFactor.z, 0.00390625;\nMUL   fogFactor.x, fogFactor.x, fogFactor.y;\nMIN   fogFactor, fogFactor, 1;\nMAX   fogFactor, fogFactor, 0;\nMUL   fogFactor.z, fogFactor.z, iTexCoord.z;\nMAD   viewPos.xyz, waterPlane.xyzw, fogFactor.zzzz, viewPos.xyzw;\nMAX   oTexCoord1.xyz, fogFactor.xxxx, fogFactor.yyyy;\nMOV   oTexCoord1.w, 1;\nMOV   oColour, iColour;\nDP4   oPos.x, pMatrix[0], viewPos;\nDP4   oPos.y, pMatrix[1], viewPos;\nDP4   oPos.z, pMatrix[2], viewPos;\nDP4   oPos.w, pMatrix[3], viewPos;\nMOV   oFogCoord.x, viewPos.z;\nDP3   oTexCoord0.x, tMatrix[0], iTexCoord;\nDP3   oTexCoord0.y, tMatrix[1], iTexCoord;\nMOV   oTexCoord0.zw, iTexCoord;\nEND\n");
			this.aClass196_1 = Class196.method24614(this.aClass104_Sub1_25, 34336, "!!ARBvp1.0\nATTRIB  iPos         = vertex.position;\nATTRIB  iNormal      = vertex.normal;\nATTRIB  iColour      = vertex.color;\nATTRIB  iTexCoord    = vertex.texcoord[0];\nOUTPUT  oPos         = result.position;\nOUTPUT  oColour      = result.color;\nOUTPUT  oTexCoord0   = result.texcoord[0];\nOUTPUT  oTexCoord1   = result.texcoord[1];\nOUTPUT  oFogCoord    = result.fogcoord;\nPARAM   fogParams    = program.local[0];\nPARAM   waterPlane   = program.local[1];\nPARAM   tMatrix[4]   = { state.matrix.texture[0] };\nPARAM   pMatrix[4]   = { state.matrix.projection };\nPARAM   mvMatrix[4]  = { state.matrix.modelview };\nTEMP    viewPos, viewNormal, fogFactor, colour, ndotl;\nDP4   viewPos.x, mvMatrix[0], iPos;\nDP4   viewPos.y, mvMatrix[1], iPos;\nDP4   viewPos.z, mvMatrix[2], iPos;\nDP4   viewPos.w, mvMatrix[3], iPos;\nSUB   fogFactor.x, viewPos.z, fogParams.x;\nMUL   fogFactor.x, fogFactor.x, 0.001953125;\nMAD   fogFactor.y, iTexCoord.z, fogParams.z, fogParams.w;\nSUB   fogFactor.z, viewPos.z, fogParams.y;\nMUL   fogFactor.z, fogFactor.z, 0.00390625;\nMUL   fogFactor.x, fogFactor.x, fogFactor.y;\nMIN   fogFactor, fogFactor, 1;\nMAX   fogFactor, fogFactor, 0;\nMUL   fogFactor.z, fogFactor.z, iTexCoord.z;\nMAD   viewPos.xyz, waterPlane.xyzw, fogFactor.zzzz, viewPos.xyzw;\nMAX   oTexCoord1.xyz, fogFactor.xxxx, fogFactor.yyyy;\nMOV   oTexCoord1.w, 1;\nDP3   viewNormal.x, mvMatrix[0], iNormal;\nDP3   viewNormal.y, mvMatrix[1], iNormal;\nDP3   viewNormal.z, mvMatrix[2], iNormal;\nDP3   ndotl.x, viewNormal, state.light[0].position;\nDP3   ndotl.y, viewNormal, state.light[1].position;\nMAX   ndotl, ndotl, 0;\nMOV   colour, state.lightmodel.ambient;\nMAD   colour, state.light[0].diffuse, ndotl.xxxx, colour;\nMAD   colour, state.light[1].diffuse, ndotl.yyyy, colour;\nMUL   oColour, iColour, colour;\nDP4   oPos.x, pMatrix[0], viewPos;\nDP4   oPos.y, pMatrix[1], viewPos;\nDP4   oPos.z, pMatrix[2], viewPos;\nDP4   oPos.w, pMatrix[3], viewPos;\nMOV   oFogCoord.x, viewPos.z;\nDP3   oTexCoord0.x, tMatrix[0], iTexCoord;\nDP3   oTexCoord0.y, tMatrix[1], iTexCoord;\nMOV   oTexCoord0.zw, iTexCoord;\nEND\n");
			this.aClass196_3 = Class196.method24614(this.aClass104_Sub1_25, 34336, "!!ARBvp1.0\nATTRIB  iPos         = vertex.position;\nATTRIB  iColour      = vertex.color;\nATTRIB  iTexCoord    = vertex.texcoord[0];\nOUTPUT  oPos         = result.position;\nOUTPUT  oColour      = result.color;\nOUTPUT  oTexCoord0   = result.texcoord[0];\nOUTPUT  oTexCoord1   = result.texcoord[1];\nOUTPUT  oFogCoord    = result.fogcoord;\nPARAM   fogParams    = program.local[0];\nPARAM   waterPlane   = program.local[1];\nPARAM   pMatrix[4]   = { state.matrix.projection };\nPARAM   mvMatrix[4]  = { state.matrix.modelview };\nPARAM   texMatrix[4] = { state.matrix.texture[0] };\nTEMP    viewPos, fogFactor, depth;\nDP4   viewPos.x, mvMatrix[0], iPos;\nDP4   viewPos.y, mvMatrix[1], iPos;\nDP4   viewPos.z, mvMatrix[2], iPos;\nDP4   viewPos.w, mvMatrix[3], iPos;\nSUB   fogFactor.x, viewPos.z, fogParams.x;\nMUL   fogFactor.x, fogFactor.x, 0.001953125;\nDP4   depth, waterPlane, viewPos;\nMAD   fogFactor.y, -depth, fogParams.z, fogParams.w;\nSUB   fogFactor.z, viewPos.z, fogParams.y;\nMUL   fogFactor.z, fogFactor.z, 0.00390625;\nMIN   fogFactor, fogFactor, 1;\nMAX   fogFactor, fogFactor, 0;\nMUL   fogFactor.z, fogFactor.z, -depth;\nMAD   viewPos.xyz, waterPlane.xyzw, fogFactor.zzzz, viewPos.xyzw;\nMAX   oTexCoord1.xyz, fogFactor.xxxx, fogFactor.yyyy;\nMOV   oTexCoord1.w, 1;\nMOV   oColour, iColour;\nDP4   oPos.x, pMatrix[0], viewPos;\nDP4   oPos.y, pMatrix[1], viewPos;\nDP4   oPos.z, pMatrix[2], viewPos;\nDP4   oPos.w, pMatrix[3], viewPos;\nMOV   oFogCoord.x, viewPos.z;\nDP4   oTexCoord0.x, texMatrix[0], iTexCoord;\nDP4   oTexCoord0.y, texMatrix[1], iTexCoord;\nDP4   oTexCoord0.z, texMatrix[2], iTexCoord;\nMOV   oTexCoord0.w, 1;\nEND\n");
			this.aClass196_2 = Class196.method24614(this.aClass104_Sub1_25, 34336, "!!ARBvp1.0\nATTRIB  iPos         = vertex.position;\nATTRIB  iNormal      = vertex.normal;\nATTRIB  iColour      = vertex.color;\nATTRIB  iTexCoord    = vertex.texcoord[0];\nOUTPUT  oPos         = result.position;\nOUTPUT  oColour      = result.color;\nOUTPUT  oTexCoord0   = result.texcoord[0];\nOUTPUT  oTexCoord1   = result.texcoord[1];\nOUTPUT  oFogCoord    = result.fogcoord;\nPARAM   fogParams    = program.local[0];\nPARAM   waterPlane   = program.local[1];\nPARAM   pMatrix[4]   = { state.matrix.projection };\nPARAM   mvMatrix[4]  = { state.matrix.modelview };\nPARAM   texMatrix[4] = { state.matrix.texture[0] };\nTEMP    viewPos, viewNormal, fogFactor, depth, colour, ndotl;\nDP4   viewPos.x, mvMatrix[0], iPos;\nDP4   viewPos.y, mvMatrix[1], iPos;\nDP4   viewPos.z, mvMatrix[2], iPos;\nDP4   viewPos.w, mvMatrix[3], iPos;\nSUB   fogFactor.x, viewPos.z, fogParams.x;\nMUL   fogFactor.x, fogFactor.x, 0.001953125;\nDP4   depth, waterPlane, viewPos;\nMAD   fogFactor.y, -depth, fogParams.z, fogParams.w;\nSUB   fogFactor.z, viewPos.z, fogParams.y;\nMUL   fogFactor.z, fogFactor.z, 0.00390625;\nMIN   fogFactor, fogFactor, 1;\nMAX   fogFactor, fogFactor, 0;\nMUL   fogFactor.z, fogFactor.z, -depth;\nMAD   viewPos.xyz, waterPlane.xyzw, fogFactor.zzzz, viewPos.xyzw;\nMAX   oTexCoord1.xyz, fogFactor.xxxx, fogFactor.yyyy;\nMOV   oTexCoord1.w, 1;\nDP3   viewNormal.x, mvMatrix[0], iNormal;\nDP3   viewNormal.y, mvMatrix[1], iNormal;\nDP3   viewNormal.z, mvMatrix[2], iNormal;\nDP3   ndotl.x, viewNormal, state.light[0].position;\nDP3   ndotl.y, viewNormal, state.light[1].position;\nMAX   ndotl, ndotl, 0;\nMOV   colour, state.lightmodel.ambient;\nMAD   colour, state.light[0].diffuse, ndotl.xxxx, colour;\nMAD   colour, state.light[1].diffuse, ndotl.yyyy, colour;\nMUL   oColour, iColour, colour;\nDP4   oPos.x, pMatrix[0], viewPos;\nDP4   oPos.y, pMatrix[1], viewPos;\nDP4   oPos.z, pMatrix[2], viewPos;\nDP4   oPos.w, pMatrix[3], viewPos;\nMOV   oFogCoord.x, viewPos.z;\nDP4   oTexCoord0.x, texMatrix[0], iTexCoord;\nDP4   oTexCoord0.y, texMatrix[1], iTexCoord;\nDP4   oTexCoord0.z, texMatrix[2], iTexCoord;\nMOV   oTexCoord0.w, 1;\nEND\n");
			if (this.aClass196_4 != null & this.aClass196_1 != null & this.aClass196_3 != null & this.aClass196_2 != null) {
				...
				this.aClass88_Sub2_1.method18079(false, false);
	...
	@OriginalMember(owner = "client!aes", name = "e", descriptor = "()Z", line = 43)
	@Override
	boolean method2790() {
		return this.aBoolean63;
	}

	@OriginalMember(owner = "client!aes", name = "l", descriptor = "()Z", line = 43)
	@Override
	boolean method2796() {
		return this.aBoolean63;
	}

	@OriginalMember(owner = "client!aes", name = "u", descriptor = "()Z", line = 43)
	@Override
	boolean method2802() {
		return this.aBoolean63;
	}

	@OriginalMember(owner = "client!aes", name = "p", descriptor = "()Z", line = 43)
	@Override
	boolean method2791() {
		return this.aBoolean63;
	}

	@OriginalMember(owner = "client!aes", name = "d", descriptor = "()Z", line = 43)
	@Override
	boolean method2799() {
		return this.aBoolean63;
	}

	@OriginalMember(owner = "client!aes", name = "z", descriptor = "()Z", line = 43)
	@Override
	boolean method2798() {
		return this.aBoolean63;
	}

	@OriginalMember(owner = "client!aes", name = "n", descriptor = "(Z)V", line = 47)
	@Override
	void method2801(@OriginalArg(0) boolean arg0) {
		this.aBoolean61 = arg0;
		this.aClass104_Sub1_25.method3882(1);
		this.aClass104_Sub1_25.method3887(this.aClass88_Sub2_1);
		this.aClass104_Sub1_25.method3894(34165, 7681);
		this.aClass104_Sub1_25.method3898(0, 34166, 768);
		this.aClass104_Sub1_25.method3898(2, 5890, 770);
		this.aClass104_Sub1_25.method3903(0, 34168, 770);
		this.aClass104_Sub1_25.method3882(0);
		this.method2637();
	}

	@OriginalMember(owner = "client!aes", name = "c", descriptor = "(Z)V", line = 47)
	@Override
	...
	@OriginalMember(owner = "client!aes", name = "r", descriptor = "(Z)V", line = 58)
	@Override
	void method2797(@OriginalArg(0) boolean arg0) {
	}

	@OriginalMember(owner = "client!aes", name = "m", descriptor = "(Z)V", line = 58)
	@Override
	void method2792(@OriginalArg(0) boolean arg0) {
	}

	@OriginalMember(owner = "client!aes", name = "v", descriptor = "()V", line = 61)
	@Override
	void method2795() {
		if (this.aBoolean62) {
	...
	@OriginalMember(owner = "client!aes", name = "k", descriptor = "()V", line = 61)
	@Override
	void method2793() {
		if (this.aBoolean62) {
			OpenGL.glBindProgramARB(34336, 0);
	...
	@OriginalMember(owner = "client!aes", name = "b", descriptor = "()V", line = 82)
	void method2637() {
	...
	@OriginalMember(owner = "client!aes", name = "a", descriptor = "()V", line = 82)
	void method2638() {
		@Pc(3) Class489 local3 = this.aClass104_Sub1_25.aClass489_3;
		if (this.aBoolean61) {
			OpenGL.glBindProgramARB(34336, this.aClass104_Sub1_25.anInt581 == Integer.MAX_VALUE ? this.aClass196_1.anInt3365 : this.aClass196_2.anInt3365);
	...
	@OriginalMember(owner = "client!aes", name = "g", descriptor = "()V", line = 82)
	void method2639() {
		@Pc(3) Class489 local3 = this.aClass104_Sub1_25.aClass489_3;
		if (this.aBoolean61) {
			OpenGL.glBindProgramARB(34336, this.aClass104_Sub1_25.anInt581 == Integer.MAX_VALUE ? this.aClass196_1.anInt3365 : this.aClass196_2.anInt3365);
	...
	@OriginalMember(owner = "client!aes", name = "h", descriptor = "()V", line = 104)
	void method2640() {
		if (!this.aBoolean62) {
			return;
		}
		...
		OpenGL.glProgramLocalParameter4fARB(34336, 0, local26, local18, 256.0F / (float) (this.aClass104_Sub1_25.aClass237_1.anInt3815 * -2052057497), (float) (this.aClass104_Sub1_25.aClass237_1.anInt3819 * -94478965) / 255.0F);
		this.aClass104_Sub1_25.method3882(1);
		this.aClass104_Sub1_25.method3906(this.aClass104_Sub1_25.aClass237_1.anInt3817 * -1393096381);
		this.aClass104_Sub1_25.method3882(0);
	}

	@OriginalMember(owner = "client!aes", name = "i", descriptor = "()V", line = 104)
	void method2641() {
		if (!this.aBoolean62) {
			return;
		}
	...
	@OriginalMember(owner = "client!aes", name = "j", descriptor = "()V", line = 104)
	void method2642() {
		if (!this.aBoolean62) {
			return;
		}
	...
	@OriginalMember(owner = "client!aes", name = "w", descriptor = "(Lclient!bq;I)V", line = 117)
	@Override
	void method2789(@OriginalArg(0) Class88 arg0, @OriginalArg(1) int arg1) {
		if (arg0 != null) {
			...
			this.aClass104_Sub1_25.method3887(this.aClass104_Sub1_25.aClass88_Sub2_2);
			this.aClass104_Sub1_25.method3888(1);
	...
	@OriginalMember(owner = "client!aes", name = "q", descriptor = "(Lclient!bq;I)V", line = 117)
	@Override
	...
	@OriginalMember(owner = "client!aes", name = "x", descriptor = "(Lclient!bq;I)V", line = 117)
	@Override
	...
	@OriginalMember(owner = "client!aes", name = "s", descriptor = "(II)V", line = 137)
	@Override
	void method2804(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	}

	@OriginalMember(owner = "client!aes", name = "o", descriptor = "(II)V", line = 137)
	@Override
	void method2803(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	}

	@OriginalMember(owner = "client!aes", name = "y", descriptor = "(II)V", line = 137)
	@Override
	void method2805(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	}

	@OriginalMember(owner = "client!aes", name = "f", descriptor = "(II)V", line = 137)
	@Override
