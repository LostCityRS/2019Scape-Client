...
public class class550 {
	...
	public void method8717(int arg0, int arg1, int arg2, class1196 arg3) {
	...
	public void method8718(int arg0, int arg1, int arg2, int arg3, class1199 arg4) {
		...
		arg4.method10531(new class423((float) ((arg1 << this.field6900) + this.field6924), (float) arg3, (float) ((arg2 << this.field6900) + this.field6924)));
		var6.field6971 = arg4;
	...
	public boolean method8768(class1200 arg0, boolean arg1) {
		...
		for (int var12 = var8; var12 <= var9; var12++) {
			for (int var13 = var10; var13 <= var11; var13++) {
				...
				if (var14 != null) {
					class557 var15 = class557.method644(arg0);
					class557 var16 = var14.field6964;
					if (var16 == null) {
		...
		if (arg1) {
			class423 var20 = class423.method6484(arg0.method10536().field4298);
	...
	public class1196 method8728(int arg0, int arg1, int arg2) {
		class551 var4 = this.field6928[arg0][arg1][arg2];
		if (var4 == null) {
			return null;
		}
	...
	public class557 method8738(int arg0, int arg1, int arg2) {
		class551 var4 = this.field6928[arg0][arg1][arg2];
		return var4 == null ? null : var4.field6964;
	}

	@ObfuscatedName("tx.ar(IIII)Lasv;")
	public class1196 method8767(int arg0, int arg1, int arg2) {
		class551 var4 = this.field6928[arg0][arg1][arg2];
			...
			for (int var2 = 0; var2 < this.field6910; var2++) {
				for (int var3 = 0; var3 < this.field6911; var3++) {
					...
					if (var4 != null) {
						...
						for (class557 var7 = var4.field6964; var7 != null; var7 = var7.field7058) {
						...
						for (int var14 = var10; var14 <= var11; var14++) {
							if (var14 >= 0 && var14 < this.field6911 && (!var7 || var13 >= var9 || var14 >= var11 || var14 < arg3 && arg2 != var13)) {
								...
								if (var15 != null) {
									...
									for (class557 var19 = var15.field6964; var19 != null; var19 = var19.field7058) {
	...
	public void method8845(int arg0, int arg1, int arg2, int arg3, byte[][][] arg4, int[] arg5, int[] arg6, int[] arg7, int[] arg8, int[] arg9, int arg10, byte arg11, int arg12, int arg13, boolean arg14, boolean arg15, int arg16, boolean arg17) {
		...
		if (!this.field6959.field6884) {
			...
			while (var34.hasNext()) {
				class552 var35 = (class552) var34.next();
				var34.remove();
	...
	public void method8745(class1019 arg0) {
		class423 var2 = arg0.method10536().field4298;
	...
	public boolean method8748(class1019 arg0, boolean arg1, byte[][][] arg2, int arg3, byte arg4) {
		if (!this.field6955) {
			...
			class423 var12 = arg0.method10536().field4298;
	...
	public void method8749(class1019 arg0, class973[] arg1) {
		...
		if (this.field6917 == this.field6913) {
			boolean var4 = false;
			boolean var5 = false;
			class423 var6 = arg0.method10536().field4298;
			int var7;
			int var8;
		...
		class552 var12 = arg0.method17372(this.field6907);
		if (var12 == null) {
			return;
		}
		if (var12.field6977) {
