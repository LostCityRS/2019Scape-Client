...
public final class Exception_Sub5 extends Exception {
	...
	@OriginalMember(owner = "client!apl", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/Throwable;)V")
	...
	@OriginalMember(owner = "client!apl", name = "<init>", descriptor = "(ILjava/lang/String;)V")
