...
public class Class681 {
	...
	int[] anIntArray519 = new int[1000];
	...
	int anInt5889 = -2047914607;

	@OriginalMember(owner = "client!yf", name = "<init>", descriptor = "()V", line = 48)
	Class681() {
	}

	@OriginalMember(owner = "client!yf", name = "c", descriptor = "([J[Ljava/lang/Object;III)V", line = 222)
	static void method33245(@OriginalArg(0) long[] arg0, @OriginalArg(1) Object[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg2 >= arg3) {
			return;
		}
		...
		method33245(arg0, arg1, arg2, local10 - 1, -1942541066);
		method33245(arg0, arg1, local10 + 1, arg3, -1028044048);
	}
}
