...
import com.jagex.game.runetek5.config.skyboxtype.SkyBoxType;
...
public class Component {
	...
	public ServerActiveProperties field2268 = ServerActiveProperties.field11386;
	...
	public NpcTypeCustomization field2363;
	...
	public void method3938(Packet arg0) {
		...
		int var21 = -1;
		if (ServerActiveProperties.method16667(var7) != 0) {
			var21 = arg0.g2();
			if (var21 == 65535) {
				var21 = -1;
			}
		...
		this.field2268 = new ServerActiveProperties(var7, var21);
		if (var2 >= 0) {
			int var22 = arg0.g1();
