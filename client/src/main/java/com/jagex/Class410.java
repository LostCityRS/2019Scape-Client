...
public class Class410 {
	...
	static final int anInt4705 = 128;

	@OriginalMember(owner = "client!ly", name = "e", descriptor = "I")
	static final int anInt4706 = 7;
	...
	@OriginalMember(owner = "client!ly", name = "<init>", descriptor = "(Lclient!afc;Lclient!lg;Lclient!aem;IIIII)V", line = 25)
	Class410(@OriginalArg(0) Class104_Sub2 arg0, @OriginalArg(1) Class397 arg1, @OriginalArg(2) Class99_Sub3 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		...
		if (local25 > 0) {
			this.anInt4711 = Integer.MIN_VALUE;
			this.anInt4712 = Integer.MAX_VALUE;
			this.anInterface40_8 = this.aClass104_Sub2_39.method21165(false);
			this.anInterface40_8.method29351(local25);
				...
				for (@Pc(114) int local114 = 0; local114 < local23; local114++) {
					...
					if (local123 != null) {
						for (@Pc(127) int local127 = 0; local127 < local123.length; local127++) {
							...
							if (local137 < this.anInt4712) {
								this.anInt4712 = local137;
							}
							if (local137 > this.anInt4711) {
								this.anInt4711 = local137;
							}
			...
			this.anInterface40_8.method29333(0, local93.position(), this.aClass104_Sub2_39.aLong132);
			this.anInt4710 = local25 / 3;
		} else {
			this.anInt4710 = 0;
	...
	@OriginalMember(owner = "client!ly", name = "k", descriptor = "(Lclient!jj;)V", line = 72)
	void method28590(@OriginalArg(0) Class131 arg0) {
		this.method28593(arg0, this.anInterface40_8, 0, this.anInt4710);
	}

	@OriginalMember(owner = "client!ly", name = "e", descriptor = "(Lclient!jj;)V", line = 72)
	void method28591(@OriginalArg(0) Class131 arg0) {
		this.method28593(arg0, this.anInterface40_8, 0, this.anInt4710);
	}

	@OriginalMember(owner = "client!ly", name = "f", descriptor = "(Lclient!jj;)V", line = 72)
	void method28592(@OriginalArg(0) Class131 arg0) {
		this.method28593(arg0, this.anInterface40_8, 0, this.anInt4710);
	}

	@OriginalMember(owner = "client!ly", name = "n", descriptor = "(Lclient!jj;Lclient!ml;II)V", line = 76)
	void method28593(@OriginalArg(0) Class131 arg0, @OriginalArg(1) Interface40 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg3 <= 0) {
			return;
		}
		this.method28595();
		this.aClass104_Sub2_39.method21180(arg1);
		arg0.anInterface38_18 = this.anInterface38_25;
		arg0.anInt1140 = this.anInt4712;
		arg0.anInt1141 = this.anInt4711 - this.anInt4712 + 1;
		arg0.anInt1138 = arg2;
		arg0.anInt1137 = arg3;
		arg0.method10103(false);
	}

	@OriginalMember(owner = "client!ly", name = "w", descriptor = "(Lclient!jj;Lclient!ml;II)V", line = 76)
	void method28594(@OriginalArg(0) Class131 arg0, @OriginalArg(1) Interface40 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg3 <= 0) {
			return;
		}
		this.method28595();
	...
	@OriginalMember(owner = "client!ly", name = "m", descriptor = "()V", line = 89)
	void method28595() {
		if (!this.aBoolean748) {
			return;
		}
		this.aBoolean748 = false;
		@Pc(10) byte[] local10 = this.aClass397_2.aByteArray90;
		@Pc(12) int local12 = 0;
		@Pc(16) int local16 = this.aClass397_2.anInt4669;
		@Pc(26) int local26 = this.anInt4707 + this.anInt4708 * this.aClass397_2.anInt4669;
		@Pc(28) int local28;
		...
		if (this.anInterface38_25 != null && this.anInt4709 == local12) {
			this.aBoolean748 = false;
			return;
		}
		this.anInt4709 = local12;
		local28 = 0;
		local26 = this.anInt4707 + this.anInt4708 * local16;
		@Pc(98) int local98;
		@Pc(102) int local102;
		@Pc(116) int local116;
		if (!this.aClass104_Sub2_39.method21144(Class206.aClass206_19, Class226.aClass226_22)) {
			if (this.anIntArray440 == null) {
				this.anIntArray440 = new int[16384];
			}
			@Pc(208) int[] local208 = this.anIntArray440;
			for (local98 = -128; local98 < 0; local98++) {
				...
				local26 += this.aClass397_2.anInt4669 - 128;
			}
			if (this.anInterface38_25 == null) {
				this.anInterface38_25 = this.aClass104_Sub2_39.method21038(128, 128, false, this.anIntArray440);
				this.anInterface38_25.method11344(false, false);
			} else {
				this.anInterface38_25.method11345(0, 0, 128, 128, this.anIntArray440, 0, 128);
			}
			return;
		}
		...
		@Pc(96) byte[] local96 = this.aByteArray91;
		for (local98 = -128; local98 < 0; local98++) {
			for (local102 = -128; local102 < 0; local102++) {
				if (local10[local26] == 0) {
					local116 = 0;
		...
		if (this.anInterface38_25 == null) {
			this.anInterface38_25 = this.aClass104_Sub2_39.method21042(Class206.aClass206_19, 128, 128, false, this.aByteArray91);
			this.anInterface38_25.method11344(false, false);
		} else {
			this.anInterface38_25.method11356(0, 0, 128, 128, this.aByteArray91, Class206.aClass206_19, 0, 128);
		}
	}
}
