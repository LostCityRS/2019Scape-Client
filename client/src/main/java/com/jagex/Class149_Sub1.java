...
public final class Class149_Sub1 extends Class149 {
	...
	@OriginalMember(owner = "client!ajc", name = "bl", descriptor = "(Lclient!yf;I)V")
	static void method11777(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	@OriginalMember(owner = "client!ajc", name = "d", descriptor = "(Lclient!st;S)Z")
	static boolean method11778(@OriginalArg(0) Interface61 arg0, @OriginalArg(1) short arg1) {
		@Pc(9) Class610 local9 = (Class610) client.aClass532_1.method30647(912481518).method18273(arg0.method13423(-1037211373), 1840718394);
		if (local9.anInt5762 * -303013723 == -1) {
			return true;
		} else {
			@Pc(26) Class65 local26 = (Class65) Class466.aClass32_Sub20_3.method18273(local9.anInt5762 * -303013723, -2043580661);
			return local26.anInt232 * -1612489907 == -1 ? true : local26.method1177(-196635201);
		}
	}

	@OriginalMember(owner = "client!ajc", name = "<init>", descriptor = "(IIII)V")
	...
	@OriginalMember(owner = "client!ajc", name = "n", descriptor = "(IIIII)V")
	...
	@OriginalMember(owner = "client!ajc", name = "m", descriptor = "(IIII)V")
	...
	@OriginalMember(owner = "client!ajc", name = "k", descriptor = "(IIII)V")
	...
	@OriginalMember(owner = "client!ajc", name = "f", descriptor = "(IIII)V")
