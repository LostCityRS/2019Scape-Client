...
public class MapElementType implements ConfigType {
	...
	public boolean method4030(class151 arg0, class147 arg1) {
		...
		if (this.field2387 == -1) {
			...
			class149 var4 = arg0.method695(VarDomainType.field4594, this.field2387);
		...
		if (this.field2391 == -1) {
			...
			class149 var9 = arg0.method695(VarDomainType.field4594, this.field2391);
	...
	public final MapElementType method4024(class151 arg0, class147 arg1) {
		...
		if (this.field2371 != -1) {
			...
			class149 var5 = arg0.method695(VarDomainType.field4594, this.field2387);
			if (var5 != null) {
