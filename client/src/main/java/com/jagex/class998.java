...
public class class998 extends Node {
	...
	public void method18163(Packet arg0) {
		if (arg0 == null || arg0.data == null) {
			...
			if (var2 < 23) {
				...
				if (var2 >= 29) {
					this.field11514 = new class1055(arg0.g1(), this);
				}
				this.field11537 = new class1052(arg0.g1(), this);
				if (var2 >= 31) {
					this.field11517 = new class1058(arg0.g1(), this);
				}
				this.field11516 = new class1052(this.field11537.method18639(), this);
				this.field11519 = new class1050(arg0.g1(), this);
				this.field11549 = new class1025(arg0.g1(), this);
				this.field11520 = new class1043(arg0.g1(), this);
				if (var2 >= 27) {
					this.field11522 = new class1057(arg0.g1(), this);
				}
				this.field11523 = new class1026(arg0.g1(), this);
				this.field11564 = new class1028(arg0.g1(), this);
				this.field11525 = new class1054(arg0.g1(), this);
				this.field11526 = new class1033(arg0.g1(), this);
				this.field11546 = new class1053(arg0.g1(), this);
				this.field11528 = new class1022(arg0.g1(), this);
				this.field11529 = new class1037(arg0.g1(), this);
				if (var2 >= 33) {
					this.field11530 = new class1030(arg0.g1(), this);
				}
				if (var2 >= 34) {
					arg0.g1();
				}
				if (var2 >= 24) {
					this.field11531 = new class1036(arg0.g1(), this);
				}
				this.field11532 = new class1031(arg0.g1(), this);
				this.field11533 = new class1034(arg0.g1(), this);
				this.field11534 = new class1034(this.field11533.method18496(), this);
				this.field11539 = new class1044(arg0.g1(), this);
				if (var2 >= 25) {
					this.field11508 = new class1048(arg0.g1(), this);
				}
				this.field11568 = new class1029(arg0.g1(), this);
				if (var2 <= 25) {
					arg0.pos++;
				}
				this.field11538 = new class1027(arg0.g1(), this);
				this.field11524 = new class1041(arg0.g1(), this);
				this.field11540 = new class1041(this.field11524.method18545(), this);
				arg0.g1();
				this.field11541 = new class1038(arg0.g1(), this);
				this.field11542 = new class1040(arg0.g1(), this);
				if (var2 >= 35) {
					this.field11545 = new class1047(arg0.g1(), this);
					this.field11527 = new class1039(arg0.g1(), this);
					this.field11547 = new class1035(arg0.g1(), this);
					this.field11544 = new class1024(arg0.g1(), this);
					this.field11548 = new class1046(arg0.g1(), this);
					this.field11555 = new class1045(arg0.g1b(), this);
				}
				if (var2 >= 36) {
					this.field11550 = new class1056(arg0.g1(), this);
					this.field11518 = new class1042(arg0.g1(), this);
				}
				if (var2 >= 37) {
					this.field11552 = new class1051(arg0.g2(), this);
					this.field11553 = new class1032(arg0.g2(), this);
				}
				if (var2 >= 38) {
					this.field11551 = new class1023(arg0.g2(), this);
					this.field11554 = new class1049(arg0.g2(), this);
				}
				this.field11543 = new class1040(this.field11542.method18539(), this);
				this.field11556 = new class1068(arg0.g1(), this);
				this.field11515 = new class1062(arg0.g1(), this);
				this.field11560 = new class1063(arg0.g1(), this);
				this.field11559 = new class1061(arg0.g1(), this);
				this.field11536 = new class1064(arg0.g1(), this);
				if (var2 >= 26) {
					this.field11561 = new class1065(arg0.g1(), this);
				}
				if (var2 >= 28) {
					this.field11562 = new class1060(arg0.g1(), this);
				}
				if (var2 >= 30) {
					this.field11521 = new class1059(arg0.g1(), this);
				}
				this.field11563 = new class1067(arg0.g1(), this);
				this.field11511 = new class1067(arg0.g1(), this);
				this.field11565 = new class1067(arg0.g1(), this);
				this.field11566 = new class1067(arg0.g1(), this);
				this.field11567 = new class1067(arg0.g1(), this);
				this.field11557 = new class1066(arg0.g1(), this);
	...
	public void method18155(Packet arg0, int arg1) {
		this.field11549 = new class1025(arg0.g1(), this);
		arg0.pos++;
		this.field11533 = new class1034(arg0.g1() + 1, this);
		this.field11526 = new class1033(arg0.g1(), this);
		arg0.pos++;
		this.field11546 = new class1053(arg0.g1(), this);
		this.field11523 = new class1026(arg0.g1(), this);
	...
	public Packet method18156() {
		...
		var1.p1(38);
		var1.p1(this.field11514.method18665());
		var1.p1(this.field11537.method18639());
		var1.p1(this.field11517.method18695());
		var1.p1(this.field11519.method18625());
		var1.p1(this.field11549.method18408());
		var1.p1(this.field11520.method18570());
		var1.p1(this.field11522.method18688());
		var1.p1(this.field11523.method18419());
		var1.p1(this.field11564.method18434());
		var1.p1(this.field11525.method18651());
		var1.p1(this.field11526.method18489());
		var1.p1(this.field11546.method18645());
		var1.p1(this.field11528.method18389());
		var1.p1(this.field11529.method18515());
		var1.p1(this.field11530.method18458());
		var1.p1(0);
		var1.p1(this.field11531.method18504());
		var1.p1(this.field11532.method18468());
		var1.p1(this.field11533.method18496());
		var1.p1(this.field11539.method18581());
		var1.p1(this.field11508.method18607());
		var1.p1(this.field11568.method18453());
		var1.p1(this.field11538.method18426());
		var1.p1(this.field11524.method18545());
		var1.p1(0);
		var1.p1(this.field11541.method18522());
		var1.p1(this.field11542.method18539());
		var1.p1(this.field11545.method18601());
		var1.p1(this.field11527.method18533());
		var1.p1(this.field11547.method18498());
		var1.p1(this.field11544.method18400());
		var1.p1(this.field11548.method18594());
		var1.p1(this.field11555.method18588());
		var1.p1(this.field11550.method18676());
		var1.p1(this.field11518.method18559());
		var1.p2(this.field11552.method18633());
		var1.p2(this.field11553.method18482());
		var1.p2(this.field11551.method18391());
		var1.p2(this.field11554.method18621());
		var1.p1(this.field11556.method18771());
		var1.p1(this.field11515.method18721());
		var1.p1(this.field11560.method18735());
		var1.p1(this.field11559.method18714());
		var1.p1(this.field11536.method18740());
		var1.p1(this.field11561.method18750());
		var1.p1(this.field11562.method18707());
		var1.p1(this.field11521.method18701());
		var1.p1(this.field11563.method18763());
		var1.p1(this.field11511.method18763());
		var1.p1(this.field11565.method18763());
		var1.p1(this.field11566.method18763());
		var1.p1(this.field11567.method18763());
		var1.p1(this.field11557.method18758());
		return var1;
	}
