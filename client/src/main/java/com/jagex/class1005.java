...
public class class1005 extends Stream {
	...
	public class559 field11678;

	@ObfuscatedName("all.m")
	public class562 field11676;

	public class1005(Socket arg0, int arg1, int arg2) throws IOException {
		...
		this.field11678 = new class559(this.field11677.getInputStream(), arg1);
		this.field11676 = new class562(this.field11677.getOutputStream(), arg2);
	}
