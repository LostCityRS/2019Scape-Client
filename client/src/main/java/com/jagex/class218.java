...
@ObfuscatedName("hk")
public class class218 implements class365 {
	...
	@ObfuscatedName("hk.z")
	public class372 field2052;

	@ObfuscatedName("hk.p")
	public class370 field2053;
	...
	@ObfuscatedName("hk.y")
	public class219[] field2060;

	@ObfuscatedName("hk.q")
	public class216[] field2061;

	@ObfuscatedName("hk.x")
	public class215[] field2062;

	@ObfuscatedName("hk.b")
	public class221[] field2063;

	@ObfuscatedName("hk.h")
	public boolean[] field2064;

	@ObfuscatedName("hk.a")
	public int[] field2065;

	@ObfuscatedName("hk.g")
	public class220[] field2066;
	...
	public class220[] field2070;

	@ObfuscatedName("hk.ag")
	public class220 field2071;

	@ObfuscatedName("hk.ah")
	public class220 field2072;

	@ObfuscatedName("hk.al")
	public class220 field2073;

	@ObfuscatedName("hk.ac")
	public class220 field2074;

	@ObfuscatedName("hk.ai")
	public class220 field2075;

	@ObfuscatedName("hk.aw")
	public class220 field2069;
	...
	public class218(float arg0) {
		this.field2059 = arg0;
		this.field2052 = class372.field3441;
		this.field2053 = class370.field3439;
	...
	public class372 method3733() {
		return this.field2052;
	}

	@ObfuscatedName("hk.v()Lmw;")
	public class370 method3734() {
		return this.field2053;
	}

	@ObfuscatedName("hk.o(ILnd;Lmw;I)V")
	public void method3774(int arg0, class372 arg1, class370 arg2, int arg3) {
		this.field2081 = arg3;
	...
	public boolean method3723(int arg0, class372 arg1, class370 arg2) {
		if (class372.field3441 == arg1) {
			return true;
		} else if (class372.field3442 == arg1) {
			return true;
		} else if (class372.field3440 == arg1) {
			return true;
		} else {
			return class372.field3443 == arg1;
		}
	}
	...
	public class220[] method3753(int arg0, int arg1) {
		class220[] var3 = new class220[arg0];
	...
	public class220 method3836(int arg0) {
		...
		synchronized (field2067) {
			...
			while (var4 != null) {
				...
				var4 = (class220) field2067.method2937();
			}
			if (var4 == null) {
				var4 = var5;
			}
			if (var4 == null) {
				var4 = new class220(this);
				int var7 = 0;
				boolean var8 = false;
	...
	public void method3743(class220[] arg0) {
		if (arg0 != null) {
	...
	public int method3853(int arg0) {
		int var2 = 0;
		int var3 = 0;
	...
	public void method3757() {
		...
		do {
			if (!var2.hasNext()) {
				this.field2060 = new class219[var1];
				for (int var5 = 0; var5 < var1; var5++) {
					if (this.field2060[var5] == null) {
						this.field2060[var5] = new class219();
					}
		...
		for (int var4 = 0; var4 < this.field2060.length; var4++) {
			this.field2060[var4].method3880(this);
		}
	}

	@ObfuscatedName("hk.ar([BI)V")
	public void method3758(byte[] arg0, int arg1) {
		this.field2101 = 0;
		if (this.method3868()) {
			return;
		}
		...
		if (var4 == 1) {
			...
			int var5 = this.method3853(32);
			this.field2045 = this.method3853(8);
			this.field2076 = this.method3853(32);
			this.field2046 = this.method3853(32);
			this.field2055 = this.method3853(32);
			this.field2048 = this.method3853(32);
			this.field2058 = 0x1 << this.method3853(4);
			this.field2051 = 0x1 << this.method3853(4);
			int var6 = 0x1 << this.method3853(1);
			if (var5 != 0 || var6 == 0) {
				throw new RuntimeException("");
			}
			this.field2086 = true;
			...
			for (int var7 = 0; var7 < 2; var7++) {
				...
				int var10 = var8 >> 2;
				int var11 = var8 >> 3;
				class220 var12 = this.method3836(var9);
				...
				class220 var14 = this.method3836(var9);
				...
				class220 var16 = this.method3836(var10);
				...
				int var19 = class783.method8327(var11 - 1);
				for (int var20 = 0; var20 < var11; var20++) {
					var18[var20] = class783.method6012(var20, var19);
				}
				if (var7 == 0) {
			...
			this.method3757();
			int var21 = this.method3853(6) + 1;
			for (int var22 = 0; var22 < var21; var22++) {
				this.method3853(16);
			}
			int var23 = this.method3853(6) + 1;
			if (this.field2061 == null || this.field2061.length != var23) {
				this.field2061 = new class216[var23];
			}
			for (int var24 = 0; var24 < var23; var24++) {
				if (this.field2061[var24] == null) {
					this.field2061[var24] = new class216();
				}
				this.field2061[var24].method3681(this, this.field2045);
			}
			int var25 = this.method3853(6) + 1;
			if (this.field2062 == null || this.field2062.length != var25) {
				this.field2062 = new class215[var25];
			}
			for (int var26 = 0; var26 < var25; var26++) {
				if (this.field2062[var26] == null) {
					this.field2062[var26] = new class215();
				}
				this.field2062[var26].method3674(this);
			}
			int var27 = this.method3853(6) + 1;
			if (this.field2063 == null || this.field2063.length != var27) {
				this.field2063 = new class221[var27];
			}
			for (int var28 = 0; var28 < var27; var28++) {
				if (this.field2063[var28] == null) {
					this.field2063[var28] = new class221();
				}
				this.field2063[var28].method3898(this);
			}
			int var29 = this.method3853(6) + 1;
			this.field2064 = new boolean[var29];
			this.field2065 = new int[var29];
			for (int var30 = 0; var30 < var29; var30++) {
				this.field2064[var30] = this.method3845() != 0;
				this.method3853(16);
				this.method3853(16);
				this.field2065[var30] = this.method3853(8);
			}
	...
	public boolean method3776(byte[] arg0, int arg1, int arg2, AtomicReference arg3) {
		if (arg0 == null) {
			...
			if (var5 != 0) {
				this.method3758(arg0, arg1);
				return false;
			} else if (this.method3868()) {
				int var6 = this.method3853(this.method3759(this.field2065.length - 1));
				boolean var7 = this.field2064[var6];
				...
				class221 var18 = this.field2063[this.field2065[var6]];
				...
				for (int var19 = 0; var19 < this.field2045; var19++) {
					...
					this.field2111[var19] = !this.field2061[var22].method3687(var19);
				...
				for (int var24 = 0; var24 < var18.field2130; var24++) {
					...
					class215 var28 = this.field2062[var18.field2128[var24]];
					Object var29 = null;
					class220[] var35;
					if (var28.field2019 == 2) {
						class220[] var30 = this.method3753(1, this.field2045 * var8);
						int var31 = 0;
						while (true) {
							if (var31 >= var8) {
								class220[] var34 = var28.method3676(var30, var8 >> 1, this.field2080);
				...
				for (int var43 = var18.field2132 - 1; var43 >= 0; var43--) {
					class220 var44 = this.field2070[var18.field2127[var43]];
					class220 var45 = this.field2070[var18.field2133[var43]];
				...
				for (int var54 = 0; var54 < this.field2045; var54++) {
					if (!this.field2111[var54]) {
						...
						this.field2061[var57].method3688(var54);
						this.field2061[var57].method3689(this.field2070[var54], var8 >> 1, var54);
					}
				}
				for (int var58 = 0; var58 < this.field2045; var58++) {
					if (this.field2111[var58]) {
						...
						int var61 = var8 >> 2;
						int var62 = var8 >> 3;
						class220 var63 = this.field2070[var58];
						...
						class220 var66 = var7 ? this.field2074 : this.field2071;
						class220 var67 = var7 ? this.field2075 : this.field2072;
						class220 var68 = var7 ? this.field2069 : this.field2073;
						...
						int var82 = class783.method8327(var8 - 1);
				...
				class220[] var132 = this.field2066;
