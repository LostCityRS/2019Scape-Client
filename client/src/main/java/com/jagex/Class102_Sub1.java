...
public final class Class102_Sub1 extends Class102 {
	...
	@OriginalMember(owner = "client!aep", name = "<init>", descriptor = "(Lclient!afa;[I)V")
	...
	@OriginalMember(owner = "client!aep", name = "m", descriptor = "()Lclient!bq;")
	Class88 method2580() {
		return this.aClass88_1;
	}

	@OriginalMember(owner = "client!aep", name = "e", descriptor = "()Lclient!bq;")
	Class88 method2581() {
		return this.aClass88_1;
	}

	@OriginalMember(owner = "client!aep", name = "n", descriptor = "([I)[B")
	...
	@OriginalMember(owner = "client!aep", name = "l", descriptor = "([I)[B")
	...
	@OriginalMember(owner = "client!aep", name = "k", descriptor = "([I)[B")
	...
	@OriginalMember(owner = "client!aep", name = "f", descriptor = "([I)[B")
	...
	@OriginalMember(owner = "client!aep", name = "w", descriptor = "([I)[B")
